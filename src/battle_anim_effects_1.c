...
struct {
  ...
  s16 targetX;
  s16 targetY;
} static EWRAM_DATA sFrenzyPlantRootData = {
    0}; // Debug? Written to but never read.
...
const union AnimCmd gPowderParticlesAnimCmds[] = {
    ANIMCMD_FRAME(0, 5),  ANIMCMD_FRAME(2, 5),  ANIMCMD_FRAME(4, 5),
    ANIMCMD_FRAME(6, 5),  ANIMCMD_FRAME(8, 5),  ANIMCMD_FRAME(10, 5),
    ANIMCMD_FRAME(12, 5), ANIMCMD_FRAME(14, 5), ANIMCMD_JUMP(0),
};
...
const union AnimCmd *const gSolarBeamBigOrbAnimTable[] = {
    gSolarBeamBigOrbAnimCmds1, gSolarBeamBigOrbAnimCmds2,
    gSolarBeamBigOrbAnimCmds3, gSolarBeamBigOrbAnimCmds4,
    gSolarBeamBigOrbAnimCmds5, gSolarBeamBigOrbAnimCmds6,
...
const union AnimCmd gRazorLeafParticleAnimCmds1[] = {
    ...
    ANIMCMD_FRAME(16, 5), ANIMCMD_FRAME(12, 5), ANIMCMD_FRAME(8, 5),
...
static const union AnimCmd sAnim_ConstrictBinding[] = {
    ANIMCMD_FRAME(0, 4),  ANIMCMD_FRAME(32, 4), ANIMCMD_FRAME(64, 4),
    ANIMCMD_FRAME(96, 4), ANIMCMD_END,
};
...
const union AnimCmd gIngrainRootAnimCmds1[] = {
    ANIMCMD_FRAME(0, 7),  ANIMCMD_FRAME(16, 7), ANIMCMD_FRAME(32, 7),
    ANIMCMD_FRAME(48, 7), ANIMCMD_END,
};
...
const union AnimCmd gPresentHealParticleAnimCmds[] = {
    ...
    ANIMCMD_FRAME(12, 4), ANIMCMD_END,
};
...
const union AnimCmd *const gLeafBladeAnimTable[] = {
    gLeafBladeAnimCmds1, gLeafBladeAnimCmds2, gLeafBladeAnimCmds3,
    gLeafBladeAnimCmds4, gLeafBladeAnimCmds5, gLeafBladeAnimCmds6,
    gLeafBladeAnimCmds7,
};
...
const u16 gMagicalLeafBlendColors[] = {
    RGB_RED,        RGB(31, 19, 0),  RGB_YELLOW,      RGB_GREEN,
    RGB(5, 14, 31), RGB(22, 10, 31), RGB(22, 21, 31),
};
...
static const union AnimCmd sAnim_Whip[] = {
    ANIMCMD_FRAME(64, 3),  ANIMCMD_FRAME(80, 3), ANIMCMD_FRAME(96, 3),
    ANIMCMD_FRAME(112, 6), ANIMCMD_END,
};
...
const union AffineAnimCmd gMilkBottleAffineAnimCmds2[] = {
    AFFINEANIMCMD_FRAME(0x0, 0x0, 2, 12),  AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 6),
    AFFINEANIMCMD_FRAME(0x0, 0x0, -2, 24), AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 6),
    AFFINEANIMCMD_FRAME(0x0, 0x0, 2, 12),  AFFINEANIMCMD_JUMP(0),
};
...
const union AnimCmd gGrantingStarsAnimCmds[] = {
    ANIMCMD_FRAME(0, 7),  ANIMCMD_FRAME(16, 7),  ANIMCMD_FRAME(32, 7),
    ANIMCMD_FRAME(48, 7), ANIMCMD_FRAME(64, 7),  ANIMCMD_FRAME(80, 7),
    ANIMCMD_FRAME(96, 7), ANIMCMD_FRAME(112, 7), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_BubbleBurst[] = {
    ...
    ANIMCMD_FRAME(12, 10), ANIMCMD_FRAME(16, 26), ANIMCMD_FRAME(16, 5),
    ANIMCMD_FRAME(20, 5),  ANIMCMD_FRAME(24, 15), ANIMCMD_END,
};
...
const union AnimCmd gEndureEnergyAnimCmds[] = {
    ANIMCMD_FRAME(0, 4),  ANIMCMD_FRAME(8, 12), ANIMCMD_FRAME(16, 4),
    ANIMCMD_FRAME(24, 4), ANIMCMD_END,
};
...
const union AnimCmd gSharpenSphereAnimCmds[] = {
    ANIMCMD_FRAME(0, 18), ANIMCMD_FRAME(0, 6),   ANIMCMD_FRAME(16, 18),
    ANIMCMD_FRAME(0, 6),  ANIMCMD_FRAME(16, 6),  ANIMCMD_FRAME(32, 18),
    ANIMCMD_FRAME(16, 6), ANIMCMD_FRAME(32, 6),  ANIMCMD_FRAME(48, 18),
    ANIMCMD_FRAME(32, 6), ANIMCMD_FRAME(48, 6),  ANIMCMD_FRAME(64, 18),
    ANIMCMD_FRAME(48, 6), ANIMCMD_FRAME(64, 54), ANIMCMD_END,
};
...
const union AnimCmd gConversionAnimCmds[] = {
    ANIMCMD_FRAME(3, 5), ANIMCMD_FRAME(2, 5), ANIMCMD_FRAME(1, 5),
...
const union AnimCmd gConversion2AnimCmds[] = {
    ANIMCMD_FRAME(0, 5), ANIMCMD_FRAME(1, 5), ANIMCMD_FRAME(2, 5),
...
const union AnimCmd gMoonlightSparkleAnimCmds[] = {
    ...
    ANIMCMD_FRAME(12, 8), ANIMCMD_JUMP(0),
};
...
const union AnimCmd gHealingBlueStarAnimCmds[] = {
    ANIMCMD_FRAME(0, 2),  ANIMCMD_FRAME(16, 2), ANIMCMD_FRAME(32, 2),
    ANIMCMD_FRAME(48, 3), ANIMCMD_FRAME(64, 5), ANIMCMD_FRAME(80, 3),
    ANIMCMD_FRAME(96, 2), ANIMCMD_FRAME(0, 2),  ANIMCMD_END,
};
...
const union AnimCmd gSuperFangAnimCmds[] = {
    ANIMCMD_FRAME(0, 2),  ANIMCMD_FRAME(16, 2), ANIMCMD_FRAME(32, 2),
    ANIMCMD_FRAME(48, 2), ANIMCMD_END,
};
...
const union AnimCmd *const gMusicNotesAnimTable[] = {
    gWavyMusicNotesAnimCmds1, gWavyMusicNotesAnimCmds2,
    gWavyMusicNotesAnimCmds3, gWavyMusicNotesAnimCmds4,
    gWavyMusicNotesAnimCmds5, gWavyMusicNotesAnimCmds6,
    gWavyMusicNotesAnimCmds7, gWavyMusicNotesAnimCmds8,
};
...
const u16 gParticlesColorBlendTable[][6] = {
    {ANIM_TAG_MUSIC_NOTES, RGB_WHITE, RGB(31, 26, 28), RGB(31, 22, 26),
     RGB(31, 17, 24), RGB(31, 13, 22)},
    {ANIM_TAG_BENT_SPOON, RGB_WHITE, RGB(25, 31, 26), RGB(20, 31, 21),
     RGB(15, 31, 16), RGB(10, 31, 12)},
    {ANIM_TAG_SPHERE_TO_CUBE, RGB_WHITE, RGB(31, 31, 24), RGB(31, 31, 17),
     RGB(31, 31, 10), RGB(31, 31, 3)},
    {ANIM_TAG_LARGE_FRESH_EGG, RGB_WHITE, RGB(26, 28, 31), RGB(21, 26, 31),
     RGB(16, 24, 31), RGB(12, 22, 31)},
};
...
const union AnimCmd gMetronomeThroughtBubbleAnimCmds4[] = {
    ANIMCMD_FRAME(48, 2), ANIMCMD_FRAME(32, 2), ANIMCMD_FRAME(16, 2),
...
const union AnimCmd gTauntFingerAnimCmds3[] = {
    ANIMCMD_FRAME(0, 4),  ANIMCMD_FRAME(16, 4), ANIMCMD_FRAME(32, 4),
    ANIMCMD_FRAME(16, 4), ANIMCMD_FRAME(0, 4),  ANIMCMD_FRAME(16, 4),
    ANIMCMD_FRAME(32, 4), ANIMCMD_END,
};
...
static void AnimPetalDanceBigFlower_Step(struct Sprite *sprite) {
  if (!AnimTranslateLinear(sprite)) {
    ...
    if ((u16)(sprite->data[5] - 0x40) < 0x80)
      sprite->subpriority =
          GetBattlerSpriteSubpriority(gBattleAnimAttacker) - 1;
    else
      sprite->subpriority =
          GetBattlerSpriteSubpriority(gBattleAnimAttacker) + 1;
...
static void AnimTranslateLinearSingleSineWave(struct Sprite *sprite) {
  ...
  if (!gBattleAnimArgs[6]) {
    ...
    SetAverageBattlerPositions(gBattleAnimTarget, TRUE, &sprite->data[2],
                               &sprite->data[4]);
    sprite->data[2] += gBattleAnimArgs[2];
...
static void AnimTranslateLinearSingleSineWave_Step(struct Sprite *sprite) {
  ...
  if (sprite->x + sprite->x2 > DISPLAY_WIDTH + 16 ||
      sprite->x + sprite->x2 < -16 || sprite->y + sprite->y2 > DISPLAY_HEIGHT ||
...
void AnimTask_ShrinkTargetCopy(u8 taskId) {
  ...
  if (gSprites[spriteId].invisible) {
    ...
    gSprites[spriteId].oam.priority =
        GetBattlerSpriteBGPriority(gBattleAnimTarget);
...
static void AnimTask_DuplicateAndShrinkToPos_Step1(u8 taskId) {
  ...
  SetSpriteRotScale(spriteId, gTasks[taskId].data[11], gTasks[taskId].data[11],
                    0);
...
static void AnimMimicOrb(struct Sprite *sprite) {
  ...
  case 1:
    ...
    if (sprite->affineAnimEnded) {
      ...
      sprite->data[2] =
          GetBattlerSpriteCoord(gBattleAnimAttacker, BATTLER_COORD_X_2);
      sprite->data[4] = GetBattlerSpriteCoord(gBattleAnimAttacker,
...
// Places a root on the path to the target mon that flickers away after some
// time. arg 0: percent along the path to the target mon arg 1: x pixel offset
...
static void AnimTrickBag_Step2(struct Sprite *sprite) {
  if (sprite->data[2] == gTrickBagCoordinates[sprite->data[0]][1]) {
    ...
    sprite->data[2]++;
    sprite->data[1] = (gTrickBagCoordinates[sprite->data[0]][0] *
...
void AnimTask_LeafBlade(u8 taskId) {
  ...
  task->data[7] =
      GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET);
  task->data[10] =
      GetBattlerSpriteCoordAttr(gBattleAnimTarget, BATTLER_COORD_ATTR_WIDTH);
  task->data[11] =
      GetBattlerSpriteCoordAttr(gBattleAnimTarget, BATTLER_COORD_ATTR_HEIGHT);
  task->data[5] =
      (GetBattlerSide(gBattleAnimTarget) == B_SIDE_OPPONENT) ? 1 : -1;
  task->data[9] = 56 - (task->data[5] * 64);
  task->data[8] = task->data[7] - task->data[9] + task->data[6];
  task->data[2] = CreateSprite(&gLeafBladeSpriteTemplate, task->data[8],
  ...
  gSprites[task->data[2]].data[5] =
      LeafBladeGetPosFactor(&gSprites[task->data[2]]);
...
static void AnimTask_LeafBlade_Step2(struct Task *task, u8 taskId) {
  ...
  if (task->data[14] > 0) {
    ...
    spriteId = CreateSprite(&gLeafBladeSpriteTemplate, spriteX, spriteY,
                            task->data[4]);
...
void AnimTask_CycleMagicalLeafPal(u8 taskId) {
  ...
  case 1:
    if (++task->data[9] >= 0) {
      task->data[9] = 0;
      BlendPalette(task->data[8], 16, task->data[10],
                   gMagicalLeafBlendColors[task->data[11]]);
      BlendPalette(task->data[12], 16, task->data[10],
                   gMagicalLeafBlendColors[task->data[11]]);
      if (++task->data[10] == 17) {
        task->data[10] = 0;
        if (++task->data[11] == 7)
...
static void AnimNeedleArmSpike(struct Sprite *sprite) {
  ...
  if (gBattleAnimArgs[4] == 0) {
    ...
    if (gBattleAnimArgs[0] == 0) {
      ...
      b = GetBattlerSpriteCoord(gBattleAnimAttacker,
                                BATTLER_COORD_Y_PIC_OFFSET);
    } else {
...
static void AnimAirCutterSlice(struct Sprite *sprite) {
  ...
  case 1:
    x = GetBattlerSpriteCoord(BATTLE_PARTNER(gBattleAnimTarget),
                              BATTLER_COORD_X);
    y = GetBattlerSpriteCoord(BATTLE_PARTNER(gBattleAnimTarget),
                              BATTLER_COORD_Y);
    break;
  case 2:
...
static void AnimProtect(struct Sprite *sprite) {
  ...
  SetGpuReg(REG_OFFSET_BLDALPHA,
            BLDALPHA_BLEND(16 - sprite->data[7], sprite->data[7]));
...
static void AnimSparklingStars(struct Sprite *sprite) {
  ...
  if (IsDoubleBattle() && IsBattlerSpriteVisible(BATTLE_PARTNER(battler))) {
    SetAverageBattlerPositions(battler, gBattleAnimArgs[6], &sprite->x,
                               &sprite->y);
    SetAnimSpriteInitialXOffset(sprite, gBattleAnimArgs[0]);
    sprite->y += gBattleAnimArgs[1];
  } else {
    if (!gBattleAnimArgs[6]) {
      ...
      sprite->y =
          GetBattlerSpriteCoord(battler, BATTLER_COORD_Y) + gBattleAnimArgs[1];
    } else {
...
static void AnimLockOnTarget_Step1(struct Sprite *sprite) {
  ...
  case 1:
    ...
    sprite->data[0] = 8;
    sprite->data[2] =
        sprite->x + gInclineMonCoordTable[sprite->data[5] >> 8][0];
    sprite->data[4] =
        sprite->y + gInclineMonCoordTable[sprite->data[5] >> 8][1];
    sprite->callback = StartAnimLinearTranslation;
    StoreSpriteCallbackInData6(sprite, AnimLockOnTarget_Step2);
    sprite->data[5] += 0x100;
    PlaySE12WithPanning(SE_M_LOCK_ON,
                        BattleAnimAdjustPanning(SOUND_PAN_TARGET));
    break;
  }
...
static void AnimLockOnTarget_Step3(struct Sprite *sprite) {
  ...
  if (sprite->oam.affineParam == 0) {
    ...
    sprite->data[0] = 6;
    sprite->data[2] =
        GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2) + a;
    sprite->data[4] =
        GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET) +
        b;
    sprite->callback = StartAnimLinearTranslation;
...
static void AnimLockOnTarget_Step4(struct Sprite *sprite) {
  ...
  BlendPalettes(
      GetBattlePalettesMask(TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE),
      sprite->data[1], RGB_WHITE);
  if (sprite->data[1] == 16) {
    int pal;
    sprite->data[2]++;
    pal = sprite->oam.paletteNum;
    LoadPalette(&gPlttBufferUnfaded[OBJ_PLTT_ID(pal) + 8], OBJ_PLTT_ID(pal) + 1,
                PLTT_SIZEOF(2));
...
static void AnimBowMon_Step1_Callback(struct Sprite *sprite) {
  if (sprite->data[0] == 0) {
    ...
    sprite->data[4] = (sprite->data[6] = GetBattlerSide(gBattleAnimAttacker))
                          ? 0x300
                          : 0xFFFFFD00;
    sprite->data[5] = 0;
  }
...
static void AnimFalseSwipeSlice(struct Sprite *sprite) {
  sprite->x =
      GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2) + 0xFFD0;
  sprite->y =
      GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET);
...
void AnimTask_ConversionAlphaBlend(u8 taskId) {
  if (gTasks[taskId].data[2] == 1) {
    ...
    if (++gTasks[taskId].data[0] == 4) {
      gTasks[taskId].data[0] = 0;
      gTasks[taskId].data[1]++;
      SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(16 - gTasks[taskId].data[1],
                                                    gTasks[taskId].data[1]));
...
void AnimTask_MoonlightEndFade(u8 taskId) {
  ...
  c = a | b;
  StorePointerInVars(&gTasks[taskId].data[14], &gTasks[taskId].data[15],
                     (void *)c);
  ...
  case 2:
    if (++task->data[1] > 30) {
      BeginNormalPaletteFade(
          (u32)LoadPointerFromVars(task->data[14], task->data[15]), 0, 16, 0,
          RGB(27, 29, 31));
      task->data[0]++;
    }
    break;
...
static void AnimWavyMusicNotes(struct Sprite *sprite) {
  ...
  if ((index = IndexOfSpritePaletteTag(
           gParticlesColorBlendTable[gBattleAnimArgs[1]][0])) != 0xFF)
  ...
  AnimWavyMusicNotes_CalcVelocity(x - sprite->x, y - sprite->y,
                                  &sprite->sVelocX, &sprite->sVelocY, 40);
  sprite->callback = AnimWavyMusicNotes_Step;
}

static void AnimWavyMusicNotes_CalcVelocity(s16 x, s16 y, s16 *velocX,
                                            s16 *velocY, s8 xSpeedFactor) {
  int x2;
  int time;
  if (x < 0)
...
static void AnimWavyMusicNotes_Step(struct Sprite *sprite) {
  ...
  y = sprite->y;
  if (sprite->x < -16 || sprite->x > DISPLAY_WIDTH + 16 || y < -16 ||
      y > DISPLAY_HEIGHT - 32) {
    DestroySpriteAndMatrix(sprite);
  } else {
    if (sprite->sBlendCycleTime &&
        ++sprite->sBlendTimer > sprite->sBlendCycleTime) {
      sprite->sBlendTimer = 0;
      if (++sprite->sBlendTableIdx >
          (int)ARRAY_COUNT(gParticlesColorBlendTable) - 1)
        sprite->sBlendTableIdx = 0;

      index = IndexOfSpritePaletteTag(
          gParticlesColorBlendTable[sprite->sBlendTableIdx][0]);
      if (index != 0xFF)
        sprite->oam.paletteNum = index;
    }
  }
...
void AnimSlowFlyingMusicNotes(struct Sprite *sprite) {
  ...
  index =
      IndexOfSpritePaletteTag(gParticlesColorBlendTable[gBattleAnimArgs[2]][0]);
  if (index != 0xFF)
    sprite->oam.paletteNum = index;
