...
#define CURSOR_AREA_IN_HAND                                                    \
  CURSOR_AREA_BOX_TITLE // Alt name for cursor area used by Move Items
...
static const union AnimCmd sAnim_ChooseBoxMenu_TopLeft[] = {ANIMCMD_FRAME(0, 5),
                                                            ANIMCMD_END};

static const union AnimCmd sAnim_ChooseBoxMenu_BottomLeft[] = {
    ANIMCMD_FRAME(4, 5), ANIMCMD_END};

static const union AnimCmd sAnim_ChooseBoxMenu_TopRight[] = {
    ANIMCMD_FRAME(6, 5), ANIMCMD_END};

static const union AnimCmd sAnim_ChooseBoxMenu_BottomRight[] = {
    ANIMCMD_FRAME(10, 5), ANIMCMD_END};

static const union AnimCmd *const sAnims_ChooseBoxMenu[] = {
    sAnim_ChooseBoxMenu_TopLeft, sAnim_ChooseBoxMenu_BottomLeft,
    sAnim_ChooseBoxMenu_TopRight, sAnim_ChooseBoxMenu_BottomRight};
...
static const u8 sChooseBoxMenu_TextColors[] = {
...
static const u16 sChooseBoxMenu_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/box_selection_popup.gbapal");
static const u8 sChooseBoxMenuCenter_Gfx[] =
    INCBIN_U8("graphics/pokemon_storage/box_selection_popup_center.4bpp");
static const u8 sChooseBoxMenuSides_Gfx[] =
    INCBIN_U8("graphics/pokemon_storage/box_selection_popup_sides.4bpp");
static const u32 sScrollingBg_Gfx[] =
    INCBIN_U32("graphics/pokemon_storage/scrolling_bg.4bpp.lz");
static const u32 sScrollingBg_Tilemap[] =
    INCBIN_U32("graphics/pokemon_storage/scrolling_bg.bin.lz");
static const u16 sDisplayMenu_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/display_menu.gbapal"); // Unused
static const u32 sDisplayMenu_Tilemap[] =
    INCBIN_U32("graphics/pokemon_storage/display_menu.bin.lz");
static const u16 sPkmnData_Tilemap[] =
    INCBIN_U16("graphics/pokemon_storage/pkmn_data.bin");
// sInterface_Pal - parts of the display frame, "PkmnData"'s normal color, Close
// Box
static const u16 sInterface_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/interface.gbapal");
static const u16 sPkmnDataGray_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/pkmn_data_gray.gbapal");
static const u16 sScrollingBg_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/scrolling_bg.gbapal");
static const u16 sScrollingBgMoveItems_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/scrolling_bg_move_items.gbapal");
static const u16 sCloseBoxButton_Tilemap[] =
    INCBIN_U16("graphics/pokemon_storage/close_box_button.bin");
static const u16 sPartySlotFilled_Tilemap[] =
    INCBIN_U16("graphics/pokemon_storage/party_slot_filled.bin");
static const u16 sPartySlotEmpty_Tilemap[] =
    INCBIN_U16("graphics/pokemon_storage/party_slot_empty.bin");
static const u16 sWaveform_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/waveform.gbapal");
static const u32 sWaveform_Gfx[] =
    INCBIN_U32("graphics/pokemon_storage/waveform.4bpp");
static const u16 sUnused_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/unused.gbapal");
static const u16 sTextWindows_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/text_windows.gbapal");
...
static const struct SpritePalette sWaveformSpritePalette = {sWaveform_Pal,
                                                            PALTAG_MISC_2};
...
static const union AnimCmd sAnim_Waveform_LeftOff[] = {ANIMCMD_FRAME(0, 5),
                                                       ANIMCMD_END};

static const union AnimCmd sAnim_Waveform_LeftOn[] = {
    ANIMCMD_FRAME(2, 8), ANIMCMD_FRAME(4, 8), ANIMCMD_FRAME(6, 8),
    ANIMCMD_JUMP(0)};

static const union AnimCmd sAnim_Waveform_RightOff[] = {ANIMCMD_FRAME(8, 5),
                                                        ANIMCMD_END};

static const union AnimCmd sAnim_Waveform_RightOn[] = {
    ANIMCMD_FRAME(10, 8), ANIMCMD_FRAME(4, 8), ANIMCMD_FRAME(12, 8),
    ANIMCMD_JUMP(0)};

static const union AnimCmd *const sAnims_Waveform[] = {
    sAnim_Waveform_LeftOff, sAnim_Waveform_LeftOn, sAnim_Waveform_RightOff,
...
static const union AffineAnimCmd sAffineAnim_ReleaseMon_CameBack[] = {
    AFFINEANIMCMD_FRAME(16, 16, 0, 0), AFFINEANIMCMD_FRAME(16, 16, 0, 15),
    AFFINEANIMCMD_END};
...
static const union AnimCmd sAnim_BoxTitle_Left[] = {ANIMCMD_FRAME(0, 5),
                                                    ANIMCMD_END};

static const union AnimCmd sAnim_BoxTitle_Right[] = {ANIMCMD_FRAME(8, 5),
                                                     ANIMCMD_END};

static const union AnimCmd *const sAnims_BoxTitle[] = {sAnim_BoxTitle_Left,
...
static const union AnimCmd sAnim_Arrow_Left[] = {ANIMCMD_FRAME(0, 5),
                                                 ANIMCMD_END};

static const union AnimCmd sAnim_Arrow_Right[] = {ANIMCMD_FRAME(2, 5),
                                                  ANIMCMD_END};

static const union AnimCmd *const sAnims_Arrow[] = {sAnim_Arrow_Left,
                                                    sAnim_Arrow_Right};
...
static const u16 sHandCursor_Pal[] =
    INCBIN_U16("graphics/pokemon_storage/hand_cursor.gbapal");
static const u8 sHandCursor_Gfx[] =
    INCBIN_U8("graphics/pokemon_storage/hand_cursor.4bpp");
static const u8 sHandCursorShadow_Gfx[] =
...
void DrawTextWindowAndBufferTiles(const u8 *string, void *dst, u8 zero1,
  ...
  AddTextPrinterParameterized4(windowId, FONT_NORMAL, 0, 1, 0, 0, txtColor,
                               TEXT_SKIP_DRAW, string);
  ...
  // Never used. bytesToBuffer is always passed <= 6, so remainingBytes is
  // always <= 0 here
  if (remainingBytes > 0)
...
static void UNUSED UnusedDrawTextWindow(const u8 *string, void *dst, u16 offset,
                                        u8 bgColor, u8 fgColor,
                                        u8 shadowColor) {
  u32 tilesSize;
  u8 windowId;
  u8 txtColor[3];
  ...
  AddTextPrinterParameterized4(windowId, FONT_NORMAL, 0, 2, 0, 0, txtColor,
                               TEXT_SKIP_DRAW, string);
...
static void UNUSED UnusedWriteRectCpu(u16 *dest, u16 dest_left, u16 dest_top,
                                      const u16 *src, u16 src_left, u16 src_top,
                                      u16 dest_width, u16 dest_height,
                                      u16 src_width) {
  u16 i;
...
static void UNUSED UnusedWriteRectDma(u16 *dest, u16 dest_left, u16 dest_top,
...
static void Task_PCMainMenu(u8 taskId) {
  ...
  case STATE_LOAD:
    ...
    AddTextPrinterParameterized2(0, FONT_NORMAL,
                                 sMainMenuTexts[task->tSelectedOption].desc,
                                 TEXT_SKIP_DRAW, NULL, TEXT_COLOR_DARK_GRAY,
  ...
  case STATE_HANDLE_INPUT:
    ...
    case MENU_NOTHING_CHOSEN:
      ...
      if (task->tSelectedOption != task->tNextOption) {
        ...
        AddTextPrinterParameterized2(
            0, FONT_NORMAL, sMainMenuTexts[task->tSelectedOption].desc, 0, NULL,
    ...
    default:
      if (task->tInput == OPTION_WITHDRAW && CountPartyMons() == PARTY_SIZE) {
        // Can't withdraw
        FillWindowPixelBuffer(0, PIXEL_FILL(1));
        AddTextPrinterParameterized2(0, FONT_NORMAL, gText_PartyFull, 0, NULL,
                                     TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE,
                                     TEXT_COLOR_LIGHT_GRAY);
        task->tState = STATE_ERROR_MSG;
      } else if (task->tInput == OPTION_DEPOSIT && CountPartyMons() == 1) {
        // Can't deposit
        FillWindowPixelBuffer(0, PIXEL_FILL(1));
        AddTextPrinterParameterized2(0, FONT_NORMAL, gText_JustOnePkmn, 0, NULL,
                                     TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE,
                                     TEXT_COLOR_LIGHT_GRAY);
        task->tState = STATE_ERROR_MSG;
      } else {
...
static void CreateMainMenu(u8 whichMenu, s16 *windowIdPtr) {
  ...
  template.width =
      GetMaxWidthInMenuTable((void *)sMainMenuTexts, OPTIONS_COUNT);
...
static s16 UNUSED StorageSystemGetNextMonIndex(struct BoxPokemon *box,
                                               s8 startIdx, u8 stopIdx,
                                               u8 mode) {
  s16 i;
  s16 direction;
  if (mode == 0 || mode == 1) {
...
static void LoadChooseBoxMenuGfx(struct ChooseBoxMenu *menu, u16 tileTag,
                                 u16 palTag, u8 subpriority, bool32 loadPal) {
  // Because loadPal is always false, the below palette is never used.
  // The Choose Box menu instead uses the palette indicated by palTag, which is
  // always PALTAG_MISC_1 (sHandCursor_Pal)
  struct SpritePalette palette = {sChooseBoxMenu_Pal, palTag};
  struct SpriteSheet sheets[] = {{sChooseBoxMenuCenter_Gfx, 0x800, tileTag},
...
static void ChooseBoxMenu_CreateSprites(u8 curBox) {
  ...
  for (i = 0; i < ARRAY_COUNT(sChooseBoxMenu->arrowSprites); i++) {
    sChooseBoxMenu->arrowSprites[i] = CreateChooseBoxArrows(
        72 * i + 124, 88, i, 0, sChooseBoxMenu->subpriority);
...
static void ChooseBoxMenu_MoveLeft(void) {
  sChooseBoxMenu->curBox =
      (sChooseBoxMenu->curBox == 0 ? TOTAL_BOXES_COUNT - 1
...
static void ChooseBoxMenu_PrintInfo(void) {
  ...
  AddTextPrinterParameterized3(windowId, FONT_NORMAL, center, 1,
                               sChooseBoxMenu_TextColors, TEXT_SKIP_DRAW,
                               boxName);

  // Print #/30 for number of Pokémon in the box
  ConvertIntToDecimalStringN(numBoxMonsText, numInBox,
  ...
  AddTextPrinterParameterized3(windowId, FONT_NORMAL, center, 17,
                               sChooseBoxMenu_TextColors, TEXT_SKIP_DRAW,
                               numBoxMonsText);

  winTileData = GetWindowAttribute(windowId, WINDOW_TILE_DATA);
  CpuCopy32((void *)winTileData,
            (void *)OBJ_VRAM0 + 0x100 +
                (GetSpriteTileStartByTag(sChooseBoxMenu->tileTag) * 32),
            0x400);
...
static void ResetForPokeStorage(void) {
  ...
  UnkUtil_Init(&sStorage->unkUtil, sStorage->unkUtilData,
               ARRAY_COUNT(sStorage->unkUtilData));
...
static void Task_ReshowPokeStorage(u8 taskId) {
  ...
  case 1:
    if (!UpdatePaletteFade()) {
      if (sWhichToReshow == SCREEN_CHANGE_ITEM_FROM_BAG - 1 &&
...
static void Task_DepositMenu(u8 taskId) {
  ...
  case 0:
    ...
    LoadChooseBoxMenuGfx(&sStorage->chooseBoxMenu, GFXTAG_CHOOSE_BOX_MENU,
                         PALTAG_MISC_1, 3, FALSE);
...
static void Task_TakeItemForMoving(u8 taskId) {
  ...
  case 1:
    ...
    TakeItemFromMon(sInPartyMenu ? CURSOR_AREA_IN_PARTY : CURSOR_AREA_IN_BOX,
                    GetCursorPosition());
    sStorage->state++;
    break;
  case 2:
...
static void Task_GiveMovingItemToMon(u8 taskId) {
  ...
  case 1:
    StartCursorAnim(CURSOR_ANIM_OPEN);
    GiveItemToMon(sInPartyMenu ? CURSOR_AREA_IN_PARTY : CURSOR_AREA_IN_BOX,
                  GetCursorPosition());
    sStorage->state++;
    break;
  case 2:
...
static void Task_ItemToBag(u8 taskId) {
  ...
  case 0:
    if (!AddBagItem(sStorage->displayMonItemId, 1)) {
      ...
      PlaySE(SE_SELECT);
      MoveItemFromMonToBag(sInPartyMenu ? CURSOR_AREA_IN_PARTY
                                        : CURSOR_AREA_IN_BOX,
                           GetCursorPosition());
      sStorage->state = 1;
    }
...
static void Task_SwitchSelectedItem(u8 taskId) {
  ...
  case 1:
    StartCursorAnim(CURSOR_ANIM_OPEN);
    SwapItemsWithMon(sInPartyMenu ? CURSOR_AREA_IN_PARTY : CURSOR_AREA_IN_BOX,
                     GetCursorPosition());
    sStorage->state++;
    break;
  case 2:
  ...
  case 1:
    ...
    default:
      ...
      if (sStorage->newCurrBoxId == BOXID_CANCELED ||
          sStorage->newCurrBoxId == StorageGetCurrentBox()) {
        AnimateBoxScrollArrows(TRUE);
        SetPokeStorageTask(Task_PokeStorageMain);
      } else {
        sStorage->state++;
...
static void Task_ChangeScreen(u8 taskId) {
  ...
  case SCREEN_CHANGE_SUMMARY_SCREEN:
    ...
    if (mode == SUMMARY_MODE_NORMAL && boxMons == &sSavedMovingMon.box)
      ShowPokemonSummaryScreenHandleDeoxys(mode, boxMons, monIndex, maxMonIndex,
                                           CB2_ReturnToPokeStorage);
    else
      ShowPokemonSummaryScreen(mode, boxMons, monIndex, maxMonIndex,
                               CB2_ReturnToPokeStorage);
    break;
  case SCREEN_CHANGE_NAME_BOX:
    FreePokeStorageData();
    DoNamingScreen(NAMING_SCREEN_BOX, GetBoxNamePtr(StorageGetCurrentBox()), 0,
                   0, 0, CB2_ReturnToPokeStorage);
    break;
...
static void SetScrollingBackground(void) {
  SetGpuReg(REG_OFFSET_BG3CNT, BGCNT_PRIORITY(3) | BGCNT_CHARBASE(3) |
                                   BGCNT_16COLOR | BGCNT_SCREENBASE(31));
...
static void InitPalettesAndSprites(void) {
  ...
  if (sStorage->boxOption != OPTION_MOVE_ITEMS)
    ...
    LoadPalette(sScrollingBgMoveItems_Pal, BG_PLTT_ID(3),
                sizeof(sScrollingBgMoveItems_Pal));

  SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(1) | BGCNT_CHARBASE(1) |
                                   BGCNT_16COLOR | BGCNT_SCREENBASE(30));
...
static void CreateMarkingComboSprite(void) {
  sStorage->markingComboSprite = CreateMonMarkingComboSprite(
      GFXTAG_MARKING_COMBO, PALTAG_MARKING_COMBO, NULL);
  ...
  sStorage->markingComboTilesPtr =
      (void *)OBJ_VRAM0 + 32 * GetSpriteTileStartByTag(GFXTAG_MARKING_COMBO);
}
...
static void RefreshDisplayMonData(void) {
  LoadDisplayMonGfx(sStorage->displayMonSpecies,
...
static void StartDisplayMonMosaicEffect(void) {
  ...
  if (sStorage->displayMonSprite) {
    ...
    SetGpuReg(REG_OFFSET_MOSAIC,
              (sStorage->displayMonSprite->data[0] << 12) |
                  (sStorage->displayMonSprite->data[0] << 8));
  }
}
...
static void SpriteCB_DisplayMonMosaic(struct Sprite *sprite) {
  ...
  if (sprite->data[0] < 0)
    sprite->data[0] = 0;
  SetGpuReg(REG_OFFSET_MOSAIC,
            (sprite->data[0] << 12) | (sprite->data[0] << 8));
  if (sprite->data[0] == 0) {
...
static void CreateDisplayMonSprite(void) {
  ...
  u8 palSlot;
  u8 spriteId;
  struct SpriteSheet sheet = {sStorage->tileBuffer, MON_PIC_SIZE,
                              GFXTAG_DISPLAY_MON};
  struct SpritePalette palette = {sStorage->displayMonPalBuffer,
                                  PALTAG_DISPLAY_MON};
  ...
  do {
    ...
    sStorage->displayMonTilePtr =
        (void *)OBJ_VRAM0 + tileStart * TILE_SIZE_4BPP;
  } while (0);
...
static void LoadDisplayMonGfx(u16 species, u32 pid) {
  ...
  if (species != SPECIES_NONE) {
    LoadSpecialPokePic(&gMonFrontPicTable[species], sStorage->tileBuffer,
                       species, pid, TRUE);
    LZ77UnCompWram(sStorage->displayMonPalette, sStorage->displayMonPalBuffer);
    CpuCopy32(sStorage->tileBuffer, sStorage->displayMonTilePtr, MON_PIC_SIZE);
    LoadPalette(sStorage->displayMonPalBuffer, sStorage->displayMonPalOffset,
                PLTT_SIZE_4BPP);
...
static void PrintDisplayMonInfo(void) {
  ...
  if (sStorage->boxOption != OPTION_MOVE_ITEMS) {
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_NORMAL,
                                sStorage->displayMonNameText, 6, 0,
                                TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_SHORT,
                                sStorage->displayMonSpeciesName, 6, 15,
                                TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_SHORT,
                                sStorage->displayMonGenderLvlText, 10, 29,
                                TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_SMALL,
                                sStorage->displayMonItemName, 6, 43,
                                TEXT_SKIP_DRAW, NULL);
  } else {
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_SMALL,
                                sStorage->displayMonItemName, 6, 0,
                                TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_NORMAL,
                                sStorage->displayMonNameText, 6, 13,
                                TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_SHORT,
                                sStorage->displayMonSpeciesName, 6, 28,
                                TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_SHORT,
                                sStorage->displayMonGenderLvlText, 10, 42,
                                TEXT_SKIP_DRAW, NULL);
  }

  CopyWindowToVram(WIN_DISPLAY_INFO, COPYWIN_GFX);
  if (sStorage->displayMonSpecies != SPECIES_NONE) {
    UpdateMonMarkingTiles(sStorage->displayMonMarkings,
                          sStorage->markingComboTilesPtr);
...
static void InitSupplementalTilemaps(void) {
  LZ77UnCompWram(gStorageSystemPartyMenu_Tilemap,
                 sStorage->partyMenuTilemapBuffer);
  LoadPalette(gStorageSystemPartyMenu_Pal, BG_PLTT_ID(1), PLTT_SIZE_4BPP);
  TilemapUtil_SetMap(TILEMAPID_PARTY_MENU, 1, sStorage->partyMenuTilemapBuffer,
                     12, 22);
...
static void PrintMessage(u8 id) {
  ...
  DynamicPlaceholderTextUtil_ExpandPlaceholders(sStorage->messageText,
                                                sMessages[id].text);
  FillWindowPixelBuffer(WIN_MESSAGE, PIXEL_FILL(1));
  AddTextPrinterParameterized(WIN_MESSAGE, FONT_NORMAL, sStorage->messageText,
...
static void CreateMovingMonIcon(void) {
  ...
  sStorage->movingMonSprite =
      CreateMonIconSprite(species, personality, 0, 0, priority, 7);
  ...
  for (i = 0; i < IN_BOX_ROWS; i++) {
    for (j = 0; j < IN_BOX_COLUMNS; j++) {
      ...
      if (species != SPECIES_NONE) {
        ...
        sStorage->boxMonsSprites[count] =
            CreateMonIconSprite(species, personality, 8 * (3 * j) + 100,
                                8 * (3 * i) + 44, 2, 19 - j);
      } else {
...
static void CreateBoxMonIconAtPos(u8 boxPosition) {
  ...
  if (species != SPECIES_NONE) {
    ...
    sStorage->boxMonsSprites[boxPosition] = CreateMonIconSprite(
        species, personality, x, y, 2, 19 - (boxPosition % IN_BOX_COLUMNS));
    if (sStorage->boxOption == OPTION_MOVE_ITEMS)
      sStorage->boxMonsSprites[boxPosition]->oam.objMode = ST_OAM_OBJ_BLEND;
  }
}
    ...
    for (i = 0; i < IN_BOX_ROWS; i++) {
      if (sStorage->boxSpecies[boxPosition] != SPECIES_NONE) {
        sStorage->boxMonsSprites[boxPosition] = CreateMonIconSprite(
            ...
            sStorage->boxPersonalities[boxPosition], x, y, 2, subpriority);
        if (sStorage->boxMonsSprites[boxPosition] != NULL) {
    ...
    for (i = 0; i < IN_BOX_ROWS; i++) {
      if (sStorage->boxSpecies[boxPosition] != SPECIES_NONE) {
        ...
        if (sStorage->boxMonsSprites[boxPosition] != NULL) {
          ...
          sStorage->boxMonsSprites[boxPosition]->callback =
              SpriteCB_BoxMonIconScrollIn;
          if (GetBoxMonDataAt(sStorage->incomingBoxId, boxPosition,
                              MON_DATA_HELD_ITEM) == ITEM_NONE)
            sStorage->boxMonsSprites[boxPosition]->oam.objMode =
                ST_OAM_OBJ_BLEND;
          iconsCreated++;
        }
      }
...
static bool8 UpdateBoxMonIconScroll(void) {
  ...
  case 1:
    ...
    sStorage->iconScrollNumIncoming += CreateBoxMonIconsInColumn(
        sStorage->iconScrollCurColumn, sStorage->iconScrollDistance,
        sStorage->iconScrollSpeed);

    if ((sStorage->iconScrollDirection > 0 &&
         sStorage->iconScrollCurColumn == IN_BOX_COLUMNS - 1) ||
        (sStorage->iconScrollDirection < 0 &&
         sStorage->iconScrollCurColumn == 0)) {
...
static void GetIncomingBoxMonData(u8 boxId) {
  ...
  for (i = 0; i < IN_BOX_ROWS; i++) {
    for (j = 0; j < IN_BOX_COLUMNS; j++) {
      sStorage->boxSpecies[boxPosition] =
          GetBoxMonDataAt(boxId, boxPosition, MON_DATA_SPECIES_OR_EGG);
      if (sStorage->boxSpecies[boxPosition] != SPECIES_NONE)
...
static void CreatePartyMonsSprites(bool8 visible) {
  ...
  sStorage->partySprites[0] =
      CreateMonIconSprite(species, personality, 104, 64, 1, 12);
  count = 1;
  for (i = 1; i < PARTY_SIZE; i++) {
    ...
    if (species != SPECIES_NONE) {
      ...
      sStorage->partySprites[i] = CreateMonIconSprite(
          species, personality, 152, 8 * (3 * (i - 1)) + 16, 1, 12);
      count++;
    } else {
      sStorage->partySprites[i] = NULL;
    }
...
static void SetPlacedMonSprite(u8 boxId, u8 position) {
  if (boxId == TOTAL_BOXES_COUNT) // party mon
  {
    ...
    sStorage->boxMonsSprites[position]->subpriority =
        19 - (position % IN_BOX_COLUMNS);
  }
...
static bool8 MoveShiftingMons(void) {
  ...
  (*sStorage->shiftMonSpritePtr)->x2 =
      gSineTable[sStorage->shiftTimer * 8] / 16;
  sStorage->movingMonSprite->x2 = -(gSineTable[sStorage->shiftTimer * 8] / 16);
  if (sStorage->shiftTimer == 8) {
    sStorage->movingMonSprite->oam.priority =
        (*sStorage->shiftMonSpritePtr)->oam.priority;
...
static void ReshowReleaseMon(void) {
  if (*sStorage->releaseMonSpritePtr != NULL) {
    ...
    StartSpriteAffineAnim(*sStorage->releaseMonSpritePtr,
                          RELEASE_ANIM_CAME_BACK);
  }
}
...
static u16 TryLoadMonIconTiles(u16 species) {
  ...
  offset = 16 * i;
  CpuCopy32(GetMonIconTiles(species, TRUE),
            (void *)(OBJ_VRAM0) + offset * TILE_SIZE_4BPP, 0x200);
...
static struct Sprite *CreateMonIconSprite(u16 species, u32 personality, s16 x,
                                          s16 y, u8 oamPriority,
                                          u8 subpriority) {
  u16 tileNum;
  u8 spriteId;
...
static void Task_InitBox(u8 taskId) {
  ...
  case 0:
    ...
    sStorage->bg2_X = 0;
    task->tDmaIdx =
        RequestDma3Fill(0, sStorage->wallpaperBgTilemapBuffer,
  ...
  case 3:
    ...
    SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(2) | BGCNT_CHARBASE(2) |
                                     BGCNT_SCREENBASE(27) | BGCNT_TXT512x256);
    break;
  case 4:
    DestroyTask(taskId);
    break;
...
static bool8 DoWallpaperGfxChange(void) {
  ...
  case 0:
    BeginNormalPaletteFade(sStorage->wallpaperPalBits, 1, 0, 16,
                           RGB_WHITEALPHA);
  ...
  case 2:
    if (WaitForWallpaperGfxLoad() == TRUE) {
      CycleBoxTitleColor();
      BeginNormalPaletteFade(sStorage->wallpaperPalBits, 1, 16, 0,
                             RGB_WHITEALPHA);
      sStorage->wallpaperChangeState++;
    }
    break;
...
static void LoadWallpaperGfx(u8 boxId, s8 direction) {
  ...
  if (wallpaperId != WALLPAPER_FRIENDS) {
    ...
    DrawWallpaper(sStorage->wallpaperTilemap, sStorage->wallpaperLoadDir,
                  sStorage->wallpaperOffset);

    if (sStorage->wallpaperLoadDir != 0)
      LoadPalette(wallpaper->palettes,
                  BG_PLTT_ID(4) + BG_PLTT_ID(sStorage->wallpaperOffset * 2),
                  2 * PLTT_SIZE_4BPP);
    else
      CpuCopy16(wallpaper->palettes,
                &gPlttBufferUnfaded[BG_PLTT_ID(4) +
                                    BG_PLTT_ID(sStorage->wallpaperOffset * 2)],
                2 * PLTT_SIZE_4BPP);

    sStorage->wallpaperTiles =
        malloc_and_decompress(wallpaper->tiles, &tilesSize);
    LoadBgTiles(2, sStorage->wallpaperTiles, tilesSize,
                sStorage->wallpaperOffset << 8);
  } else {
    ...
    if (sStorage->wallpaperLoadDir != 0)
      LoadPalette(sStorage->wallpaperTilemap,
                  BG_PLTT_ID(4) + BG_PLTT_ID(sStorage->wallpaperOffset * 2),
                  2 * PLTT_SIZE_4BPP);
    else
      CpuCopy16(sStorage->wallpaperTilemap,
                &gPlttBufferUnfaded[BG_PLTT_ID(4) +
                                    BG_PLTT_ID(sStorage->wallpaperOffset * 2)],
                2 * PLTT_SIZE_4BPP);
    ...
    iconGfx = malloc_and_decompress(
        sWaldaWallpaperIcons[GetWaldaWallpaperIconId()], &iconSize);
...
static void DrawWallpaper(const void *tilemap, s8 direction, u8 offset) {
  ...
  CopyRectToBgTilemapBufferRect(2, tilemap, 0, 0, 20, 18, x, 2, 20, 18, 17,
                                tileOffset, paletteNum);
...
static void InitBoxTitle(u8 boxId) {
  ...
  struct SpriteSheet spriteSheet = {sStorage->boxTitleTiles, 0x200,
                                    GFXTAG_BOX_TITLE};
  ...
  StringCopyPadded(sStorage->boxTitleText, GetBoxNamePtr(boxId), 0,
                   BOX_NAME_LENGTH);
  DrawTextWindowAndBufferTiles(sStorage->boxTitleText, sStorage->boxTitleTiles,
                               0, 0, 2);
...
static void CreateIncomingBoxTitle(u8 boxId, s8 direction) {
  ...
  DrawTextWindowAndBufferTiles(sStorage->boxTitleText, sStorage->boxTitleTiles,
                               0, 0, 2);
  LoadSpriteSheet(&spriteSheet);
  LoadPalette(sBoxTitleColors[GetBoxWallpaper(boxId)], palOffset,
              sizeof(sBoxTitleColors[0]));
  x = GetBoxTitleBaseX(GetBoxNamePtr(boxId));
  adjustedX = x;
...
static void CycleBoxTitleColor(void) {
  ...
  if (sStorage->boxTitleCycleId == 0)
    CpuCopy16(sBoxTitleColors[wallpaperId],
              &gPlttBufferUnfaded[sStorage->boxTitlePalOffset], PLTT_SIZEOF(2));
  else
    CpuCopy16(sBoxTitleColors[wallpaperId],
              &gPlttBufferUnfaded[sStorage->boxTitleAltPalOffset],
              PLTT_SIZEOF(2));
}
...
static struct Sprite *CreateChooseBoxArrows(u16 x, u16 y, u8 animId,
                                            u8 priority, u8 subpriority) {
...
static void GetCursorCoordsByPos(u8 cursorArea, u8 cursorPosition, u16 *x,
                                 u16 *y) {
  switch (cursorArea) {
...
struct {
  ...
  u16 move;
    ...
    {MAP_GROUP(EVER_GRANDE_CITY_POKEMON_LEAGUE_1F),
     MAP_NUM(EVER_GRANDE_CITY_POKEMON_LEAGUE_1F), MOVE_STRENGTH},
    {MAP_GROUP(EVER_GRANDE_CITY_POKEMON_LEAGUE_1F),
     MAP_NUM(EVER_GRANDE_CITY_POKEMON_LEAGUE_1F), MOVE_ROCK_SMASH},
    {MAP_GROUP(EVER_GRANDE_CITY_POKEMON_LEAGUE_2F),
     MAP_NUM(EVER_GRANDE_CITY_POKEMON_LEAGUE_2F), MOVE_STRENGTH},
    {MAP_GROUP(EVER_GRANDE_CITY_POKEMON_LEAGUE_2F),
     MAP_NUM(EVER_GRANDE_CITY_POKEMON_LEAGUE_2F), MOVE_ROCK_SMASH},
};
...
static void GetRestrictedReleaseMoves(u16 *moves) {
  ...
  for (i = 0; i < ARRAY_COUNT(sRestrictedReleaseMoves); i++) {
    if (sRestrictedReleaseMoves[i].mapGroup == MAP_GROUPS_COUNT ||
        (sRestrictedReleaseMoves[i].mapGroup ==
             gSaveBlock1Ptr->location.mapGroup &&
         sRestrictedReleaseMoves[i].mapNum ==
...
static void InitCanReleaseMonVars(void) {
  ...
  if (sIsMonBeingMoved) {
    ...
    if (sCursorArea == CURSOR_AREA_IN_PARTY) {
      ...
      BoxMonAtToMon(StorageGetCurrentBox(), sCursorPosition,
                    &sStorage->tempMon);
  ...
  sStorage->restrictedReleaseMonMoves =
      GetMonData(&sStorage->tempMon, MON_DATA_KNOWN_MOVES,
...
static s8 RunCanReleaseMon(void) {
  ...
  case 0:
    ...
    for (i = 0; i < PARTY_SIZE; i++) {
      ...
      if (sStorage->releaseBoxId != TOTAL_BOXES_COUNT ||
          sStorage->releaseBoxPos != i) {
  ...
  case 1:
    ...
    for (i = 0; i < IN_BOX_COUNT; i++) {
      knownMoves = GetAndCopyBoxMonDataAt(
          sStorage->releaseCheckBoxId, sStorage->releaseCheckBoxPos,
  ...
  if (sIsMonBeingMoved) {
    if (sCursorArea == CURSOR_AREA_IN_PARTY &&
      ...
      if (sStorage->displayMonIsEgg ||
          GetMonData(&sStorage->movingMon, MON_DATA_HP) == 0)
        return FALSE;
    }
    return TRUE;
  }
...
static void TryRefreshDisplayMon(void) {
  ...
  if (!sIsMonBeingMoved) {
    ...
    case CURSOR_AREA_BOX_TITLE:
      ...
      break;
    case CURSOR_AREA_IN_BOX:
      SetDisplayMonData(GetBoxedMonPtr(StorageGetCurrentBox(), sCursorPosition),
                        MODE_BOX);
      break;
    }
  }
...
static void SetDisplayMonData(void *pokemon, u8 mode) {
  ...
  if (mode == MODE_PARTY) {
    ...
    sStorage->displayMonSpecies =
        GetBoxMonData(pokemon, MON_DATA_SPECIES_OR_EGG);
    if (sStorage->displayMonSpecies != SPECIES_NONE) {
      ...
      sStorage->displayMonPalette = GetMonSpritePalFromSpeciesAndPersonality(
          sStorage->displayMonSpecies, otId, sStorage->displayMonPersonality);
      gender = GetGenderFromSpeciesAndPersonality(
          sStorage->displayMonSpecies, sStorage->displayMonPersonality);
  ...
  if (sStorage->displayMonSpecies == SPECIES_NONE) {
    ...
    if (sanityIsBadEgg)
      StringCopyPadded(sStorage->displayMonNameText, sStorage->displayMonName,
                       CHAR_SPACE, 5);
    else
      StringCopyPadded(sStorage->displayMonNameText, gText_EggNickname,
                       CHAR_SPACE, 8);
    ...
    *(txtPtr)++ = CHAR_SLASH;
    StringCopyPadded(txtPtr, gSpeciesNames[sStorage->displayMonSpecies],
                     CHAR_SPACE, 5);
    ...
    *(txtPtr++) = CHAR_LV_2;
    ...
    txtPtr = ConvertIntToDecimalStringN(txtPtr, sStorage->displayMonLevel,
                                        STR_CONV_MODE_LEFT_ALIGN, 3);
    txtPtr[0] = CHAR_SPACE;
    txtPtr[1] = EOS;

    if (sStorage->displayMonItemId != ITEM_NONE)
      StringCopyPadded(sStorage->displayMonItemName,
                       ItemId_GetName(sStorage->displayMonItemId), CHAR_SPACE,
                       8);
    else
      StringFill(sStorage->displayMonItemName, CHAR_SPACE, 8);
  }
...
static void CreateCursorSprites(void) {
  ...
  static const union AnimCmd sAnim_Cursor_Still[] = {ANIMCMD_FRAME(0, 5),
                                                     ANIMCMD_END};
  static const union AnimCmd sAnim_Cursor_Open[] = {ANIMCMD_FRAME(32, 5),
                                                    ANIMCMD_END};
  static const union AnimCmd sAnim_Cursor_Fist[] = {ANIMCMD_FRAME(48, 5),
                                                    ANIMCMD_END};
  ...
  sStorage->cursorPalNums[0] =
      IndexOfSpritePaletteTag(PALTAG_MISC_2); // White hand, normal
  sStorage->cursorPalNums[1] = IndexOfSpritePaletteTag(
      PALTAG_MISC_1); // Yellow hand, when auto-action is on
  ...
  if (spriteId != MAX_SPRITES) {
    ...
    sStorage->cursorSprite->oam.paletteNum =
        sStorage->cursorPalNums[sAutoActionOn];
    sStorage->cursorSprite->oam.priority = 1;
    if (sIsMonBeingMoved)
      StartSpriteAnim(sStorage->cursorSprite, CURSOR_ANIM_FIST);
  } else {
...
static u8 UNUSED GetMovingMonOriginalBoxId(void) { return sMovingMonOrigBoxId; }
...
static void AddMenu(void) {
  ...
  PrintMenuTable(sStorage->menuWindowId, sStorage->menuItemsCount,
                 (void *)sStorage->menuItems);
  InitMenuInUpperLeftCornerNormal(sStorage->menuWindowId,
                                  sStorage->menuItemsCount, 0);
  ScheduleBgCopyTilemapToVram(0);
...
static bool8 MultiMove_ChangeSelection(void) {
  ...
  case 0:
    if (!UpdateCursorPos()) {
      GetCursorBoxColumnAndRow(&sMultiMove->cursorColumn,
...
static void MultiMove_UpdateSelectedIcons(void) {
  ...
  s16 rowChange = (abs(sMultiMove->fromRow - sMultiMove->cursorRow)) -
                  (abs(sMultiMove->fromRow - sMultiMove->toRow));

  if (columnChange > 0)
    MultiMove_SelectColumn(sMultiMove->cursorColumn, sMultiMove->fromRow,
                           sMultiMove->toRow);

  if (columnChange < 0) {
    MultiMove_DeselectColumn(sMultiMove->toColumn, sMultiMove->fromRow,
                             sMultiMove->toRow);
    MultiMove_SelectColumn(sMultiMove->cursorColumn, sMultiMove->fromRow,
                           sMultiMove->toRow);
  }
  ...
  if (rowChange > 0)
    MultiMove_SelectRow(sMultiMove->cursorRow, sMultiMove->fromColumn,
                        sMultiMove->toColumn);

  if (rowChange < 0) {
    MultiMove_DeselectRow(sMultiMove->toRow, sMultiMove->fromColumn,
                          sMultiMove->toColumn);
    MultiMove_SelectRow(sMultiMove->cursorRow, sMultiMove->fromColumn,
                        sMultiMove->toColumn);
  }
...
static void MultiMove_SetIconToBg(u8 x, u8 y) {
  ...
  if (species != SPECIES_NONE) {
    ...
    BlitBitmapRectToWindow4BitTo8Bit(sStorage->multiMoveWindowId, iconGfx, 0, 0,
                                     32, 32, 24 * x, 24 * y, 32, 32, index);
  }
}
...
static void MultiMove_ClearIconFromBg(u8 x, u8 y) {
  ...
  if (species != SPECIES_NONE) {
    FillWindowPixelRect8Bit(sStorage->multiMoveWindowId, PIXEL_FILL(0), 24 * x,
                            24 * y, 32, 32);
  }
}
...
static void MultiMove_GetMonsFromSelection(void) {
  ...
  sMultiMove->columnsTotal =
      abs(sMultiMove->fromColumn - sMultiMove->toColumn) + 1;
...
static void MultiMove_CreatePlacedMonIcons(void) {
  ...
  for (i = sMultiMove->minRow; i < rowCount; i++) {
    u8 boxPosition = (IN_BOX_COLUMNS * i) + sMultiMove->minColumn;
    for (j = sMultiMove->minColumn; j < columnCount; j++) {
      if (GetBoxMonData(&sMultiMove->boxMons[monArrayId],
...
static const u32 sItemInfoFrame_Gfx[] =
    INCBIN_U32("graphics/pokemon_storage/item_info_frame.4bpp");
...
static const union AffineAnimCmd sAffineAnim_ItemIcon_Appear[] = {
    AFFINEANIMCMD_FRAME(88, 88, 0, 0), AFFINEANIMCMD_FRAME(5, 5, 0, 8),
    AFFINEANIMCMD_END};

static const union AffineAnimCmd sAffineAnim_ItemIcon_Disappear[] = {
    AFFINEANIMCMD_FRAME(128, 128, 0, 0), AFFINEANIMCMD_FRAME(-5, -5, 0, 8),
    AFFINEANIMCMD_END};

static const union AffineAnimCmd sAffineAnim_ItemIcon_PickUp[] = {
    AFFINEANIMCMD_FRAME(128, 128, 0, 0), AFFINEANIMCMD_FRAME(10, 10, 0, 12),
    AFFINEANIMCMD_FRAME(256, 256, 0, 0), AFFINEANIMCMD_END};

static const union AffineAnimCmd sAffineAnim_ItemIcon_PutDown[] = {
    AFFINEANIMCMD_FRAME(256, 256, 0, 0), AFFINEANIMCMD_FRAME(-10, -10, 0, 12),
    AFFINEANIMCMD_FRAME(128, 128, 0, 0), AFFINEANIMCMD_END};

static const union AffineAnimCmd sAffineAnim_ItemIcon_PutAway[] = {
    AFFINEANIMCMD_FRAME(256, 256, 0, 0), AFFINEANIMCMD_FRAME(-5, -5, 0, 16),
    AFFINEANIMCMD_END};
...
static void CreateItemIconSprites(void) {
  ...
  if (sStorage->boxOption == OPTION_MOVE_ITEMS) {
    ...
    for (i = 0; i < MAX_ITEM_ICONS; i++) {
      ...
      sStorage->itemIcons[i].tiles =
          GetSpriteTileStartByTag(spriteSheet.tag) * TILE_SIZE_4BPP +
          (void *)(OBJ_VRAM0);
      sStorage->itemIcons[i].palIndex =
          AllocSpritePalette(PALTAG_ITEM_ICON_0 + i);
      sStorage->itemIcons[i].palIndex =
          OBJ_PLTT_ID(sStorage->itemIcons[i].palIndex);
...
static void SwapItemsWithMon(u8 cursorArea, u8 cursorPos) {
  ...
  if (cursorArea == CURSOR_AREA_IN_BOX) {
    ...
    SetMonData(&gPlayerParty[cursorPos], MON_DATA_HELD_ITEM,
               &sStorage->movingItemId);
    sStorage->movingItemId = itemId;
  }
...
static void LoadItemIconGfx(u8 id, const u32 *itemTiles, const u32 *itemPal) {
  ...
  for (i = 0; i < 3; i++)
    CpuFastCopy(&sStorage->tileBuffer[i * 0x60],
                &sStorage->itemIconBuffer[i * 0x80], 0x60);

  CpuFastCopy(sStorage->itemIconBuffer, sStorage->itemIcons[id].tiles, 0x200);
  LZ77UnCompWram(itemPal, sStorage->itemIconBuffer);
  LoadPalette(sStorage->itemIconBuffer, sStorage->itemIcons[id].palIndex,
              PLTT_SIZE_4BPP);
}
...
static void SetItemIconCallback(u8 id, u8 callbackId, u8 cursorArea,
                                u8 cursorPos) {
  if (id >= MAX_ITEM_ICONS)
    return;
...
static void PrintItemDescription(void) {
  ...
  AddTextPrinterParameterized5(WIN_ITEM_DESC, FONT_NORMAL, description, 4, 0, 0,
                               NULL, 0, 1);
}
...
static bool8 UpdateItemInfoWindowSlideIn(void) {
  ...
  for (i = 0; i < pos; i++)
    WriteSequenceToBgTilemapBuffer(0,
                                   GetBgAttribute(0, BG_ATTR_BASETILE) + 0x14 +
                                       sStorage->itemInfoWindowOffset + i,
                                   i, 13, 1, 7, 15, 21);
...
static void SpriteCB_ItemIcon_ToMon(struct Sprite *sprite) {
  ...
  case 1:
    ...
    sprite->y = sprite->data[2] >> 4;
    if (++sprite->data[5] > 11) {
      SetItemIconPosition(GetItemIconIdxBySprite(sprite), sprite->sCursorArea,
                          sprite->sCursorPos);
      sprite->callback = SpriteCallbackDummy;
    }
    break;
...
u32 GetBoxMonDataAt(u8 boxId, u8 boxPosition, s32 request) {
  if (boxId < TOTAL_BOXES_COUNT && boxPosition < IN_BOX_COUNT)
    return GetBoxMonData(&gPokemonStoragePtr->boxes[boxId][boxPosition],
                         request);
  else
    return 0;
}
...
void SetBoxMonDataAt(u8 boxId, u8 boxPosition, s32 request, const void *value) {
  if (boxId < TOTAL_BOXES_COUNT && boxPosition < IN_BOX_COUNT)
    SetBoxMonData(&gPokemonStoragePtr->boxes[boxId][boxPosition], request,
                  value);
}
...
void GetBoxMonNickAt(u8 boxId, u8 boxPosition, u8 *dst) {
  if (boxId < TOTAL_BOXES_COUNT && boxPosition < IN_BOX_COUNT)
    GetBoxMonData(&gPokemonStoragePtr->boxes[boxId][boxPosition],
                  MON_DATA_NICKNAME, dst);
  else
    *dst = EOS;
}
...
void SetBoxMonNickAt(u8 boxId, u8 boxPosition, const u8 *nick) {
  if (boxId < TOTAL_BOXES_COUNT && boxPosition < IN_BOX_COUNT)
    SetBoxMonData(&gPokemonStoragePtr->boxes[boxId][boxPosition],
                  MON_DATA_NICKNAME, nick);
}
...
void CreateBoxMonAt(u8 boxId, u8 boxPosition, u16 species, u8 level, u8 fixedIV,
                    ...
                    u32 otID) {
  if (boxId < TOTAL_BOXES_COUNT && boxPosition < IN_BOX_COUNT) {
    CreateBoxMon(&gPokemonStoragePtr->boxes[boxId][boxPosition], species, level,
                 fixedIV, hasFixedPersonality, personality, otIDType, otID);
  }
}
...
s16 AdvanceStorageMonIndex(struct BoxPokemon *boxMons, u8 currIndex,
  ...
  if (mode == 1 || mode == 3) {
    for (i = (s8)currIndex + direction; i >= 0 && i <= maxIndex;
         i += direction) {
...
bool8 CheckFreePokemonStorageSpace(void) {
  ...
  for (i = 0; i < TOTAL_BOXES_COUNT; i++) {
    for (j = 0; j < IN_BOX_COUNT; j++) {
      if (!GetBoxMonData(&gPokemonStoragePtr->boxes[i][j],
                         MON_DATA_SANITY_HAS_SPECIES))
        return TRUE;
    }
  }
...
u32 CountStorageNonEggMons(void) {
  ...
  for (i = 0; i < TOTAL_BOXES_COUNT; i++) {
    for (j = 0; j < IN_BOX_COUNT; j++) {
      if (GetBoxMonData(&gPokemonStoragePtr->boxes[i][j],
                        MON_DATA_SANITY_HAS_SPECIES) &&
          !GetBoxMonData(&gPokemonStoragePtr->boxes[i][j],
                         MON_DATA_SANITY_IS_EGG))
        count++;
    }
  }
  ...
  for (i = 0; i < TOTAL_BOXES_COUNT; i++) {
    for (j = 0; j < IN_BOX_COUNT; j++) {
      if (GetBoxMonData(&gPokemonStoragePtr->boxes[i][j],
          ...
          !GetBoxMonData(&gPokemonStoragePtr->boxes[i][j],
                         MON_DATA_SANITY_IS_EGG) &&
          GetBoxMonData(&gPokemonStoragePtr->boxes[i][j], MON_DATA_KNOWN_MOVES,
                        (u8 *)moves))
        return TRUE;
    }
  }
...
static void TilemapUtil_SetMap(u8 id, u8 bg, const void *tilemap, u16 width,
                               u16 height) {
...
static void TilemapUtil_DrawPrev(u8 id) {
  ...
  const void *tiles =
      (sTilemapUtil[id].savedTilemap + (adder * sTilemapUtil[id].prev.destY)) +
      (sTilemapUtil[id].tileSize * sTilemapUtil[id].prev.destX);

  for (i = 0; i < sTilemapUtil[id].prev.height; i++) {
    CopyToBgTilemapBufferRect(
        sTilemapUtil[id].bg, tiles, sTilemapUtil[id].prev.destX,
        sTilemapUtil[id].prev.destY + i, sTilemapUtil[id].prev.width, 1);
    tiles += adder;
  }
}
...
static void TilemapUtil_Draw(u8 id) {
  ...
  const void *tiles =
      (sTilemapUtil[id].tilemap + (adder * sTilemapUtil[id].cur.y)) +
      (sTilemapUtil[id].tileSize * sTilemapUtil[id].cur.x);

  for (i = 0; i < sTilemapUtil[id].cur.height; i++) {
    CopyToBgTilemapBufferRect(
        sTilemapUtil[id].bg, tiles, sTilemapUtil[id].cur.destX,
        sTilemapUtil[id].cur.destY + i, sTilemapUtil[id].cur.width, 1);
    tiles += adder;
  }
}
...
static void UnkUtil_Init(struct UnkUtil *util, struct UnkUtilData *data,
                         u32 max) {
  sUnkUtil = util;
  util->data = data;
  util->max = max;
...
static bool8 UNUSED UnkUtil_CpuAdd(u8 *dest, u16 dLeft, u16 dTop, const u8 *src,
                                   u16 sLeft, u16 sTop, u16 width, u16 height,
                                   u16 unkArg) {
  struct UnkUtilData *data;
...
static bool8 UNUSED UnkUtil_DmaAdd(void *dest, u16 dLeft, u16 dTop, u16 width,
                                   u16 height) {
  struct UnkUtilData *data;
