...
static const u16 sGrass_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/grass.gbapal");
static const u16 sGrassSunset_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/grass_sunset.gbapal");
static const u16 sGrassNight_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/grass_night.gbapal");
static const u32 sGrass_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/grass.4bpp.lz");
static const u32 sGrass_Tilemap[] =
    INCBIN_U32("graphics/intro/scene_2/grass_map.bin.lz");
static const u16 sCloudsBg_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/clouds_bg.gbapal");
static const u16 sCloudsBgSunset_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/clouds_bg_sunset.gbapal");
static const u32 sCloudsBg_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/clouds_bg.4bpp.lz");
static const u32 sCloudsBg_Tilemap[] =
    INCBIN_U32("graphics/intro/scene_2/clouds_bg_map.bin.lz");
static const u16 sClouds_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/clouds.gbapal");
static const u16 sCloudsSunset_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/clouds_sunset.gbapal");
static const u32 sClouds_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/clouds.4bpp.lz");
static const u16 sTrees_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/trees.gbapal");
static const u16 sTreesSunset_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/trees_sunset.gbapal");
static const u32 sTrees_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/trees.4bpp.lz");
static const u32 sTrees_Tilemap[] =
    INCBIN_U32("graphics/intro/scene_2/trees_map.bin.lz");
static const u16 sTreesSmall_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/trees_small.gbapal");
static const u32 sTreesSmall_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/trees_small.4bpp.lz");
static const u16 sHouses_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/houses.gbapal");
static const u32 sHouses_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/houses.4bpp.lz");
static const u16 sHouseSilhouette_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/house_silhouette.gbapal");
static const u32 sHouses_Tilemap[] =
    INCBIN_U32("graphics/intro/scene_2/houses_map.bin.lz");
static const u32 sHouseSilhouette_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/house_silhouette.4bpp.lz");
static const u16 sBrendanCredits_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/brendan_credits.gbapal");
static const u32 sBrendanCredits_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/brendan_credits.4bpp.lz");
static const u16 sMayCredits_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/may_credits.gbapal");
static const u16 sUnused[0xF0] = {0};
static const u32 sMayCredits_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/may_credits.4bpp.lz");
static const u32 sBicycle_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/bicycle.4bpp.lz");
static const u16 sLatios_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/latios.gbapal");
static const u32 sLatios_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/latios.4bpp.lz");
static const u16 sLatias_Pal[] =
    INCBIN_U16("graphics/intro/scene_2/latias.gbapal");
static const u32 sLatias_Gfx[] =
    INCBIN_U32("graphics/intro/scene_2/latias.4bpp.lz");
...
static const struct CompressedSpriteSheet sSpriteSheet_Clouds[] = {
    {.data = sClouds_Gfx, .size = 0x400, .tag = TAG_MOVING_SCENERY}, {}};

static const union AnimCmd sAnim_Cloud_Largest[] = {ANIMCMD_FRAME(0, 30),
                                                    ANIMCMD_END};

static const union AnimCmd sAnim_Cloud_Large[] = {ANIMCMD_FRAME(16, 30),
                                                  ANIMCMD_END};

static const union AnimCmd sAnim_Cloud_Small[] = {ANIMCMD_FRAME(20, 30),
                                                  ANIMCMD_END};

static const union AnimCmd sAnim_Cloud_Smallest[] = {ANIMCMD_FRAME(22, 30),
                                                     ANIMCMD_END};

static const union AnimCmd *const sAnims_Clouds[] = {
    sAnim_Cloud_Largest, sAnim_Cloud_Large, sAnim_Cloud_Small,
...
static const struct CompressedSpriteSheet sSpriteSheet_TreesSmall[] = {
    {.data = sTreesSmall_Gfx, .size = 0x400, .tag = TAG_MOVING_SCENERY}, {}};

static const union AnimCmd sAnim_Trees_0[] = {ANIMCMD_FRAME(0, 30),
                                              ANIMCMD_END};

static const union AnimCmd sAnim_Trees_1[] = {ANIMCMD_FRAME(16, 30),
                                              ANIMCMD_END};

static const union AnimCmd sAnim_Trees_2[] = {ANIMCMD_FRAME(24, 30),
                                              ANIMCMD_END};

static const union AnimCmd *const sAnims_Trees[] = {
    sAnim_Trees_0, sAnim_Trees_1, sAnim_Trees_2};
...
static const struct CompressedSpriteSheet sSpriteSheet_HouseSilhouette[] = {
    {.data = sHouseSilhouette_Gfx, .size = 0x400, .tag = TAG_MOVING_SCENERY},
    {}};

static const union AnimCmd sAnim_HouseSilhouette[] = {ANIMCMD_FRAME(0, 30),
                                                      ANIMCMD_END};

static const union AnimCmd *const sAnims_HouseSilhouette[] = {
    sAnim_HouseSilhouette};

static const struct IntroCreditsSpriteMetadata
    sSpriteMetadata_HouseSilhouette[] = {{
                                             .animNum = 0,
                                             .shape = SPRITE_SHAPE(32x32),
                                             .size = SPRITE_SIZE(32x32),
                                             .x = 24,
...
static const struct OamData sOamData_Player = {.y = DISPLAY_HEIGHT,
...
static const union AnimCmd *const sAnims_Player[] = {sAnim_Player};
...
static const struct OamData sOamData_Bicycle = {.y = DISPLAY_HEIGHT,
                                                .shape = SPRITE_SHAPE(64x32),
                                                .size = SPRITE_SIZE(64x32),
                                                .priority = 1};

static const union AnimCmd sAnim_Bicycle[] = {
    ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(32, 8), ANIMCMD_FRAME(64, 8),
...
static const struct OamData sOamData_Flygon = {.y = DISPLAY_HEIGHT,
                                               .shape = SPRITE_SHAPE(64x64),
                                               .size = SPRITE_SIZE(64x64),
                                               .priority = 1};

static const union AnimCmd sAnim_FlygonLeft[] = {ANIMCMD_FRAME(0, 16),
                                                 ANIMCMD_END};

static const union AnimCmd sAnim_FlygonRight[] = {ANIMCMD_FRAME(64, 16),
                                                  ANIMCMD_END};

static const union AnimCmd *const sAnims_Flygon[] = {sAnim_FlygonLeft,
                                                     sAnim_FlygonRight};
...
// In RS these were Latios/Latias. In Emerald both are replaced with Flygon and
// now only 1 is used
static const struct CompressedSpriteSheet sSpriteSheet_IntroFlygon_Unused[] = {
    {.data = gIntroFlygon_Gfx, .size = 0x1000, .tag = TAG_FLYGON_LATIOS}, {}};
...
const struct CompressedSpriteSheet gSpriteSheet_CreditsBrendan[] = {
    {.data = sBrendanCredits_Gfx, .size = 0x3800, .tag = TAG_BRENDAN}, {}};

const struct CompressedSpriteSheet gSpriteSheet_CreditsMay[] = {
    {.data = sMayCredits_Gfx, .size = 0x3800, .tag = TAG_MAY}, {}};
...
static const struct CompressedSpriteSheet sSpriteSheet_Latios[] = {
    {.data = sLatios_Gfx, .size = 0x1000, .tag = TAG_FLYGON_LATIOS}, {}};

// Unused
static const struct CompressedSpriteSheet sSpriteSheet_Latias[] = {
    {.data = sLatias_Gfx, .size = 0x1000, .tag = TAG_FLYGON_LATIAS}, {}};
...
const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalBrendan[] = {
    {.data = sBrendanCredits_Gfx, .size = 0x2000, .tag = TAG_BRENDAN}, {}};

const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalMay[] = {
    {.data = sMayCredits_Gfx, .size = 0x2000, .tag = TAG_MAY}, {}};
...
void LoadCreditsSceneGraphics(u8 scene) {
  ...
  case SCENE_OCEAN_SUNSET:
    ...
    LZ77UnCompVram(sCloudsBg_Gfx, (void *)(VRAM));
    LZ77UnCompVram(sCloudsBg_Tilemap, (void *)(BG_SCREEN_ADDR(6)));
    LoadPalette(&sCloudsBgSunset_Pal, BG_PLTT_ID(0),
                sizeof(sCloudsBgSunset_Pal));
    LoadCompressedSpriteSheet(sSpriteSheet_Clouds);
    LZ77UnCompVram(sClouds_Gfx, (void *)(OBJ_VRAM0));
  ...
  case SCENE_CITY_NIGHT:
    ...
    LoadPalette(&sHouseSilhouette_Pal, OBJ_PLTT_ID(0),
                sizeof(sHouseSilhouette_Pal));
    CreateHouseSprites();
    break;
  }
  gReservedSpritePaletteCount = 8;
...
#define tMode                                                                  \
  data[0] // Can be 0-2, but only != 0 matters. Determines vertical movement for
          // bg2
...
u8 CreateBicycleBgAnimationTask(u8 mode, u16 bg1Speed, u16 bg2Speed,
                                u16 bg3Speed) {
...
static void Task_BicycleBgAnimation(u8 taskId) {
  ...
  if (bg1Speed != 0) {
    ...
    SetGpuReg(REG_OFFSET_BG1VOFS, gIntroCredits_MovingSceneryVBase +
...
static void
CreateMovingScenerySprites(bool8 hasVerticalMove,
                           const struct IntroCreditsSpriteMetadata *metadata,
                           const union AnimCmd *const *anims, u8 numSprites) {
  u8 i;

  for (i = 0; i < numSprites; i++) {
    u8 sprite = CreateSprite(&sSpriteTemplate_MovingScenery, metadata[i].x,
                             metadata[i].y, metadata[i].subpriority);
    CalcCenterToCornerVec(&gSprites[sprite], metadata[i].shape,
                          metadata[i].size, ST_OAM_AFFINE_OFF);
...
static void CreateHouseSprites(void) {
  CreateMovingScenerySprites(TRUE, sSpriteMetadata_HouseSilhouette,
                             sAnims_HouseSilhouette, 6);
}
...
u8 CreateIntroBrendanSprite(s16 x, s16 y) {
  ...
  u8 bicycleSpriteId =
      CreateSprite(&sSpriteTemplate_BrendanBicycle, x, y + 8, 3);
...
// In RS these were for Latios/Latias. In Emerald both are replaced with Flygon
// and now only 1 is used
