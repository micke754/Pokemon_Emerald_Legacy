...
static union PokemonSubstruct *GetSubstruct(struct BoxPokemon *boxMon,
                                            u32 personality, u8 substructType);
...
EWRAM_DATA static struct MonSpritesGfxManager
    *sMonSpritesGfxManagers[MON_SPR_GFX_MANAGERS_COUNT] = {NULL};
...
static const struct CombinedMove sCombinedMoves[2] = {
    {MOVE_EMBER, MOVE_GUST, MOVE_HEAT_WAVE}, {0xFFFF, 0xFFFF, 0xFFFF}};
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] = {
    ...
    HOENN_TO_NATIONAL(
        BULBASAUR), // Pokémon from here onwards are UNSEEN in the HoennDex.
...
const struct SpindaSpot gSpindaSpotGraphics[] = {
    {.x = 16,
     .y = 7,
     .image = INCBIN_U16("graphics/pokemon/spinda/spots/spot_0.1bpp")},
    {.x = 40,
     .y = 8,
     .image = INCBIN_U16("graphics/pokemon/spinda/spots/spot_1.1bpp")},
    {.x = 22,
     .y = 25,
     .image = INCBIN_U16("graphics/pokemon/spinda/spots/spot_2.1bpp")},
    {.x = 34,
     .y = 26,
     .image = INCBIN_U16("graphics/pokemon/spinda/spots/spot_3.1bpp")}};

#include "data/pokemon/item_effects.h"

const s8 gNatureStatTable[NUM_NATURES][NUM_NATURE_STATS] = {
    // Attack  Defense  Speed  Sp.Atk  Sp.Def
    [NATURE_HARDY] = {0, 0, 0, 0, 0},     [NATURE_LONELY] = {+1, -1, 0, 0, 0},
    [NATURE_BRAVE] = {+1, 0, -1, 0, 0},   [NATURE_ADAMANT] = {+1, 0, 0, -1, 0},
    [NATURE_NAUGHTY] = {+1, 0, 0, 0, -1}, [NATURE_BOLD] = {-1, +1, 0, 0, 0},
    [NATURE_DOCILE] = {0, 0, 0, 0, 0},    [NATURE_RELAXED] = {0, +1, -1, 0, 0},
    [NATURE_IMPISH] = {0, +1, 0, -1, 0},  [NATURE_LAX] = {0, +1, 0, 0, -1},
    [NATURE_TIMID] = {-1, 0, +1, 0, 0},   [NATURE_HASTY] = {0, -1, +1, 0, 0},
    [NATURE_SERIOUS] = {0, 0, 0, 0, 0},   [NATURE_JOLLY] = {0, 0, +1, -1, 0},
    [NATURE_NAIVE] = {0, 0, +1, 0, -1},   [NATURE_MODEST] = {-1, 0, 0, +1, 0},
    [NATURE_MILD] = {0, -1, 0, +1, 0},    [NATURE_QUIET] = {0, 0, -1, +1, 0},
    [NATURE_BASHFUL] = {0, 0, 0, 0, 0},   [NATURE_RASH] = {0, 0, 0, +1, -1},
    [NATURE_CALM] = {-1, 0, 0, 0, +1},    [NATURE_GENTLE] = {0, -1, 0, 0, +1},
    [NATURE_SASSY] = {0, 0, -1, 0, +1},   [NATURE_CAREFUL] = {0, 0, 0, -1, +1},
...
// SPECIES_NONE are ignored in the following two tables, so decrement before
// accessing these arrays to get the right result
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] = {
    [SPECIES_BLASTOISE - 1] = 50,  [SPECIES_WEEDLE - 1] = 10,
    [SPECIES_KAKUNA - 1] = 20,     [SPECIES_BEEDRILL - 1] = 35,
    [SPECIES_PIDGEOTTO - 1] = 25,  [SPECIES_FEAROW - 1] = 2,
    [SPECIES_EKANS - 1] = 30,      [SPECIES_NIDORAN_F - 1] = 28,
    [SPECIES_NIDOKING - 1] = 25,   [SPECIES_PARAS - 1] = 10,
    [SPECIES_PARASECT - 1] = 45,   [SPECIES_VENONAT - 1] = 20,
    [SPECIES_DIGLETT - 1] = 25,    [SPECIES_DUGTRIO - 1] = 35,
    [SPECIES_MEOWTH - 1] = 40,     [SPECIES_PERSIAN - 1] = 20,
    [SPECIES_MANKEY - 1] = 20,     [SPECIES_GROWLITHE - 1] = 30,
    [SPECIES_ARCANINE - 1] = 40,   [SPECIES_POLIWHIRL - 1] = 5,
    [SPECIES_WEEPINBELL - 1] = 3,  [SPECIES_MUK - 1] = 45,
    [SPECIES_SHELLDER - 1] = 20,   [SPECIES_HAUNTER - 1] = 23,
    [SPECIES_DROWZEE - 1] = 48,    [SPECIES_HYPNO - 1] = 40,
    [SPECIES_HITMONCHAN - 1] = 25, [SPECIES_SCYTHER - 1] = 10,
    [SPECIES_TAUROS - 1] = 10,     [SPECIES_TYPHLOSION - 1] = 20,
    [SPECIES_FERALIGATR - 1] = 5,  [SPECIES_NATU - 1] = 30,
    [SPECIES_MAREEP - 1] = 50,     [SPECIES_AMPHAROS - 1] = 10,
    [SPECIES_POLITOED - 1] = 40,   [SPECIES_DUNSPARCE - 1] = 10,
    [SPECIES_STEELIX - 1] = 45,    [SPECIES_QWILFISH - 1] = 39,
    [SPECIES_SCIZOR - 1] = 19,     [SPECIES_OCTILLERY - 1] = 20,
    [SPECIES_SMOOCHUM - 1] = 40,   [SPECIES_TYRANITAR - 1] = 10,
    [SPECIES_LUGIA - 1] = 20,      [SPECIES_WAILORD - 1] = 10,
    [SPECIES_KECLEON - 1] = 30,    [SPECIES_MILOTIC - 1] = 45,
    [SPECIES_SPHEAL - 1] = 15,     [SPECIES_SNORUNT - 1] = 20,
    [SPECIES_GRUMPIG - 1] = 15,    [SPECIES_WYNAUT - 1] = 15,
    [SPECIES_DUSCLOPS - 1] = 30,   [SPECIES_ABSOL - 1] = 45,
    [SPECIES_SALAMENCE - 1] = 70,  [SPECIES_KYOGRE - 1] = 60,
    [SPECIES_RAYQUAZA - 1] = 60,
};

#define PP_UP_SHIFTS(val) val, (val) << 2, (val) << 4, (val) << 6
#define PP_UP_SHIFTS_INV(val)                                                  \
  (u8) ~(val), (u8) ~((val) << 2), (u8) ~((val) << 4), (u8) ~((val) << 6)
...
// gPPUpClearMask - A mask to clear the number of PP Ups applied to that move
// slot gPPUpAddValues - A value to add to the PP Bonuses byte to apply 1 PP Up
// to that move slot
...
const u16 gUnionRoomFacilityClasses[NUM_UNION_ROOM_CLASSES * GENDER_COUNT] = {
    // Male classes
    FACILITY_CLASS_COOLTRAINER_M, FACILITY_CLASS_BLACK_BELT,
    FACILITY_CLASS_CAMPER, FACILITY_CLASS_YOUNGSTER, FACILITY_CLASS_PSYCHIC_M,
    FACILITY_CLASS_BUG_CATCHER, FACILITY_CLASS_PKMN_BREEDER_M,
    FACILITY_CLASS_GUITARIST,
    // Female classes
    FACILITY_CLASS_COOLTRAINER_F, FACILITY_CLASS_HEX_MANIAC,
    FACILITY_CLASS_PICNICKER, FACILITY_CLASS_LASS, FACILITY_CLASS_PSYCHIC_F,
    FACILITY_CLASS_BATTLE_GIRL, FACILITY_CLASS_PKMN_BREEDER_F,
...
const struct SpriteTemplate gBattlerSpriteTemplates[MAX_BATTLERS_COUNT] = {
    ...
    [B_POSITION_OPPONENT_RIGHT] = {.tileTag = TAG_NONE,
                                   .paletteTag = 0,
                                   .oam = &gOamData_BattleSpriteOpponentSide,
                                   .anims = NULL,
...
static const u8
    sSecretBaseFacilityClasses[GENDER_COUNT][NUM_SECRET_BASE_CLASSES] = {
        [MALE] = {FACILITY_CLASS_YOUNGSTER, FACILITY_CLASS_BUG_CATCHER,
                  FACILITY_CLASS_RICH_BOY, FACILITY_CLASS_CAMPER,
                  FACILITY_CLASS_COOLTRAINER_M},
        [FEMALE] = {FACILITY_CLASS_LASS, FACILITY_CLASS_SCHOOL_KID_F,
                    FACILITY_CLASS_LADY, FACILITY_CLASS_PICNICKER,
...
static const u8 sStatsToRaise[] = {STAT_ATK, STAT_ATK,   STAT_SPEED,
                                   STAT_DEF, STAT_SPATK, STAT_ACC};
...
static const u16 sHMMoves[] = {MOVE_CUT,       MOVE_FLY,   MOVE_SURF,
                               MOVE_STRENGTH,  MOVE_FLASH, MOVE_ROCK_SMASH,
                               MOVE_WATERFALL, MOVE_DIVE,  HM_MOVES_END};
...
static const struct OamData sOamData_64x64 = {.y = 0,
...
void CreateMon(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV,
  ...
  u32 mail;
  ZeroMonData(mon);
  CreateBoxMon(&mon->box, species, level, fixedIV, hasFixedPersonality,
...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV,
  ...
  case OT_ID_RANDOM_NO_SHINY: {
    ...
    do {
      value = Random32();
      shinyValue = HIHALF(value) ^ LOHALF(value) ^ HIHALF(personality) ^
                   LOHALF(personality);
  ...
  default: {
    ...
    if (FlagGet(FLAG_SHINY_CREATION)) {
      ...
      do {
        personality = Random32();
        personality =
            ((((Random() % SHINY_ODDS) ^ (HIHALF(value) ^ LOHALF(value))) ^
              LOHALF(personality))
             << 16) |
            LOHALF(personality);
  ...
  SetBoxMonData(boxMon, MON_DATA_EXP,
...
void CreateMonWithNature(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV,
  ...
  CreateMon(mon, species, level, fixedIV, TRUE, personality, OT_ID_PLAYER_ID,
            0);
}
  ...
  if ((u8)(unownLetter - 1) < NUM_UNOWN_FORMS) {
    ...
    do {
      ...
      actualLetter = GET_UNOWN_LETTER(personality);
             ...
             gender !=
                 GetGenderFromSpeciesAndPersonality(species, personality) ||
...
void CreateMaleMon(struct Pokemon *mon, u16 species, u8 level) {
  ...
  do {
    otId = Random32();
    personality = Random32();
  } while (GetGenderFromSpeciesAndPersonality(species, personality) !=
           MON_MALE);
...
void CreateBattleTowerMon(struct Pokemon *mon, struct BattleTowerPokemon *src) {
  ...
  CreateMon(mon, src->species, src->level, 0, TRUE, src->personality,
            OT_ID_PRESET, src->otId);
...
void CreateBattleTowerMon_HandleLevel(struct Pokemon *mon,
  ...
  CreateMon(mon, src->species, level, 0, TRUE, src->personality, OT_ID_PRESET,
            src->otId);
...
void CreateApprenticeMon(struct Pokemon *mon, const struct Apprentice *src,
  ...
  u32 personality = ((gApprentices[src->id].otId >> 8) |
                     ((gApprentices[src->id].otId & 0xFF) << 8)) +
                    src->party[monId].species + src->number;

  CreateMon(mon, src->party[monId].species,
            GetFrontierEnemyMonLevel(src->lvlMode - 1), MAX_PER_STAT_IVS, TRUE,
  ...
  SetMonData(mon, MON_DATA_LANGUAGE, &language);
  SetMonData(mon, MON_DATA_OT_NAME,
             GetApprenticeNameInLanguage(src->id, language));
  CalculateMonStats(mon);
}
...
static void CreateEventMon(struct Pokemon *mon, u16 species, u8 level,
...
// If FALSE, should load this game's Deoxys form. If TRUE, should load normal
// Deoxys form
...
static u16 GetDeoxysStat(struct Pokemon *mon, s32 statId) {
  ...
  statValue =
      ((sDeoxysBaseStats[statId] * 2 + ivVal + evVal / 4) * mon->level) / 100 +
      5;
...
static u16 CalculateBoxMonChecksum(struct BoxPokemon *boxMon) {
  u16 checksum = 0;
  union PokemonSubstruct *substruct0 =
      GetSubstruct(boxMon, boxMon->personality, 0);
  union PokemonSubstruct *substruct1 =
      GetSubstruct(boxMon, boxMon->personality, 1);
  union PokemonSubstruct *substruct2 =
      GetSubstruct(boxMon, boxMon->personality, 2);
  union PokemonSubstruct *substruct3 =
      GetSubstruct(boxMon, boxMon->personality, 3);
  s32 i;
...
u16 MonTryLearningNewMove(struct Pokemon *mon, bool8 firstMove) {
  ...
  if (firstMove) {
    ...
    while ((gLevelUpLearnsets[species][sLearningMoveTableID] &
  ...
  if ((gLevelUpLearnsets[species][sLearningMoveTableID] & LEVEL_UP_MOVE_LV) ==
      (level << 9)) {
    gMoveToLearn =
        (gLevelUpLearnsets[species][sLearningMoveTableID] & LEVEL_UP_MOVE_ID);
    sLearningMoveTableID++;
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker,
  ...
  if (attackerHoldEffect == HOLD_EFFECT_DEEP_SEA_TOOTH &&
    ...
    spAttack *= 2;
  if (defenderHoldEffect == HOLD_EFFECT_DEEP_SEA_SCALE &&
  ...
  if (type == TYPE_ELECTRIC &&
      AbilityBattleEffects(ABILITYEFFECT_FIELD_SPORT, 0, 0,
                           ABILITYEFFECT_MUD_SPORT, 0))
    gBattleMovePower /= 2;
  if (type == TYPE_FIRE && AbilityBattleEffects(ABILITYEFFECT_FIELD_SPORT, 0, 0,
                                                ABILITYEFFECT_WATER_SPORT, 0))
    gBattleMovePower /= 2;
  ...
  if (IS_TYPE_PHYSICAL(type)) {
    if (gCritMultiplier == 2) {
      // Critical hit, if attacker has lost attack stat stages then ignore stat
      // drop
    ...
    if (gCritMultiplier == 2) {
      // Critical hit, if defender has gained defense stat stages then ignore
      // stat increase
  ...
  if (IS_TYPE_SPECIAL(type)) {
    if (gCritMultiplier == 2) {
      // Critical hit, if attacker has lost sp. attack stat stages then ignore
      // stat drop
    ...
    if (gCritMultiplier == 2) {
      // Critical hit, if defender has gained sp. defense stat stages then
    ...
    if (WEATHER_HAS_EFFECT2) {
      ...
      if ((gBattleWeather &
           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_HAIL)) &&
    ...
    if ((gBattleResources->flags->flags[battlerIdAtk] &
...
void SetMultiuseSpriteTemplateToPokemon(u16 speciesTag, u8 battlerPosition) {
  if (gMonSpritesGfxPtr != NULL)
    ...
    gMultiuseSpriteTemplate = sMonSpritesGfxManagers[MON_SPR_GFX_MANAGER_A]
                                  ->templates[battlerPosition];
  else if (sMonSpritesGfxManagers[MON_SPR_GFX_MANAGER_B])
    gMultiuseSpriteTemplate = sMonSpritesGfxManagers[MON_SPR_GFX_MANAGER_B]
                                  ->templates[battlerPosition];
  else
  ...
  if (battlerPosition == B_POSITION_PLAYER_LEFT ||
      battlerPosition == B_POSITION_PLAYER_RIGHT)
    gMultiuseSpriteTemplate.anims = gAnims_MonPic;
  else if (speciesTag > SPECIES_SHINY_TAG)
    gMultiuseSpriteTemplate.anims =
        gMonFrontAnimsPtrTable[speciesTag - SPECIES_SHINY_TAG];
  else
    gMultiuseSpriteTemplate.anims = gMonFrontAnimsPtrTable[speciesTag];
}

void SetMultiuseSpriteTemplateToTrainerBack(u16 trainerPicId,
                                            u8 battlerPosition) {
...
u32 GetMonData2(struct Pokemon *mon, s32 field)
    __attribute__((alias("GetMonData3")));
...
u32 GetBoxMonData3(struct BoxPokemon *boxMon, s32 field, u8 *data) {
  ...
  // Any field greater than MON_DATA_ENCRYPT_SEPARATOR is encrypted and must be
  // treated as such
  ...
  case MON_DATA_SPECIES_OR_EGG:
    ...
    break;
  case MON_DATA_IVS:
    retVal = substruct3->hpIV | (substruct3->attackIV << 5) |
             (substruct3->defenseIV << 10) | (substruct3->speedIV << 15) |
             (substruct3->spAttackIV << 20) | (substruct3->spDefenseIV << 25);
    break;
  ...
  case MON_DATA_RIBBONS:
    ...
    if (substruct0->species && !substruct3->isEgg) {
      retVal =
          substruct3->championRibbon | (substruct3->coolRibbon << 1) |
          ...
          (substruct3->effortRibbon << 19) | (substruct3->marineRibbon << 20) |
          (substruct3->landRibbon << 21) | (substruct3->skyRibbon << 22) |
          (substruct3->countryRibbon << 23) |
          (substruct3->nationalRibbon << 24) | (substruct3->earthRibbon << 25) |
...
u32 GetBoxMonData2(struct BoxPokemon *boxMon, s32 field)
    __attribute__((alias("GetBoxMonData3")));

#define SET8(lhs) (lhs) = *data
#define SET16(lhs) (lhs) = data[0] + (data[1] << 8)
#define SET32(lhs)                                                             \
  (lhs) = data[0] + (data[1] << 8) + (data[2] << 16) + (data[3] << 24)
...
u8 GetMonsStateToDoubles(void) {
  ...
  return (aliveCount > 1) ? PLAYER_HAS_TWO_USABLE_MONS
  ...
  for (i = 0; i < PARTY_SIZE; i++) {
    if (gBattleResources->secretBase->party.species[i]) {
      CreateMon(&gEnemyParty[i], gBattleResources->secretBase->party.species[i],
                gBattleResources->secretBase->party.levels[i], 15, TRUE,
...
u8 GetSecretBaseTrainerPicIndex(void) {
  u8 facilityClass =
      sSecretBaseFacilityClasses[gBattleResources->secretBase->gender]
                                [gBattleResources->secretBase->trainerId[0] %
                                 NUM_SECRET_BASE_CLASSES];
...
u8 CalculatePPWithBonus(u16 move, u8 ppBonuses, u8 moveIndex) {
  ...
  return basePP +
         ((basePP * 20 *
           ((gPPUpGetMask[moveIndex] & ppBonuses) >> (2 * moveIndex))) /
          100);
}
...
void CopyPlayerPartyMonToBattleData(u8 battlerId, u8 partyIndex) {
  ...
  gBattleMons[battlerId].species =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_SPECIES, NULL);
  gBattleMons[battlerId].item =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_HELD_ITEM, NULL);
  ...
  gBattleMons[battlerId].experience =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_EXP, NULL);
  gBattleMons[battlerId].hpIV =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_HP_IV, NULL);
  gBattleMons[battlerId].attackIV =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_ATK_IV, NULL);
  gBattleMons[battlerId].defenseIV =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_DEF_IV, NULL);
  gBattleMons[battlerId].speedIV =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_SPEED_IV, NULL);
  ...
  gBattleMons[battlerId].status1 =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_STATUS, NULL);
  gBattleMons[battlerId].level =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_LEVEL, NULL);
  gBattleMons[battlerId].hp =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_HP, NULL);
  gBattleMons[battlerId].maxHP =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_MAX_HP, NULL);
  gBattleMons[battlerId].attack =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_ATK, NULL);
  gBattleMons[battlerId].defense =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_DEF, NULL);
  gBattleMons[battlerId].speed =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_SPEED, NULL);
  gBattleMons[battlerId].spAttack =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_SPATK, NULL);
  gBattleMons[battlerId].spDefense =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_SPDEF, NULL);
  gBattleMons[battlerId].isEgg =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_IS_EGG, NULL);
  gBattleMons[battlerId].abilityNum =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_ABILITY_NUM, NULL);
  gBattleMons[battlerId].otId =
      GetMonData(&gPlayerParty[partyIndex], MON_DATA_OT_ID, NULL);
  gBattleMons[battlerId].type1 =
      gSpeciesInfo[gBattleMons[battlerId].species].types[0];
  gBattleMons[battlerId].type2 =
      gSpeciesInfo[gBattleMons[battlerId].species].types[1];
  gBattleMons[battlerId].ability = GetAbilityBySpecies(
      gBattleMons[battlerId].species, gBattleMons[battlerId].abilityNum);
  GetMonData(&gPlayerParty[partyIndex], MON_DATA_NICKNAME, nickname);
  StringCopy_Nickname(gBattleMons[battlerId].nickname, nickname);
  GetMonData(&gPlayerParty[partyIndex], MON_DATA_OT_NAME,
             gBattleMons[battlerId].otName);
...
#define UPDATE_FRIENDSHIP_FROM_ITEM()                                          \
  {                                                                            \
    if ((retVal == 0 || friendshipOnly) && !ShouldSkipFriendshipChange() &&    \
        friendshipChange == 0) {                                               \
...
bool8 PokemonUseItemEffects(struct Pokemon *mon, u16 item, u8 partyIndex,
  ...
  for (i = 0; i < ITEM_EFFECT_ARG_START; i++) {
    ...
    // Handle ITEM0 effects (infatuation, Dire Hit, X Attack). ITEM0_SACRED_ASH
    // is handled in party_menu.c
    case 0:
      // Cure infatuation
      if ((itemEffect[i] & ITEM0_INFATUATION) && gMain.inBattle &&
          battlerId != MAX_BATTLERS_COUNT &&
    ...
    case 2:
      ...
      if ((itemEffect[i] & ITEM2_X_ACCURACY) &&
        ...
        gBattleMons[gActiveBattler].statStages[STAT_ACC] +=
            (itemEffect[i] & ITEM2_X_ACCURACY) >> 4;
    ...
    case 3:
      ...
      if ((itemEffect[i] & ITEM3_SLEEP) &&
          HealStatusConditions(mon, partyIndex, STATUS1_SLEEP, battlerId) ==
              0) {
      ...
      if ((itemEffect[i] & ITEM3_POISON) &&
          HealStatusConditions(mon, partyIndex,
                               STATUS1_PSN_ANY | STATUS1_TOXIC_COUNTER,
                               battlerId) == 0)
        retVal = FALSE;
      if ((itemEffect[i] & ITEM3_BURN) &&
      ...
      if ((itemEffect[i] & ITEM3_PARALYSIS) &&
          HealStatusConditions(mon, partyIndex, STATUS1_PARALYSIS, battlerId) ==
              0)
        retVal = FALSE;
    ...
    // Handle ITEM4 effects (Change HP/Atk EVs, HP heal, PP heal, PP up, Revive,
        ...
        if (effectFlags & 1) {
          ...
          case 1: // ITEM4_EV_ATK
            ...
            if (evChange > 0) // Increasing EV (HP or Atk)
            {
              ...
              if (dataSigned + evChange > EV_ITEM_RAISE_LIMIT)
                temp2 =
                    EV_ITEM_RAISE_LIMIT - (dataSigned + evChange) + evChange;
              else
                temp2 = evChange;
              ...
              if (gMain.inBattle) {
                if (battlerId != MAX_BATTLERS_COUNT) {
                  ...
                  CopyPlayerPartyMonToBattleData(
                      battlerId, GetPartyIdFromBattlePartyId(
          ...
          case 3: // ITEM4_HEAL_PP
            if (!(effectFlags & (ITEM4_HEAL_PP_ONE >> 3))) {
              ...
              for (temp2 = 0; (signed)(temp2) < (signed)(MAX_MON_MOVES);
                   temp2++) {
                u16 moveId;
                ...
                if (dataUnsigned !=
                    CalculatePPWithBonus(
                        moveId, GetMonData(mon, MON_DATA_PP_BONUSES, NULL),
                        temp2)) {
                  dataUnsigned += itemEffect[itemEffectParam];
                  moveId = GetMonData(mon, MON_DATA_MOVE1 + temp2,
                                      NULL); // Redundant
                  if (dataUnsigned >
                      CalculatePPWithBonus(
                          moveId, GetMonData(mon, MON_DATA_PP_BONUSES, NULL),
                  ...
                  if (gMain.inBattle && battlerId != MAX_BATTLERS_COUNT &&
                      MOVE_IS_PERMANENT(battlerId, temp2))
              ...
              if (dataUnsigned !=
                  CalculatePPWithBonus(
                      ...
                      moveIndex)) {
                dataUnsigned += itemEffect[itemEffectParam++];
                moveId = GetMonData(mon, MON_DATA_MOVE1 + moveIndex,
                                    NULL); // Redundant
                if (dataUnsigned >
                    CalculatePPWithBonus(
                        moveId, GetMonData(mon, MON_DATA_PP_BONUSES, NULL),
                ...
                // Heal battler PP too (if applicable)
                if (gMain.inBattle && battlerId != MAX_BATTLERS_COUNT &&
                    MOVE_IS_PERMANENT(battlerId, moveIndex))
            ...
            // cases 4-6 are ITEM4_HEAL_PP_ONE, ITEM4_PP_UP, and ITEM4_REVIVE,
            // which are already handled above by other cases or before the loop
    ...
    // Handle ITEM5 effects (Change Def/SpDef/SpAtk/Speed EVs, PP Max, and
    // friendship changes)
    case 5:
      effectFlags = itemEffect[i];
      temp1 = 0;
      ...
      while (effectFlags != 0) {
        if (effectFlags & 1) {
          ...
          case 3: // ITEM5_EV_SPATK
            ...
            temp2 = itemEffect[itemEffectParam];
            dataSigned =
                GetMonData(mon, sGetMonDataEVConstants[temp1 + 2], NULL);
            evChange = temp2;
          ...
          case 4: // ITEM5_PP_MAX
            ...
            // Check if 3 PP Ups have been applied already, and that the move
            // has a total PP of at least 5 (excludes Sketch)
            if (dataUnsigned < 3 && temp2 >= 5) {
              dataUnsigned = GetMonData(mon, MON_DATA_PP_BONUSES, NULL);
              dataUnsigned &= gPPUpClearMask[moveIndex];
              dataUnsigned +=
                  gPPUpAddValues[moveIndex] * 3; // Apply 3 PP Ups (max)
...
u16 GetEvolutionTargetSpecies(struct Pokemon *mon, u8 mode, u16 evolutionItem) {
  ...
  // Prevent evolution with Everstone, unless we're just viewing the party menu
  // with an evolution item
...
u16 HoennPokedexNumToSpecies(u16 hoennNum) {
  ...
  while (species < (NUM_SPECIES - 1) &&
         sSpeciesToHoennPokedexNum[species] != hoennNum)
    species++;
...
u16 NationalPokedexNumToSpecies(u16 nationalNum) {
  ...
  while (species < (NUM_SPECIES - 1) &&
         sSpeciesToNationalPokedexNum[species] != nationalNum)
    species++;
...
u16 NationalToHoennOrder(u16 nationalNum) {
  ...
  while (hoennNum < (NUM_SPECIES - 1) &&
         sHoennToNationalOrder[hoennNum] != nationalNum)
    hoennNum++;
...
/*
    The macro below handles drawing the randomly-placed spots on Spinda's front
   sprite. Spinda has 4 spots, each with an entry in gSpindaSpotGraphics. Each
   entry contains a base x and y coordinate for the spot and a 16x16 binary
   image. Each bit in the image determines whether that pixel should be
   considered part of the spot.

    The position of each spot is randomized using the Spinda's personality. The
   entire 32 bit personality value is used, 4 bits for each coordinate of the 4
   spots. If the personality value is 0x87654321, then 0x1 will be used for the
   1st spot's x coord, 0x2 will be used for the 1st spot's y coord, 0x3 will be
   used for the 2nd spot's x coord, and so on. Each coordinate is calculated as
   (baseCoord + (given 4 bits of personality) - 8). In effect this means each
   spot can start at any position -8 to +7 off of its base coordinates (256
   possibilities).

    The macro then loops over the 16x16 spot image. For each bit in the spot's
   binary image, if the bit is set then it's part of the spot; try to draw it. A
   pixel is drawn on Spinda if the pixel on Spinda satisfies the following
   formula: ((u8)(colorIndex - 1) <= 2). The -1 excludes transparent pixels, as
   these are index 0. Therefore only colors 1, 2, or 3 on Spinda will allow a
   spot to be drawn. These color indexes are Spinda's light brown body colors.
   To create the spot it adds 4 to the color index, so Spinda's spots will be
   colors 5, 6, and 7.

    The above is done two different ways in the macro: one with << 4, and one
   without. This is because Spinda's sprite is a 4 bits per pixel image, but the
   pointer to Spinda's pixels (destPixels) is an 8 bit pointer, so it addresses
   two pixels. Shifting by 4 accesses the 2nd of these pixels, so this is done
   every other time.
*/
...
static void UNUSED DrawSpindaSpotsUnused(u16 species, u32 personality,
                                         u8 *dest) {
...
void EvolutionRenameMon(struct Pokemon *mon, u16 oldSpecies, u16 newSpecies) {
  ...
  if (language == GAME_LANGUAGE &&
      !StringCompare(gSpeciesNames[oldSpecies], gStringVar1))
    SetMonData(mon, MON_DATA_NICKNAME, gSpeciesNames[newSpecies]);
}

// The below two functions determine which side of a multi battle the trainer
// battles on 0 is the left (top in  party menu), 1 is right (bottom in party
// menu)
    ...
    if ((event != FRIENDSHIP_EVENT_WALKING || !(Random() & 1)) &&
      ...
      if (mod > 0) {
        if (GetMonData(mon, MON_DATA_POKEBALL, 0) == ITEM_LUXURY_BALL)
          friendship++;
        if (GetMonData(mon, MON_DATA_MET_LOCATION, 0) ==
            GetCurrentRegionMapSectionId())
          friendship++;
      }
      if (friendship < 0)
...
u8 CheckPartyPokerus(struct Pokemon *party, u8 selection) {
  ...
  if (selection) {
    do {
      if ((selection & 1) &&
          (GetMonData(&party[partyIndex], MON_DATA_POKERUS, 0) & 0xF))
        retVal |= curBit;
      partyIndex++;
      curBit <<= 1;
      selection >>= 1;
...
u8 CheckPartyHasHadPokerus(struct Pokemon *party, u8 selection) {
  ...
  if (selection) {
    do {
      if ((selection & 1) &&
          GetMonData(&party[partyIndex], MON_DATA_POKERUS, 0))
        retVal |= curBit;
      partyIndex++;
      curBit <<= 1;
      selection >>= 1;
...
bool8 TryIncrementMonLevel(struct Pokemon *mon) {
  ...
  if (expPoints >
      gExperienceTables[gSpeciesInfo[species].growthRate][MAX_LEVEL]) {
    expPoints = gExperienceTables[gSpeciesInfo[species].growthRate][MAX_LEVEL];
    SetMonData(mon, MON_DATA_EXP, &expPoints);
  }
  if (nextLevel > MAX_LEVEL ||
      expPoints <
          gExperienceTables[gSpeciesInfo[species].growthRate][nextLevel]) {
    return FALSE;
  } else {
...
u8 GetMoveRelearnerMoves(struct Pokemon *mon, u16 *moves) {
  ...
  for (i = 0; i < MAX_LEVEL_UP_MOVES; i++) {
    ...
    if (moveLevel <= (level << 9)) {
      ...
      if (j == MAX_MON_MOVES) {
        for (k = 0; k < numMoves && moves[k] != (gLevelUpLearnsets[species][i] &
                                                 LEVEL_UP_MOVE_ID);
             k++)
          ;
...
u8 GetLevelUpMovesBySpecies(u16 species, u16 *moves) {
  ...
  for (i = 0;
       i < MAX_LEVEL_UP_MOVES && gLevelUpLearnsets[species][i] != LEVEL_UP_END;
       i++)
    moves[numMoves++] = gLevelUpLearnsets[species][i] & LEVEL_UP_MOVE_ID;
...
u16 SpeciesToPokedexNum(u16 species) {
  if (species == SPECIES_DEOXYS_SPEED || species == SPECIES_DEOXYS_ATTACK ||
...
u16 GetBattleBGM(void) {
  if (gBattleTypeFlags & BATTLE_TYPE_KYOGRE_GROUDON)
    ...
    case TRAINER_CLASS_RIVAL:
      if (gBattleTypeFlags & BATTLE_TYPE_FRONTIER)
        return MUS_VS_RIVAL;
      if (!StringCompare(gTrainers[gTrainerBattleOpponent_A].trainerName,
...
bool8 IsOtherTrainer(u32 otId, u8 *otName) {
  if (otId == (gSaveBlock2Ptr->playerTrainerId[0] |
               (gSaveBlock2Ptr->playerTrainerId[1] << 8) |
               (gSaveBlock2Ptr->playerTrainerId[2] << 16) |
               (gSaveBlock2Ptr->playerTrainerId[3] << 24))) {
    int i;
...
void MonRestorePP(struct Pokemon *mon) { BoxMonRestorePP(&mon->box); }
...
void SetMonPreventsSwitchingString(void) {
  ...
  PREPARE_MON_NICK_WITH_PREFIX_BUFFER(
      gBattleTextBuff2, gBattlerInMenuId,
...
void SetWildMonHeldItem(void) {
  if (!(gBattleTypeFlags & (BATTLE_TYPE_LEGENDARY | BATTLE_TYPE_TRAINER |
                            BATTLE_TYPE_PYRAMID | BATTLE_TYPE_PIKE))) {
    u16 rnd = Random() % 100;
    ...
    if (gMapHeader.mapLayoutId == LAYOUT_ALTERING_CAVE) {
      ...
      if (alteringCaveId != 0) {
        ...
        if (rnd < chanceNotRare)
          return;
        SetMonData(&gEnemyParty[0], MON_DATA_HELD_ITEM,
...
static void Task_AnimateAfterDelay(u8 taskId) {
  if (--gTasks[taskId].sAnimDelay == 0) {
    LaunchAnimationTaskForFrontSprite(READ_PTR_FROM_TASK(taskId, 0),
                                      gTasks[taskId].sAnimId);
    DestroyTask(taskId);
  }
}
...
static void Task_PokemonSummaryAnimateAfterDelay(u8 taskId) {
  if (--gTasks[taskId].sAnimDelay == 0) {
    StartMonSummaryAnimation(READ_PTR_FROM_TASK(taskId, 0),
                             gTasks[taskId].sAnimId);
...
void BattleAnimateFrontSprite(struct Sprite *sprite, u16 species, bool8 noCry,
  ...
  if (gHitMarker & HITMARKER_NO_ANIMATIONS &&
    ...
    DoMonFrontSpriteAnimation(sprite, species, noCry,
                              panMode | SKIP_FRONT_ANIM);
  else
...
void DoMonFrontSpriteAnimation(struct Sprite *sprite, u16 species, bool8 noCry,
                               u8 panModeAnimFlag) {
  s8 pan;
  switch (panModeAnimFlag &
          (u8)~SKIP_FRONT_ANIM) // Exclude anim flag to get pan mode
  {
  case 0:
    pan = -25;
    break;
  ...
  if (panModeAnimFlag & SKIP_FRONT_ANIM) {
    ...
    if (sMonAnimationDelayTable[species - 1] != 0) {
      ...
      LaunchAnimationTaskForFrontSprite(sprite,
                                        sMonFrontAnimIdsTable[species - 1]);
    }
...
void HandleSetPokedexFlag(u16 nationalNum, u8 caseId, u32 personality) {
  u8 getFlagCaseId =
      (caseId == FLAG_SET_SEEN) ? FLAG_GET_SEEN : FLAG_GET_CAUGHT;
  if (!GetSetPokedexFlag(nationalNum,
                         getFlagCaseId)) // don't set if it's already set
  {
...
bool8 HasTwoFramesAnimation(u16 species) {
  return (species != SPECIES_CASTFORM && species != SPECIES_DEOXYS &&
          species != SPECIES_SPINDA && species != SPECIES_UNOWN);
}
...
// The below functions are for the 'MonSpritesGfxManager', a method of
// allocating space for Pokémon sprites. These are only used for the summary
// screen Pokémon sprites (unless gMonSpritesGfxPtr is in use), but were set up
// for more general use. Only the 'default' mode (MON_SPR_GFX_MODE_NORMAL) is
// used, which is set up to allocate 4 sprites using the battler sprite
// templates (gBattlerSpriteTemplates). MON_SPR_GFX_MODE_BATTLE is identical but
// never used. MON_SPR_GFX_MODE_FULL_PARTY is set up to allocate 7 sprites
// (party + trainer?) using a generic 64x64 template, and is also never used.

// Between the unnecessarily large sizes below, a mistake allocating the
// spritePointers field, and the fact that ultimately only 1 of the 4 sprite
// positions is used, this system wastes a good deal of memory.
...
static void InitMonSpritesGfx_Battle(struct MonSpritesGfxManager *gfx) {
  ...
  for (i = 0; i < gfx->numSprites; i++) {
    ...
    for (j = 0; j < gfx->numFrames; j++)
      gfx->frameImages[i * gfx->numFrames + j].data =
          &gfx->spritePointers[i][j * MON_PIC_SIZE];
...
static void InitMonSpritesGfx_FullParty(struct MonSpritesGfxManager *gfx) {
  ...
  for (i = 0; i < gfx->numSprites; i++) {
    ...
    for (j = 0; j < gfx->numFrames; j++)
      gfx->frameImages[i * gfx->numSprites + j].data =
          &gfx->spritePointers[i][j * MON_PIC_SIZE];
...
struct MonSpritesGfxManager *CreateMonSpritesGfxManager(u8 managerId, u8 mode) {
  ...
  gfx->spriteBuffer = AllocZeroed(gfx->dataSize * MON_PIC_SIZE *
                                  MAX_MON_PIC_FRAMES * gfx->numSprites);
  gfx->spritePointers = AllocZeroed(
      gfx->numSprites *
      32); // ? Only * 4 is necessary, perhaps they were thinking bits.
  if (gfx->spriteBuffer == NULL || gfx->spritePointers == NULL) {
    failureFlags |= ALLOC_FAIL_BUFFER;
  } else {
    for (i = 0; i < gfx->numSprites; i++)
      gfx->spritePointers[i] =
          gfx->spriteBuffer +
          (gfx->dataSize * MON_PIC_SIZE * MAX_MON_PIC_FRAMES * i);
  }

  // Set up sprite structs
  gfx->templates = AllocZeroed(sizeof(struct SpriteTemplate) * gfx->numSprites);
  gfx->frameImages = AllocZeroed(sizeof(struct SpriteFrameImage) *
                                 gfx->numSprites * gfx->numFrames);
...
u8 *MonSpritesGfxManager_GetSpritePtr(u8 managerId, u8 spriteNum) {
  struct MonSpritesGfxManager *gfx =
      sMonSpritesGfxManagers[managerId % MON_SPR_GFX_MANAGERS_COUNT];
  if (gfx->active != GFX_MANAGER_ACTIVE) {
    return NULL;
  } else {
