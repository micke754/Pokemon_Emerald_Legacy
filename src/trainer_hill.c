...
static const u16 sPrizeListRareCandy1[] = {ITEM_RARE_CANDY,  ITEM_ETHER,
                                           ITEM_MAX_POTION,  ITEM_REVIVE,
                                           ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_LUXURY_BALL, ITEM_ETHER,
                                            ITEM_MAX_POTION,  ITEM_REVIVE,
                                            ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxRevive1[] = {ITEM_MAX_REVIVE,  ITEM_ETHER,
                                           ITEM_MAX_POTION,  ITEM_REVIVE,
                                           ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxEther1[] = {ITEM_MAX_ETHER,   ITEM_ETHER,
                                          ITEM_MAX_POTION,  ITEM_REVIVE,
                                          ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListElixir1[] = {ITEM_ELIXIR,      ITEM_ETHER,
                                        ITEM_MAX_POTION,  ITEM_REVIVE,
                                        ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListRoar[] = {ITEM_TM_ROAR,     ITEM_ETHER,
                                     ITEM_MAX_POTION,  ITEM_REVIVE,
                                     ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListSludgeBomb[] = {
    ITEM_TM_SLUDGE_BOMB, ITEM_ETHER,       ITEM_MAX_POTION,
    ITEM_REVIVE,         ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListToxic[] = {ITEM_TM_TOXIC,    ITEM_ETHER,
                                      ITEM_MAX_POTION,  ITEM_REVIVE,
                                      ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListSunnyDay[] = {ITEM_RARE_CANDY, ITEM_SAFARI_BALL,
                                         ITEM_PP_UP,      ITEM_ELIXIR,
                                         ITEM_ETHER,      ITEM_RED_SHARD};
static const u16 sPrizeListEarthQuake[] = {ITEM_TM_EARTHQUAKE, ITEM_ETHER,
                                           ITEM_MAX_POTION,    ITEM_REVIVE,
                                           ITEM_FLUFFY_TAIL,   ITEM_GREAT_BALL};

static const u16 sPrizeListRareCandy2[] = {ITEM_RARE_CANDY,  ITEM_ETHER,
                                           ITEM_MAX_POTION,  ITEM_REVIVE,
                                           ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_LUXURY_BALL, ITEM_ETHER,
                                            ITEM_MAX_POTION,  ITEM_REVIVE,
                                            ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxRevive2[] = {ITEM_MAX_REVIVE,  ITEM_ETHER,
                                           ITEM_MAX_POTION,  ITEM_REVIVE,
                                           ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxEther2[] = {ITEM_MAX_ETHER,   ITEM_ETHER,
                                          ITEM_MAX_POTION,  ITEM_REVIVE,
                                          ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListElixir2[] = {ITEM_PP_MAX, ITEM_SAFARI_BALL,
                                        ITEM_PP_UP,  ITEM_ELIXIR,
                                        ITEM_ETHER,  ITEM_BLUE_SHARD};
static const u16 sPrizeListBrickBreak[] = {ITEM_MASTER_BALL, ITEM_SAFARI_BALL,
                                           ITEM_PP_UP,       ITEM_ELIXIR,
                                           ITEM_ETHER,       ITEM_YELLOW_SHARD};
static const u16 sPrizeListTorment[] = {ITEM_TM_TORMENT,  ITEM_ETHER,
                                        ITEM_MAX_POTION,  ITEM_REVIVE,
                                        ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListSkillSwap[] = {ITEM_TM_SKILL_SWAP, ITEM_ETHER,
                                          ITEM_MAX_POTION,    ITEM_REVIVE,
                                          ITEM_FLUFFY_TAIL,   ITEM_GREAT_BALL};
static const u16 sPrizeListGigaDrain[] = {ITEM_SACRED_ASH, ITEM_SAFARI_BALL,
                                          ITEM_PP_UP,      ITEM_ELIXIR,
                                          ITEM_ETHER,      ITEM_GREEN_SHARD};
static const u16 sPrizeListAttract[] = {ITEM_TM_ATTRACT,  ITEM_ETHER,
                                        ITEM_MAX_POTION,  ITEM_REVIVE,
                                        ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};

static const u16 *const sPrizeLists1[NUM_TRAINER_HILL_PRIZE_LISTS] = {
    sPrizeListRareCandy1, sPrizeListLuxuryBall1, sPrizeListMaxRevive1,
    sPrizeListMaxEther1,  sPrizeListElixir1,     sPrizeListRoar,
    sPrizeListSludgeBomb, sPrizeListToxic,       sPrizeListSunnyDay,
    sPrizeListEarthQuake};

static const u16 *const sPrizeLists2[NUM_TRAINER_HILL_PRIZE_LISTS] = {
    sPrizeListRareCandy2, sPrizeListLuxuryBall2, sPrizeListMaxRevive2,
    sPrizeListMaxEther2,  sPrizeListElixir2,     sPrizeListBrickBreak,
    sPrizeListTorment,    sPrizeListSkillSwap,   sPrizeListGigaDrain,
    sPrizeListAttract};

static const u16 *const *const sPrizeListSets[] = {sPrizeLists1, sPrizeLists2};

static const u16 sEReader_Pal[] =
    INCBIN_U16("graphics/trainer_hill/ereader.gbapal");
static const u8 sRecordWinColors[] = {
    TEXT_COLOR_TRANSPARENT, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY};

static const struct TrainerHillChallenge
    *const sChallengeData[NUM_TRAINER_HILL_MODES] = {
...
static void SetUpDataStruct(void) {
  if (sHillData == NULL) {
    ...
    // This copy depends on the floor data for each challenge being directly
    // after the challenge header data, and for the field 'floors' in sHillData
    // to come directly after the field 'challenge'. e.g. for HILL_MODE_NORMAL,
    // it will copy sChallenge_Normal to sHillData->challenge and it will copy
    // sFloors_Normal to sHillData->floors
    CpuCopy32(sChallengeData[gSaveBlock1Ptr->trainerHill.mode],
              &sHillData->challenge,
              sizeof(sHillData->challenge) + sizeof(sHillData->floors));
    TrainerHillDummy();
  }
}

static void FreeDataStruct(void) { TRY_FREE_AND_SET_NULL(sHillData); }
...
void CopyTrainerHillTrainerText(u8 which, u16 trainerId) {
  ...
  case TRAINER_HILL_TEXT_INTRO:
    FrontierSpeechToString(
        sHillData->floors[floorId].trainers[id].speechBefore);
    break;
...
static void GetOwnerState(void) {
  ...
  if (gSaveBlock1Ptr->trainerHill.spokeToOwner)
    gSpecialVar_Result++;
  if (gSaveBlock1Ptr->trainerHill.receivedPrize &&
      gSaveBlock1Ptr->trainerHill.checkedFinalTime)
    gSpecialVar_Result++;
...
// Otherwise the owner says it was a slow time and to complete it faster next
// time
static void CheckFinalTime(void) {
  if (gSaveBlock1Ptr->trainerHill.checkedFinalTime) {
    ...
    SetTimerValue(&gSaveBlock1Ptr->trainerHill.bestTime,
                  gSaveBlock1Ptr->trainerHill.timer);
...
static void BufferChallengeTime(void) {
  ...
  ConvertIntToDecimalStringN(gStringVar1, minutes, STR_CONV_MODE_RIGHT_ALIGN,
                             2);
  ConvertIntToDecimalStringN(gStringVar2, secondsWhole,
                             STR_CONV_MODE_RIGHT_ALIGN, 2);
  ConvertIntToDecimalStringN(gStringVar3, secondsFraction,
...
// The only time fewer than all 4 floors are used is for the JP-exclusive
// E-Reader and Default modes
static void GetAllFloorsUsed(void) {
  SetUpDataStruct();
  if (sHillData->challenge.numFloors != NUM_TRAINER_HILL_FLOORS) {
    ConvertIntToDecimalStringN(gStringVar1, sHillData->challenge.numFloors,
...
// May have been dummied. Every time this is called a conditional for var result
// occurs afterwards Relation to E-Reader is an assumption, most dummied Trainer
// Hill code seems to be JP E-Reader mode related
static void GetInEReaderMode(void) {
  SetUpDataStruct();
  gSpecialVar_Result = FALSE;
  FreeDataStruct();
...
void PrintOnTrainerHillRecordsWindow(void) {
  ...
  AddTextPrinterParameterized3(0, FONT_NORMAL, x, 2, sRecordWinColors,
                               TEXT_SKIP_DRAW, gText_TimeBoard);

  y = 18;
  for (i = 0; i < NUM_TRAINER_HILL_MODES; i++) {
    AddTextPrinterParameterized3(0, FONT_NORMAL, 0, y, sRecordWinColors,
                                 TEXT_SKIP_DRAW, sModeStrings[i]);
    y += 15;
    ...
    ConvertIntToDecimalStringN(gStringVar3, secondsFraction,
                               STR_CONV_MODE_LEADING_ZEROS, 2);
    StringExpandPlaceholders(StringCopy(gStringVar4, gText_TimeCleared),
                             gText_XMinYDotZSec);
    x = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar4, 0xD0);
    AddTextPrinterParameterized3(0, FONT_NORMAL, x, y, sRecordWinColors,
...
static u32 GetTimerValue(u32 *src) { return *src; }

static void SetTimerValue(u32 *dst, u32 val) { *dst = val; }
...
void LoadTrainerHillObjectEventTemplates(void) {
  ...
  for (i = 0; i < HILL_TRAINERS_PER_FLOOR; i++) {
    ...
    eventTemplates[i].graphicsId = FacilityClassToGraphicsId(
        sHillData->floors[floorId].trainers[i].facilityClass);
    eventTemplates[i].x = sHillData->floors[floorId].map.trainerCoords[i] & 0xF;
    eventTemplates[i].y =
        ((sHillData->floors[floorId].map.trainerCoords[i] >> 4) & 0xF) +
        HILL_FLOOR_HEIGHT_MARGIN;
    bits = i << 2;
    eventTemplates[i].movementType =
        ((sHillData->floors[floorId].map.trainerDirections >> bits) & 0xF) +
        MOVEMENT_TYPE_FACE_UP;
    eventTemplates[i].trainerRange_berryTreeId =
        (sHillData->floors[floorId].map.trainerRanges >> bits) & 0xF;
...
static u16 GetMetatileForFloor(u8 floorId, u32 x, u32 y,
                               u32 floorWidth) // floorWidth is always 16
{
  bool8 impassable;
  u16 metatile;
  u16 elevation;
  ...
  impassable =
      (sHillData->floors[floorId].map.collisionData[y] >> (15 - x) & 1);
  metatile = sHillData->floors[floorId].map.metatileData[floorWidth * y + x] +
             NUM_METATILES_IN_PRIMARY;
  elevation = 3 << MAPGRID_ELEVATION_SHIFT;

  return ((impassable << MAPGRID_COLLISION_SHIFT) & MAPGRID_COLLISION_MASK) |
         elevation | (metatile & MAPGRID_METATILE_ID_MASK);
}
...
const struct WarpEvent *SetWarpDestinationTrainerHill4F(void) {
  const struct MapHeader *header = Overworld_GetMapHeaderByGroupAndId(
      MAP_GROUP(TRAINER_HILL_4F), MAP_NUM(TRAINER_HILL_4F));

  return &header->events->warps[1];
}

// For warping from the roof in challenges where the 4F is not the final
// challenge floor This would only occur in the JP-exclusive Default and
// E-Reader challenges
const struct WarpEvent *
SetWarpDestinationTrainerHillFinalFloor(u8 warpEventId) {
  u8 numFloors;
  ...
  header = Overworld_GetMapHeaderByGroupAndId(MAP_GROUP(TRAINER_HILL_4F),
                                              sNextFloorMapNum[numFloors - 1]);
...
static void CreateNPCTrainerHillParty(u16 trainerId, u8 firstMonId) {
  ...
  floorId = GetFloorId();
  for (i = firstMonId, partySlot = 0; i < firstMonId + PARTY_SIZE / 2;
       i++, partySlot++) {
    u8 id = sTrainerPartySlots[trId][partySlot];
    struct Pokemon *mon = &gEnemyParty[i];

    CreateBattleTowerMon(mon,
                         &sHillData->floors[floorId].trainers[trId].mons[id]);
...
u32 GetTrainerHillAIFlags(void) {
  return (AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT |
...
static void SetGameSaved(void) { gSaveBlock2Ptr->frontier.savedGame = TRUE; }

static void ClearGameSaved(void) { gSaveBlock2Ptr->frontier.savedGame = FALSE; }

// Always FALSE
bool32 OnTrainerHillEReaderChallengeFloor(void) {
  if (!InTrainerHillChallenge() ||
      GetCurrentTrainerHillMapId() == TRAINER_HILL_ENTRANCE)
    return FALSE;
...
static void TrainerHillSetMode(void) {
  ...
  gSaveBlock1Ptr->trainerHill.bestTime =
      gSaveBlock1Ptr->trainerHillTimes[gSpecialVar_0x8005];
}
...
static u8 GetPrizeListId(bool8 allowTMs) {
  ...
  // The initial selection depends on the trainer numbers for the completed
  // challenge. These don't change with the available challenge modes, so
  // Normal/Unique will always have a prizeListId of 8, and Variety/Expert will
  // have a prizeListId of 24.
  prizeListId = 0;
  ...
  // The 2nd half of the lists in both sets of lists all have a TM as the "grand
  // prize", while the 1st half do not, so taking the mod of the (total / 2)
  // ensures that a prize list without a TM will be used.
  if (allowTMs)
...
static u16 GetPrizeItemId(void) {
  ...
  // First determine which set of prize lists to use. The sets of lists only
  // differ in what TMs they can offer as the "grand prize" for a time under 12
  // minutes. Which set of lists gets used is based on the sum of all the
  // trainer numbers for that challenge. These don't change with the available
  // challenge modes, so Normal will always have a prizeListSetId of 0, and
  // Unique/Variety/Expert will have a prizeListSetId of 1.
  for (i = 0; i < NUM_TRAINER_HILL_FLOORS; i++) {
  ...
  // Now get which prize list to use from the set. See GetPrizeListId for
  // details. The below conditional will always be true, because a Trainer Hill
  // challenge can't be entered until the player has entered the Hall of Fame
  // (FLAG_SYS_GAME_CLEAR is set) and because all of the available challenge
  // modes have the full 8 trainers (NUM_TRAINER_HILL_TRAINERS).
  if (FlagGet(FLAG_SYS_GAME_CLEAR) &&
      sHillData->challenge.numTrainers == NUM_TRAINER_HILL_TRAINERS)
    i = GetPrizeListId(TRUE);
  else
    i = GetPrizeListId(FALSE);

  // 1 is added to Expert mode's prize list selection because otherwise it has
  // the same prizes as Variety
  ...
  // After the above (non-random) calculations, the following are the possible
  // prize list selections: sPrizeListSets[0][8] (Normal) sPrizeListSets[1][4]
  // (Variety) sPrizeListSets[1][8] (Unique) sPrizeListSets[1][5] (Expert)
  ...
  // As an additional note, if players were allowed to enter a Trainer Hill
  // challenge before entering the Hall of Fame, there would be 1 additional
  // prize possibility (ITEM_MAX_ETHER) as Normal / Unique modes would use
  // sPrizeListSets[0][3] / sPrizeListSets[1][3] respectively.
