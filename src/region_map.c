...
/*
 *  This file handles region maps generally, and the map used when selecting a
 * fly destination. Specific features of other region map uses are handled
 * elsewhere
 *
 *  For the region map in the pokenav, see pokenav_region_map.c
 *  For the region map in the pokedex, see
 * pokdex_area_screen.c/pokedex_area_region_map.c For the region map that can be
 * viewed on the wall of pokemon centers, see field_region_map.c
 *
 */
...
enum {
  WIN_MAPSEC_NAME,
  WIN_MAPSEC_NAME_TALL, // For fly destinations with subtitles (just Ever
                        // Grande)
  WIN_FLY_TO_WHERE,
};
...
static void CalcZoomScrollParams(s16 scrollX, s16 scrollY, s16 c, s16 d, u16 e,
                                 u16 f, u8 rotation);
...
static const u16 sRegionMapCursorPal[] =
    INCBIN_U16("graphics/pokenav/region_map/cursor.gbapal");
static const u32 sRegionMapCursorSmallGfxLZ[] =
    INCBIN_U32("graphics/pokenav/region_map/cursor_small.4bpp.lz");
static const u32 sRegionMapCursorLargeGfxLZ[] =
    INCBIN_U32("graphics/pokenav/region_map/cursor_large.4bpp.lz");
static const u16 sRegionMapBg_Pal[] =
    INCBIN_U16("graphics/pokenav/region_map/map.gbapal");
static const u32 sRegionMapBg_GfxLZ[] =
    INCBIN_U32("graphics/pokenav/region_map/map.8bpp.lz");
static const u32 sRegionMapBg_TilemapLZ[] =
    INCBIN_U32("graphics/pokenav/region_map/map.bin.lz");
static const u16 sRegionMapPlayerIcon_BrendanPal[] =
    INCBIN_U16("graphics/pokenav/region_map/brendan_icon.gbapal");
static const u8 sRegionMapPlayerIcon_BrendanGfx[] =
    INCBIN_U8("graphics/pokenav/region_map/brendan_icon.4bpp");
static const u16 sRegionMapPlayerIcon_MayPal[] =
    INCBIN_U16("graphics/pokenav/region_map/may_icon.gbapal");
static const u8 sRegionMapPlayerIcon_MayGfx[] =
    INCBIN_U8("graphics/pokenav/region_map/may_icon.4bpp");
...
static const u16 sMarineCaveMapSecIds[] = {MAPSEC_MARINE_CAVE,
...
#define MARINE_CAVE_COORD(location)                                            \
  (ABNORMAL_WEATHER_##location - MARINE_CAVE_LOCATIONS_START)
...
static const union AnimCmd sRegionMapCursorAnim2[] = {
    ANIMCMD_FRAME(0, 10), ANIMCMD_FRAME(16, 10), ANIMCMD_FRAME(32, 10),
    ANIMCMD_FRAME(16, 10), ANIMCMD_JUMP(0)};

static const union AnimCmd *const sRegionMapCursorAnimTable[] = {
    sRegionMapCursorAnim1, sRegionMapCursorAnim2};

static const struct SpritePalette sRegionMapCursorSpritePalette = {
    .data = sRegionMapCursorPal, .tag = TAG_CURSOR};
...
static const union AnimCmd sRegionMapPlayerIconAnim1[] = {ANIMCMD_FRAME(0, 5),
                                                          ANIMCMD_END};
...
static const u8 sMapSecIdsOffMap[] = {MAPSEC_BIRTH_ISLAND,
                                      MAPSEC_FARAWAY_ISLAND, MAPSEC_NAVEL_ROCK};

static const u16 sRegionMapFramePal[] =
    INCBIN_U16("graphics/pokenav/region_map/frame.gbapal");
static const u32 sRegionMapFrameGfxLZ[] =
    INCBIN_U32("graphics/pokenav/region_map/frame.4bpp.lz");
static const u32 sRegionMapFrameTilemapLZ[] =
    INCBIN_U32("graphics/pokenav/region_map/frame.bin.lz");
static const u16 sFlyTargetIcons_Pal[] =
    INCBIN_U16("graphics/pokenav/region_map/fly_target_icons.gbapal");
static const u32 sFlyTargetIcons_Gfx[] =
    INCBIN_U32("graphics/pokenav/region_map/fly_target_icons.4bpp.lz");
...
static const u8 sMapHealLocations[][3] = {
    ...
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN),
                            HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_DEWFORD_TOWN] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN),
                             HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_LAVARIDGE_TOWN] = {MAP_GROUP(LAVARIDGE_TOWN),
                               MAP_NUM(LAVARIDGE_TOWN),
                               HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_FALLARBOR_TOWN] = {MAP_GROUP(FALLARBOR_TOWN),
                               MAP_NUM(FALLARBOR_TOWN),
                               HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_VERDANTURF_TOWN] = {MAP_GROUP(VERDANTURF_TOWN),
                                MAP_NUM(VERDANTURF_TOWN),
                                HEAL_LOCATION_VERDANTURF_TOWN},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP(PACIFIDLOG_TOWN),
                                MAP_NUM(PACIFIDLOG_TOWN),
                                HEAL_LOCATION_PACIFIDLOG_TOWN},
    [MAPSEC_PETALBURG_CITY] = {MAP_GROUP(PETALBURG_CITY),
                               MAP_NUM(PETALBURG_CITY),
                               HEAL_LOCATION_PETALBURG_CITY},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP(SLATEPORT_CITY),
                               MAP_NUM(SLATEPORT_CITY),
                               HEAL_LOCATION_SLATEPORT_CITY},
    [MAPSEC_MAUVILLE_CITY] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY),
                              HEAL_LOCATION_MAUVILLE_CITY},
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY),
                              HEAL_LOCATION_RUSTBORO_CITY},
    [MAPSEC_FORTREE_CITY] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY),
                             HEAL_LOCATION_FORTREE_CITY},
    [MAPSEC_LILYCOVE_CITY] = {MAP_GROUP(LILYCOVE_CITY), MAP_NUM(LILYCOVE_CITY),
                              HEAL_LOCATION_LILYCOVE_CITY},
    [MAPSEC_MOSSDEEP_CITY] = {MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY),
                              HEAL_LOCATION_MOSSDEEP_CITY},
    [MAPSEC_SOOTOPOLIS_CITY] = {MAP_GROUP(SOOTOPOLIS_CITY),
                                MAP_NUM(SOOTOPOLIS_CITY),
                                HEAL_LOCATION_SOOTOPOLIS_CITY},
    [MAPSEC_EVER_GRANDE_CITY] = {MAP_GROUP(EVER_GRANDE_CITY),
                                 MAP_NUM(EVER_GRANDE_CITY),
    ...
    [MAPSEC_ROUTE_104] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_105] = {MAP_GROUP(ROUTE105), MAP_NUM(ROUTE105),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_106] = {MAP_GROUP(ROUTE106), MAP_NUM(ROUTE106),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_107] = {MAP_GROUP(ROUTE107), MAP_NUM(ROUTE107),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_108] = {MAP_GROUP(ROUTE108), MAP_NUM(ROUTE108),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_109] = {MAP_GROUP(ROUTE109), MAP_NUM(ROUTE109),
                          HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ROUTE_114] = {MAP_GROUP(ROUTE114), MAP_NUM(ROUTE114),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_115] = {MAP_GROUP(ROUTE115), MAP_NUM(ROUTE115),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_116] = {MAP_GROUP(ROUTE116), MAP_NUM(ROUTE116),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_117] = {MAP_GROUP(ROUTE117), MAP_NUM(ROUTE117),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_118] = {MAP_GROUP(ROUTE118), MAP_NUM(ROUTE118),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_119] = {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_120] = {MAP_GROUP(ROUTE120), MAP_NUM(ROUTE120),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_121] = {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_122] = {MAP_GROUP(ROUTE122), MAP_NUM(ROUTE122),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_123] = {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_124] = {MAP_GROUP(ROUTE124), MAP_NUM(ROUTE124),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_125] = {MAP_GROUP(ROUTE125), MAP_NUM(ROUTE125),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_126] = {MAP_GROUP(ROUTE126), MAP_NUM(ROUTE126),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_127] = {MAP_GROUP(ROUTE127), MAP_NUM(ROUTE127),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_128] = {MAP_GROUP(ROUTE128), MAP_NUM(ROUTE128),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_129] = {MAP_GROUP(ROUTE129), MAP_NUM(ROUTE129),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_130] = {MAP_GROUP(ROUTE130), MAP_NUM(ROUTE130),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_131] = {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_132] = {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_133] = {MAP_GROUP(ROUTE133), MAP_NUM(ROUTE133),
                          HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_134] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134),
                          HEAL_LOCATION_NONE},
};

static const u8 *const sEverGrandeCityNames[] = {gText_PokemonLeague,
                                                 gText_PokemonCenter};
...
static const struct SpritePalette sFlyTargetIconsSpritePalette = {
    .data = sFlyTargetIcons_Pal, .tag = TAG_FLY_ICON};
...
static const union AnimCmd sFlyDestIcon_Anim_8x8CanFly[] = {ANIMCMD_FRAME(0, 5),
                                                            ANIMCMD_END};
...
void InitRegionMapData(struct RegionMap *regionMap,
                       const struct BgTemplate *template, bool8 zoomed) {
...
bool8 LoadRegionMapGfx(void) {
  ...
  case 0:
    if (sRegionMap->bgManaged)
      DecompressAndCopyTileDataToVram(sRegionMap->bgNum, sRegionMapBg_GfxLZ, 0,
                                      0, 0);
    else
  ...
  case 1:
    if (sRegionMap->bgManaged) {
      if (!FreeTempTileDataBuffersIfPossible())
        DecompressAndCopyTileDataToVram(sRegionMap->bgNum,
                                        sRegionMapBg_TilemapLZ, 0, 0, 1);
    } else {
  ...
  case 5:
    ...
    sRegionMap->playerIconSpritePosY = sRegionMap->cursorPosY;
    sRegionMap->mapSecId =
        CorrectSpecialMapSecId_Internal(sRegionMap->mapSecId);
  ...
  case 6:
    if (sRegionMap->zoomed == FALSE) {
      ...
      CalcZoomScrollParams(sRegionMap->scrollX, sRegionMap->scrollY, 0x38, 0x48,
                           0x80, 0x80, 0);
    }
    break;
  case 7:
    ...
    if (sRegionMap->bgManaged) {
      ...
      SetBgAttribute(sRegionMap->bgNum, BG_ATTR_CHARBASEINDEX,
                     sRegionMap->charBaseIdx);
      SetBgAttribute(sRegionMap->bgNum, BG_ATTR_MAPBASEINDEX,
...
void BlendRegionMap(u16 color, u32 coeff) {
  ...
  CpuCopy16(&gPlttBufferFaded[BG_PLTT_ID(7)],
            &gPlttBufferUnfaded[BG_PLTT_ID(7)], 3 * PLTT_SIZE_4BPP);
}
...
u8 DoRegionMapInputCallback(void) { return sRegionMap->inputCallback(); }
...
static u8 MoveRegionMapCursor_Zoomed(void) {
  ...
  if (sRegionMap->zoomedCursorMovementFrameCounter == 8) {
    ...
    if (x != sRegionMap->zoomedCursorPosX ||
      ...
      if (mapSecId != sRegionMap->mapSecId) {
        sRegionMap->mapSecId = mapSecId;
        GetMapName(sRegionMap->mapSecName, sRegionMap->mapSecId,
                   MAP_NAME_LENGTH);
      }
      GetPositionOfCursorWithinMapSec();
    }
...
bool8 UpdateRegionMapZoom(void) {
  ...
  if (sRegionMap->unk_06e == 16) {
    ...
    sRegionMap->unk_04c =
        (sRegionMap->zoomed == FALSE) ? (128 << 8) : (256 << 8);
    sRegionMap->zoomed = !sRegionMap->zoomed;
    sRegionMap->inputCallback = (sRegionMap->zoomed == FALSE)
                                    ? ProcessRegionMapInput_Full
                                    : ProcessRegionMapInput_Zoomed;
    CreateRegionMapCursor(sRegionMap->cursorTileTag,
                          sRegionMap->cursorPaletteTag);
  ...
  CalcZoomScrollParams(sRegionMap->scrollX, sRegionMap->scrollY, 0x38, 0x48,
                       sRegionMap->unk_04c >> 8, sRegionMap->unk_04c >> 8, 0);
  return retVal;
}
...
static u16 GetMapSecIdAt(u16 x, u16 y) {
  if (y < MAPCURSOR_Y_MIN || y > MAPCURSOR_Y_MAX || x < MAPCURSOR_X_MIN ||
      x > MAPCURSOR_X_MAX) {
    return MAPSEC_NONE;
  }
  y -= MAPCURSOR_Y_MIN;
...
static void InitMapBasedOnPlayerLocation(void) {
  ...
  switch (GetMapTypeByGroupAndId(gSaveBlock1Ptr->location.mapGroup,
  ...
  case MAP_TYPE_SECRET_BASE:
    mapHeader = Overworld_GetMapHeaderByGroupAndId(
        (u16)gSaveBlock1Ptr->dynamicWarp.mapGroup,
  ...
  sRegionMap->cursorPosX =
      gRegionMapEntries[sRegionMap->mapSecId].x + x + MAPCURSOR_X_MIN;
  sRegionMap->cursorPosY =
      gRegionMapEntries[sRegionMap->mapSecId].y + y + MAPCURSOR_Y_MIN;
}
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void) {
  ...
  case SS_TIDAL_LOCATION_CURRENTS:
    ...
    sRegionMap->mapSecId = mapHeader->regionMapSectionId;
    dimensionScale = mapHeader->mapLayout->width /
                     gRegionMapEntries[sRegionMap->mapSecId].width;
    if (dimensionScale == 0)
      dimensionScale = 1;
    ...
    dimensionScale = mapHeader->mapLayout->height /
                     gRegionMapEntries[sRegionMap->mapSecId].height;
    if (dimensionScale == 0)
      dimensionScale = 1;
...
static u8 GetMapsecType(u16 mapSecId) {
  ...
  case MAPSEC_SOUTHERN_ISLAND:
    return FlagGet(FLAG_LANDMARK_SOUTHERN_ISLAND) ? MAPSECTYPE_ROUTE
                                                  : MAPSECTYPE_NONE;
  default:
...
u16 GetRegionMapSecIdAt(u16 x, u16 y) { return GetMapSecIdAt(x, y); }
...
// Probably meant to be an "IsPlayerInIndoorDungeon" function, but in practice
// it only has the one mapsec Additionally, because the mapsec doesnt exist in
// Emerald, this function always returns FALSE
static bool32 IsPlayerInAquaHideout(u8 mapSecId) {
  u32 i;
...
void CreateRegionMapCursor(u16 tileTag, u16 paletteTag) {
  ...
  if (spriteId != MAX_SPRITES) {
    ...
    sRegionMap->cursorSprite->data[2] =
        OBJ_PLTT_ID(IndexOfSpritePaletteTag(paletteTag)) + 1;
...
void CreateRegionMapPlayerIcon(u16 tileTag, u16 paletteTag) {
  ...
  if (!sRegionMap->zoomed) {
    ...
    sRegionMap->playerIconSprite->x =
        sRegionMap->playerIconSpritePosX * 16 - 0x30;
    sRegionMap->playerIconSprite->y =
        sRegionMap->playerIconSpritePosY * 16 - 0x42;
...
static void UnhideRegionMapPlayerIcon(void) {
  if (sRegionMap->playerIconSprite != NULL) {
    if (sRegionMap->zoomed == TRUE) {
      ...
      sRegionMap->playerIconSprite->x =
          sRegionMap->playerIconSpritePosX * 8 + 4;
      sRegionMap->playerIconSprite->y =
          sRegionMap->playerIconSpritePosY * 8 + 4;
...
static void SpriteCB_PlayerIconMapZoomed(struct Sprite *sprite) {
  ...
  if (sprite->sY < -8 || sprite->sY > DISPLAY_HEIGHT + 8 || sprite->sX < -8 ||
      sprite->sX > DISPLAY_WIDTH + 8)
...
static void GetMapSecDimensions(u16 mapSecId, u16 *x, u16 *y, u16 *width,
                                u16 *height) {
...
bool8 IsRegionMapZoomed(void) { return sRegionMap->zoomed; }
...
void CB2_OpenFlyMap(void) {
  ...
  case 1:
    ...
    InitBgsFromTemplates(1, sFlyMapBgTemplates,
                         ARRAY_COUNT(sFlyMapBgTemplates));
    gMain.state++;
    break;
  case 2:
  ...
  case 7:
    ...
    AddTextPrinterParameterized(WIN_FLY_TO_WHERE, FONT_NORMAL, gText_FlyToWhere,
                                0, 1, 0, NULL);
...
static void DrawFlyDestTextWindow(void) {
  ...
  if (sFlyMap->regionMap.mapSecType > MAPSECTYPE_NONE &&
    ...
    for (i = 0; i < ARRAY_COUNT(sMultiNameFlyDestinations); i++) {
      if (sFlyMap->regionMap.mapSecId ==
          sMultiNameFlyDestinations[i].mapSecId) {
        if (FlagGet(sMultiNameFlyDestinations[i].flag)) {
          StringLength(sMultiNameFlyDestinations[i]
                           .name[sFlyMap->regionMap.posWithinMapSec]);
          namePrinted = TRUE;
          ClearStdWindowAndFrameToTransparent(WIN_MAPSEC_NAME, FALSE);
          DrawStdFrameWithCustomTileAndPalette(WIN_MAPSEC_NAME_TALL, FALSE, 101,
                                               13);
          AddTextPrinterParameterized(WIN_MAPSEC_NAME_TALL, FONT_NORMAL,
                                      sFlyMap->regionMap.mapSecName, 0, 1, 0,
                                      NULL);
          name = sMultiNameFlyDestinations[i]
                     .name[sFlyMap->regionMap.posWithinMapSec];
          AddTextPrinterParameterized(
              WIN_MAPSEC_NAME_TALL, FONT_NORMAL, name,
              GetStringRightAlignXOffset(FONT_NORMAL, name, 96), 17, 0, NULL);
          ScheduleBgCopyTilemapToVram(0);
          sDrawFlyDestTextWindow = TRUE;
        }
        break;
    ...
    if (!namePrinted) {
      ...
      AddTextPrinterParameterized(WIN_MAPSEC_NAME, FONT_NORMAL,
                                  sFlyMap->regionMap.mapSecName, 0, 1, 0, NULL);
      ScheduleBgCopyTilemapToVram(0);
...
static void CreateFlyDestIcons(void) {
  ...
  for (mapSecId = MAPSEC_LITTLEROOT_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY;
       mapSecId++) {
...
// Flickers fly destination icon color (by hiding the fly icon sprite) if the
// cursor is currently on it
static void SpriteCB_FlyDestIcon(struct Sprite *sprite) {
