...
static const u16
    sSaveLocationReloadLocList[] = // There's only 1 location, and it's presumed
                                   // its for the save reload feature for battle
                                   // tower.
    {
...
// These flags are read by Pokémon Colosseum/XD for linking. XD Additionally
// requires FLAG_SYS_GAME_CLEAR
