...
/*
    This file handles the cutscene showing Rayquaza arriving to settle the
   Groudon/Kyogre fight It consists of 5 separate scenes:
    - Groudon and Kyogre facing one another in a thunderstorm
   (RAY_ANIM_DUO_FIGHT)
    - Over-the-shoulder of Rayquaza flying (RAY_ANIM_TAKES_FLIGHT)
    - Rayquaza emerging from a spotlight down through the clouds
   (RAY_ANIM_DESCENDS)
    - A close-up of Rayquaza flying down (RAY_ANIM_CHARGES)
    - Rayquaza floating above Groudon/Kyogre as they back away offscreen
   (RAY_ANIM_CHASES_AWAY)

    A shortened version of the first scene is used when the player first arrives
    in Sootopolis during the Groudon/Kyogre conflict, before awakening Rayquaza
   (RAY_ANIM_DUO_FIGHT_PRE) This is indicated with the first two arguments to
   DoRayquazaScene
*/
...
static const struct OamData sOam_64x64 = {.y = 0,
...
static const struct OamData sOam_32x32 = {.y = 0,
                                          .affineMode = ST_OAM_AFFINE_OFF,
                                          .objMode = ST_OAM_OBJ_NORMAL,
                                          .mosaic = FALSE,
                                          .bpp = ST_OAM_4BPP,
...
static const struct OamData sOam_64x32 = {.y = 0,
                                          .affineMode = ST_OAM_AFFINE_OFF,
                                          .objMode = ST_OAM_OBJ_NORMAL,
                                          .mosaic = FALSE,
                                          .bpp = ST_OAM_4BPP,
...
static const struct OamData sOam_32x16 = {.y = 0,
                                          .affineMode = ST_OAM_AFFINE_OFF,
                                          .objMode = ST_OAM_OBJ_NORMAL,
                                          .mosaic = FALSE,
                                          .bpp = ST_OAM_4BPP,
...
static const struct OamData sOam_16x8 = {.y = 0,
                                         .affineMode = ST_OAM_AFFINE_OFF,
                                         .objMode = ST_OAM_OBJ_NORMAL,
                                         .mosaic = FALSE,
                                         .bpp = ST_OAM_4BPP,
...
static const struct OamData sOam_16x32 = {.y = 0,
                                          .affineMode = ST_OAM_AFFINE_OFF,
                                          .objMode = ST_OAM_OBJ_NORMAL,
                                          .mosaic = FALSE,
                                          .bpp = ST_OAM_4BPP,
...
static const struct OamData sOam_16x16 = {.y = 0,
                                          .affineMode = ST_OAM_AFFINE_OFF,
                                          .objMode = ST_OAM_OBJ_NORMAL,
                                          .mosaic = FALSE,
                                          .bpp = ST_OAM_4BPP,
...
static const struct OamData sOam_32x8 = {.y = 0,
                                         .affineMode = ST_OAM_AFFINE_OFF,
                                         .objMode = ST_OAM_OBJ_NORMAL,
                                         .mosaic = FALSE,
                                         .bpp = ST_OAM_4BPP,
...
static const union AnimCmd sAnim_DuoFightPre_Groudon_Head[] = {
    ANIMCMD_FRAME(0, 30),  ANIMCMD_FRAME(64, 30), ANIMCMD_FRAME(128, 30),
    ANIMCMD_FRAME(64, 30), ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_DuoFightPre_Groudon_Body[] = {
    ANIMCMD_FRAME(192, 30), ANIMCMD_FRAME(256, 30), ANIMCMD_FRAME(320, 30),
    ANIMCMD_FRAME(256, 30), ANIMCMD_JUMP(0),
};

static const union AnimCmd *const sAnims_DuoFightPre_Groudon[] = {
    sAnim_DuoFightPre_Groudon_Head, sAnim_DuoFightPre_Groudon_Body};
...
static const union AnimCmd
    *const sAnims_DuoFightPre_GroudonShoulderKyogreDorsalFin[] = {
...
static const union AnimCmd sAnim_DuoFightPre_KyogrePectoralFin[] = {
    ANIMCMD_FRAME(0, 36), ANIMCMD_FRAME(2, 36), ANIMCMD_FRAME(4, 36),
    ANIMCMD_FRAME(2, 36), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_DuoFight_Groudon_Head[] = {
    ANIMCMD_FRAME(0, 20),  ANIMCMD_FRAME(64, 20), ANIMCMD_FRAME(128, 20),
    ANIMCMD_FRAME(64, 20), ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_DuoFight_Groudon_Body[] = {
    ANIMCMD_FRAME(192, 20), ANIMCMD_FRAME(256, 20), ANIMCMD_FRAME(320, 20),
    ANIMCMD_FRAME(256, 20), ANIMCMD_JUMP(0),
};

static const union AnimCmd *const sAnims_DuoFight_Groudon[] = {
    sAnim_DuoFight_Groudon_Head, sAnim_DuoFight_Groudon_Body};
...
static const union AnimCmd
    *const sAnims_DuoFight_GroudonShoulderKyogreDorsalFin[] = {
        sAnim_DuoFight_GroudonShoulderKyogreDorsalFin};

static const struct CompressedSpriteSheet
    sSpriteSheet_DuoFight_GroudonShoulder = {
        gRaySceneDuoFight_GroudonShoulder_Gfx, 0x200,
        TAG_DUOFIGHT_GROUDON_SHOULDER};
...
static const union AnimCmd sAnim_DuoFight_GroudonClaw[] = {ANIMCMD_FRAME(0, 1),
                                                           ANIMCMD_END};
...
static const union AnimCmd sAnim_DuoFight_Kyogre_LeftPectoralFin[] = {
    ANIMCMD_FRAME(48, 24), ANIMCMD_FRAME(64, 24), ANIMCMD_FRAME(80, 24),
    ANIMCMD_FRAME(64, 24), ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_DuoFight_Kyogre_LeftShoulder[] = {
    ANIMCMD_FRAME(56, 24), ANIMCMD_FRAME(72, 24), ANIMCMD_FRAME(88, 24),
    ANIMCMD_FRAME(72, 24), ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_DuoFight_Kyogre_RightShoulder[] = {
    ANIMCMD_FRAME(96, 24),  ANIMCMD_FRAME(104, 24), ANIMCMD_FRAME(112, 24),
    ANIMCMD_FRAME(104, 24), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_DuoFight_KyogrePectoralFin[] = {
    ANIMCMD_FRAME(0, 24), ANIMCMD_FRAME(2, 24), ANIMCMD_FRAME(4, 24),
    ANIMCMD_FRAME(2, 24), ANIMCMD_JUMP(0),
};
...
static const struct CompressedSpriteSheet
    sSpriteSheet_DuoFight_KyogrePectoralFin = {
        gRaySceneDuoFight_KyogrePectoralFin_Gfx, 0xC0,
        TAG_DUOFIGHT_KYOGRE_PECTORAL_FIN};
...
static const struct CompressedSpriteSheet
    sSpriteSheet_DuoFight_KyogreDorsalFin = {
        gRaySceneDuoFight_KyogreDorsalFin_Gfx, 0x200,
        TAG_DUOFIGHT_KYOGRE_DORSAL_FIN};
...
static const union AnimCmd sAnim_TakesFlight_Smoke[] = {ANIMCMD_FRAME(0, 1),
                                                        ANIMCMD_END};
...
static const struct BgTemplate sBgTemplates_Descends[] = {{.bg = 0,
                                                           .charBaseIndex = 0,
                                                           .mapBaseIndex = 31,
                                                           .screenSize = 0,
                                                           .paletteMode = 0,
...
static const struct CompressedSpritePalette sSpritePal_Descends_Rayquaza = {
    ...
    TAG_DESCENDS_RAYQUAZA // "Takes flight" palette re-used here
};
...
static const struct BgTemplate sBgTemplates_Charges[] = {{.bg = 0,
                                                          .charBaseIndex = 2,
                                                          .mapBaseIndex = 31,
                                                          .screenSize = 0,
                                                          .paletteMode = 0,
...
static const union AnimCmd sAnim_ChasesAway_RayquazaTail_Shouting[] = {
    ANIMCMD_FRAME(48, 1), ANIMCMD_END};
...
static const struct BgTemplate sBgTemplates_ChasesAway[] = {{.bg = 0,
                                                             .charBaseIndex = 1,
                                                             .mapBaseIndex = 31,
                                                             .screenSize = 0,
                                                             .paletteMode = 0,
...
// The cutscene window is cropped to a narrower view, with black borders on each
// vertical edge This function is used in scenes where sprites in these borders
// need to be hidden
...
static u8 DuoFightPre_CreateGroudonSprites(void) {
  ...
  sGroudonBodySpriteId =
      CreateSprite(&sSpriteTemplate_DuoFightPre_Groudon, 56, 104, 3);
  sGroudonShoulderSpriteId =
      CreateSprite(&sSpriteTemplate_DuoFightPre_GroudonShoulder, 75, 101, 0);
  sGroudonClawSpriteId =
      CreateSprite(&sSpriteTemplate_DuoFightPre_GroudonClaw, 109, 114, 1);
...
static u8 DuoFightPre_CreateKyogreSprites(void) {
  ...
  data[4] =
      CreateSprite(&sSpriteTemplate_DuoFightPre_KyogrePectoralFin, 208, 132, 0)
      << 8;
  data[4] |=
      CreateSprite(&sSpriteTemplate_DuoFightPre_KyogreDorsalFin, 200, 120, 1);
...
static void InitDuoFightSceneBgs(void) {
  ...
  InitBgsFromTemplates(0, sBgTemplates_DuoFight,
                       ARRAY_COUNT(sBgTemplates_DuoFight));
...
static void LoadDuoFightSceneGfx(void) {
  ...
  while (FreeTempTileDataBuffersIfPossible())
    ;
  LZDecompressWram(gRaySceneDuoFight_Clouds2_Tilemap,
                   sRayScene->tilemapBuffers[0]);
  LZDecompressWram(gRaySceneDuoFight_Clouds1_Tilemap,
                   sRayScene->tilemapBuffers[1]);
  LZDecompressWram(gRaySceneDuoFight_Clouds3_Tilemap,
                   sRayScene->tilemapBuffers[2]);
  LoadCompressedPalette(gRaySceneDuoFight_Clouds_Pal, BG_PLTT_ID(0),
                        2 * PLTT_SIZE_4BPP);
...
static void Task_DuoFightAnim(u8 taskId) {
  ...
  CpuFastFill16(0, gScanlineEffectRegBuffers,
                sizeof(gScanlineEffectRegBuffers));
    ...
    if (frame == 32 || frame == 112) {
      ...
      case 380:
        SetGpuReg(REG_OFFSET_BLDCNT,
                  BLDCNT_TGT1_BG2 | BLDCNT_TGT2_BG1 | BLDCNT_EFFECT_BLEND);
...
// In the below functions, BlendPalettesGradually flashes the bg white and the
// duo black and gradually fades them back to original color to simulate
// lightning
static void DuoFight_Lightning1(void) {
  PlaySE(SE_THUNDER);
  BlendPalettesGradually(PALETTES_BG & ~(0x8000), 0, 16, 0, RGB_WHITEALPHA, 0,
                         0);
...
static void DuoFight_Lightning2(void) {
  PlaySE(SE_THUNDER);
  BlendPalettesGradually(PALETTES_BG & ~(0x8000), 0, 16, 16, RGB_WHITEALPHA, 0,
                         0);
  BlendPalettesGradually(PALETTES_OBJECTS, 0, 16, 16, RGB_BLACK, 0, 1);
}

static void DuoFight_LightningLong(void) {
  BlendPalettesGradually(PALETTES_BG & ~(0x8000), 4, 16, 0, RGB_WHITEALPHA, 0,
                         0);
...
// Only used by the full version, which pans up at the end (so scene objects
// move down) DuoFightPre just fades to black with no pan
...
static u8 DuoFight_CreateGroudonSprites(void) {
  ...
  data = gSprites[spriteId].data;
  sGroudonBodySpriteId =
      CreateSprite(&sSpriteTemplate_DuoFight_Groudon, 66, 104, 3);
  sGroudonShoulderSpriteId =
      CreateSprite(&sSpriteTemplate_DuoFight_GroudonShoulder, 85, 101, 0);
  sGroudonClawSpriteId =
      CreateSprite(&sSpriteTemplate_DuoFight_GroudonClaw, 119, 114, 1);
  StartSpriteAnim(&gSprites[sGroudonBodySpriteId], 1);
  return spriteId;
}
...
static u8 DuoFight_CreateKyogreSprites(void) {
  ...
  data[4] =
      CreateSprite(&sSpriteTemplate_DuoFight_KyogrePectoralFin, 198, 132, 0)
      << 8;
  data[4] |=
      CreateSprite(&sSpriteTemplate_DuoFight_KyogreDorsalFin, 190, 120, 1);
...
static void InitTakesFlightSceneBgs(void) {
  ResetVramOamAndBgCntRegs();
  ResetBgsAndClearDma3BusyFlags(0);
  InitBgsFromTemplates(1, sBgTemplates_TakesFlight,
                       ARRAY_COUNT(sBgTemplates_TakesFlight));
  SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
  SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
  SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
  ResetAllBgsCoordinates();
...
static void LoadTakesFlightSceneGfx(void) {
  ResetTempTileDataBuffers();
  DecompressAndCopyTileDataToVram(0, gRaySceneDuoFight_Clouds_Gfx, 0, 0,
                                  0); // Re-uses clouds from previous scene
  DecompressAndCopyTileDataToVram(1, gRaySceneTakesFlight_Bg_Gfx, 0, 0, 0);
  DecompressAndCopyTileDataToVram(2, gRaySceneTakesFlight_Rayquaza_Gfx, 0, 0,
                                  0);
  while (FreeTempTileDataBuffersIfPossible())
    ;
  LZDecompressWram(gRaySceneDuoFight_Clouds2_Tilemap,
                   sRayScene->tilemapBuffers[0]);
  LZDecompressWram(gRaySceneTakesFlight_Bg_Tilemap,
                   sRayScene->tilemapBuffers[1]);
  LZDecompressWram(gRaySceneTakesFlight_Rayquaza_Tilemap,
                   sRayScene->tilemapBuffers[2]);
  LoadCompressedPalette(gRaySceneTakesFlight_Rayquaza_Pal, BG_PLTT_ID(0),
                        2 * PLTT_SIZE_4BPP);
...
static void Task_RayTakesFlightAnim(u8 taskId) {
  ...
  SetGpuReg(REG_OFFSET_BLDCNT,
            BLDCNT_TGT1_OBJ | BLDCNT_TGT2_BG1 | BLDCNT_EFFECT_BLEND);
...
// Animate Rayquaza (flying up and down, and changing size as it gets further
// from the screen) In this scene Rayquaza is a bg tilemap on bg 2, not a sprite
static void Task_HandleRayTakesFlight(u8 taskId) {
  ...
  case 2:
    // Float up and down
    tTimer++;
    SetBgAffine(2, 0x7800, 0x1800, 120, tYCoord + 32 + (tYOffset >> 2), tScale,
                tScale, 0);
...
static void Task_TakesFlight_CreateSmoke(u8 taskId) {
  ...
  if ((tTimer & 3) == 0) {
    u8 spriteId =
        CreateSprite(&sSpriteTemplate_TakesFlight_Smoke,
                     (sTakesFlight_SmokeCoords[tSmokeId][0] * 4) + 120,
                     (sTakesFlight_SmokeCoords[tSmokeId][1] * 4) + 80, 0);
...
static void InitDescendsSceneBgs(void) {
  ResetVramOamAndBgCntRegs();
  ResetBgsAndClearDma3BusyFlags(0);
  InitBgsFromTemplates(0, sBgTemplates_Descends,
...
static void LoadDescendsSceneGfx(void) {
  ...
  while (FreeTempTileDataBuffersIfPossible())
    ;
  LZDecompressWram(gRaySceneDescends_Light_Tilemap,
                   sRayScene->tilemapBuffers[0]);
  ...
  CpuFastCopy(sRayScene->tilemapBuffers[3], sRayScene->tilemapBuffers[1],
              BG_SCREEN_SIZE);
  CpuFastFill16(0, &sRayScene->tilemapBuffers[1][0x100], 0x340);

  LoadCompressedPalette(gRaySceneDescends_Bg_Pal, BG_PLTT_ID(0),
                        2 * PLTT_SIZE_4BPP);
...
static void HBlankCB_RayDescends(void) {
  ...
  if (vcount >= 24 && vcount <= 135 &&
      vcount - 24 <= sRayScene->revealedLightLine)
    REG_BLDALPHA =
        0xD08; // This line is above where light has been revealed, draw it
  else
...
static void Task_RayDescendsAnim(u8 taskId) {
  ...
  SetGpuRegBits(REG_OFFSET_BLDCNT, BLDCNT_TGT1_BG0 | BLDCNT_TGT2_BG1 |
...
static u8 CreateDescendsRayquazaSprite(void) {
  ...
  sTailSpriteId =
      CreateSprite(&sSpriteTemplate_Descends_RayquazaTail, 184, -48, 0);
...
static void InitChargesSceneBgs(void) {
  ResetVramOamAndBgCntRegs();
  ResetBgsAndClearDma3BusyFlags(0);
  InitBgsFromTemplates(0, sBgTemplates_Charges,
                       ARRAY_COUNT(sBgTemplates_Charges));
  SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
  SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
  SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
  SetBgTilemapBuffer(3, sRayScene->tilemapBuffers[3]);
  ...
  SetGpuReg(REG_OFFSET_DISPCNT,
            DISPCNT_OBJ_ON | DISPCNT_OBJ_1D_MAP | DISPCNT_WIN0_ON);
  ShowBg(0);
  ShowBg(1);
  ShowBg(2);
  ShowBg(3);
...
static void LoadChargesSceneGfx(void) {
  ...
  LZDecompressWram(gRaySceneCharges_Rayquaza_Tilemap,
                   sRayScene->tilemapBuffers[1]);
  LZDecompressWram(gRaySceneCharges_Streaks_Tilemap,
                   sRayScene->tilemapBuffers[2]);
  LZDecompressWram(gRaySceneCharges_Bg_Tilemap, sRayScene->tilemapBuffers[3]);
  LoadCompressedPalette(gRaySceneCharges_Bg_Pal, BG_PLTT_ID(0),
                        4 * PLTT_SIZE_4BPP);
}
...
static void InitChasesAwaySceneBgs(void) {
  ResetVramOamAndBgCntRegs();
  ResetBgsAndClearDma3BusyFlags(0);
  InitBgsFromTemplates(1, sBgTemplates_ChasesAway,
                       ARRAY_COUNT(sBgTemplates_ChasesAway));
  SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
  SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
  SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
  ResetAllBgsCoordinates();
...
static void LoadChasesAwaySceneGfx(void) {
  ...
  while (FreeTempTileDataBuffersIfPossible())
    ;
  LZDecompressWram(gRaySceneChasesAway_Bg_Tilemap,
                   sRayScene->tilemapBuffers[1]);
  LZDecompressWram(gRaySceneChasesAway_Light_Tilemap,
                   sRayScene->tilemapBuffers[0]);
  LZDecompressWram(gRaySceneChasesAway_Ring_Tilemap,
                   sRayScene->tilemapBuffers[2]);
  LoadCompressedPalette(gRaySceneChasesAway_Bg_Pal, BG_PLTT_ID(0),
                        3 * PLTT_SIZE_4BPP);
...
static void Task_RayChasesAwayAnim(u8 taskId) {
  ...
  SetGpuReg(REG_OFFSET_BLDCNT,
            BLDCNT_TGT1_BG0 | BLDCNT_TGT2_BG1 | BLDCNT_EFFECT_BLEND);
...
static void Task_HandleRayChasesAway(u8 taskId) {
  ...
  case 2:
    ...
    if (tTimer == 448) {
      ...
      tTimer++;
      if (tTimer % 144 == 0) {
        BlendPalettesGradually(PALETTES_BG & ~1, 0, 16, 0, RGB_WHITEALPHA, 0,
                               0);
        BlendPalettesGradually(PALETTES_OBJECTS, 0, 16, 0, RGB_BLACK, 0, 1);
      }
    }
...
static void Task_ChasesAway_AnimateBg(u8 taskId) {
  ...
  if ((tTimer & 0xF) == 0) {
    SetGpuReg(REG_OFFSET_BLDALPHA,
              ((tBlendHi + 14) << 8 & 0x1F00) | ((tBlendLo + 9) & 0xF));
...
static void ChasesAway_CreateTrioSprites(u8 taskId) {
  ...
  tGroudonSpriteId =
      CreateSprite(&sSpriteTemplate_ChasesAway_Groudon, 64, 120, 0);
  spriteData = gSprites[tGroudonSpriteId].data;
  spriteData[0] =
      CreateSprite(&sSpriteTemplate_ChasesAway_GroudonTail, 16, 130, 0);
  gSprites[tGroudonSpriteId].oam.priority = 1;
  gSprites[spriteData[0]].oam.priority = 1;

  tKyogreSpriteId =
      CreateSprite(&sSpriteTemplate_ChasesAway_Kyogre, 160, 128, 1);
  ...
  tRayquazaSpriteId =
      CreateSprite(&sSpriteTemplate_ChasesAway_Rayquaza, 120, -65, 0);
  spriteData = gSprites[tRayquazaSpriteId].data;
  spriteData[0] =
      CreateSprite(&sSpriteTemplate_ChasesAway_RayquazaTail, 120, -113, 0);
...
// Pushes Groudon/Kyogre back slightly, for when Rayquaza's hyper voice ring
// comes out
...
static void SpriteCB_ChasesAway_KyogreLeave(struct Sprite *sprite) {
  ...
  if (sprite->data[5] == 128) {
    sprite->data[7] =
        CreateSprite(&sSpriteTemplate_ChasesAway_KyogreSplash, 152, 132, 0);
    gSprites[sprite->data[7]].oam.priority = 1;
    sprite->data[7] =
        CreateSprite(&sSpriteTemplate_ChasesAway_KyogreSplash, 224, 132, 0);
    gSprites[sprite->data[7]].oam.priority = 1;
...
static void SpriteCB_ChasesAway_RayquazaFloat(struct Sprite *body) {
  ...
  if (!(body->sFloatTimer & tail->sTailFloatDelay)) {
    ...
    gSprites[body->sTailSpriteId].y2 +=
        body->sYOffset; // why access gSprites again? tail->y2 would be
                        // sufficient
...
static void ChasesAway_SetRayquazaAnim(struct Sprite *body, u8 animNum, s16 x,
                                       s16 y) {
  struct Sprite *tail = &gSprites[body->sTailSpriteId];
