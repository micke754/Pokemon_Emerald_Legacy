...
#define PALTAG_OPTIONS_DEFAULT                                                 \
  4 // Includes green for Smart/Region Map and yellow for Tough
...
static const u16 sPokenavBgDotsPal[] =
    INCBIN_U16("graphics/pokenav/bg_dots.gbapal");
static const u32 sPokenavBgDotsTiles[] =
    INCBIN_U32("graphics/pokenav/bg_dots.4bpp.lz");
static const u32 sPokenavBgDotsTilemap[] =
    INCBIN_U32("graphics/pokenav/bg_dots.bin.lz");
static const u16 sPokenavDeviceBgPal[] =
    INCBIN_U16("graphics/pokenav/device_outline.gbapal");
static const u32 sPokenavDeviceBgTiles[] =
    INCBIN_U32("graphics/pokenav/device_outline.4bpp.lz");
static const u32 sPokenavDeviceBgTilemap[] =
    INCBIN_U32("graphics/pokenav/device_outline_map.bin.lz");
static const u16 sMatchCallBlueLightPal[] =
    INCBIN_U16("graphics/pokenav/blue_light.gbapal");
static const u32 sMatchCallBlueLightTiles[] =
    INCBIN_U32("graphics/pokenav/blue_light.4bpp.lz");
...
static const struct CompressedSpriteSheet sPokenavOptionsSpriteSheets[] = {
    {.data = gPokenavOptions_Gfx, .size = 0x3400, .tag = GFXTAG_OPTIONS},
...
static const u16 sOptionsLabelGfx_RegionMap[] = {
    0x000, PALTAG_OPTIONS_DEFAULT - PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Condition[] = {
    0x020, PALTAG_OPTIONS_BLUE - PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_MatchCall[] = {
    0x040, PALTAG_OPTIONS_RED - PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Ribbons[] = {0x060, PALTAG_OPTIONS_PINK -
                                                          PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_SwitchOff[] = {
    0x080, PALTAG_OPTIONS_BEIGE - PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Party[] = {0x0A0, PALTAG_OPTIONS_BLUE -
                                                        PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Search[] = {0x0C0, PALTAG_OPTIONS_BLUE -
                                                         PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Cool[] = {0x0E0, PALTAG_OPTIONS_RED -
                                                       PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Beauty[] = {0x100, PALTAG_OPTIONS_BLUE -
                                                         PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Cute[] = {0x120, PALTAG_OPTIONS_PINK -
                                                       PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Smart[] = {0x140, PALTAG_OPTIONS_DEFAULT -
                                                        PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Tough[] = {0x160, PALTAG_OPTIONS_DEFAULT -
                                                        PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_Cancel[] = {0x180, PALTAG_OPTIONS_BEIGE -
                                                         PALTAG_OPTIONS_START};
...
struct {
  ...
  const u16 *gfx[MAX_POKENAV_MENUITEMS];
    ...
    [POKENAV_MENU_TYPE_DEFAULT] = {.yStart = 42,
                                   .deltaY = 20,
                                   .gfx = {sOptionsLabelGfx_RegionMap,
                                           sOptionsLabelGfx_Condition,
                                           sOptionsLabelGfx_SwitchOff}},
    [POKENAV_MENU_TYPE_UNLOCK_MC] = {.yStart = 42,
                                     .deltaY = 20,
                                     .gfx = {sOptionsLabelGfx_RegionMap,
                                             sOptionsLabelGfx_Condition,
    ...
    [POKENAV_MENU_TYPE_UNLOCK_MC_RIBBONS] =
        {.yStart = 42,
         ...
         .gfx = {sOptionsLabelGfx_RegionMap, sOptionsLabelGfx_Condition,
                 sOptionsLabelGfx_MatchCall, sOptionsLabelGfx_Ribbons,
                 sOptionsLabelGfx_SwitchOff}},
    [POKENAV_MENU_TYPE_CONDITION] = {.yStart = 56,
                                     .deltaY = 20,
                                     .gfx = {sOptionsLabelGfx_Party,
                                             sOptionsLabelGfx_Search,
                                             sOptionsLabelGfx_Cancel}},
    [POKENAV_MENU_TYPE_CONDITION_SEARCH] =
        {.yStart = 40,
         .deltaY = 16,
         .gfx = {sOptionsLabelGfx_Cool, sOptionsLabelGfx_Beauty,
                 sOptionsLabelGfx_Cute, sOptionsLabelGfx_Smart,
                 sOptionsLabelGfx_Tough, sOptionsLabelGfx_Cancel}},
};
...
static const u8 sOptionDescTextColors[] = {TEXT_COLOR_GREEN, TEXT_COLOR_BLUE,
                                           TEXT_COLOR_LIGHT_GREEN};
static const u8 sOptionDescTextColors2[] = {TEXT_COLOR_GREEN, TEXT_COLOR_BLUE,
                                            TEXT_COLOR_LIGHT_GREEN};
...
static const union AffineAnimCmd *const sAffineAnims_MenuOption[] = {
    sAffineAnim_MenuOption_Normal, sAffineAnim_MenuOption_Zoom};
...
static bool32 AreAnyTrainerRematchesNearby(void) {
  ...
  for (i = 0; i < REMATCH_TABLE_ENTRIES; i++) {
    if (GetMatchTableMapSectionId(i) == gMapHeader.regionMapSectionId &&
        IsRematchEntryRegistered(i) && gSaveBlock1Ptr->trainerRematches[i])
      return TRUE;
  }
...
static struct Pokenav_MenuGfx *OpenPokenavMenu(void) {
  struct Pokenav_MenuGfx *gfx = AllocSubstruct(POKENAV_SUBSTRUCT_MENU_GFX,
                                               sizeof(struct Pokenav_MenuGfx));
...
static u32 LoopedTask_OpenMenu(s32 state) {
  ...
  switch (state) {
  case 0:
    InitBgTemplates(sPokenavMainMenuBgTemplates,
                    ARRAY_COUNT(sPokenavMainMenuBgTemplates));
    ...
    CopyPaletteIntoBufferUnfaded(gPokenavMessageBox_Pal, BG_PLTT_ID(1),
                                 PLTT_SIZE_4BPP);
  ...
  case 1:
    ...
    CopyPaletteIntoBufferUnfaded(sPokenavDeviceBgPal, BG_PLTT_ID(2),
                                 sizeof(sPokenavDeviceBgPal));
    return LT_INC_AND_PAUSE;
  case 2:
    if (FreeTempTileDataBuffersIfPossible())
      return LT_PAUSE;
...
// For redisplaying the Ribbons description to replace the No Ribbon Winners
// message
...
// For selecting a feature option from a menu, e.g. the Map, Match Call, Beauty
// search, etc.
...
static void CreateMenuOptionSprites(void) {
  ...
  for (i = 0; i < MAX_POKENAV_MENUITEMS; i++) {
    for (j = 0; j < NUM_OPTION_SUBSPRITES; j++) {
      u8 spriteId =
          CreateSprite(&sMenuOptionSpriteTemplate, 0x8c, 20 * i + 40, 3);
...
static void DrawCurrentMenuOptionLabels(void) {
  ...
  DrawOptionLabelGfx(sPokenavMenuOptionLabelGfx[menuType].gfx,
                     sPokenavMenuOptionLabelGfx[menuType].yStart,
                     sPokenavMenuOptionLabelGfx[menuType].deltaY);
}

static void DrawOptionLabelGfx(const u16 *const *optionGfx, s32 yPos,
                               s32 deltaY) {
  s32 i, j;
  struct Pokenav_MenuGfx *gfx = GetSubstructPtr(POKENAV_SUBSTRUCT_MENU_GFX);
  ...
  for (i = 0; i < MAX_POKENAV_MENUITEMS; i++) {
    if (*optionGfx != NULL) {
      for (j = 0; j < NUM_OPTION_SUBSPRITES; j++) {
        gfx->iconSprites[i][j]->oam.tileNum =
            (*optionGfx)[0] + baseTile + 8 * j;
        gfx->iconSprites[i][j]->oam.paletteNum =
            IndexOfSpritePaletteTag((*optionGfx)[1] + PALTAG_OPTIONS_START);
...
static void StartOptionAnimations_CursorMoved(void) {
  ...
  StartOptionSlide(gfx->iconSprites[gfx->cursorPos], OPTION_SELECTED_X,
                   OPTION_DEFAULT_X, 4);
  StartOptionSlide(gfx->iconSprites[newPos], OPTION_DEFAULT_X,
                   OPTION_SELECTED_X, 4);
...
static void StartOptionAnimations_Exit(void) {
  ...
  for (i = 0; i < MAX_POKENAV_MENUITEMS; i++) {
    if (gfx->iconVisible[i]) {
      ...
      if (gfx->cursorPos != i)
        StartOptionSlide(gfx->iconSprites[i], OPTION_DEFAULT_X, OPTION_EXIT_X,
                         8);
      else
...
static void StartOptionSlide(struct Sprite **sprites, s32 startX, s32 endX,
                             s32 time) {
  s32 i;
  ...
  if (tBlendDelay == 0) {
    ...
    case 1:
      ...
      SetGpuReg(REG_OFFSET_BLDALPHA,
                BLDALPHA_BLEND(tBlendTarget1, tBlendTarget2));
      tBlendCounter++;
      if (tBlendCounter == 12) {
        ((struct Pokenav_MenuGfx *)GetSubstructPtr(POKENAV_SUBSTRUCT_MENU_GFX))
            ->numIconsBlending--;
...
static void PrintCurrentOptionDescription(void) {
  ...
  FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
  AddTextPrinterParameterized3(gfx->optionDescWindowId, FONT_NORMAL,
                               (192 - width) / 2, 1, sOptionDescTextColors, 0,
                               desc);
}

// Printed when Ribbons is selected if no PC/party mons have ribbons
// Can occur by obtaining a mon with a ribbon and then releasing all ribbon
// winners
static void PrintNoRibbonWinners(void) {
  struct Pokenav_MenuGfx *gfx = GetSubstructPtr(POKENAV_SUBSTRUCT_MENU_GFX);
  ...
  FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
  AddTextPrinterParameterized3(gfx->optionDescWindowId, FONT_NORMAL,
                               (192 - width) / 2, 1, sOptionDescTextColors2, 0,
                               s);
}
...
static void Task_MoveBgDots(u8 taskId) { ChangeBgX(3, 0x80, BG_COORD_ADD); }
...
static void ChangeBgDotsColorToPurple(void) {
  CopyPaletteIntoBufferUnfaded(sPokenavBgDotsPal + 7, BG_PLTT_ID(3) + 1,
                               PLTT_SIZEOF(2));
}
...
static void ResetBldCnt(void) { SetGpuReg(REG_OFFSET_BLDCNT, 0); }
...
static void SetMenuOptionGlow(void) {
  ...
  int r4 = sPokenavMenuOptionLabelGfx[menuType].deltaY * cursorPos +
           sPokenavMenuOptionLabelGfx[menuType].yStart - 8;
...
void ResetBldCnt_(void) { ResetBldCnt(); }
