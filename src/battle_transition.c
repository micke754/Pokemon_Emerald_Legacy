...
#define B_TRANS_DMA_FLAGS                                                      \
  (1 | ((DMA_SRC_INC | DMA_DEST_FIXED | DMA_REPEAT | DMA_16BIT |               \
         DMA_START_HBLANK | DMA_ENABLE)                                        \
        << 16))

// Used by each transition task to determine which of its functions to call
#define tState data[0]

// Below are data defines for InitBlackWipe and UpdateBlackWipe, for the
// TransitionData data array. These will be re-used by any transitions that use
// these functions.
...
static bool16 UpdateRectangularSpiralLine(const s16 *const *,
                                          struct RectangularSpiralLine *);
...
static const u8 sPokeball_Gfx[] =
    INCBIN_U8("graphics/battle_transitions/pokeball.4bpp");
static const u32 sEliteFour_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/elite_four_bg.4bpp");
static const u8 sUnusedBrendan_Gfx[] =
    INCBIN_U8("graphics/battle_transitions/unused_brendan.4bpp");
static const u8 sUnusedLass_Gfx[] =
    INCBIN_U8("graphics/battle_transitions/unused_lass.4bpp");
static const u32 sShrinkingBoxTileset[] =
    INCBIN_U32("graphics/battle_transitions/shrinking_box.4bpp");
static const u16 sEvilTeam_Palette[] =
    INCBIN_U16("graphics/battle_transitions/evil_team.gbapal");
static const u32 sTeamAqua_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/team_aqua.4bpp.lz");
static const u32 sTeamAqua_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/team_aqua.bin.lz");
static const u32 sTeamMagma_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/team_magma.4bpp.lz");
static const u32 sTeamMagma_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/team_magma.bin.lz");
static const u32 sRegis_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/regis.4bpp");
static const u16 sRegice_Palette[] =
    INCBIN_U16("graphics/battle_transitions/regice.gbapal");
static const u16 sRegisteel_Palette[] =
    INCBIN_U16("graphics/battle_transitions/registeel.gbapal");
static const u16 sRegirock_Palette[] =
    INCBIN_U16("graphics/battle_transitions/regirock.gbapal");
static const u32 sRegice_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/regice.bin");
static const u32 sRegisteel_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/registeel.bin");
static const u32 sRegirock_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/regirock.bin");
static const u16 sUnused_Palette[] =
    INCBIN_U16("graphics/battle_transitions/unused.gbapal");
static const u32 sKyogre_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/kyogre.4bpp.lz");
static const u32 sKyogre_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/kyogre.bin.lz");
static const u32 sGroudon_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/groudon.4bpp.lz");
static const u32 sGroudon_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/groudon.bin.lz");
static const u16 sKyogre1_Palette[] =
    INCBIN_U16("graphics/battle_transitions/kyogre_pt1.gbapal");
static const u16 sKyogre2_Palette[] =
    INCBIN_U16("graphics/battle_transitions/kyogre_pt2.gbapal");
static const u16 sGroudon1_Palette[] =
    INCBIN_U16("graphics/battle_transitions/groudon_pt1.gbapal");
static const u16 sGroudon2_Palette[] =
    INCBIN_U16("graphics/battle_transitions/groudon_pt2.gbapal");
static const u16 sRayquaza_Palette[] =
    INCBIN_U16("graphics/battle_transitions/rayquaza.gbapal");
static const u32 sRayquaza_Tileset[] =
    INCBIN_U32("graphics/battle_transitions/rayquaza.4bpp");
static const u32 sRayquaza_Tilemap[] =
    INCBIN_U32("graphics/battle_transitions/rayquaza.bin");
...
static const u16 sFrontierSquares_Palette[] = INCBIN_U16(
...
static const TransitionStateFunc sTaskHandlers[] = {
    &Transition_StartIntro, &Transition_WaitForIntro, &Transition_StartMain,
    &Transition_WaitForMain};

static const TransitionStateFunc sBlur_Funcs[] = {Blur_Init, Blur_Main,
                                                  Blur_End};
...
static const TransitionStateFunc sAqua_Funcs[] = {Aqua_Init,
                                                  Aqua_SetGfx,
                                                  PatternWeave_Blend1,
                                                  PatternWeave_Blend2,
...
static const TransitionStateFunc sMagma_Funcs[] = {Magma_Init,
                                                   Magma_SetGfx,
                                                   PatternWeave_Blend1,
                                                   PatternWeave_Blend2,
                                                   PatternWeave_FinishAppear,
...
static const TransitionStateFunc sBigPokeball_Funcs[] = {
    BigPokeball_Init,    BigPokeball_SetGfx,        PatternWeave_Blend1,
    PatternWeave_Blend2, PatternWeave_FinishAppear, PatternWeave_CircularMask};

static const TransitionStateFunc sRegice_Funcs[] = {Regi_Init,
                                                    Regice_SetGfx,
                                                    PatternWeave_Blend1,
                                                    PatternWeave_Blend2,
                                                    PatternWeave_FinishAppear,
...
static const TransitionStateFunc sRegisteel_Funcs[] = {
    Regi_Init,           Registeel_SetGfx,          PatternWeave_Blend1,
    PatternWeave_Blend2, PatternWeave_FinishAppear, PatternWeave_CircularMask};

static const TransitionStateFunc sRegirock_Funcs[] = {
    Regi_Init,           Regirock_SetGfx,           PatternWeave_Blend1,
    PatternWeave_Blend2, PatternWeave_FinishAppear, PatternWeave_CircularMask};
...
static const TransitionStateFunc sPokeballsTrail_Funcs[] = {
    PokeballsTrail_Init, PokeballsTrail_Main, PokeballsTrail_End};

#define NUM_POKEBALL_TRAILS 5
static const s16 sPokeballsTrail_StartXCoords[2] = {-16, DISPLAY_WIDTH + 16};
static const s16 sPokeballsTrail_Delays[NUM_POKEBALL_TRAILS] = {0, 32, 64, 18,
                                                                48};
static const s16 sPokeballsTrail_Speeds[2] = {8, -8};

static const TransitionStateFunc sClockwiseWipe_Funcs[] = {
    ClockwiseWipe_Init,   ClockwiseWipe_TopRight, ClockwiseWipe_Right,
    ClockwiseWipe_Bottom, ClockwiseWipe_Left,     ClockwiseWipe_TopLeft,
    ClockwiseWipe_End};

static const TransitionStateFunc sRipple_Funcs[] = {Ripple_Init, Ripple_Main};
...
static const s16 sMugshotsOpponentCoords[MUGSHOTS_COUNT][2] = {
    [MUGSHOT_SIDNEY] = {0, 0},    [MUGSHOT_PHOEBE] = {0, 0},
    [MUGSHOT_GLACIA] = {-4, 4},   [MUGSHOT_DRAKE] = {0, 5},
    [MUGSHOT_CHAMPION] = {-8, 7}, [MUGSHOT_CHAMPION_STEVEN] = {-8, 7},
};

static const TransitionSpriteCallback sMugshotTrainerPicFuncs[] = {
    MugshotTrainerPic_Pause, MugshotTrainerPic_Init,
    MugshotTrainerPic_Slide, MugshotTrainerPic_SlideSlow,
    MugshotTrainerPic_Pause, MugshotTrainerPic_SlideOffscreen,
...
static const TransitionStateFunc sSlice_Funcs[] = {Slice_Init, Slice_Main,
                                                   Slice_End};

static const TransitionStateFunc sShredSplit_Funcs[] = {
    ShredSplit_Init, ShredSplit_Main, ShredSplit_BrokenCheck, ShredSplit_End};
...
static const TransitionStateFunc sRectangularSpiral_Funcs[] = {
    RectangularSpiral_Init, RectangularSpiral_Main, RectangularSpiral_End};

#define SPIRAL_END (-1)
#define SPIRAL_REBOUND (-2)

// Note that the directions are inverted for the lines originating at the
// bottom. i.e. MOVE_RIGHT is a right move for the top lines and a left move for
// the inverted bottom lines.
enum {
  MOVE_RIGHT = 1,
  MOVE_LEFT,
  MOVE_UP,
...
static const s16 sRectangularSpiral_Major_InwardRight[] = {MOVE_RIGHT, 27, 275,
                                                           SPIRAL_END};
static const s16 sRectangularSpiral_Major_InwardLeft[] = {MOVE_LEFT, 486,
                                                          SPIRAL_END};
static const s16 sRectangularSpiral_Major_InwardUp[] = {MOVE_UP, 262,
                                                        SPIRAL_END};
static const s16 sRectangularSpiral_Major_InwardDown[] = {MOVE_DOWN, 507,
                                                          SPIRAL_REBOUND};

static const s16 sRectangularSpiral_Minor_InwardRight[] = {MOVE_RIGHT, 213,
                                                           SPIRAL_END};
static const s16 sRectangularSpiral_Minor_InwardLeft[] = {MOVE_LEFT, 548,
                                                          SPIRAL_REBOUND};
static const s16 sRectangularSpiral_Minor_InwardUp[] = {MOVE_UP, 196,
                                                        SPIRAL_END};
static const s16 sRectangularSpiral_Minor_InwardDown[] = {MOVE_DOWN, 573, 309,
                                                          SPIRAL_END};

static const s16 sRectangularSpiral_Minor_OutwardRight[] = {MOVE_RIGHT, 474,
                                                            SPIRAL_END};
static const s16 sRectangularSpiral_Minor_OutwardLeft[] = {MOVE_LEFT, 295, 32,
                                                           SPIRAL_END};
static const s16 sRectangularSpiral_Minor_OutwardUp[] = {MOVE_UP, 58,
                                                         SPIRAL_END};
static const s16 sRectangularSpiral_Minor_OutwardDown[] = {MOVE_DOWN, 455,
                                                           SPIRAL_END};

static const s16 sRectangularSpiral_Major_OutwardRight[] = {MOVE_RIGHT, 540,
                                                            SPIRAL_END};
static const s16 sRectangularSpiral_Major_OutwardLeft[] = {MOVE_LEFT, 229,
                                                           SPIRAL_END};
static const s16 sRectangularSpiral_Major_OutwardUp[] = {MOVE_UP, 244, 28,
                                                         SPIRAL_END};
static const s16 sRectangularSpiral_Major_OutwardDown[] = {MOVE_DOWN, 517,
                                                           SPIRAL_END};
...
static const s16 *const sRectangularSpiral_MoveDataTable_MinorDiagonal[] = {
    [SPIRAL_INWARD_START] = sRectangularSpiral_Minor_InwardDown,
    sRectangularSpiral_Minor_InwardLeft,
    sRectangularSpiral_Minor_InwardUp,
    sRectangularSpiral_Minor_InwardRight,

    [SPIRAL_OUTWARD_START] = sRectangularSpiral_Minor_OutwardLeft,
...
static const TransitionStateFunc sRayquaza_Funcs[] = {
    WeatherTrio_BgFadeBlack, WeatherTrio_WaitFade,  Rayquaza_Init,
    Rayquaza_SetGfx,         Rayquaza_PaletteFlash, Rayquaza_FadeToBlack,
    Rayquaza_WaitFade,       Rayquaza_SetBlack,     Rayquaza_TriRing,
    Blackhole_Vibrate,       Blackhole_GrowEnd};

static const TransitionStateFunc sWhiteBarsFade_Funcs[] = {
    WhiteBarsFade_Init, WhiteBarsFade_StartBars, WhiteBarsFade_WaitBars,
    WhiteBarsFade_BlendToBlack, WhiteBarsFade_End};

#define NUM_WHITE_BARS 8
static const s16 sWhiteBarsFade_StartDelays[NUM_WHITE_BARS] = {0,  20, 15, 40,
                                                               10, 25, 35, 5};

static const TransitionStateFunc sGridSquares_Funcs[] = {
    GridSquares_Init, GridSquares_Main, GridSquares_End};

static const TransitionStateFunc sAngledWipes_Funcs[] = {
    AngledWipes_Init, AngledWipes_SetWipeData, AngledWipes_DoWipe,
    AngledWipes_TryEnd, AngledWipes_StartNext};
...
static const s16 sAngledWipes_EndDelays[NUM_ANGLED_WIPES] = {8, 4, 2, 1,
                                                             1, 1, 0};

static const TransitionStateFunc sTransitionIntroFuncs[] = {
    TransitionIntro_FadeToGray, TransitionIntro_FadeFromGray};

static const struct SpriteFrameImage sSpriteImage_Pokeball[] = {
    {sPokeball_Gfx, sizeof(sPokeball_Gfx)}};

static const union AnimCmd sSpriteAnim_Pokeball[] = {ANIMCMD_FRAME(0, 1),
                                                     ANIMCMD_END};
...
static const union AffineAnimCmd sSpriteAffineAnim_Pokeball1[] = {
    AFFINEANIMCMD_FRAME(0, 0, -4, 1), AFFINEANIMCMD_JUMP(0)};
...
const struct SpritePalette gSpritePalette_Pokeball = {
    sFieldEffectPal_Pokeball, FLDEFF_PAL_TAG_POKEBALL_TRAIL};

static const u16 sMugshotPal_Sidney[] =
    INCBIN_U16("graphics/battle_transitions/sidney_bg.gbapal");
static const u16 sMugshotPal_Phoebe[] =
    INCBIN_U16("graphics/battle_transitions/phoebe_bg.gbapal");
static const u16 sMugshotPal_Glacia[] =
    INCBIN_U16("graphics/battle_transitions/glacia_bg.gbapal");
static const u16 sMugshotPal_Drake[] =
    INCBIN_U16("graphics/battle_transitions/drake_bg.gbapal");
...
static const u16 sMugshotPal_May[] =
    INCBIN_U16("graphics/battle_transitions/may_bg.gbapal");
...
static const struct SpritePalette sSpritePalette_UnusedTrainer = {
    sUnusedTrainerPalette, PALTAG_UNUSED_MUGSHOT};
...
static const TransitionStateFunc sFrontierLogoWiggle_Funcs[] = {
    FrontierLogoWiggle_Init,   FrontierLogoWiggle_SetGfx,
    PatternWeave_Blend1,       PatternWeave_Blend2,
    PatternWeave_FinishAppear, PatternWeave_CircularMask};

static const TransitionStateFunc sFrontierLogoWave_Funcs[] = {
    FrontierLogoWave_Init, FrontierLogoWave_SetGfx,
    FrontierLogoWave_InitScanline, FrontierLogoWave_Main};

static const TransitionStateFunc sFrontierSquares_Funcs[] = {
    FrontierSquares_Init, FrontierSquares_Draw, FrontierSquares_Shrink,
    FrontierSquares_End};

static const TransitionStateFunc sFrontierSquaresSpiral_Funcs[] = {
    FrontierSquaresSpiral_Init, FrontierSquaresSpiral_Outward,
    FrontierSquaresSpiral_SetBlack, FrontierSquaresSpiral_Inward,
    FrontierSquares_End};

static const TransitionStateFunc sFrontierSquaresScroll_Funcs[] = {
    FrontierSquaresScroll_Init, FrontierSquaresScroll_Draw,
    FrontierSquaresScroll_SetBlack, FrontierSquaresScroll_Erase,
    FrontierSquaresScroll_End};

#define SQUARE_SIZE 4
#define MARGIN_SIZE                                                            \
  1 // Squares do not fit evenly across the width, so there is a margin on
    // either side.
#define NUM_SQUARES_PER_ROW                                                    \
  ((DISPLAY_WIDTH - (MARGIN_SIZE * 8 * 2)) / (SQUARE_SIZE * 8))
...
static const u8 sFrontierSquaresSpiral_Positions[NUM_SQUARES] = {
    28, 29, 30, 31, 32, 33, 34, 27, 20, 13, 6,  5, 4, 3,  2,  1,  0, 7,
    14, 21, 22, 23, 24, 25, 26, 19, 12, 11, 10, 9, 8, 15, 16, 17, 18};
...
static const u8 sFrontierSquaresScroll_Positions[] = {
    0,  16, 41, 22, 44, 2,  43, 21, 46, 27, 9,  48, 38, 5,  57, 59,
    12, 63, 35, 28, 10, 53, 7,  49, 39, 23, 55, 1,  62, 17, 61, 30,
    6,  34, 15, 51, 32, 58, 13, 45, 37, 52, 11, 24, 60, 19, 56, 33,
    29, 50, 40, 54, 14, 3,  47, 20, 18, 25, 4,  36, 26, 42, 31, 8};
...
static bool8 Swirl_Init(struct Task *task) {
  ...
  SetSinWave(gScanlineEffectRegBuffers[1], sTransitionData->cameraX, 0, 2, 0,
             DISPLAY_HEIGHT);
...
static bool8 Swirl_End(struct Task *task) {
  ...
  SetSinWave(gScanlineEffectRegBuffers[0], sTransitionData->cameraX,
             task->tSinIndex, 2, task->tAmplitude, DISPLAY_HEIGHT);
...
static void VBlankCB_Swirl(void) {
  ...
  if (sTransitionData->VBlank_DMA)
    DmaCopy16(3, gScanlineEffectRegBuffers[0], gScanlineEffectRegBuffers[1],
              DISPLAY_HEIGHT * 2);
}
...
static bool8 Shuffle_Init(struct Task *task) {
  ...
  BeginNormalPaletteFade(PALETTES_ALL, 4, 0, 16, RGB_BLACK);
  memset(gScanlineEffectRegBuffers[1], sTransitionData->cameraY,
         DISPLAY_HEIGHT * 2);
...
static bool8 Shuffle_End(struct Task *task) {
  ...
  for (i = 0; i < DISPLAY_HEIGHT; i++, sinVal += 4224) {
    ...
    gScanlineEffectRegBuffers[0][i] =
        sTransitionData->cameraY + Sin(sinIndex, amplitude);
  }
...
static void InitPatternWeaveTransition(struct Task *task) {
  ...
  sTransitionData->BLDCNT =
      BLDCNT_TGT1_BG0 | BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_ALL;
  sTransitionData->BLDALPHA =
      BLDALPHA_BLEND(task->tBlendTarget2, task->tBlendTarget1);
...
static bool8 BigPokeball_Init(struct Task *task) {
  ...
  LoadPalette(sFieldEffectPal_Pokeball, BG_PLTT_ID(15),
              sizeof(sFieldEffectPal_Pokeball));
...
static bool8 BigPokeball_SetGfx(struct Task *task) {
  ...
  SetSinWave(gScanlineEffectRegBuffers[0], 0, task->tSinIndex, 132,
             task->tAmplitude, DISPLAY_HEIGHT);
...
static bool8 PatternWeave_Blend1(struct Task *task) {
  ...
  SetSinWave(gScanlineEffectRegBuffers[0], 0, task->tSinIndex, 132,
             task->tAmplitude >> 8, DISPLAY_HEIGHT);
...
// Do a shrinking circular mask to go to a black screen after the pattern
// appears.
static bool8 PatternWeave_CircularMask(struct Task *task) {
  sTransitionData->VBlank_DMA = FALSE;
  if (task->tRadiusDelta < (4 << 8))
    task->tRadiusDelta +=
        128; // 256 is 1 unit of speed. Speed up every other frame (128 / 256)
  if (task->tRadius != 0) {
    task->tRadius -= task->tRadiusDelta >> 8;
    if (task->tRadius < 0)
      task->tRadius = 0;
  }
  SetCircularMask(gScanlineEffectRegBuffers[0], DISPLAY_WIDTH / 2,
                  DISPLAY_HEIGHT / 2, task->tRadius);
  if (task->tRadius == 0) {
...
static bool8 PokeballsTrail_Main(struct Task *task) {
  ...
  memcpy(startX, sPokeballsTrail_StartXCoords,
         sizeof(sPokeballsTrail_StartXCoords));
...
bool8 FldEff_PokeballTrail(void) {
  u8 spriteId =
      CreateSpriteAtEnd(&sSpriteTemplate_Pokeball, gFieldEffectArguments[0],
...
static bool8 ClockwiseWipe_Init(struct Task *task) {
  ...
  for (i = 0; i < DISPLAY_HEIGHT; i++)
    gScanlineEffectRegBuffers[1][i] =
        ((DISPLAY_WIDTH + 3) << 8) | (DISPLAY_WIDTH + 4);
...
static bool8 ClockwiseWipe_TopRight(struct Task *task) {
  ...
  InitBlackWipe(sTransitionData->data, DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2,
                sTransitionData->tWipeEndX, -1, 1, 1);
  do {
    gScanlineEffectRegBuffers[0][sTransitionData->tWipeCurrY] =
        (sTransitionData->tWipeCurrX + 1) | ((DISPLAY_WIDTH / 2) << 8);
...
static bool8 ClockwiseWipe_Right(struct Task *task) {
  ...
  InitBlackWipe(sTransitionData->data, DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2,
                DISPLAY_WIDTH, sTransitionData->tWipeEndY, 1, 1);
...
static bool8 ClockwiseWipe_Bottom(struct Task *task) {
  ...
  InitBlackWipe(sTransitionData->data, DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2,
                sTransitionData->tWipeEndX, DISPLAY_HEIGHT, 1, 1);
  do {
    gScanlineEffectRegBuffers[0][sTransitionData->tWipeCurrY] =
        (sTransitionData->tWipeCurrX << 8) | DISPLAY_WIDTH;
  } while (!UpdateBlackWipe(sTransitionData->data, TRUE, TRUE));
...
static bool8 ClockwiseWipe_Left(struct Task *task) {
  ...
  InitBlackWipe(sTransitionData->data, DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, 0,
                sTransitionData->tWipeEndY, 1, 1);
...
static bool8 ClockwiseWipe_TopLeft(struct Task *task) {
  ...
  InitBlackWipe(sTransitionData->data, DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2,
                sTransitionData->tWipeEndX, 0, 1, 1);
  do {
    s16 start, end;
    start = DISPLAY_WIDTH / 2, end = sTransitionData->tWipeCurrX;
...
static bool8 Ripple_Main(struct Task *task) {
  ...
  for (i = 0; i < DISPLAY_HEIGHT; i++, sinVal += speed) {
    ...
    gScanlineEffectRegBuffers[0][i] =
        sTransitionData->cameraY + Sin(sinIndex & 0xffff, amplitude);
  }
...
static bool8 Wave_Main(struct Task *task) {
  ...
  for (i = 0, finished = TRUE; i < DISPLAY_HEIGHT;
       i++, sinIndex += 4, toStore++) {
...
static bool8 Mugshot_Init(struct Task *task) {
  ...
  sTransitionData->WININ = WININ_WIN0_ALL;
  sTransitionData->WINOUT = WINOUT_WIN01_BG1 | WINOUT_WIN01_BG2 |
  ...
  for (i = 0; i < DISPLAY_HEIGHT; i++)
    gScanlineEffectRegBuffers[1][i] =
        (DISPLAY_WIDTH << 8) | (DISPLAY_WIDTH + 1);
...
static bool8 Mugshot_SetGfx(struct Task *task) {
  ...
  LoadPalette(sOpponentMugshotsPals[task->tMugshotId], BG_PLTT_ID(15),
              PLTT_SIZE_4BPP);
  LoadPalette(sPlayerMugshotsPals[gSaveBlock2Ptr->playerGender],
              BG_PLTT_ID(15) + 10, PLTT_SIZEOF(6));
...
static bool8 Mugshot_StartOpponentSlide(struct Task *task) {
  ...
  for (i = 0, toStore = gScanlineEffectRegBuffers[0]; i < DISPLAY_HEIGHT;
       i++, toStore++)
...
static void Mugshots_CreateTrainerPics(struct Task *task) {
  ...
  task->tPlayerSpriteId = CreateTrainerSprite(
      ...
      DISPLAY_WIDTH + 32, 106, 0, gDecompressionBuffer);
  ...
  CalcCenterToCornerVec(opponentSprite, SPRITE_SHAPE(64x32), SPRITE_SIZE(64x32),
                        ST_OAM_AFFINE_DOUBLE);
  CalcCenterToCornerVec(playerSprite, SPRITE_SHAPE(64x32), SPRITE_SIZE(64x32),
                        ST_OAM_AFFINE_DOUBLE);
...
static bool8 MugshotTrainerPic_Pause(struct Sprite *sprite) { return FALSE; }
...
static void VBlankCB_Slice(void) {
  ...
  if (sTransitionData->VBlank_DMA)
    DmaCopy16(3, gScanlineEffectRegBuffers[0], gScanlineEffectRegBuffers[1],
              DISPLAY_HEIGHT * 4);
  DmaSet(0, &gScanlineEffectRegBuffers[1][DISPLAY_HEIGHT], &REG_WIN0H,
         B_TRANS_DMA_FLAGS);
}
...
static bool8 Blackhole_Vibrate(struct Task *task) {
  ...
  task->tVibrateId =
      (task->tVibrateId + 1) % (int)ARRAY_COUNT(sBlackhole_Vibrations);
  SetCircularMask(gScanlineEffectRegBuffers[0], DISPLAY_WIDTH / 2,
                  DISPLAY_HEIGHT / 2, task->tRadius);
  if (task->tRadius < 9) {
    task->tState++;
...
static bool8 RectangularSpiral_Main(struct Task *task) {
  ...
  for (i = 0; i < 2; i++) {
    for (j = 0; j < ARRAY_COUNT(sRectangularSpiralLines); j++) {
      ...
      if (UpdateRectangularSpiralLine(sRectangularSpiral_MoveDataTables[j / 2],
                                      &sRectangularSpiralLines[j])) {
...
static bool16 UpdateRectangularSpiralLine(const s16 *const *moveDataTable,
...
static bool8 Groudon_PaletteFlash(struct Task *task) {
  if (task->tTimer % 3 == 0) {
    ...
    LoadPalette(&sGroudon1_Palette[offset * 16], BG_PLTT_ID(15),
                PLTT_SIZE_4BPP);
  }
  if (++task->tTimer > 58) {
    task->tState++;
...
static bool8 Groudon_PaletteBrighten(struct Task *task) {
  if (task->tTimer % 5 == 0) {
    s16 offset = task->tTimer / 5;
    LoadPalette(&sGroudon2_Palette[offset * 16], BG_PLTT_ID(15),
                PLTT_SIZE_4BPP);
  }
  if (++task->tTimer > 68) {
    task->tState++;
...
static bool8 Rayquaza_Init(struct Task *task) {
  ...
  SetGpuReg(REG_OFFSET_BG0CNT,
            BGCNT_CHARBASE(2) | BGCNT_SCREENBASE(26) | BGCNT_TXT256x512);
  GetBg0TilesDst(&tilemap, &tileset);
  CpuFill16(0, tilemap, BG_SCREEN_SIZE);
...
static bool8 WhiteBarsFade_Init(struct Task *task) {
  ...
  sTransitionData->WININ =
      WININ_WIN0_BG1 | WININ_WIN0_BG2 | WININ_WIN0_BG3 | WININ_WIN0_OBJ;
  sTransitionData->WINOUT = WINOUT_WIN01_ALL;
  sTransitionData->WIN0V = DISPLAY_HEIGHT;
...
static bool8 WhiteBarsFade_StartBars(struct Task *task) {
  ...
  memcpy(delays, sWhiteBarsFade_StartDelays,
         sizeof(sWhiteBarsFade_StartDelays));

  for (i = 0, posY = 0; i < NUM_WHITE_BARS;
       i++, posY += DISPLAY_HEIGHT / NUM_WHITE_BARS) {
...
static void SpriteCB_WhiteBarFade(struct Sprite *sprite) {
  if (sprite->sDelay) {
    ...
    if (sprite->sFinished) {
      ...
      if (!sprite->sIsMainSprite ||
          (sTransitionData->counter >= NUM_WHITE_BARS - 1 &&
           sprite->sDestroyAttempts++ > 7)) {
...
static bool8 AngledWipes_Init(struct Task *task) {
  ...
  CpuSet(gScanlineEffectRegBuffers[0], gScanlineEffectRegBuffers[1],
         DISPLAY_HEIGHT);
...
static bool8 AngledWipes_SetWipeData(struct Task *task) {
  InitBlackWipe(sTransitionData->data, sAngledWipes_MoveData[task->tWipeId][0],
                sAngledWipes_MoveData[task->tWipeId][1],
                sAngledWipes_MoveData[task->tWipeId][2],
                sAngledWipes_MoveData[task->tWipeId][3], 1, 1);
...
static void CreateIntroTask(s16 fadeToGrayDelay, s16 fadeFromGrayDelay,
                            s16 numFades, s16 fadeToGrayIncrement,
                            s16 fadeFromGrayIncrement) {
...
static void SetSinWave(s16 *array, s16 sinAdd, s16 index, s16 indexIncrementer,
                       s16 amplitude, s16 arrSize) {
  u8 i;
...
static void InitBlackWipe(s16 *data, s16 startX, s16 startY, s16 endX, s16 endY,
                          s16 xMove, s16 yMove) {
  tWipeStartX = startX;
  tWipeStartY = startY;
  tWipeCurrX = startX;
...
static bool8 FrontierLogoWiggle_Init(struct Task *task) {
  ...
  LoadPalette(sFrontierLogo_Palette, BG_PLTT_ID(15),
              sizeof(sFrontierLogo_Palette));
...
static bool8 FrontierLogoWave_Main(struct Task *task) {
  ...
  for (i = 0; i < DISPLAY_HEIGHT; i++, sinVal += sinSpread) {
    ...
    gScanlineEffectRegBuffers[0][i] =
        sTransitionData->cameraY + Sin(index & 0xff, amplitude);
  }
...
static bool8 FrontierSquares_Init(struct Task *task) {
  ...
  LoadPalette(sFrontierSquares_Palette, BG_PLTT_ID(15),
              sizeof(sFrontierSquares_Palette));
...
static bool8 FrontierSquares_Draw(struct Task *task) {
  CopyRectToBgTilemapBufferRect(0, sFrontierSquares_Tilemap, 0, 0, SQUARE_SIZE,
                                SQUARE_SIZE, task->tPosX, task->tPosY,
                                SQUARE_SIZE, SQUARE_SIZE, 15, 0, 0);
  CopyBgTilemapBufferToVram(0);
...
static bool8 FrontierSquaresSpiral_Init(struct Task *task) {
  ...
  FillBgTilemapBufferRect(0, 1, 30 - MARGIN_SIZE, 0, MARGIN_SIZE, 32, 15);
  CopyBgTilemapBufferToVram(0);
  LoadPalette(sFrontierSquares_Palette, BG_PLTT_ID(14),
              sizeof(sFrontierSquares_Palette));
  LoadPalette(sFrontierSquares_Palette, BG_PLTT_ID(15),
              sizeof(sFrontierSquares_Palette));
...
static bool8 FrontierSquaresSpiral_Outward(struct Task *task) {
  ...
  CopyRectToBgTilemapBufferRect(0, sFrontierSquares_Tilemap, 0, 0, SQUARE_SIZE,
                                SQUARE_SIZE, SQUARE_SIZE * x + MARGIN_SIZE,
                                SQUARE_SIZE * y, SQUARE_SIZE, SQUARE_SIZE, 15,
                                0, 0);
  CopyBgTilemapBufferToVram(0);
...
static bool8 FrontierSquaresSpiral_Inward(struct Task *task) {
  // Each square is faded first, then the one that was faded last move is
  // erased.
  if (task->tFadeFlag ^= 1) {
    // Shade square
    CopyRectToBgTilemapBufferRect(
        0, sFrontierSquares_Tilemap, 0, 0, SQUARE_SIZE, SQUARE_SIZE,
        SQUARE_SIZE * (sFrontierSquaresSpiral_Positions[task->tSquareNum] %
                       NUM_SQUARES_PER_ROW) +
            MARGIN_SIZE,
        SQUARE_SIZE * (sFrontierSquaresSpiral_Positions[task->tSquareNum] /
                       NUM_SQUARES_PER_ROW),
        SQUARE_SIZE, SQUARE_SIZE, 14, 0, 0);
  } else {
    if (task->tSquareNum > 0) {
      // Erase square
      FillBgTilemapBufferRect(
          0, 1,
          SQUARE_SIZE *
                  (sFrontierSquaresSpiral_Positions[task->tSquareNum - 1] %
                   NUM_SQUARES_PER_ROW) +
              MARGIN_SIZE,
          SQUARE_SIZE *
              (sFrontierSquaresSpiral_Positions[task->tSquareNum - 1] /
               NUM_SQUARES_PER_ROW),
          SQUARE_SIZE, SQUARE_SIZE, 15);
    }
    task->tSquareNum++;
  }
...
static bool8 FrontierSquaresScroll_Draw(struct Task *task) {
  ...
  u8 x =
      pos /
      (NUM_SQUARES_PER_ROW +
       1); // +1 because during scroll an additional column covers the margin.
...
static bool8 FrontierSquaresScroll_Erase(struct Task *task) {
  ...
  FillBgTilemapBufferRect(0, 1, SQUARE_SIZE * x + MARGIN_SIZE, SQUARE_SIZE * y,
                          SQUARE_SIZE, SQUARE_SIZE, 15);
  CopyBgTilemapBufferToVram(0);

  if (++task->tSquareNum >=
      (int)ARRAY_COUNT(sFrontierSquaresScroll_Positions)) {
