...
bool8 SiiRtcSetAlarm(struct SiiRtcInfo *rtc) {
  ...
  GPIOPortDirection =
      DIR_ALL_OUT; // Why is this the only instance that uses a symbol?
...
static void EnableGpioPortRead() { GPIO_PORT_READ_ENABLE = TRUE; }

static void DisableGpioPortRead() { GPIO_PORT_READ_ENABLE = FALSE; }
