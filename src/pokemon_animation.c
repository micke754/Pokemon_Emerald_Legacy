...
/*
    ...
    The table linking species to a BACK_ANIM is in this file
   (sSpeciesToBackAnimSet) while the table linking species to an ANIM for their
   front animation is in pokemon.c (sMonFrontAnimIdsTable).
...
#define sDontFlip                                                              \
  data[1] // TRUE if a normal animation, FALSE if Summary Screen animation
...
static const u8 sYellowFlashData[][2] = {
    {FALSE, 5}, {TRUE, 1},  {FALSE, 15}, {TRUE, 4},  {FALSE, 2},
    {TRUE, 2},  {FALSE, 2}, {TRUE, 2},   {FALSE, 2}, {TRUE, 2},
    {FALSE, 2}, {TRUE, 2},  {FALSE, 2},  {FALSE, -1}};

static const u8 sVerticalShakeData[][2] = {{6, 30}, {-2, 15}, {6, 30}, {-1, 0}};
...
static void (*const sMonAnimFunctions[])(struct Sprite *sprite) = {
    ...
    [ANIM_DEEP_V_SQUISH_AND_BOUNCE_TWICE] =
        Anim_DeepVerticalSquishBounce_Twice, // Unused
...
// BACK_ANIM_NONE is skipped below. GetSpeciesBackAnimSet subtracts 1 from the
// back anim id
static const u8 sBackAnimationIds[] = {
    [(BACK_ANIM_H_VIBRATE - 1) * 3] = ANIM_H_VIBRATE_FASTEST,
    ANIM_H_VIBRATE_FAST,
    ANIM_H_VIBRATE,
    [(BACK_ANIM_H_SLIDE - 1) * 3] = ANIM_H_SLIDE_FAST,
    ANIM_H_SLIDE,
    ANIM_H_SLIDE_SLOW,
    [(BACK_ANIM_H_SPRING - 1) * 3] = ANIM_H_SPRING_FAST,
    ANIM_H_SPRING,
    ANIM_H_SPRING_SLOW,
    [(BACK_ANIM_H_SPRING_REPEATED - 1) * 3] = ANIM_H_REPEATED_SPRING_FAST,
    ANIM_H_REPEATED_SPRING,
    ANIM_H_REPEATED_SPRING_SLOW,
    [(BACK_ANIM_SHRINK_GROW - 1) * 3] = ANIM_SHRINK_GROW_FAST,
    ANIM_SHRINK_GROW,
    ANIM_SHRINK_GROW_SLOW,
    [(BACK_ANIM_GROW - 1) * 3] = ANIM_GROW_TWICE,
    ANIM_GROW,
    ANIM_GROW_IN_STAGES,
    [(BACK_ANIM_CIRCLE_COUNTERCLOCKWISE - 1) * 3] =
        ANIM_CIRCLE_C_CLOCKWISE_LONG,
    ANIM_CIRCLE_C_CLOCKWISE,
    ANIM_CIRCLE_C_CLOCKWISE_SLOW,
    [(BACK_ANIM_H_SHAKE - 1) * 3] = ANIM_H_SHAKE_FAST,
    ANIM_H_SHAKE,
    ANIM_H_SHAKE_SLOW,
    [(BACK_ANIM_V_SHAKE - 1) * 3] = ANIM_V_SHAKE_BACK_FAST,
    ANIM_V_SHAKE_BACK,
    ANIM_V_SHAKE_BACK_SLOW,
    [(BACK_ANIM_V_SHAKE_H_SLIDE - 1) * 3] = ANIM_V_SHAKE_H_SLIDE_FAST,
    ...
    [(BACK_ANIM_H_STRETCH - 1) * 3] = ANIM_H_STRETCH_FAR_TWICE,
    ANIM_H_STRETCH_FAR,
    ANIM_H_STRETCH_FAR_SLOW,
    [(BACK_ANIM_GROW_STUTTER - 1) * 3] = ANIM_GROW_STUTTER_TWICE,
    ANIM_GROW_STUTTER,
    ANIM_GROW_STUTTER_SLOW,
    [(BACK_ANIM_V_SHAKE_LOW - 1) * 3] = ANIM_V_SHAKE_LOW_TWICE_FAST,
    ANIM_V_SHAKE_LOW_TWICE,
    ANIM_V_SHAKE_LOW_TWICE_SLOW,
    [(BACK_ANIM_TRIANGLE_DOWN - 1) * 3] = ANIM_TRIANGLE_DOWN_TWICE,
    ANIM_TRIANGLE_DOWN,
    ANIM_TRIANGLE_DOWN_SLOW,
    [(BACK_ANIM_CONCAVE_ARC_LARGE - 1) * 3] = ANIM_CONCAVE_ARC_LARGE_TWICE,
    ANIM_CONCAVE_ARC_LARGE,
    ANIM_CONCAVE_ARC_LARGE_SLOW,
    [(BACK_ANIM_CONVEX_DOUBLE_ARC - 1) * 3] = ANIM_CONVEX_DOUBLE_ARC_TWICE,
    ANIM_CONVEX_DOUBLE_ARC,
    ANIM_CONVEX_DOUBLE_ARC_SLOW,
    [(BACK_ANIM_CONCAVE_ARC_SMALL - 1) * 3] = ANIM_CONCAVE_ARC_SMALL_TWICE,
    ANIM_CONCAVE_ARC_SMALL,
    ANIM_CONCAVE_ARC_SMALL_SLOW,
    [(BACK_ANIM_DIP_RIGHT_SIDE - 1) * 3] = ANIM_H_DIP_TWICE,
    ANIM_H_DIP,
    ANIM_H_DIP_FAST,
    [(BACK_ANIM_SHRINK_GROW_VIBRATE - 1) * 3] = ANIM_SHRINK_GROW_VIBRATE_FAST,
    ANIM_SHRINK_GROW_VIBRATE,
    ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [(BACK_ANIM_JOLT_RIGHT - 1) * 3] = ANIM_JOLT_RIGHT_FAST,
    ANIM_JOLT_RIGHT,
    ...
    [(BACK_ANIM_SHAKE_GLOW_RED - 1) * 3] = ANIM_SHAKE_GLOW_RED_FAST,
    ANIM_SHAKE_GLOW_RED,
    ANIM_SHAKE_GLOW_RED_SLOW,
    [(BACK_ANIM_SHAKE_GLOW_GREEN - 1) * 3] = ANIM_SHAKE_GLOW_GREEN_FAST,
    ANIM_SHAKE_GLOW_GREEN,
    ANIM_SHAKE_GLOW_GREEN_SLOW,
    [(BACK_ANIM_SHAKE_GLOW_BLUE - 1) * 3] = ANIM_SHAKE_GLOW_BLUE_FAST,
    ANIM_SHAKE_GLOW_BLUE,
    ANIM_SHAKE_GLOW_BLUE_SLOW,
};

static const u8 sBackAnimNatureModTable[NUM_NATURES] = {
    [NATURE_HARDY] = 0,   [NATURE_LONELY] = 2,  [NATURE_BRAVE] = 0,
    [NATURE_ADAMANT] = 0, [NATURE_NAUGHTY] = 0, [NATURE_BOLD] = 1,
    [NATURE_DOCILE] = 1,  [NATURE_RELAXED] = 1, [NATURE_IMPISH] = 0,
    [NATURE_LAX] = 1,     [NATURE_TIMID] = 2,   [NATURE_HASTY] = 0,
    [NATURE_SERIOUS] = 1, [NATURE_JOLLY] = 0,   [NATURE_NAIVE] = 0,
    [NATURE_MODEST] = 2,  [NATURE_MILD] = 2,    [NATURE_QUIET] = 2,
    [NATURE_BASHFUL] = 2, [NATURE_RASH] = 1,    [NATURE_CALM] = 1,
    [NATURE_GENTLE] = 2,  [NATURE_SASSY] = 1,   [NATURE_CAREFUL] = 2,
    [NATURE_QUIRKY] = 1,
};
...
static const union AffineAnimCmd *const sMonAffineAnims[] = {sMonAffineAnim_0,
                                                             sMonAffineAnim_1};

static void MonAnimDummySpriteCallback(struct Sprite *sprite) {}

static void SetPosForRotation(struct Sprite *sprite, u16 index, s16 amplitudeX,
                              s16 amplitudeY) {
  s16 xAdder, yAdder;
...
#define ANIM_SPRITE(taskId)                                                    \
  ((struct Sprite *)((gTasks[taskId].tPtrHi << 16) |                           \
                     ((u16)gTasks[taskId].tPtrLo)))
...
static void SetAffineData(struct Sprite *sprite, s16 xScale, s16 yScale,
                          u16 rotation) {
  u8 matrixNum;
...
static void HandleSetAffineData(struct Sprite *sprite, s16 xScale, s16 yScale,
                                u16 rotation) {
  if (!sprite->sDontFlip) {
    xScale *= -1;
    rotation *= -1;
...
static void ResetSpriteAfterAnim(struct Sprite *sprite) {
  ...
  if (sIsSummaryAnim == TRUE) {
    ...
    // FIX: Reset these back to normal after they were changed so Poké Ball
    // catch/release animations without a screen transition in between don't
    // break
...
static void BounceRotateToSides(struct Sprite *sprite) {
  ...
  r10 =
      sBounceRotateToSidesData[sAnims[structId].data][sprite->data[4]][1] - r9;
  ...
  if (sBounceRotateToSidesData[arrId][sprite->data[4]][2] == 0) {
    ...
    sprite->y2 = -(Sin(
        r7 * 128 / sBounceRotateToSidesData[arrId][sprite->data[4]][2], 10));
    sprite->x2 =
        (r10 * r7 / sBounceRotateToSidesData[arrId][sprite->data[4]][2]) + r9;
...
static void Anim_GlowRed(struct Sprite *sprite) { GlowColor(RGB_RED, 12, 2); }

static void Anim_GlowBlue(struct Sprite *sprite) { GlowColor(RGB_BLUE, 12, 2); }
...
static void DeepVerticalSquishBounce(struct Sprite *sprite) {
  if (sAnims[sprite->data[0]].delay != 0) {
    ...
    if (sprite->data[5] == 0) {
      ...
      HandleSetAffineData(sprite, 256 - sprite->data[6], 256 + sprite->data[7],
                          0);
...
// Very similar in appearance to Anim_VerticalShakeTwice (especially the fast
// variant), but deeper
static void Anim_VerticalShakeLowTwice(struct Sprite *sprite) {
  sprite->data[0] = 40;
  sprite->data[7] = 6;
...
static void TriangleDown(struct Sprite *sprite) {
  ...
  if (sTriangleDownData[sprite->data[3]][2] / sprite->data[5] ==
      sprite->data[2]) {
    sprite->data[3]++;
    sprite->data[2] = 0;
  }
  ...
  if (sTriangleDownData[sprite->data[3]][2] / sprite->data[5] == 0) {
    ...
    sprite->y2 +=
        (sTriangleDownData[sprite->data[3]][1] *
         sprite->data[5]); // Not using amplitude here. No reason for this.
    sprite->data[2]++;
    TryFlipX(sprite);
  }
}
...
static void ShrinkGrowVibrate(struct Sprite *sprite) {
  if (sprite->data[2] > sprite->data[7]) {
    ...
    u16 y;
    s16 index =
        ((u16)(sprite->data[2] % sprite->data[6] * 256) / sprite->data[6]) %
        256;
    if (sprite->data[2] % 2 == 0) {
      sprite->data[4] = Sin(index, 32) + 256;
      sprite->data[5] = Sin(index, 32) + 256;
...
static const struct YellowFlashData sShakeYellowFlashData_Fast[] = {
    {FALSE, 1}, {TRUE, 2},   {FALSE, 15}, {TRUE, 1},  {FALSE, 15},
    {TRUE, 1},  {FALSE, 15}, {TRUE, 1},   {FALSE, 1}, {TRUE, 1},
...
static const struct YellowFlashData sShakeYellowFlashData_Slow[] = {
    {FALSE, 1}, {TRUE, 1},   {FALSE, 20}, {TRUE, 1},  {FALSE, 20},
    {TRUE, 1},  {FALSE, 20}, {TRUE, 1},   {FALSE, 1}, {FALSE, -1}};

static const struct YellowFlashData *const sShakeYellowFlashData[] = {
    sShakeYellowFlashData_Fast, sShakeYellowFlashData_Normal,
...
enum { SHAKEGLOW_RED, SHAKEGLOW_GREEN, SHAKEGLOW_BLUE, SHAKEGLOW_BLACK };

static void ShakeGlow_Blend(struct Sprite *sprite) {
  static const u16 sColors[] = {[SHAKEGLOW_RED] = RGB_RED,
  ...
  if (sprite->data[2] > 127) {
    ...
    BlendPalette(sprite->data[7], 16, sprite->data[6],
                 sColors[sprite->data[1]]);
  }
}
...
static void ShakeGlow_Move(struct Sprite *sprite) {
  if (sprite->data[3] < sprite->data[4]) {
    ...
    if (sprite->data[5] > sprite->data[0]) {
      ...
      sprite->x2 =
          sign * Sin((sprite->data[5] * 384 / sprite->data[0]) % 256, 6);
      sprite->data[5]++;
    }
