...
// unused
void InitMirageRnd(void) { SetMirageRnd((Random() << 16) | Random()); }
...
void WaitWeather(void) { CreateTask(Task_WaitWeather, 80); }

void InitBirchState(void) { *GetVarPointer(VAR_BIRCH_STATE) = 0; }
