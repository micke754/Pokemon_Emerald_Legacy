...
void *const gMPlayJumpTableTemplate[] = {
    ...
    SampleFreqSet, TrackStop, FadeOutBody, TrkVolPitSet, RealClearChain,
    SoundMainBTM,
};
...
const XcmdFunc gXcmdTable[] = {
    ply_xxx,   ply_xwave, ply_xtype,   ply_xxx,     ply_xatta,
    ply_xdeca, ply_xsust, ply_xrele,   ply_xiecv,   ply_xiecl,
    ply_xleng, ply_xswee, ply_xcmd_0C, ply_xcmd_0D,
};
