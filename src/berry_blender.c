...
#define ARROW_FALL_ROTATION                                                    \
  0x5800 // The amount the arrow spins as it falls in at the start
...
static bool32 TryAddContestLinkTvShow(struct Pokeblock *,
                                      struct TvBlenderStruct *);
...
static const u16 sBlenderCenter_Pal[] =
    INCBIN_U16("graphics/berry_blender/center.gbapal");
static const u8 sBlenderCenter_Tilemap[] =
    INCBIN_U8("graphics/berry_blender/center_map.bin");
static const u16 sBlenderOuter_Pal[] =
    INCBIN_U16("graphics/berry_blender/outer.gbapal");

static const u16 sUnused_Pal[] =
    INCBIN_U16("graphics/berry_blender/unused.gbapal");
...
static const u8 *const sBlenderOpponentsNames[] = {
    [BLENDER_MISTER] = sText_Mister, [BLENDER_LADDIE] = sText_Laddie,
    [BLENDER_LASSIE] = sText_Lassie, [BLENDER_MASTER] = sText_Master,
    [BLENDER_DUDE] = sText_Dude,     [BLENDER_MISS] = sText_Miss};
...
static const u8 sText_WouldLikeToBlendAnotherBerry[] =
    _("Would you like to blend another BERRY?");
static const u8 sText_RunOutOfBerriesForBlending[] =
    _("You've run out of BERRIES for\nblending in the BERRY BLENDER.\p");
static const u8 sText_YourPokeblockCaseIsFull[] =
    _("Your {POKEBLOCK} CASE is full.\p");
static const u8 sText_HasNoBerriesToPut[] =
    _(" has no BERRIES to put in\nthe BERRY BLENDER.");
static const u8 sText_ApostropheSPokeblockCaseIsFull[] =
    _("'s {POKEBLOCK} CASE is full.\p");
...
static const union AnimCmd sAnim_PlayerArrow_TopLeft[] = {
    ANIMCMD_FRAME(16, 5, .vFlip = TRUE, .hFlip = TRUE), ANIMCMD_END};
...
static const union AnimCmd sAnim_PlayerArrow_TopRight_Flash[] = {
    ANIMCMD_FRAME(48, 2, .vFlip = TRUE), ANIMCMD_FRAME(32, 5, .vFlip = TRUE),
    ANIMCMD_FRAME(48, 3, .vFlip = TRUE), ANIMCMD_FRAME(16, 5, .vFlip = TRUE),
    ANIMCMD_END};

static const union AnimCmd sAnim_PlayerArrow_BottomLeft_Flash[] = {
    ANIMCMD_FRAME(48, 2, .hFlip = TRUE), ANIMCMD_FRAME(32, 5, .hFlip = TRUE),
    ANIMCMD_FRAME(48, 3, .hFlip = TRUE), ANIMCMD_FRAME(16, 5, .hFlip = TRUE),
    ANIMCMD_END};

static const union AnimCmd sAnim_PlayerArrow_BottomRight_Flash[] = {
    ANIMCMD_FRAME(48, 2, 0, 0), ANIMCMD_FRAME(32, 5, 0, 0),
    ANIMCMD_FRAME(48, 3, 0, 0), ANIMCMD_FRAME(16, 5, 0, 0), ANIMCMD_END};
...
static const union AnimCmd sAnim_PlayerArrow_TopRight_Off[] = {
    ANIMCMD_FRAME(0, 5, .vFlip = TRUE), ANIMCMD_END};
...
static const union AnimCmd sAnim_PlayerArrow_BottomRight_Off[] = {
    ANIMCMD_FRAME(0, 5, 0, 0), ANIMCMD_END};

static const union AnimCmd *const sAnims_PlayerArrow[] = {
    sAnim_PlayerArrow_TopLeft,          sAnim_PlayerArrow_TopRight,
    sAnim_PlayerArrow_BottomLeft,       sAnim_PlayerArrow_BottomRight,
    sAnim_PlayerArrow_TopLeft_Flash,    sAnim_PlayerArrow_TopRight_Flash,
    sAnim_PlayerArrow_BottomLeft_Flash, sAnim_PlayerArrow_BottomRight_Flash,
    sAnim_PlayerArrow_TopLeft_Off,      sAnim_PlayerArrow_TopRight_Off,
    sAnim_PlayerArrow_BottomLeft_Off,   sAnim_PlayerArrow_BottomRight_Off};
...
static const union AnimCmd sAnim_ScoreSymbols_Good[] = {ANIMCMD_FRAME(0, 20),
                                                        ANIMCMD_END};

static const union AnimCmd sAnim_ScoreSymbols_Miss[] = {
    ANIMCMD_FRAME(4, 20, 1, 0), ANIMCMD_END};

static const union AnimCmd sAnim_ScoreSymbols_BestFlash[] = {
    ANIMCMD_FRAME(8, 4),  ANIMCMD_FRAME(12, 4), ANIMCMD_FRAME(8, 4),
    ANIMCMD_FRAME(12, 4), ANIMCMD_FRAME(8, 4),  ANIMCMD_END};
...
static const union AnimCmd sAnim_SparkleCrossToX[] = {
    ANIMCMD_FRAME(0, 3), ANIMCMD_FRAME(1, 4), ANIMCMD_FRAME(3, 5),
    ANIMCMD_FRAME(1, 4), ANIMCMD_FRAME(0, 3), ANIMCMD_END};

static const union AnimCmd sAnim_SparkleXToCross[] = {
    ANIMCMD_FRAME(0, 3), ANIMCMD_FRAME(2, 4), ANIMCMD_FRAME(4, 5),
    ANIMCMD_FRAME(2, 4), ANIMCMD_FRAME(0, 3), ANIMCMD_END};

static const union AnimCmd sAnim_SparkleFull[] = {
    ANIMCMD_FRAME(0, 2), ANIMCMD_FRAME(1, 2), ANIMCMD_FRAME(2, 2),
    ANIMCMD_FRAME(4, 4), ANIMCMD_FRAME(3, 3), ANIMCMD_FRAME(2, 2),
    ANIMCMD_FRAME(1, 2), ANIMCMD_FRAME(0, 2), ANIMCMD_END};

static const union AnimCmd sAnim_GreenArrow[] = {ANIMCMD_FRAME(5, 5, 1, 1),
                                                 ANIMCMD_END};

static const union AnimCmd sAnim_GreenDot[] = {ANIMCMD_FRAME(6, 5, 1, 1),
                                               ANIMCMD_END};
...
static const union AnimCmd sAnim_CountdownNumbers_3[] = {ANIMCMD_FRAME(32, 30),
                                                         ANIMCMD_END};

static const union AnimCmd sAnim_CountdownNumbers_2[] = {ANIMCMD_FRAME(16, 30),
                                                         ANIMCMD_END};

static const union AnimCmd sAnim_CountdownNumbers_1[] = {ANIMCMD_FRAME(0, 30),
                                                         ANIMCMD_END};
...
static const struct SpriteSheet sSpriteSheet_Start = {gBerryBlenderStart_Gfx,
                                                      0x400, GFXTAG_START};
...
// If the player's berry is one of the 5 possible berries, a set is chosen that
// excludes it
static const u8 sOpponentBerrySets[NUM_NPC_BERRIES * 2][3] = {
    ...
    // These sets are used if the player chose a different berry (set is
    // selected by player's berry % 5)
...
// Berry master's berries follow the same rules as above, but instead of
// explicitly listing the alternate sets if the player chooses one of these
// berries, it implicitly uses these berries + 5
...
static void UpdateHitPitch(void) {
  m4aMPlayPitchControl(&gMPlayInfo_SE2, TRACKS_ALL,
                       2 * (sBerryBlender->speed - MIN_ARROW_SPEED));
}

static void VBlankCB_BerryBlender(void) {
  SetBgPos();
  SetBgAffine(2, sBerryBlender->bgAffineSrc.texX,
              sBerryBlender->bgAffineSrc.texY, sBerryBlender->bgAffineSrc.scrX,
              sBerryBlender->bgAffineSrc.scrY, sBerryBlender->bgAffineSrc.sx,
              sBerryBlender->bgAffineSrc.sy, sBerryBlender->bgAffineSrc.alpha);
  LoadOam();
...
static bool8 LoadBerryBlenderGfx(void) {
  ...
  case 0:
    sBerryBlender->tilesBuffer =
        AllocZeroed(GetDecompressedDataSize(gBerryBlenderCenter_Gfx) + 100);
  ...
  case 1:
    ...
    break;
  case 2:
    LoadBgTiles(2, sBerryBlender->tilesBuffer,
                GetDecompressedDataSize(gBerryBlenderCenter_Gfx), 0);
    sBerryBlender->loadGfxState++;
    break;
  case 3:
    ...
    break;
  case 4:
    LoadBgTiles(1, sBerryBlender->tilesBuffer,
                GetDecompressedDataSize(gBerryBlenderOuter_Gfx), 0);
    sBerryBlender->loadGfxState++;
    break;
  case 5:
    ...
    break;
  case 6:
    CopyToBgTilemapBuffer(1, sBerryBlender->tilesBuffer,
                          GetDecompressedDataSize(gBerryBlenderOuter_Tilemap),
                          0);
...
static void DrawBlenderBg(void) {
  FillBgTilemapBufferRect_Palette0(0, 0, 0, 0, DISPLAY_TILE_WIDTH,
                                   DISPLAY_TILE_HEIGHT);
...
static void InitBerryBlenderWindows(void) {
  if (InitWindows(sWindowTemplates)) {
    ...
    // Initialize only the main text windows (player names and message box;
    // excludes results screen)
...
static void CB2_LoadBerryBlender(void) {
    ...
    if (LoadBerryBlenderGfx()) {
      for (i = 0; i < BLENDER_MAX_PLAYERS; i++) {
        sBerryBlender->playerArrowSpriteIds[i] =
            CreateSprite(&sSpriteTemplate_PlayerArrow, sPlayerArrowPos[i][0],
                         sPlayerArrowPos[i][1], 1);
        StartSpriteAnim(&gSprites[sBerryBlender->playerArrowSpriteIds[i]],
                        i + 8);
      }
  ...
  case 3:
    ...
    break;
  case 4:
    if (PrintMessage(&sBerryBlender->textState, sText_BerryBlenderStart,
...
static void SetBerrySpriteData(struct Sprite *sprite, s16 x, s16 y,
                               s16 bounceSpeed, s16 xSpeed, s16 ySpeed) {
  sprite->sTargetY = y;
  sprite->sX = x;
  sprite->sY = y;
...
static void CreateBerrySprite(u16 itemId, u8 playerId) {
  u8 spriteId =
      CreateSpinningBerrySprite(ITEM_TO_BERRY(itemId) - 1, 0, 80, playerId & 1);
  SetBerrySpriteData(
      &gSprites[spriteId], sBerrySpriteData[playerId][0],
      sBerrySpriteData[playerId][1], sBerrySpriteData[playerId][2],
      sBerrySpriteData[playerId][3], sBerrySpriteData[playerId][4]);
}
...
static void CB2_StartBlenderLink(void) {
  ...
  case 2:
    for (i = 0; i < BLENDER_MAX_PLAYERS; i++) {
      sBerryBlender->playerArrowSpriteIds2[i] =
          CreateSprite(&sSpriteTemplate_PlayerArrow, sPlayerArrowPos[i][0],
                       sPlayerArrowPos[i][1], 1);
      StartSpriteAnim(&gSprites[sBerryBlender->playerArrowSpriteIds2[i]],
                      i + 8);
    }
    if (gReceivedRemoteLinkPlayers && gWirelessCommType) {
      LoadWirelessStatusIndicatorSpriteGfx();
  ...
  case 8:
    ...
    ConvertItemToBlenderBerry(&sBerryBlender->blendedBerries[0],
                              gSpecialVar_ItemId);
    memcpy(gBlockSendBuffer, &sBerryBlender->blendedBerries[0],
    ...
    if (++sBerryBlender->framesToWait > 20) {
      ...
      if (GetBlockReceivedStatus() == GetLinkPlayerCountAsBitFlags()) {
        for (i = 0; i < GetLinkPlayerCount(); i++) {
          memcpy(&sBerryBlender->blendedBerries[i], &gBlockRecvBuffer[i][0],
                 sizeof(struct BlenderBerry));
  ...
  case 11:
    ...
    for (i = 0; i < BLENDER_MAX_PLAYERS; i++) {
      if (sBerryBlender->playerToThrowBerry ==
          sPlayerIdMap[sBerryBlender->numPlayers - 2][i]) {
        CreateBerrySprite(
            sBerryBlender->chosenItemId[sBerryBlender->playerToThrowBerry], i);
        break;
      }
    }
    ...
    if (++sBerryBlender->framesToWait > 60) {
      if (sBerryBlender->playerToThrowBerry >= sBerryBlender->numPlayers) {
        ...
        sBerryBlender->arrowPos =
            sArrowStartPos[sArrowStartPosIds[sBerryBlender->numPlayers - 2]] -
            ARROW_FALL_ROTATION;
      } else {
...
static void SetOpponentsBerryData(u16 playerBerryItemId, u8 playersNum,
                                  struct BlenderBerry *playerBerry) {
  u16 opponentSetId = 0;
  u16 opponentBerryId;
  u16 berryMasterDiff;
  u16 i;
  ...
  for (i = 0; i < playersNum - 1; i++) {
    ...
    berryMasterDiff =
        ITEM_TO_BERRY(playerBerryItemId) - ITEM_TO_BERRY(ITEM_SPELON_BERRY);
    if (!FlagGet(FLAG_HIDE_LILYCOVE_CONTEST_HALL_BLEND_MASTER) &&
  ...
  for (i = 0; i < BLENDER_MAX_PLAYERS; i++) {
    if (sBerryBlender->arrowIdToPlayerId[i] != NO_PLAYER) {
      sBerryBlender->playerArrowSpriteIds[sBerryBlender->arrowIdToPlayerId[i]] =
          sBerryBlender->playerArrowSpriteIds2[i];
      StartSpriteAnim(&gSprites[sBerryBlender->playerArrowSpriteIds
                                    [sBerryBlender->arrowIdToPlayerId[i]]],
                      i);
      ...
      if (playerId == sBerryBlender->arrowIdToPlayerId[i])
        Blender_AddTextPrinter(i, text, xPos, 1, 0,
                               2); // Highlight player's name in red
      else
...
static void CB2_StartBlenderLocal(void) {
  ...
  case 0:
    ...
    ConvertItemToBlenderBerry(&sBerryBlender->blendedBerries[0],
                              gSpecialVar_ItemId);
    SetOpponentsBerryData(gSpecialVar_ItemId, sBerryBlender->numPlayers,
                          &sBerryBlender->blendedBerries[0]);
    ...
    if (gSpecialVar_0x8004 == 1) {
      if (!FlagGet(FLAG_HIDE_LILYCOVE_CONTEST_HALL_BLEND_MASTER))
        sBerryBlender->opponentTaskIds[0] =
            CreateTask(Task_HandleBerryMaster, 10);
      else
        sBerryBlender->opponentTaskIds[0] =
            CreateTask(sLocalOpponentTasks[0], 10);
    }

    if (gSpecialVar_0x8004 > 1) {
      for (i = 0; i < gSpecialVar_0x8004; i++)
        sBerryBlender->opponentTaskIds[i] =
            CreateTask(sLocalOpponentTasks[i], 10 + i);
    }
...
static void Task_OpponentMiss(u8 taskId) {
  if (++gTasks[taskId].tTimer > gTasks[taskId].tDelay) {
    gRecvCmds[gTasks[taskId].tPlayerId][BLENDER_COMM_SCORE] =
...
static void Task_HandleOpponent2(u8 taskId) {
  ...
  if ((var1 >> 8) > sArrowHitRangeStart[arrowId] + 20 &&
      (var1 >> 8) < sArrowHitRangeStart[arrowId] + 40) {
    if (!gTasks[taskId].tDidInput) {
      if (!sBerryBlender->perfectOpponents) {
        u8 rand = Random() / 655;
        if (sBerryBlender->speed < 500) {
...
static void UpdateSpeedFromHit(u16 cmd) {
  ...
  case LINKCMD_BLENDER_SCORE_BEST:
    if (sBerryBlender->speed < 1500) {
      sBerryBlender->speed +=
          (384 / sNumPlayersToSpeedDivisor[sBerryBlender->numPlayers]);
    } else {
      sBerryBlender->speed +=
          (128 / sNumPlayersToSpeedDivisor[sBerryBlender->numPlayers]);
      ShakeBgCoordForHit(&sBerryBlender->bg_X,
                         (sBerryBlender->speed / 100) - 10);
      ShakeBgCoordForHit(&sBerryBlender->bg_Y,
                         (sBerryBlender->speed / 100) - 10);
    }
    break;
  case LINKCMD_BLENDER_SCORE_GOOD:
    if (sBerryBlender->speed < 1500)
      sBerryBlender->speed +=
          (256 / sNumPlayersToSpeedDivisor[sBerryBlender->numPlayers]);
    break;
...
// Return TRUE if the received command matches the corresponding Link or RFU
// command
...
static void UpdateOpponentScores(void) {
  ...
  for (i = 0; i < sBerryBlender->numPlayers; i++) {
    if (CheckRecvCmdMatches(gRecvCmds[i][BLENDER_COMM_INPUT_STATE],
      ...
      } else if (gRecvCmds[i][BLENDER_COMM_SCORE] ==
      ...
      if (gRecvCmds[i][BLENDER_COMM_SCORE] == LINKCMD_BLENDER_SCORE_MISS ||
        ...
        if (sBerryBlender->speed > 1500)
          m4aMPlayTempoControl(&gMPlayInfo_BGM,
                               ((sBerryBlender->speed - 750) / 20) + 256);
        else
...
static void HandlePlayerInput(void) {
  ...
  if (sBerryBlender->gameEndState == 0) {
    ...
    if (pressedA) {
      u8 proximity;
      StartSpriteAnim(
          &gSprites[sBerryBlender->playerArrowSpriteIds
...
static void CB2_PlayBlender(void) {
  ...
  if (sBerryBlender->gameFrameTime <
      (99 * 60 * 60) + (59 * 60)) // game time can't be longer than 99 minutes
                                  // and 59 seconds, can't print 3 digits
    sBerryBlender->gameFrameTime++;

  HandlePlayerInput();
  SetLinkDebugValues((u16)(sBerryBlender->speed),
                     sBerryBlender->progressBarValue);
...
static bool8 AreBlenderBerriesSame(struct BlenderBerry *berries, u8 a, u8 b) {
  // First check to itemId is pointless (and wrong anyway?), always false when
  // this is called Only used to determine if two enigma berries are equivalent
  if (berries[a].itemId != berries[b].itemId ||
      (StringCompare(berries[a].name, berries[b].name) == 0 &&
       (berries[a].flavors[FLAVOR_SPICY] == berries[b].flavors[FLAVOR_SPICY] &&
        ...
        berries[a].flavors[FLAVOR_BITTER] ==
            berries[b].flavors[FLAVOR_BITTER] &&
...
static u32 CalculatePokeblockColor(struct BlenderBerry *berries, s16 *_flavors,
                                   u8 numPlayers, u8 negativeFlavors) {
  ...
  for (i = 0; i < numPlayers; i++) {
    for (j = 0; j < numPlayers; j++) {
      if (berries[i].itemId == berries[j].itemId && i != j &&
          (berries[i].itemId != ITEM_ENIGMA_BERRY ||
  ...
  if (numFlavors == 2) {
    ...
    // The weaker flavor is returned in the upper 16 bits, but this is ignored
    // in the color assignment
    if (flavors[sPokeblockPresentFlavors[0]] >=
        flavors[sPokeblockPresentFlavors[1]]) {
...
static void Debug_SetMaxRPMStage(s16 value) { sDebug_MaxRPMStage = value; }

static s16 UNUSED Debug_GetMaxRPMStage(void) { return sDebug_MaxRPMStage; }

static void Debug_SetGameTimeStage(s16 value) { sDebug_GameTimeStage = value; }

static s16 UNUSED Debug_GetGameTimeStage(void) { return sDebug_GameTimeStage; }

static void CalculatePokeblock(struct BlenderBerry *berries,
                               struct Pokeblock *pokeblock, u8 numPlayers,
  ...
  // Subtract the number of negative flavor totals from each positive total
  ...
  pokeblock->color = CalculatePokeblockColor(berries, &sPokeblockFlavors[0],
                                             numPlayers, numNegatives);
  sPokeblockFlavors[FLAVOR_COUNT] =
      (sPokeblockFlavors[FLAVOR_COUNT] / numPlayers) - numPlayers;
...
static void UNUSED Debug_CalculatePokeblock(struct BlenderBerry *berries,
                                            struct Pokeblock *pokeblock,
                                            u8 numPlayers, u8 *flavors,
                                            u16 maxRPM) {
...
static void CB2_EndBlenderGame(void) {
  ...
  case 3:
    if (GetMultiplayerId() != 0) {
      ...
      if (gReceivedRemoteLinkPlayers && gWirelessCommType) {
        ...
        if (SendBlock(0, &sBerryBlender->gameBlock,
                      sizeof(sBerryBlender->gameBlock)))
          sBerryBlender->gameEndState++;
      } else {
        sBerryBlender->smallBlock.time = sBerryBlender->gameFrameTime;
        sBerryBlender->smallBlock.maxRPM = sBerryBlender->maxRPM;
        if (SendBlock(0, &sBerryBlender->smallBlock,
                      sizeof(sBerryBlender->smallBlock) + 32))
          sBerryBlender->gameEndState++;
      }
    }
    break;
  case 4:
    if (GetBlockReceivedStatus()) {
      ...
      if (gReceivedRemoteLinkPlayers && gWirelessCommType) {
        ...
        struct TimeAndRPM *receivedBlock =
            (struct TimeAndRPM *)(&gBlockRecvBuffer);
  ...
  case 6:
    ...
    break;
  case 7:
    if (PrintMessage(&sBerryBlender->textState,
  ...
  case 8:
    ...
    break;
  case 13:
    if (PrintMessage(&sBerryBlender->textState, sText_CommunicationStandby,
                     GetPlayerTextSpeedDelay())) {
...
static void CB2_CheckPlayAgainLink(void) {
  ...
  case 0:
    if (sBerryBlender->playerContinueResponses[0] == LINKCMD_SEND_LINK_TYPE) {
      ...
      sBerryBlender->gameEndState = 5;
    } else if (sBerryBlender->playerContinueResponses[0] ==
               LINKCMD_BLENDER_STOP) {
      ...
      else if (sBerryBlender->canceledPlayerCmd ==
  ...
  case 2:
    ...
    break;
  case 3:
    if (PrintMessage(&sBerryBlender->textState, gStringVar4,
                     GetPlayerTextSpeedDelay())) {
      sBerryBlender->framesToWait = 0;
      sBerryBlender->gameEndState++;
    }
...
static void ProcessLinkPlayerCmds(void) {
  if (gReceivedRemoteLinkPlayers) {
    if (CheckRecvCmdMatches(gRecvCmds[0][BLENDER_COMM_INPUT_STATE],
                            LINKCMD_SEND_PACKET, RFUCMD_SEND_PACKET)) {
      if (gRecvCmds[0][BLENDER_COMM_RESP] == LINKCMD_BLENDER_STOP) {
        // Link leader has indicated play is stopping, read signal to determine
        // why
        ...
        case LINKCMD_CONT_BLOCK: // Someone selected "No" to continue playing
          ...
          sBerryBlender->canceledPlayerId =
              gRecvCmds[0][BLENDER_COMM_PLAYER_ID];
          break;
    ...
    // If player is link leader, check for responses to the "Continue playing"
    // prompt (even if it's not up yet)
    if (GetMultiplayerId() == 0 &&
        sBerryBlender->playerContinueResponses[0] != LINKCMD_BLENDER_STOP &&
        sBerryBlender->playerContinueResponses[0] != LINKCMD_SEND_LINK_TYPE) {
      u8 i;
      ...
      if (i == GetLinkPlayerCount()) {
        // Count players that decided to play again, stopping at first negative
        // response
        for (i = 0; i < GetLinkPlayerCount(); i++) {
          if (sBerryBlender->playerContinueResponses[i] !=
              LINKCMD_BLENDER_PLAY_AGAIN)
            break;
        }

        // Schedule signal to other players about whether or not play will
        // continue
        SendContinuePromptResponse(&gSendCmd[BLENDER_COMM_INPUT_STATE]);
        if (i == GetLinkPlayerCount()) {
          ...
          // At least 1 player decided to stop playing, or can't continue
          // playing
          gSendCmd[BLENDER_COMM_RESP] = LINKCMD_BLENDER_STOP;
          gSendCmd[BLENDER_COMM_STOP_TYPE] =
              sBerryBlender->playerContinueResponses[i];
...
u16 GetBlenderArrowPosition(void) { return sBerryBlender->arrowPos; }
...
static void UpdateBlenderCenter(void) {
  ...
  if (gWirelessCommType && gReceivedRemoteLinkPlayers) {
    if (playerId == 0) {
      ...
      if ((gRecvCmds[0][BLENDER_COMM_INPUT_STATE] & RFUCMD_MASK) ==
          RFUCMD_BLENDER_SEND_KEYS) {
        sBerryBlender->progressBarValue =
            gRecvCmds[0][BLENDER_COMM_PROGRESS_BAR];
...
static void UpdateProgressBar(u16 value, u16 limit) {
  ...
  // If progress bar between segments, fill with the corresponding partial
  // segment tiles
  ...
  // Essentially unnecessary, given that it starts empty and progress only goes
  // up
  for (; i < 8; i++) {
...
static void TryUpdateBerryBlenderRecord(void) {
  if (gSaveBlock1Ptr->berryBlenderRecords[sBerryBlender->numPlayers - 2] <
      sBerryBlender->maxRPM)
    gSaveBlock1Ptr->berryBlenderRecords[sBerryBlender->numPlayers - 2] =
        sBerryBlender->maxRPM;
}
...
static bool8 PrintBlendingResults(void) {
  ...
  case 3: {
    ...
    xPos =
        GetStringCenterAlignXOffset(FONT_NORMAL, sText_BlendingResults, 0xA8);
    Blender_AddTextPrinter(WIN_RESULTS, sText_BlendingResults, xPos, 1,
                           TEXT_SKIP_DRAW, 0);
    ...
    for (i = 0; i < sBerryBlender->numPlayers; yPos += 16, i++) {
      ...
      ConvertIntToDecimalStringN(sBerryBlender->stringVar, i + 1,
      ...
      Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, 8, yPos,
                             TEXT_SKIP_DRAW, 3);

      StringCopy(sBerryBlender->stringVar,
                 sBerryBlender->blendedBerries[place].name);
      ConvertInternationalString(sBerryBlender->stringVar,
                                 gLinkPlayers[place].language);
      StringAppend(sBerryBlender->stringVar, sText_SpaceBerry);
      Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, 0x54, yPos,
                             TEXT_SKIP_DRAW, 3);
    }

    Blender_AddTextPrinter(WIN_RESULTS, sText_MaximumSpeed, 0, 0x51,
                           TEXT_SKIP_DRAW, 3);
    ConvertIntToDecimalStringN(sBerryBlender->stringVar,
                               sBerryBlender->maxRPM / 100,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    StringAppend(sBerryBlender->stringVar, sText_Dot);

    ConvertIntToDecimalStringN(text, sBerryBlender->maxRPM % 100,
                               STR_CONV_MODE_LEADING_ZEROS, 2);
    StringAppend(sBerryBlender->stringVar, text);
    StringAppend(sBerryBlender->stringVar, sText_RPM);

    xPos =
        GetStringRightAlignXOffset(FONT_NORMAL, sBerryBlender->stringVar, 0xA8);
    Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, xPos, 0x51,
                           TEXT_SKIP_DRAW, 3);
    ...
    ConvertIntToDecimalStringN(sBerryBlender->stringVar, minutes,
                               STR_CONV_MODE_LEADING_ZEROS, 2);
    ...
    xPos =
        GetStringRightAlignXOffset(FONT_NORMAL, sBerryBlender->stringVar, 0xA8);
    Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, xPos, 0x61,
                           TEXT_SKIP_DRAW, 3);
  ...
  case 5:
    ...
    Debug_SetStageVars();
    CalculatePokeblock(sBerryBlender->blendedBerries, &pokeblock,
                       sBerryBlender->numPlayers, flavors,
                       sBerryBlender->maxRPM);
    ...
    break;
  case 6:
    if (PrintMessage(&sBerryBlender->textState, sBerryBlender->stringVar,
                     GetPlayerTextSpeedDelay())) {
...
static bool8 PrintBlendingRanking(void) {
  ...
  case 3:
    ...
    Blender_AddTextPrinter(WIN_RESULTS, sText_Ranking, xPos, 1, TEXT_SKIP_DRAW,
                           0);

    sBerryBlender->scoreIconIds[SCORE_BEST] =
        CreateSprite(&sSpriteTemplate_ScoreSymbols, 128, 52, 0);
    StartSpriteAnim(&gSprites[sBerryBlender->scoreIconIds[SCORE_BEST]],
                    SCOREANIM_BEST_STATIC);
    gSprites[sBerryBlender->scoreIconIds[SCORE_BEST]].callback =
        SpriteCallbackDummy;

    sBerryBlender->scoreIconIds[SCORE_GOOD] =
        CreateSprite(&sSpriteTemplate_ScoreSymbols, 160, 52, 0);
    // implicitly uses SCOREANIM_GOOD, no need to assign
    gSprites[sBerryBlender->scoreIconIds[SCORE_GOOD]].callback =
        SpriteCallbackDummy;

    sBerryBlender->scoreIconIds[SCORE_MISS] =
        CreateSprite(&sSpriteTemplate_ScoreSymbols, 192, 52, 0);
    StartSpriteAnim(&gSprites[sBerryBlender->scoreIconIds[SCORE_MISS]],
                    SCOREANIM_MISS);
    gSprites[sBerryBlender->scoreIconIds[SCORE_MISS]].callback =
        SpriteCallbackDummy;
    ...
    for (yPos = 41, i = 0; i < sBerryBlender->numPlayers; yPos += 16, i++) {
      ...
      StringAppend(sBerryBlender->stringVar, gText_Space);
      StringAppend(sBerryBlender->stringVar, gLinkPlayers[place].name);
      Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, 0, yPos,
                             TEXT_SKIP_DRAW, 3);

      ConvertIntToDecimalStringN(sBerryBlender->stringVar,
                                 sBerryBlender->scores[place][SCORE_BEST],
                                 STR_CONV_MODE_RIGHT_ALIGN, 3);
      Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, 78, yPos,
                             TEXT_SKIP_DRAW, 3);

      ConvertIntToDecimalStringN(sBerryBlender->stringVar,
                                 sBerryBlender->scores[place][SCORE_GOOD],
                                 STR_CONV_MODE_RIGHT_ALIGN, 3);
      Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, 78 + 32,
                             yPos, TEXT_SKIP_DRAW, 3);

      ConvertIntToDecimalStringN(sBerryBlender->stringVar,
                                 sBerryBlender->scores[place][SCORE_MISS],
                                 STR_CONV_MODE_RIGHT_ALIGN, 3);
      Blender_AddTextPrinter(WIN_RESULTS, sBerryBlender->stringVar, 78 + 64,
                             yPos, TEXT_SKIP_DRAW, 3);
    }
...
void ShowBerryBlenderRecordWindow(void) {
  ...
  xPos = GetStringCenterAlignXOffset(FONT_NORMAL, gText_BlenderMaxSpeedRecord,
                                     144);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL,
                              gText_BlenderMaxSpeedRecord, xPos, 1, 0, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_234Players,
                              4, 41, 0, NULL);
  ...
  for (i = 0, yPos = 41; i < NUM_SCORE_TYPES; i++) {
    ...
    txtPtr = ConvertIntToDecimalStringN(text, record / 100,
                                        STR_CONV_MODE_RIGHT_ALIGN, 3);
    txtPtr = StringAppend(txtPtr, sText_Dot);
    txtPtr = ConvertIntToDecimalStringN(txtPtr, record % 100,
                                        STR_CONV_MODE_LEADING_ZEROS, 2);
    txtPtr = StringAppend(txtPtr, sText_RPM);

    xPos = GetStringRightAlignXOffset(FONT_NORMAL, text, 140);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, text, xPos,
                                yPos + (i * 16), 0, NULL);
  }
...
static bool32 TryAddContestLinkTvShow(struct Pokeblock *pokeblock,
                                      struct TvBlenderStruct *tvBlender) {
  ...
  if (gReceivedRemoteLinkPlayers) {
    if (sBerryBlender->ownRanking == 0 && sheen > 20) {
      ...
      StringCopy(tvBlender->name,
                 gLinkPlayers[sBerryBlender
                                  ->playerPlaces[sBerryBlender->numPlayers - 1]]
                     .name);
      tvBlender->pokeblockFlavor = GetPokeblocksFlavor(pokeblock);
      if (Put3CheersForPokeblocksOnTheAir(
              tvBlender->name, tvBlender->pokeblockFlavor,
      ...
      StringCopy(tvBlender->name,
                 gLinkPlayers[sBerryBlender->playerPlaces[0]].name);
      tvBlender->pokeblockFlavor = GetPokeblocksFlavor(pokeblock);
      if (Put3CheersForPokeblocksOnTheAir(
              tvBlender->name, tvBlender->pokeblockFlavor,
              tvBlender->pokeblockColor, tvBlender->pokeblockSheen,
...
static void Blender_AddTextPrinter(u8 windowId, const u8 *string, u8 x, u8 y,
                                   s32 speed, s32 caseId) {
  u8 txtColor[3];
  u32 letterSpacing = 0;
  ...
  AddTextPrinterParameterized4(windowId, FONT_NORMAL, x, y, letterSpacing, 1,
                               txtColor, speed, string);
}
