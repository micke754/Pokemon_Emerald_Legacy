...
static void Task_DoClearSaveDataScreenYesNo(u8 taskId) {
  ...
  AddTextPrinterParameterized(0, FONT_NORMAL, gText_ClearAllSaveData, 0, 1, 0,
                              0);
...
static void VBlankCB(void) { TransferPlttBuffer(); }
...
static bool8 SetupClearSaveDataScreen(void) {
  ...
  default:
    ...
    InitBgsFromTemplates(0, sClearSaveBgTemplates,
                         ARRAY_COUNT(sClearSaveBgTemplates));
