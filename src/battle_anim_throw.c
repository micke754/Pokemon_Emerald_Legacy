...
static const struct CompressedSpriteSheet
    sBallParticleSpriteSheets[POKEBALL_COUNT] = {
        [BALL_POKE] = {gBattleAnimSpriteGfx_Particles, 0x100,
                       TAG_PARTICLES_POKEBALL},
        [BALL_GREAT] = {gBattleAnimSpriteGfx_Particles, 0x100,
                        TAG_PARTICLES_GREATBALL},
        [BALL_SAFARI] = {gBattleAnimSpriteGfx_Particles, 0x100,
                         TAG_PARTICLES_SAFARIBALL},
        [BALL_ULTRA] = {gBattleAnimSpriteGfx_Particles, 0x100,
                        TAG_PARTICLES_ULTRABALL},
        [BALL_MASTER] = {gBattleAnimSpriteGfx_Particles, 0x100,
                         TAG_PARTICLES_MASTERBALL},
        [BALL_NET] = {gBattleAnimSpriteGfx_Particles, 0x100,
                      TAG_PARTICLES_NETBALL},
        [BALL_DIVE] = {gBattleAnimSpriteGfx_Particles, 0x100,
                       TAG_PARTICLES_DIVEBALL},
        [BALL_NEST] = {gBattleAnimSpriteGfx_Particles, 0x100,
                       TAG_PARTICLES_NESTBALL},
        [BALL_REPEAT] = {gBattleAnimSpriteGfx_Particles, 0x100,
                         TAG_PARTICLES_REPEATBALL},
        [BALL_TIMER] = {gBattleAnimSpriteGfx_Particles, 0x100,
                        TAG_PARTICLES_TIMERBALL},
        [BALL_LUXURY] = {gBattleAnimSpriteGfx_Particles, 0x100,
                         TAG_PARTICLES_LUXURYBALL},
        [BALL_PREMIER] = {gBattleAnimSpriteGfx_Particles, 0x100,
                          TAG_PARTICLES_PREMIERBALL},
};

static const struct CompressedSpritePalette
    sBallParticlePalettes[POKEBALL_COUNT] = {
        [BALL_POKE] = {gBattleAnimSpritePal_CircleImpact,
                       TAG_PARTICLES_POKEBALL},
        [BALL_GREAT] = {gBattleAnimSpritePal_CircleImpact,
                        TAG_PARTICLES_GREATBALL},
        [BALL_SAFARI] = {gBattleAnimSpritePal_CircleImpact,
                         TAG_PARTICLES_SAFARIBALL},
        [BALL_ULTRA] = {gBattleAnimSpritePal_CircleImpact,
                        TAG_PARTICLES_ULTRABALL},
        [BALL_MASTER] = {gBattleAnimSpritePal_CircleImpact,
                         TAG_PARTICLES_MASTERBALL},
        [BALL_NET] = {gBattleAnimSpritePal_CircleImpact, TAG_PARTICLES_NETBALL},
        [BALL_DIVE] = {gBattleAnimSpritePal_CircleImpact,
                       TAG_PARTICLES_DIVEBALL},
        [BALL_NEST] = {gBattleAnimSpritePal_CircleImpact,
                       TAG_PARTICLES_NESTBALL},
        [BALL_REPEAT] = {gBattleAnimSpritePal_CircleImpact,
                         TAG_PARTICLES_REPEATBALL},
        [BALL_TIMER] = {gBattleAnimSpritePal_CircleImpact,
                        TAG_PARTICLES_TIMERBALL},
        [BALL_LUXURY] = {gBattleAnimSpritePal_CircleImpact,
                         TAG_PARTICLES_LUXURYBALL},
        [BALL_PREMIER] = {gBattleAnimSpritePal_CircleImpact,
                          TAG_PARTICLES_PREMIERBALL},
};

static const union AnimCmd sAnim_RegularBall[] = {
    ANIMCMD_FRAME(0, 1), ANIMCMD_FRAME(1, 1),
    ANIMCMD_FRAME(2, 1), ANIMCMD_FRAME(0, 1, .hFlip = TRUE),
    ANIMCMD_FRAME(2, 1), ANIMCMD_FRAME(1, 1),
    ANIMCMD_JUMP(0),
};
...
static const union AnimCmd *const sAnims_BallParticles[] = {
    sAnim_RegularBall, sAnim_MasterBall,        sAnim_NetDiveBall,
    sAnim_NestBall,    sAnim_LuxuryPremierBall, sAnim_UltraRepeatTimerBall,
};

static const u8 sBallParticleAnimNums[POKEBALL_COUNT] = {
    [BALL_POKE] = 0,   [BALL_GREAT] = 0, [BALL_SAFARI] = 0, [BALL_ULTRA] = 5,
    [BALL_MASTER] = 1, [BALL_NET] = 2,   [BALL_DIVE] = 2,   [BALL_NEST] = 3,
    [BALL_REPEAT] = 5, [BALL_TIMER] = 5, [BALL_LUXURY] = 4, [BALL_PREMIER] = 4,
};
...
static const struct SpriteTemplate
    sBallParticleSpriteTemplates[POKEBALL_COUNT] = {
        [BALL_POKE] =
            {
...
void AnimTask_UnusedLevelUpHealthBox(u8 taskId) {
  ...
  SetGpuReg(REG_OFFSET_WINOUT, WINOUT_WIN01_BG0 | WINOUT_WIN01_BG2 |
  ...
  AnimLoadCompressedBgGfx(animBgData.bgId, UnusedLevelupAnimationGfx,
                          animBgData.tilesOffset);
  LoadCompressedPalette(gCureBubblesPal, BG_PLTT_ID(animBgData.paletteId),
                        PLTT_SIZE_4BPP);
  ...
  case 0:
    if (gTasks[taskId].data[11]++ > 1) {
      ...
      SetGpuReg(REG_OFFSET_BLDALPHA,
                BLDALPHA_BLEND(gTasks[taskId].data[12],
                               16 - gTasks[taskId].data[12]));
...
static void LoadHealthboxPalsForLevelUp(u8 *paletteId1, u8 *paletteId2,
                                        u8 battler) {
  u8 healthBoxSpriteId;
  u8 spriteId1, spriteId2;
  u16 offset1, offset2;
  ...
  *paletteId2 = AllocSpritePalette(TAG_HEALTHBOX_PALS_2);
  ...
  LoadPalette(&gPlttBufferUnfaded[offset1], OBJ_PLTT_ID(*paletteId1),
              PLTT_SIZE_4BPP);
  LoadPalette(&gPlttBufferUnfaded[offset2], OBJ_PLTT_ID(*paletteId2),
              PLTT_SIZE_4BPP);
...
static void AnimTask_FlashHealthboxOnLevelUp_Step(u8 taskId) {
  ...
  if (gTasks[taskId].data[0]++ >= gTasks[taskId].data[11]) {
    ...
    case 0:
      ...
      BlendPalette(paletteOffset + colorOffset, 1, gTasks[taskId].data[2],
                   RGB(20, 27, 31));
      if (gTasks[taskId].data[2] == 16)
...
void AnimTask_SwitchOutShrinkMon(u8 taskId) {
  ...
  case 1:
    ...
    SetSpriteRotScale(spriteId, gTasks[taskId].data[10],
...
void AnimTask_SwitchOutBallEffect(u8 taskId) {
  ...
  if (GetBattlerSide(gBattleAnimAttacker) == B_SIDE_PLAYER)
    ball = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gBattleAnimAttacker]],
                      MON_DATA_POKEBALL);
  else
    ball = GetMonData(&gEnemyParty[gBattlerPartyIndexes[gBattleAnimAttacker]],
                      MON_DATA_POKEBALL);
...
void AnimTask_ThrowBall(u8 taskId) {
  ...
  gSprites[spriteId].sTargetX =
      GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X);
  gSprites[spriteId].sTargetY =
...
void AnimTask_ThrowBall_StandingTrainer(u8 taskId) {
  ...
  subpriority = GetBattlerSpriteSubpriority(
                ...
                1;
  spriteId =
      CreateSprite(&gBallSpriteTemplates[ballId], x + 32, y | 80, subpriority);
  gSprites[spriteId].sDuration = 34;
  gSprites[spriteId].sTargetX =
      GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X);
  gSprites[spriteId].sTargetY =
  ...
  gSprites[gBattlerSpriteIds[GetBattlerAtPosition(B_POSITION_PLAYER_LEFT)]]
      .callback = SpriteCB_TrainerThrowObject;
  gTasks[taskId].tSpriteId = spriteId;
  gTasks[taskId].func = AnimTask_ThrowBall_StandingTrainer_Step;
}

static void AnimTask_ThrowBall_StandingTrainer_Step(u8 taskId) {
  if (gSprites[gBattlerSpriteIds[GetBattlerAtPosition(B_POSITION_PLAYER_LEFT)]]
          .animCmdIndex == 1) {
...
static void Task_PlayerThrow_Wait(u8 taskId) {
  if (gSprites[gBattlerSpriteIds[GetBattlerAtPosition(B_POSITION_PLAYER_LEFT)]]
          .animEnded) {
    StartSpriteAnim(&gSprites[gBattlerSpriteIds[GetBattlerAtPosition(
...
static void SpriteCB_Ball_MonShrink_Step(struct Sprite *sprite) {
  ...
  case MON_SHRINK:
    ...
    gMonShrinkDistance = (gSprites[spriteId].y + gSprites[spriteId].y2) -
                         (sprite->y + sprite->y2);
...
static void SpriteCB_Ball_Wobble_Step(struct Sprite *sprite) {
  ...
  case BALL_ROLL_1:
    // Rolling effect: every frame in the rotation, the sprite shifts 176/256 of
    // a pixel.
...
static void SpriteCB_Ball_Capture_Step(struct Sprite *sprite) {
  ...
  if (sprite->sTimer == 40) {
    ...
    BeginNormalPaletteFade(0x10000 << sprite->oam.paletteNum, 2, 6, 0,
                           RGB_BLACK);
...
static void SpriteCB_Ball_FadeOut(struct Sprite *sprite) {
  ...
  case 1:
    if (sprite->data[1]++ > 0) {
      ...
      sprite->data[2]++;
      SetGpuReg(REG_OFFSET_BLDALPHA,
                BLDALPHA_BLEND(16 - sprite->data[2], sprite->data[2]));
      if (sprite->data[2] == 16)
        sprite->sState++;
    }
    break;
...
static void MakeCaptureStars(struct Sprite *sprite) {
  ...
  for (i = 0; i < ARRAY_COUNT(sCaptureStars); i++) {
    u8 spriteId = CreateSprite(&sBallParticleSpriteTemplates[BALL_MASTER],
                               sprite->x, sprite->y, subpriority);
...
static void SpriteCB_Ball_Release_Step(struct Sprite *sprite) {
  ...
  StartSpriteAffineAnim(&gSprites[gBattlerSpriteIds[gBattleAnimTarget]],
...
static void SpriteCB_Ball_Block_Step(struct Sprite *sprite) {
  ...
  if (sprite->y + sprite->y2 > DISPLAY_HEIGHT || sprite->x + sprite->x2 < -8) {
    sprite->sFrame = 0;
    sprite->callback = DestroySpriteAfterOneFrame;
    gDoingBattleAnim = 0;
    UpdateOamPriorityInAllHealthboxes(1);
...
static void LoadBallParticleGfx(u8 ballId) {
  if (GetSpriteTileStartByTag(sBallParticleSpriteSheets[ballId].tag) ==
      0xFFFF) {
...
u8 AnimateBallOpenParticles(u8 x, u8 y, u8 priority, u8 subpriority,
                            u8 ballId) {
  u8 taskId;
...
static void PokeBallOpenParticleAnimation(u8 taskId) {
  ...
  if (gTasks[taskId].data[0] < 16) {
    ...
    spriteId =
        CreateSprite(&sBallParticleSpriteTemplates[ballId], x, y, subpriority);
    if (spriteId != MAX_SPRITES) {
...
static void GreatBallOpenParticleAnimation(u8 taskId) {
  ...
  if (gTasks[taskId].data[7]) {
    ...
    for (i = 0; i < 8; i++) {
      spriteId = CreateSprite(&sBallParticleSpriteTemplates[ballId], x, y,
                              subpriority);
      if (spriteId != MAX_SPRITES) {
        IncrBallParticleCount();
        StartSpriteAnim(&gSprites[spriteId], sBallParticleAnimNums[ballId]);
...
static void PremierBallOpenParticleAnimation_Step1(struct Sprite *sprite) {
  sprite->x2 = Sin(sprite->data[0], sprite->data[1]);
  sprite->y2 =
      Cos(sprite->data[0], Sin(sprite->data[0] & 0x3F, sprite->data[2]));
...
u8 LaunchBallFadeMonTask(bool8 unfadeLater, u8 spritePalNum,
                         u32 selectedPalettes, u8 ballId) {
  u8 taskId;
  ...
  if (!unfadeLater) {
    ...
    BlendPalette(OBJ_PLTT_ID(spritePalNum), 16, 16,
...
static void Task_FadeMon_ToBallColor(u8 taskId) {
  ...
  if (gTasks[taskId].tTimer <= 16) {
    BlendPalette(OBJ_PLTT_ID(gTasks[taskId].tPalOffset), 16,
                 gTasks[taskId].tCoeff, gBallOpenFadeColors[ballId]);
    gTasks[taskId].tCoeff += gTasks[taskId].tdCoeff;
    gTasks[taskId].tTimer++;
  } else if (!gPaletteFade.active) {
    u32 selectedPalettes =
        (u16)gTasks[taskId].tPaletteLo | ((u16)gTasks[taskId].tPaletteHi << 16);
...
void AnimTask_SwapMonSpriteToFromSubstitute(u8 taskId) {
  ...
  case 0:
    ...
    break;
  case 1:
    LoadBattleMonGfxAndAnimate(gBattleAnimAttacker, gTasks[taskId].data[11],
                               spriteId);
    gTasks[taskId].data[10]++;
    break;
  case 2:
...
void AnimTask_SubstituteFadeToInvisible(u8 taskId) {
  ...
  switch (gTasks[taskId].data[15]) {
  case 0:
    if (GetBattlerSpriteBGPriorityRank(gBattleAnimAttacker) ==
        B_POSITION_OPPONENT_LEFT)
      SetGpuReg(REG_OFFSET_BLDCNT,
                BLDCNT_TGT1_BG1 | BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_ALL);
    else
      SetGpuReg(REG_OFFSET_BLDCNT,
                BLDCNT_TGT1_BG2 | BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_ALL);
  ...
  case 1:
    if (gTasks[taskId].data[1]++ > 1) {
      ...
      gTasks[taskId].data[0]++;
      SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(16 - gTasks[taskId].data[0],
                                                    gTasks[taskId].data[0]));
      if (gTasks[taskId].data[0] == 16)
        gTasks[taskId].data[15]++;
    }
  ...
  case 2:
    spriteId = gBattlerSpriteIds[gBattleAnimAttacker];
    RequestDma3Fill(
        0, (void *)OBJ_VRAM0 + gSprites[spriteId].oam.tileNum * TILE_SIZE_4BPP,
        MON_PIC_SIZE, 1);
...
static void SpriteCB_PokeBlock_Throw(struct Sprite *sprite) {
  ...
  sprite->sDuration = 30;
  sprite->sTargetX =
      GetBattlerSpriteCoord(GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT),
                            BATTLER_COORD_X) +
      gBattleAnimArgs[2];
  sprite->sTargetY =
      GetBattlerSpriteCoord(GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT),
  ...
  InitAnimArcTranslation(sprite);
  gSprites[gBattlerSpriteIds[gBattleAnimAttacker]].callback =
