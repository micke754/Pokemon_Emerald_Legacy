...
const u8 gText_BatteryRunDry[] =
    _("The internal battery has run dry.\nThe game can be played.\pHowever, "
      "clock-based events will\nno longer occur.");
...
const u8 gText_HOFDexRating[] =
    _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. "
      "BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_UsedVar2WildLured[] =
    _("{PLAYER} used the\n{STR_VAR_2}.\pWild POKéMON will be "
      "lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] =
    _("{PLAYER} used the\n{STR_VAR_2}.\pWild POKéMON will be "
      "repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnAlreadyHoldingItemSwitch[] =
    _("{STR_VAR_1} is already holding\none {STR_VAR_2}.\pWould you like to "
      "switch the\ntwo items?");
...
const u8 gText_12PoofForgotMove[] =
    _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE "
      "15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse "
      "{STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyKnows[] =
    _("{STR_VAR_1} already knows\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHPRestoredByVar2[] =
    _("{STR_VAR_1}'s HP was restored\nby {STR_VAR_2} "
      "point(s).{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFriendlyBaseVar2CantFall[] =
    _("{STR_VAR_1} turned friendly.\nThe base {STR_VAR_2} can't "
      "fall!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromFortreeGym[] =
...
const u8 gText_Littleroot[] =
    _("LITTLEROOT"); // Unused. Given the context, Briney may at one point have
                     // been able to sail the player here
const u8 gText_Lilycove[] =
    _("LILYCOVE"); // Unused. Given the context, Briney may at one point have
                   // been able to sail the player here
...
const u8 gText_RevivalHerb300[] =
    _("REVIVAL HERB{CLEAR_TO 108}{FONT_SMALL}300");
...
const u8 gText_PokemonMaleLv[] =
    _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE "
      "GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC "
      "1}"); // Unused
const u8 gText_PokemonFemaleLv[] =
    _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE "
      "BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC "
      "1}");                                                           // Unused
...
const u8 gText_SaveFailedCheckingBackup[] =
    _("Save failed. Checking the backup\nmemory… Please wait.\n{COLOR "
      "RED}“Time required: about 1 minute”");
...
const u8 gText_WinsLosses[] =
    _("W:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW "
      "LIGHT_GRAY}  L:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}{COLOR "
      "DARK_GRAY}{SHADOW LIGHT_GRAY}");
...
const u8 gText_WinsStraight[] =
    _("W/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW "
      "LIGHT_GRAY}  STRAIGHT/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}");
...
const u8 gText_EndedWithXUnitsPowder[] =
    _("{PAUSE_MUSIC}{PLAY_BGM MUS_LEVEL_UP}You ended up with {STR_VAR_1} units "
      "of\nsilky-smooth BERRY POWDER.{RESUME_MUSIC}\pYour total amount of "
      "BERRY POWDER\nis {STR_VAR_2}.\p");
ALIGNED(4)
...
const u8 gText_10P30P50P50P[] =
    _("{CLEAR_TO 0x03}10P{CLEAR_TO 0x2B}30P{CLEAR_TO 0x53}50P{CLEAR_TO "
      "0x77}{EMOJI_MINUS}50P");
...
const u8 gText_PokedexDiploma[] =
    _("PLAYER: {CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR "
      "DARK_GRAY}{SHADOW LIGHT_GRAY}\n\nThis document certifies\nthat you have "
      "successfully\ncompleted your\n{STR_VAR_1} POKéDEX.\n\n{CLEAR_TO "
      "0x42}{COLOR RED}{SHADOW LIGHT_RED}GAME FREAK");
...
const u8 *const gTextTable_Players[] = {gText_F700Players, gText_F701Players,
                                        gText_F702Players, gText_F703Players};
