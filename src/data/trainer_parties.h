...
trainer_control by surskitty
    .nickname = _("Nickname")
    .ivs[NUM_STATS] OR .iv Use .iv to assign all IVs to the same number. .ivs
needs an array of six stats, in order of HP ATK DEF SPEED SPATK SPDEF; many
optimal IV spreads are pre-defined in include/constants/pokemon.h .heldItem and
.moves[MAX_MON_MOVES] are as in vanilla. .ability should be set to
ABILITY_SLOT_1, ABILITY_SLOT_2, or ABILITY_HIDDEN for future-proofing.
    .evs[NUM_STATS] again uses the stat order. The constants provided are not
player-legal. .ball will still allow trainer-class balls to function when unset.
    .shiny = TRUE if you want shinies :)
    .friendship should be set to TRAINER_MON_FRIENDLY or TRAINER_MON_UNFRIENDLY
to adjust Return/Frustration.
*/
// Mt Chimney Hiker
...
static const struct TrainerMon sParty_Matt[] = {
    {.iv = 150,
     .lvl = 38,
     .species = SPECIES_ELECTRODE,
     .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_EXPLOSION,
               MOVE_MIRROR_COAT}},
    {.iv = 150,
     .lvl = 39,
     .species = SPECIES_CRAWDAUNT,
     .moves = {MOVE_CRABHAMMER, MOVE_KNOCK_OFF, MOVE_ICE_BEAM,
               MOVE_BRICK_BREAK}},
    {.iv = 150,
     .lvl = 38,
     .species = SPECIES_MACHAMP,
     .moves = {MOVE_BODY_SLAM, MOVE_SUBMISSION, MOVE_ROCK_TOMB,
               MOVE_FOCUS_ENERGY}},
    {.iv = 190,
     .lvl = 40,
...
static const struct TrainerMon sParty_ShellyWeatherInstitute[] = {
    ...
    {.iv = 100,
     ...
     .moves = {MOVE_DOUBLE_EDGE, MOVE_PSYCHIC, MOVE_WATER_PULSE,
               MOVE_AMNESIA}}};
...
static const struct TrainerMon sParty_ShellySeafloorCavern[] = {
    ...
    {.iv = 100,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_WEATHER_BALL, MOVE_RAIN_DANCE, MOVE_HEADBUTT,
               MOVE_AURORA_BEAM}},
    {.iv = 100,
     .lvl = 45,
     .species = SPECIES_GOREBYSS,
...
static const struct TrainerMon sParty_Archie[] = {
    ...
    {.iv = 150,
     ...
     .species = SPECIES_MACHAMP,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_VITAL_THROW, MOVE_KNOCK_OFF, MOVE_EARTHQUAKE,
               MOVE_ROCK_TOMB}},
    {.iv = 150,
     .lvl = 46,
     .species = SPECIES_CROBAT,
...
static const struct TrainerMon sParty_Rose5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .evs = {252, 0, 0, 252, 0, 0},
     .moves = {MOVE_SLEEP_POWDER, MOVE_LEECH_SEED, MOVE_SUBSTITUTE,
               MOVE_ENCORE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_VICTREEBEL,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER,
               MOVE_ENCORE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 252, 0},
     .moves = {MOVE_GRASS_WHISTLE, MOVE_GIGA_DRAIN, MOVE_INGRAIN,
               MOVE_SLUDGE_BOMB}}};
...
static const struct TrainerMon sParty_Chip[] = {
    {.iv = 50,
     ...
     .moves = {MOVE_PSYBEAM, MOVE_SELF_DESTRUCT, MOVE_SANDSTORM,
               MOVE_ANCIENT_POWER}},
    {.iv = 50,
     .lvl = 30,
...
static const struct TrainerMon sParty_GabbyAndTy6[] = {
    {.iv = 250,
     .lvl = 42,
     .species = SPECIES_MAGNETON,
     .moves = {MOVE_SONIC_BOOM, MOVE_THUNDER_WAVE, MOVE_METAL_SOUND,
               MOVE_THUNDERBOLT}},
    {.iv = 250,
     .lvl = 42,
...
static const struct TrainerMon sParty_Parker[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_FAINT_ATTACK,
               MOVE_NONE}}};
...
static const struct TrainerMon sParty_Braxton[] = {
    {.iv = 100,
     .lvl = 31,
     .species = SPECIES_SWELLOW,
     .moves = {MOVE_FOCUS_ENERGY, MOVE_QUICK_ATTACK, MOVE_WING_ATTACK,
               MOVE_ENDEAVOR}},
    {.iv = 100,
     .lvl = 32,
    ...
    {.iv = 100,
     .lvl = 32,
     .species = SPECIES_MAGNETON,
     .moves = {MOVE_THUNDERBOLT, MOVE_SUPERSONIC, MOVE_THUNDER_WAVE,
               MOVE_SONIC_BOOM}},
    {.iv = 100,
     .lvl = 33,
     .species = SPECIES_SHIFTRY,
     .moves = {MOVE_GIGA_DRAIN, MOVE_FAINT_ATTACK, MOVE_DOUBLE_TEAM,
               MOVE_SWAGGER}}};
// Trick House 8
...
static const struct TrainerMon sParty_Vito[] = {
    ...
    {.iv = 220,
     .lvl = 48,
     .species = SPECIES_SHIFTRY,
     .moves = {MOVE_FAINT_ATTACK, MOVE_FAKE_OUT, MOVE_LEAF_BLADE,
               MOVE_EXTRASENSORY}}};
// Victory Road CooltrainerM
...
static const struct TrainerMon sParty_Alexia[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL,
               MOVE_NONE}}};
...
static const struct TrainerMon sParty_Wendy[] = {
    ...
    {.iv = 100,
     .lvl = 33,
     .species = SPECIES_ROSELIA,
     .moves = {MOVE_MEGA_DRAIN, MOVE_MAGICAL_LEAF, MOVE_GRASS_WHISTLE,
               MOVE_LEECH_SEED}},
    {.iv = 100,
     .lvl = 33,
     .species = SPECIES_PELIPPER,
...
static const struct TrainerMon sParty_Valerie5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .moves = {MOVE_SHADOW_PUNCH, MOVE_CALM_MIND, MOVE_PAIN_SPLIT,
               MOVE_THUNDER_PUNCH}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_SABLEYE,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 252, 0},
     .moves = {MOVE_MOONLIGHT, MOVE_WILL_O_WISP, MOVE_FIRE_PUNCH,
               MOVE_SHADOW_BALL}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_BANETTE,
     ...
     .moves = {MOVE_ENDURE, MOVE_DESTINY_BOND, MOVE_SHADOW_BALL,
               MOVE_THUNDER_WAVE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 252, 0},
     .moves = {MOVE_WILL_O_WISP, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY,
               MOVE_THUNDERBOLT}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_AERIAL_ACE, MOVE_SILVER_WIND, MOVE_FAINT_ATTACK,
               MOVE_SHADOW_BALL}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_FIRE_PUNCH, MOVE_PSYCHIC, MOVE_SHADOW_BALL,
               MOVE_WILL_O_WISP}}};
// Route 104 Lady
static const struct TrainerMon sParty_Cindy1[] = {
    {.iv = 0, .lvl = 7, .species = SPECIES_SKITTY, .heldItem = ITEM_NUGGET}};
...
static const struct TrainerMon sParty_Daphne[] = {
    {.iv = 255,
     ...
     .moves = {MOVE_ATTRACT, MOVE_LOVELY_KISS, MOVE_RAIN_DANCE,
               MOVE_WATER_PULSE}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_LUVDISC,
...
static const struct TrainerMon sParty_Brianna[] = {{.iv = 150,
                                                    .lvl = 45,
...
static const struct TrainerMon sParty_Naomi[] = {
    ...
    {.iv = 255, .lvl = 53, .species = SPECIES_SKIPLOOM, .heldItem = ITEM_NONE},
};
...
static const struct TrainerMon sParty_Cindy5[] = {
    {.iv = 30,
     ...
     .species = SPECIES_DELCATTY,
     .heldItem = ITEM_NUGGET,
     .moves = {MOVE_DOUBLE_EDGE, MOVE_SING, MOVE_FAINT_ATTACK,
               MOVE_THUNDER_WAVE}}};
...
static const struct TrainerMon sParty_Olivia[] = {
    {.iv = 100,
     ...
     .moves = {MOVE_IRON_DEFENSE, MOVE_WHIRLPOOL, MOVE_RAIN_DANCE,
               MOVE_WATER_PULSE}},
    {.iv = 100,
     .lvl = 45,
     .species = SPECIES_CRAWDAUNT,
    ...
    {.iv = 100,
     .lvl = 45,
     .species = SPECIES_LUDICOLO,
     .moves = {MOVE_UPROAR, MOVE_FURY_SWIPES, MOVE_FAKE_OUT,
               MOVE_WATER_PULSE}}};
...
static const struct TrainerMon sParty_Winston1[] = {
    {.iv = 0, .lvl = 7, .species = SPECIES_SLAKOTH, .heldItem = ITEM_NUGGET}};
// Route 133 ExpertF
...
static const struct TrainerMon sParty_Garret[] = {
    {.iv = 255, .lvl = 50, .species = SPECIES_CHANSEY, .heldItem = ITEM_NUGGET},
    {.iv = 255,
     .lvl = 50,
...
static const struct TrainerMon sParty_Winston2[] = {
    {.iv = 0, .lvl = 29, .species = SPECIES_VIGOROTH, .heldItem = ITEM_NUGGET}};

static const struct TrainerMon sParty_Winston3[] = {
    {.iv = 0, .lvl = 32, .species = SPECIES_VIGOROTH, .heldItem = ITEM_NUGGET},
    {.iv = 0, .lvl = 32, .species = SPECIES_VIGOROTH, .heldItem = ITEM_NUGGET}};
...
static const struct TrainerMon sParty_Winston4[] = {
    {.iv = 0,
     ...
     .heldItem = ITEM_NUGGET,
     .moves = {MOVE_BODY_SLAM, MOVE_THUNDERBOLT, MOVE_YAWN,
               MOVE_DYNAMIC_PUNCH}},
    {.iv = 0,
     .lvl = 44,
     .species = SPECIES_SLAKING,
...
static const struct TrainerMon sParty_Winston5[] = {
    {.iv = 0,
     ...
     .species = SPECIES_SLAKING,
     .heldItem = ITEM_NUGGET,
     .moves = {MOVE_FURY_SWIPES, MOVE_EARTHQUAKE, MOVE_YAWN,
               MOVE_DYNAMIC_PUNCH}},
    {.iv = 0,
     .lvl = 60,
     .species = SPECIES_SLAKING,
    ...
    {.iv = 0,
     ...
     .species = SPECIES_SLAKING,
     .heldItem = ITEM_NUGGET,
     .moves = {MOVE_HYPER_BEAM, MOVE_FAINT_ATTACK, MOVE_YAWN,
               MOVE_THUNDERBOLT}},
    {.iv = 0,
     .lvl = 60,
     .species = SPECIES_SLAKING,
...
static const struct TrainerMon sParty_Steve2[] = {
    {.iv = 10, .lvl = 33, .species = SPECIES_SEVIPER}};
...
static const struct TrainerMon sParty_Nob5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_HI_JUMP_KICK, MOVE_ROCK_SLIDE,
               MOVE_MEGA_KICK}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
...
static const struct TrainerMon sParty_Kirk[] = {
    {.iv = 100,
     .lvl = 20,
     .species = SPECIES_VOLTORB,
     .moves = {MOVE_ROLLOUT, MOVE_SHOCK_WAVE, MOVE_SCREECH,
               MOVE_SELF_DESTRUCT}},
    {.iv = 100,
     .lvl = 20,
     .species = SPECIES_ELECTRIKE,
...
static const struct TrainerMon sParty_Dalton5[] = {
    {.ivs = BEST_IV_SPREAD_HIDDEN_POWER_ICE,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_HIDDEN_POWER, MOVE_VOLT_TACKLE, MOVE_EXPLOSION,
               MOVE_THUNDER_WAVE}},
    {.ivs = BEST_IV_SPREAD_HIDDEN_POWER_ICE,
     .lvl = 65,
     .species = SPECIES_MANECTRIC,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_OVERHEAT, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL,
               MOVE_HIDDEN_POWER}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_ELECTABUZZ,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_THUNDERBOLT, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH,
               MOVE_THUNDER_WAVE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_MINUN,
     ...
     .moves = {MOVE_TRICK, MOVE_VOLT_TACKLE, MOVE_MAGICAL_LEAF,
               MOVE_THUNDER_WAVE}},
    {.ivs = BEST_IV_SPREAD_HIDDEN_POWER_ICE,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_SHADOW_BALL,
               MOVE_HIDDEN_POWER}},
    {.ivs = BEST_IV_SPREAD_HIDDEN_POWER_ICE,
     .lvl = 65,
...
static const struct TrainerMon sParty_Bernie5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_SUNNY_DAY, MOVE_OVERHEAT, MOVE_THUNDER_PUNCH,
               MOVE_PSYCHIC}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 0, 252, 0},
     .moves = {MOVE_BELLY_DRUM, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE,
               MOVE_OVERHEAT}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_NINETALES,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 252, 252, 0, 0},
     .moves = {MOVE_WILL_O_WISP, MOVE_SUNNY_DAY, MOVE_CONFUSE_RAY,
               MOVE_FLAMETHROWER}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_MAGCARGO,
...
static const struct TrainerMon sParty_Ethan1[] = {
    {.iv = 0, .lvl = 25, .species = SPECIES_SWELLOW},
    {
        .iv = 0,
        .lvl = 25,
        .species = SPECIES_LINOONE,
...
static const struct TrainerMon sParty_Ethan2[] = {
    {.iv = 0, .lvl = 30, .species = SPECIES_SWELLOW},
    {
        .iv = 0,
        .lvl = 30,
        .species = SPECIES_LINOONE,
...
static const struct TrainerMon sParty_Jeffrey5[] = {
    {.iv = 40, .lvl = 59, .species = SPECIES_MASQUERAIN, .heldItem = ITEM_NONE},
    {.iv = 40, .lvl = 59, .species = SPECIES_DUSTOX, .heldItem = ITEM_NONE},
    {.iv = 40, .lvl = 59, .species = SPECIES_MASQUERAIN, .heldItem = ITEM_NONE},
    {.iv = 40,
     .lvl = 59,
     .species = SPECIES_MASQUERAIN,
     .heldItem = ITEM_SILVER_POWDER},
    {.iv = 40, .lvl = 59, .species = SPECIES_BEAUTIFLY, .heldItem = ITEM_NONE}};
// Route 110 PsychicM
...
static const struct TrainerMon sParty_Jacki5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_PSYCHIC,
               MOVE_ICE_PUNCH}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .moves = {MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_FIRE_PUNCH,
               MOVE_DYNAMIC_PUNCH}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_WOBBUFFET,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .moves = {MOVE_IMPRISON, MOVE_PSYCHIC, MOVE_THUNDERBOLT,
               MOVE_SHADOW_BALL}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_LUNATONE,
...
static const struct TrainerMon sParty_Walter3[] = {
    {.iv = 20,
     .lvl = 36,
     .species = SPECIES_LINOONE,
     .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_ODOR_SLEUTH,
               MOVE_FURY_SWIPES}},
    {.iv = 20,
     .lvl = 36,
     .species = SPECIES_MANECTRIC,
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    {.iv = 250,
     ...
     .species = SPECIES_SHIFTRY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_LEAF_BLADE, MOVE_FAINT_ATTACK, MOVE_AERIAL_ACE,
               MOVE_EXTRASENSORY}},
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_CRAWDAUNT,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_CRUNCH,
               MOVE_SLUDGE_BOMB}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_ABSOL,
...
static const struct TrainerMon sParty_Phoebe[] = {
    {.iv = 250,
     ...
     .species = SPECIES_SABLEYE,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_MOONLIGHT, MOVE_CRUNCH, MOVE_SHADOW_BALL,
               MOVE_CONFUSE_RAY}},
    {.iv = 250,
     .lvl = 53,
     .species = SPECIES_BANETTE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_REVENGE,
               MOVE_DESTINY_BOND}},
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_NINETALES,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_SHADOW_BALL,
               MOVE_CONFUSE_RAY}},
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_MEDICHAM,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_DUSCLOPS,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_ROCK_SLIDE,
               MOVE_EARTHQUAKE}}};
// Elite Four Glacia
static const struct TrainerMon sParty_Glacia[] = {
    ...
    {.iv = 250,
     ...
     .species = SPECIES_SNEASEL,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_FAINT_ATTACK, MOVE_BLIZZARD, MOVE_SWORDS_DANCE,
               MOVE_SLASH}},
    {.iv = 250,
     .lvl = 53,
     .species = SPECIES_CASTFORM,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_WEATHER_BALL, MOVE_HYDRO_PUMP, MOVE_HAIL,
               MOVE_THUNDERBOLT}},
    {.iv = 250,
     .lvl = 54,
...
static const struct TrainerMon sParty_Drake[] = {
    {.iv = 250,
     ...
     .species = SPECIES_FLYGON,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_SIGNAL_BEAM,
               MOVE_CRUNCH}},
    {.iv = 250,
     .lvl = 55,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_SHARP_BEAK,
     .moves = {MOVE_SKY_ATTACK, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE,
               MOVE_DOUBLE_EDGE}},
    {.iv = 250,
     .lvl = 53,
     .species = SPECIES_HUNTAIL,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE,
               MOVE_CRUNCH}}};
// Rustboro Gym Leader
...
static const struct TrainerMon sParty_Brawly1[] = {
    {.iv = 100,
     ...
     .species = SPECIES_MAKUHITA,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_VITAL_THROW, MOVE_REVERSAL, MOVE_BULK_UP,
               MOVE_FAINT_ATTACK}},
    {.iv = 100,
     .lvl = 16,
     .species = SPECIES_MEDITITE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_CONFUSION, MOVE_THUNDER_PUNCH, MOVE_LIGHT_SCREEN,
               MOVE_REFLECT}},
    {.iv = 200,
     .lvl = 19,
     .species = SPECIES_BRELOOM,
...
static const struct TrainerMon sParty_Wattson1[] = {
    {.iv = 200,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_BUBBLE_BEAM, MOVE_ICY_WIND,
               MOVE_THUNDER_WAVE}},
    {.iv = 220,
     .lvl = 23,
     .species = SPECIES_MAGNETON,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_SUPERSONIC,
               MOVE_SONIC_BOOM}},
    {.iv = 200,
     .lvl = 24,
     .species = SPECIES_PLUSLE,
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    {.iv = 200,
     ...
     .species = SPECIES_MAGCARGO,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_OVERHEAT, MOVE_ROCK_THROW, MOVE_LIGHT_SCREEN,
               MOVE_SUNNY_DAY}},
    {.iv = 250,
     .lvl = 30,
     .species = SPECIES_CAMERUPT,
...
static const struct TrainerMon sParty_Winona1[] = {
    {.iv = 200,
     ...
     .species = SPECIES_TROPIUS,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_AERIAL_ACE, MOVE_MAGICAL_LEAF, MOVE_EARTHQUAKE,
               MOVE_WHIRLWIND}},
    {.iv = 220,
     .lvl = 37,
     .species = SPECIES_SWELLOW,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_AERIAL_ACE, MOVE_STEEL_WING, MOVE_TAKE_DOWN,
               MOVE_WHIRLWIND}},
    {.iv = 200,
     .lvl = 36,
     .species = SPECIES_PELIPPER,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_WATER_PULSE, MOVE_SHOCK_WAVE, MOVE_ICE_BEAM,
               MOVE_AERIAL_ACE}},
    {.iv = 235,
     .lvl = 37,
     .species = SPECIES_SKARMORY,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_WHIRLWIND, MOVE_MUD_SLAP, MOVE_STEEL_WING,
               MOVE_AERIAL_ACE}},
    {.iv = 255,
     .lvl = 38,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_LUM_BERRY,
     .moves = {MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_DRAGON_DANCE,
               MOVE_AERIAL_ACE}}};
// Mossdeep Gym Leader
static const struct TrainerMon sParty_TateAndLiza1[] = {
    {.iv = 250,
     ...
     .species = SPECIES_CLAYDOL,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_PSYCHIC,
               MOVE_LIGHT_SCREEN}},
    {.iv = 250,
     .lvl = 44,
     .species = SPECIES_XATU,
    ...
    {.iv = 250,
     ...
     .species = SPECIES_MEDICHAM,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EXTRASENSORY, MOVE_HI_JUMP_KICK, MOVE_ICE_PUNCH,
               MOVE_FIRE_PUNCH}},
    {.iv = 250,
     .lvl = 43,
     .species = SPECIES_CHIMECHO,
    ...
    {.iv = 250,
     ...
     .species = SPECIES_SOLROCK,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_PSYCHIC, MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER,
               MOVE_SUNNY_DAY}}};
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    {.iv = 200,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_AMNESIA,
               MOVE_EARTHQUAKE}},
    {.iv = 200,
     .lvl = 43,
     .species = SPECIES_SEALEO,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_ENCORE, MOVE_BODY_SLAM, MOVE_AURORA_BEAM,
               MOVE_WATER_PULSE}},
    {.iv = 200,
     .lvl = 43,
     .species = SPECIES_CRAWDAUNT,
...
static const struct TrainerMon sParty_KateAndJoy[] = {
    {.iv = 0,
     .lvl = 33,
     .species = SPECIES_SPINDA,
     .moves = {MOVE_HYPNOSIS, MOVE_PSYBEAM, MOVE_DIZZY_PUNCH,
               MOVE_TEETER_DANCE}},
    {.iv = 0,
     .lvl = 33,
     .species = SPECIES_SLAKING,
     .moves = {MOVE_YAWN, MOVE_SLACK_OFF, MOVE_FAINT_ATTACK,
               MOVE_FURY_SWIPES}}};
// Route 117 Sr and Jr
...
static const struct TrainerMon sParty_AnnaAndMeg5[] = {
    ...
    {.iv = 40,
     .lvl = 63,
     .species = SPECIES_MACHAMP,
     .moves = {MOVE_REVENGE, MOVE_SEISMIC_TOSS, MOVE_ROCK_SLIDE,
               MOVE_FIRE_PUNCH}},
    {.iv = 40,
     .lvl = 63,
     .species = SPECIES_FURRET,
     .moves = {MOVE_EXTREME_SPEED, MOVE_IRON_TAIL, MOVE_DIG,
               MOVE_FOCUS_ENERGY}},
    {.iv = 40,
     .lvl = 64,
     .species = SPECIES_HARIYAMA,
     .moves = {MOVE_BODY_SLAM, MOVE_FOCUS_ENERGY, MOVE_BRICK_BREAK,
               MOVE_NONE}}};
// Winstrate House
...
static const struct TrainerMon sParty_Victoria[] = {
    {.iv = 150,
     ...
     .species = SPECIES_ROSELIA,
     .heldItem = ITEM_ORAN_BERRY,
     .moves = {MOVE_POISON_STING, MOVE_STUN_SPORE, MOVE_MEGA_DRAIN,
               MOVE_LEECH_SEED}}};
// Route 121 PokefanF
...
static const struct TrainerMon sParty_Isabel1[] = {
    ...
    {.iv = 0,
     ...
     .species = SPECIES_MINUN,
     .heldItem = ITEM_ORAN_BERRY,
     .moves = {MOVE_THUNDER_SHOCK, MOVE_HELPING_HAND, MOVE_LIGHT_SCREEN,
               MOVE_QUICK_ATTACK}}};
...
static const struct TrainerMon sParty_Vicky[] = {
    {.iv = 200,
     ...
     .species = SPECIES_MEDITITE,
     .heldItem = ITEM_ORAN_BERRY,
     .moves = {MOVE_HI_JUMP_KICK, MOVE_MEDITATE, MOVE_CONFUSION,
               MOVE_CALM_MIND}}};
// Mt Chimney ExpertF
...
static const struct TrainerMon sParty_Quincy[] = {
    {.iv = 100,
     .lvl = 48,
     .species = SPECIES_SLAKING,
     .moves = {MOVE_ATTRACT, MOVE_ICE_BEAM, MOVE_THUNDERBOLT,
               MOVE_FLAMETHROWER}},
    {.iv = 100,
     .lvl = 48,
     .species = SPECIES_DUSCLOPS,
...
static const struct TrainerMon sParty_Katelynn[] = {
    {.iv = 100,
     .lvl = 48,
     .species = SPECIES_GARDEVOIR,
     .moves = {MOVE_SKILL_SWAP, MOVE_PSYCHIC, MOVE_THUNDERBOLT,
               MOVE_CALM_MIND}},
    {.iv = 100,
     .lvl = 48,
     .species = SPECIES_SLAKING,
     .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_AERIAL_ACE,
               MOVE_BRICK_BREAK}}};
...
static const struct TrainerMon sParty_Wallace1[] = {
    {.iv = 255,
     ...
     .species = SPECIES_TENTACRUEL,
     .heldItem = ITEM_PETAYA_BERRY,
     .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_GIGA_DRAIN,
               MOVE_ICE_BEAM}},
    {.iv = 255,
     .lvl = 48,
     .species = SPECIES_MASQUERAIN,
     .heldItem = ITEM_SILVER_POWDER,
     .moves = {MOVE_HYDRO_PUMP, MOVE_SIGNAL_BEAM, MOVE_STUN_SPORE,
               MOVE_BLIZZARD}},
    {.iv = 255,
     .lvl = 49,
     .species = SPECIES_WHISCASH,
    ...
    {.iv = 255,
     ...
     .moves = {MOVE_GIGA_DRAIN, MOVE_WATER_PULSE, MOVE_LEECH_SEED,
               MOVE_DOUBLE_TEAM}},
    {.iv = 255,
     .lvl = 51,
     .species = SPECIES_MILOTIC,
...
static const struct TrainerMon sParty_Benjamin5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_METAL_CLAW, MOVE_CRUNCH, MOVE_SLUDGE_BOMB,
               MOVE_ROCK_SLIDE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_SKARMORY,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 252, 0, 252, 0},
     .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_REST,
               MOVE_TRI_ATTACK}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_METEOR_MASH, MOVE_BRICK_BREAK, MOVE_ROCK_SLIDE,
               MOVE_EXPLOSION}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
...
static const struct TrainerMon sParty_Nicolas5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_DYNAMIC_PUNCH, MOVE_EARTHQUAKE, MOVE_OUTRAGE,
               MOVE_THUNDER_WAVE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_SALAMENCE,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 0, 0, 252},
     .moves = {MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE, MOVE_CRUNCH,
               MOVE_EARTHQUAKE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_FLYGON,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SIGNAL_BEAM,
               MOVE_FIRE_BLAST}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_ALTARIA,
...
static const struct TrainerMon sParty_Aaron[] = {
    {.iv = 255,
     ...
     .moves = {MOVE_DRAGON_BREATH, MOVE_HEADBUTT, MOVE_FOCUS_ENERGY,
               MOVE_EMBER}},
    {.iv = 255,
     .lvl = 44,
     .species = SPECIES_SHELGON,
...
static const struct TrainerMon sParty_Robert5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_EXTREME_SPEED, MOVE_SKY_ATTACK, MOVE_TOXIC,
               MOVE_STEEL_WING}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_GYARADOS,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE, MOVE_EARTHQUAKE,
               MOVE_SLUDGE_BOMB}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_SWELLOW,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_SKY_ATTACK, MOVE_FACADE, MOVE_DOUBLE_EDGE,
               MOVE_STEEL_WING}}};
...
static const struct TrainerMon sParty_Lao5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER, MOVE_TOXIC,
               MOVE_ACID_ARMOR}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 252, 0},
     .moves = {MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_LEECH_SEED,
               MOVE_EARTHQUAKE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .moves = {MOVE_SLUDGE_BOMB, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT,
               MOVE_DESTINY_BOND}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_TENTACRUEL,
...
static const struct TrainerMon sParty_Angelica[] = {
    {.iv = 50,
     .lvl = 33,
     .species = SPECIES_CASTFORM,
     .moves = {MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_THUNDER,
               MOVE_WATER_PULSE}}};
...
static const struct TrainerMon sParty_Madeline4[] = {
    {.iv = 30,
     .lvl = 51,
     .species = SPECIES_ROSELIA,
     .moves = {MOVE_LEECH_SEED, MOVE_MEGA_DRAIN, MOVE_GRASS_WHISTLE,
               MOVE_SUNNY_DAY}},
    {.iv = 30,
     .lvl = 51,
     .species = SPECIES_CAMERUPT,
     .moves = {MOVE_FLAMETHROWER, MOVE_TAKE_DOWN, MOVE_MAGNITUDE,
               MOVE_SUNNY_DAY}}};
...
static const struct TrainerMon sParty_Madeline5[] = {
    {.iv = 40,
     .lvl = 60,
     .species = SPECIES_ROSELIA,
     .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_SOLAR_BEAM,
               MOVE_SUNNY_DAY}},
    {.iv = 40,
     .lvl = 63,
     .species = SPECIES_CAMERUPT,
     .moves = {MOVE_FLAMETHROWER, MOVE_TAKE_DOWN, MOVE_EARTHQUAKE,
               MOVE_SUNNY_DAY}}};
// Route 105 SwimmerF
...
static const struct TrainerMon sParty_Jenny1[] = {
    ...
    {.iv = 0, .lvl = 36, .species = SPECIES_WAILMER}};
// Route 124 SwimmerF
...
static const struct TrainerMon sParty_Jenny5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 252, 0},
     .moves = {MOVE_HYDRO_CANNON, MOVE_RAIN_DANCE, MOVE_ICE_BEAM,
               MOVE_EARTHQUAKE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_LUDICOLO,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_PSYCHIC,
               MOVE_THUNDERBOLT}}};
...
static const struct TrainerMon sParty_Becky[] = {
    ...
    {.iv = 0,
     .lvl = 27,
     .species = SPECIES_MARILL,
     .moves = {MOVE_ROLLOUT, MOVE_BUBBLE_BEAM, MOVE_TAIL_WHIP,
               MOVE_DEFENSE_CURL}}};
...
static const struct TrainerMon sParty_Cedric[] = {
    {.iv = 0,
     .lvl = 35,
     .species = SPECIES_WOBBUFFET,
     .moves = {MOVE_DESTINY_BOND, MOVE_SAFEGUARD, MOVE_COUNTER,
               MOVE_MIRROR_COAT}}};
...
static const struct TrainerMon sParty_AmyAndLiv1[] = {
    {.iv = 0,
     .lvl = 16,
     .species = SPECIES_PLUSLE,
     .moves = {MOVE_THUNDER_SHOCK, MOVE_GROWL, MOVE_LIGHT_SCREEN,
               MOVE_QUICK_ATTACK}},
    {.iv = 0,
     .lvl = 16,
     .species = SPECIES_MINUN,
...
static const struct TrainerMon sParty_AmyAndLiv5[] = {
    {.iv = 30,
     .lvl = 61,
     .species = SPECIES_PLUSLE,
     .moves = {MOVE_THUNDERBOLT, MOVE_CHARGE, MOVE_FAKE_TEARS,
               MOVE_HELPING_HAND}},
    {.iv = 30,
     .lvl = 61,
     .species = SPECIES_MINUN,
...
static const struct TrainerMon sParty_Jonas[] = {
    {.iv = 0,
     .lvl = 35,
     .species = SPECIES_WEEZING,
     .moves = {MOVE_TOXIC, MOVE_THUNDER, MOVE_SELF_DESTRUCT,
               MOVE_SLUDGE_BOMB}}};
...
static const struct TrainerMon sParty_Kayley[] = {
    {.iv = 0,
     .lvl = 34,
     .species = SPECIES_CASTFORM,
     .moves = {MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_FLAMETHROWER,
               MOVE_SOLAR_BEAM}}};
// Route 125 Expert
...
static const struct TrainerMon sParty_Marley[] = {
    {.iv = 255,
     ...
     .species = SPECIES_MANECTRIC,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_CRUNCH, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE,
               MOVE_THUNDERBOLT}}};
...
static const struct TrainerMon sParty_TabithaMossdeep[] = {
    {.iv = 150,
     ...
     .species = SPECIES_CROBAT,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_WING_ATTACK, MOVE_GIGA_DRAIN, MOVE_POISON_FANG,
               MOVE_CONFUSE_RAY}},
    {.iv = 150,
     .lvl = 43,
     .species = SPECIES_AGGRON,
    ...
    {.iv = 150,
     ...
     .species = SPECIES_ZANGOOSE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_CRUSH_CLAW, MOVE_FAINT_ATTACK, MOVE_SUNNY_DAY,
               MOVE_SWORDS_DANCE}}};
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    {.iv = 200,
     ...
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_SHARP_BEAK,
     .moves = {MOVE_AERIAL_ACE, MOVE_EARTHQUAKE, MOVE_FIRE_BLAST,
               MOVE_DRAGON_DANCE}},
    {.iv = 150,
     .lvl = 48,
     .species = SPECIES_ROSELIA,
     .heldItem = ITEM_PERSIM_BERRY,
     .moves = {MOVE_PETAL_DANCE, MOVE_LEECH_SEED, MOVE_SLUDGE_BOMB,
               MOVE_TOXIC}},
    {.iv = 150,
     .lvl = 49,
     .species = SPECIES_MAGNETON,
     .heldItem = ITEM_FOCUS_BAND,
     .moves = {MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_LIGHT_SCREEN,
               MOVE_THUNDER_WAVE}},
    {.iv = 250,
     .lvl = 50,
     .species = SPECIES_GARDEVOIR,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_CALM_MIND,
               MOVE_DOUBLE_TEAM}}};
// Rival 1
...
static const struct TrainerMon sParty_BrendanRoute110Mudkip[] = {
    ...
    {.iv = 100,
     ...
     .moves = {MOVE_ABSORB, MOVE_QUICK_ATTACK, MOVE_FALSE_SWIPE,
               MOVE_RAZOR_LEAF}}};
...
static const struct TrainerMon sParty_BrendanRoute119Treecko[] = {
    ...
    {.iv = 150,
     .lvl = 35,
     .species = SPECIES_COMBUSKEN,
     .moves = {MOVE_FIRE_PUNCH, MOVE_ROLLING_KICK, MOVE_BULK_UP,
               MOVE_SUNNY_DAY}}};
// Rival 1
...
static const struct TrainerMon sParty_BrendanRoute119Torchic[] = {
    ...
    {.iv = 100,
     .lvl = 33,
     .species = SPECIES_BRELOOM,
     .moves = {MOVE_MEGA_DRAIN, MOVE_HEADBUTT, MOVE_MACH_PUNCH,
               MOVE_LEECH_SEED}},
    {.iv = 150,
     .lvl = 35,
     .species = SPECIES_MARSHTOMP,
     .moves = {MOVE_MUD_SHOT, MOVE_ROCK_TOMB, MOVE_TAKE_DOWN,
               MOVE_BUBBLE_BEAM}}};
// Rival 1
...
static const struct TrainerMon sParty_Mitchell[] = {
    ...
    {.iv = 0,
     .lvl = 48,
     .species = SPECIES_SOLROCK,
     .moves = {MOVE_EXPLOSION, MOVE_REFLECT, MOVE_LIGHT_SCREEN,
               MOVE_SHADOW_BALL}}};
...
static const struct TrainerMon sParty_Isaac5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_SWORDS_DANCE, MOVE_BLIZZARD, MOVE_FAINT_ATTACK,
               MOVE_SLASH}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_SHARPEDO,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 252, 0, 0, 0},
     .moves = {MOVE_MOONLIGHT, MOVE_DOUBLE_TEAM, MOVE_CURSE,
               MOVE_FAINT_ATTACK}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_HOUNDOOM,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_DRAGON_DANCE,
               MOVE_ROCK_SLIDE}}};
// Route 117 BreederF
...
static const struct TrainerMon sParty_MaxieMagmaHideout[] = {
    ...
    {.iv = 200,
     ...
     .species = SPECIES_SHIFTRY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_LEAF_BLADE, MOVE_EXTRASENSORY, MOVE_FAINT_ATTACK,
               MOVE_SUNNY_DAY}},
    {.iv = 150,
     .lvl = 38,
     .species = SPECIES_AGGRON,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_IRON_TAIL, MOVE_ROCK_THROW, MOVE_EARTHQUAKE,
               MOVE_IRON_DEFENSE}},
    {.iv = 150,
     .lvl = 39,
     .species = SPECIES_CROBAT,
    ...
    {.iv = 150,
     ...
     .species = SPECIES_CAMERUPT,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_FIRE_BLAST, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE,
               MOVE_AMNESIA}}};
...
static const struct TrainerMon sParty_MaxieMtChimney[] = {
    ...
    {.iv = 150,
     ...
     .species = SPECIES_CAMERUPT,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_MAGNITUDE, MOVE_FLAME_WHEEL, MOVE_ROCK_TOMB,
               MOVE_MUD_SLAP}}};
// Route 102 Lass
...
static const struct TrainerMon sParty_James5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_BATON_PASS, MOVE_PROTECT, MOVE_SUBSTITUTE,
               MOVE_SILVER_WIND}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_TWINEEDLE, MOVE_ROCK_BLAST, MOVE_METAL_CLAW,
               MOVE_BRICK_BREAK}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_MASQUERAIN,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_SIGNAL_BEAM,
               MOVE_GIGA_DRAIN}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_HERACROSS,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .moves = {MOVE_SLEEP_POWDER, MOVE_SUBSTITUTE, MOVE_GIGA_DRAIN,
               MOVE_PSYCHIC}}};
...
static const struct TrainerMon sParty_Trent5[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 0, 0, 252},
     .moves = {MOVE_EXPLOSION, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE,
               MOVE_DOUBLE_EDGE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_CRADILY,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 0, 252},
     .moves = {MOVE_RECOVER, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED,
               MOVE_MIRROR_COAT}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_SKY_ATTACK, MOVE_ANCIENT_POWER, MOVE_IRON_TAIL,
               MOVE_EARTHQUAKE}}};
...
static const struct TrainerMon sParty_Gerald[] = {
    {.iv = 100,
     .lvl = 26,
     .species = SPECIES_KECLEON,
     .moves = {MOVE_FLAMETHROWER, MOVE_FURY_SWIPES, MOVE_FAINT_ATTACK,
               MOVE_BIND}}};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    {.iv = 100,
     .lvl = 18,
     .species = SPECIES_MEDITITE,
     .moves = {MOVE_THUNDER_PUNCH, MOVE_DETECT, MOVE_CONFUSION,
               MOVE_MEDITATE}}};
...
static const struct TrainerMon sParty_Riley[] = {
    ...
    {.iv = 0,
     .lvl = 30,
     .species = SPECIES_KOFFING,
     .moves = {MOVE_TACKLE, MOVE_SELF_DESTRUCT, MOVE_SLUDGE,
               MOVE_SMOKESCREEN}}};
...
static const struct TrainerMon sParty_WallyVR2[] = {
    {.iv = 255,
     ...
     .species = SPECIES_MAWILE,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_METEOR_MASH,
               MOVE_BATON_PASS}},
    {.iv = 255,
     .lvl = 56,
     .species = SPECIES_DELCATTY,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_MINUN,
     .heldItem = ITEM_WIKI_BERRY,
     .moves = {MOVE_VOLT_TACKLE, MOVE_WISH, MOVE_MAGICAL_LEAF,
               MOVE_THUNDER_WAVE}},
    {.iv = 255,
     .lvl = 57,
     .species = SPECIES_GARDEVOIR,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH,
               MOVE_CALM_MIND}}};
// Rematch 2
static const struct TrainerMon sParty_WallyVR3[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_MAWILE,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_SWORDS_DANCE, MOVE_CRUNCH, MOVE_METEOR_MASH,
               MOVE_BATON_PASS}},
    {.iv = 255,
     .lvl = 61,
     .species = SPECIES_DELCATTY,
...
static const struct TrainerMon sParty_WallyVR4[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_GRASS_WHISTLE, MOVE_LEECH_SEED, MOVE_EARTHQUAKE,
               MOVE_GIGA_DRAIN}},
    {.iv = 255,
     .lvl = 66,
     .species = SPECIES_RAPIDASH,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_OVERHEAT, MOVE_HI_JUMP_KICK, MOVE_HYPNOSIS,
               MOVE_DOUBLE_EDGE}},
    {.iv = 255,
     .lvl = 66,
...
static const struct TrainerMon sParty_WallyVR5[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_AZUMARILL,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_IRON_TAIL, MOVE_DOUBLE_EDGE, MOVE_SUPERPOWER,
               MOVE_HYDRO_PUMP}},
    {.iv = 255,
     .lvl = 73,
     .species = SPECIES_ALTARIA,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_MEGANIUM,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_GRASS_WHISTLE, MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE,
               MOVE_BODY_SLAM}}};
...
static const struct TrainerMon sParty_BrendanLilycoveTreecko[] = {
    ...
    {.iv = 200,
     .lvl = 38,
     .species = SPECIES_BLAZIKEN,
     .moves = {MOVE_BLAZE_KICK, MOVE_ROLLING_KICK, MOVE_BULK_UP,
               MOVE_MACH_PUNCH}}};
// Lilycove Rival 5
static const struct TrainerMon sParty_BrendanLilycoveTorchic[] = {
    ...
    {.iv = 150,
     .lvl = 36,
     .species = SPECIES_PINSIR,
     .moves = {MOVE_SEISMIC_TOSS, MOVE_REVENGE, MOVE_TWINEEDLE,
               MOVE_BRICK_BREAK}},
    {.iv = 150,
     .lvl = 36,
     .species = SPECIES_BRELOOM,
...
static const struct TrainerMon sParty_TyraAndIvy[] = {
    ...
    {.iv = 0,
     .lvl = 25,
     .species = SPECIES_GRAVELER,
     .moves = {MOVE_DEFENSE_CURL, MOVE_MAGNITUDE, MOVE_TACKLE,
               MOVE_ROCK_THROW}}};
...
static const struct TrainerMon sParty_Dawson[] = {
    {.iv = 0, .lvl = 10, .species = SPECIES_SPOINK, .heldItem = ITEM_NUGGET},
    {.iv = 0, .lvl = 10, .species = SPECIES_POOCHYENA, .heldItem = ITEM_NONE}};
// Route 116 Cut Lady
static const struct TrainerMon sParty_Sarah[] = {
    {.iv = 0, .lvl = 10, .species = SPECIES_LOTAD, .heldItem = ITEM_NONE},
    {.iv = 0,
     .lvl = 12,
...
static const struct TrainerMon sParty_Kaleb[] = {
    ...
    {.iv = 0,
     ...
     .species = SPECIES_PLUSLE,
     .heldItem = ITEM_ORAN_BERRY,
     .moves = {MOVE_THUNDER_SHOCK, MOVE_GROWL, MOVE_DOUBLE_TEAM,
               MOVE_QUICK_ATTACK}}};
...
static const struct TrainerMon sParty_TabithaMagmaHideout[] = {
    {.iv = 50,
     .lvl = 36,
     .species = SPECIES_CROBAT,
     .moves = {MOVE_WING_ATTACK, MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB,
               MOVE_CONFUSE_RAY}},
    {.iv = 50,
     .lvl = 35,
     .species = SPECIES_LAIRON,
    ...
    {.iv = 50,
     .lvl = 35,
     .species = SPECIES_CACTURNE,
     .moves = {MOVE_NEEDLE_ARM, MOVE_FAINT_ATTACK, MOVE_LEECH_SEED,
               MOVE_INGRAIN}},
    {.iv = 50,
     .lvl = 37,
     .species = SPECIES_ZANGOOSE,
     .moves = {MOVE_CRUSH_CLAW, MOVE_FAINT_ATTACK, MOVE_SWORDS_DANCE,
               MOVE_METAL_CLAW}}};
...
static const struct TrainerMon sParty_MaxieMossdeep[] = {
    {.iv = 200,
     ...
     .species = SPECIES_HOUNDOOM,
     .heldItem = ITEM_SALAC_BERRY,
     .moves = {MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM,
               MOVE_CRUNCH}},
    {.iv = 200,
     .lvl = 44,
     .species = SPECIES_SHIFTRY,
    ...
    {.iv = 200,
     ...
     .species = SPECIES_CAMERUPT,
     .heldItem = ITEM_FOCUS_BAND,
     .moves = {MOVE_HEAT_WAVE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE,
               MOVE_SUNNY_DAY}}};
...
static const struct TrainerMon sParty_Bryan[] = {
    {.iv = 50,
     .lvl = 30,
     .species = SPECIES_CACTURNE,
     .moves = {MOVE_GROWTH, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN,
               MOVE_FAINT_ATTACK}},
    {.iv = 100,
     .lvl = 31,
     .species = SPECIES_NOSEPASS,
...
static const struct TrainerMon sParty_Roxanne3[] = {
    ...
    {.iv = 255,
     ...
     .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SANDSTORM,
               MOVE_ROCK_SMASH}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_CRADILY,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_NOSEPASS,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_SMELLING_SALT, MOVE_PROTECT, MOVE_THUNDERBOLT,
               MOVE_THUNDER_WAVE}}};
// Roxanne Rematch 3
static const struct TrainerMon sParty_Roxanne4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_AERODACTYL,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE, MOVE_SKY_ATTACK,
               MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_DONPHAN,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_CRADILY,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_INGRAIN, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,
               MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 60,
...
static const struct TrainerMon sParty_Roxanne5[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_CHOICE_BAND,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_PURSUIT,
               MOVE_AERIAL_ACE}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_FLYGON,
     .heldItem = ITEM_LEFTOVERS,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SUBSTITUTE,
               MOVE_FIRE_BLAST}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_AERODACTYL,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_QUICK_CLAW,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_KNOCK_OFF, MOVE_SWORDS_DANCE, MOVE_TWINEEDLE,
               MOVE_ROCK_BLAST}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_NOSEPASS,
     .heldItem = ITEM_BRIGHT_POWDER,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_THUNDER_WAVE,
               MOVE_DOUBLE_TEAM}}};
...
static const struct TrainerMon sParty_Brawly2[] = {
    {.iv = 180,
     ...
     .species = SPECIES_MEDITITE,
     .heldItem = ITEM_SALAC_BERRY,
     .moves = {MOVE_EXTRASENSORY, MOVE_THUNDER_PUNCH, MOVE_LIGHT_SCREEN,
               MOVE_REFLECT}},
    {.iv = 100,
     .lvl = 30,
     .species = SPECIES_MACHOKE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_KARATE_CHOP, MOVE_ROCK_TOMB, MOVE_SEISMIC_TOSS,
               MOVE_REVENGE}},
    {.iv = 100,
     .lvl = 31,
     .species = SPECIES_BRELOOM,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_MACH_PUNCH, MOVE_MEGA_DRAIN, MOVE_BULK_UP,
               MOVE_STUN_SPORE}},
    {.iv = 200,
     .lvl = 32,
     .species = SPECIES_HARIYAMA,
...
static const struct TrainerMon sParty_Brawly3[] = {
    {.iv = 255,
     ...
     .species = SPECIES_HITMONCHAN,
     .heldItem = ITEM_BLACK_BELT,
     .moves = {MOVE_DYNAMIC_PUNCH, MOVE_ROCK_SLIDE, MOVE_AGILITY,
               MOVE_BULK_UP}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_BRELOOM,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_FOCUS_PUNCH, MOVE_LEECH_SEED, MOVE_STUN_SPORE,
               MOVE_SUBSTITUTE}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_POLIWRATH,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_PRIMEAPE,
     .heldItem = ITEM_HARD_STONE,
     .moves = {MOVE_CROSS_CHOP, MOVE_BULK_UP, MOVE_ROCK_SLIDE,
               MOVE_FAINT_ATTACK}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_HARIYAMA,
...
static const struct TrainerMon sParty_Brawly4[] = {
    {.iv = 255,
     ...
     .species = SPECIES_POLIWRATH,
     .heldItem = ITEM_SALAC_BERRY,
     .moves = {MOVE_BELLY_DRUM, MOVE_BRICK_BREAK, MOVE_SUBSTITUTE,
               MOVE_EARTHQUAKE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_MAGMAR,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_OVERHEAT, MOVE_THUNDER_PUNCH, MOVE_CROSS_CHOP,
               MOVE_FOLLOW_ME}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_MEDICHAM,
     .heldItem = ITEM_BLACK_BELT,
     .moves = {MOVE_FAKE_OUT, MOVE_HI_JUMP_KICK, MOVE_BULK_UP,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_ELECTABUZZ,
     .heldItem = ITEM_MAGNET,
     .moves = {MOVE_CROSS_CHOP, MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH,
               MOVE_THUNDER_WAVE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_BRELOOM,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_HARIYAMA,
     .heldItem = ITEM_CHOICE_BAND,
     .moves = {MOVE_BODY_SLAM, MOVE_ROCK_SLIDE, MOVE_CROSS_CHOP,
               MOVE_EARTHQUAKE}}};
// Brawly Rematch 4
static const struct TrainerMon sParty_Brawly5[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_WHITE_HERB,
     .evs = {0, 252, 0, 0, 252, 0},
     .moves = {MOVE_OVERHEAT, MOVE_THUNDER_PUNCH, MOVE_HI_JUMP_KICK,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_MEDICHAM,
     .heldItem = ITEM_CHOICE_BAND,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_MEGA_KICK, MOVE_HI_JUMP_KICK, MOVE_BRICK_BREAK,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_HERACROSS,
     .heldItem = ITEM_QUICK_CLAW,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_MEGAHORN,
               MOVE_SWORDS_DANCE}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_HARIYAMA,
...
static const struct TrainerMon sParty_Wattson2[] = {
    {.iv = 210,
     ...
     .species = SPECIES_PLUSLE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_THUNDERBOLT, MOVE_MAGICAL_LEAF, MOVE_CHARM,
               MOVE_THUNDER_WAVE}},
    {.iv = 210,
     .lvl = 34,
     .species = SPECIES_MINUN,
    ...
    {.iv = 220,
     ...
     .species = SPECIES_LANTURN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_CONFUSE_RAY,
               MOVE_THUNDER_WAVE}},
    {.iv = 230,
     .lvl = 33,
     .species = SPECIES_MAGNETON,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_REFLECT,
               MOVE_TRI_ATTACK}},
    {.iv = 250,
     .lvl = 35,
     .species = SPECIES_MANECTRIC,
...
static const struct TrainerMon sParty_Wattson3[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_LANTURN,
     .heldItem = ITEM_WIKI_BERRY,
     .moves = {MOVE_RAIN_DANCE, MOVE_DIVE, MOVE_THUNDER_WAVE,
               MOVE_CONFUSE_RAY}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_JOLTEON,
...
static const struct TrainerMon sParty_Wattson4[] = {
    {.iv = 255,
     ...
     .species = SPECIES_PLUSLE,
     .heldItem = ITEM_PETAYA_BERRY,
     .moves = {MOVE_THUNDERBOLT, MOVE_MAGICAL_LEAF, MOVE_THUNDER_WAVE,
               MOVE_SUBSTITUTE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_MINUN,
...
static const struct TrainerMon sParty_Flannery2[] = {
    {.iv = 240,
     ...
     .species = SPECIES_NINETALES,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_HEAT_WAVE, MOVE_SOLAR_BEAM, MOVE_WILL_O_WISP,
               MOVE_SUNNY_DAY}},
    {.iv = 230,
     .lvl = 38,
     .species = SPECIES_CASTFORM,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_WEATHER_BALL, MOVE_SUNNY_DAY, MOVE_HEADBUTT,
               MOVE_ICE_BEAM}},
    {.iv = 230,
     .lvl = 39,
     .species = SPECIES_MAGCARGO,
    ...
    {.iv = 240,
     ...
     .species = SPECIES_RAPIDASH,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_OVERHEAT, MOVE_DOUBLE_KICK, MOVE_IRON_TAIL,
               MOVE_DOUBLE_EDGE}},
    {.iv = 250,
     .lvl = 40,
     .species = SPECIES_TORKOAL,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_BODY_SLAM,
               MOVE_SLUDGE_BOMB}}};
// Flannery Rematch 2
static const struct TrainerMon sParty_Flannery3[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_BELLOSSOM,
     .heldItem = ITEM_MIRACLE_SEED,
     .moves = {MOVE_SYNTHESIS, MOVE_SOLAR_BEAM, MOVE_SLEEP_POWDER,
               MOVE_SUNNY_DAY}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_CAMERUPT,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_CHARIZARD,
     .heldItem = ITEM_HARD_STONE,
     .moves = {MOVE_OVERHEAT, MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_MAGMAR,
     .heldItem = ITEM_CHARCOAL,
     .moves = {MOVE_FIRE_BLAST, MOVE_PSYCHIC, MOVE_THUNDER_PUNCH,
               MOVE_CONFUSE_RAY}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_TORKOAL,
...
static const struct TrainerMon sParty_Flannery4[] = {
    {.iv = 255,
     ...
     .species = SPECIES_CHARIZARD,
     .heldItem = ITEM_CHARCOAL,
     .moves = {MOVE_SUNNY_DAY, MOVE_HEAT_WAVE, MOVE_DRAGON_CLAW,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_CAMERUPT,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_JUMPLUFF,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_SLEEP_POWDER, MOVE_SYNTHESIS, MOVE_LEECH_SEED,
               MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_HOUNDOOM,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_RAPIDASH,
     .heldItem = ITEM_FOCUS_BAND,
     .moves = {MOVE_FIRE_BLAST, MOVE_HI_JUMP_KICK, MOVE_BATON_PASS,
               MOVE_AGILITY}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_TORKOAL,
...
static const struct TrainerMon sParty_Flannery5[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_SCOPE_LENS,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_LEAF_BLADE, MOVE_FAINT_ATTACK, MOVE_SYNTHESIS,
               MOVE_SUNNY_DAY}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_BLAZIKEN,
     .heldItem = ITEM_BLACK_BELT,
     .evs = {0, 252, 0, 0, 252, 0},
     .moves = {MOVE_BLAZE_KICK, MOVE_HI_JUMP_KICK, MOVE_THUNDER_PUNCH,
               MOVE_BOUNCE}},
    {.iv = 255,
     .lvl = 65,
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    {.iv = 250,
     ...
     .species = SPECIES_EXPLOUD,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_OVERHEAT, MOVE_TEETER_DANCE, MOVE_HYPER_VOICE,
               MOVE_WATER_PULSE}},
    {.iv = 250,
     .lvl = 50,
     .species = SPECIES_ZANGOOSE,
...
static const struct TrainerMon sParty_Norman3[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_SILK_SCARF,
     .moves = {MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_REFLECT,
               MOVE_DOUBLE_EDGE}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_PORYGON2,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_EXPLOUD,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_TEETER_DANCE, MOVE_HYPER_VOICE, MOVE_OVERHEAT,
               MOVE_BRICK_BREAK}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_GIRAFARIG,
...
static const struct TrainerMon sParty_Norman4[] = {
    {.iv = 255,
     ...
     .species = SPECIES_TAUROS,
     .heldItem = ITEM_LUM_BERRY,
     .moves = {MOVE_DOUBLE_EDGE, MOVE_PURSUIT, MOVE_IRON_TAIL,
               MOVE_EARTHQUAKE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_GRANBULL,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_SLAKING,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_EARTHQUAKE, MOVE_HYPER_BEAM, MOVE_DOUBLE_EDGE,
               MOVE_BRICK_BREAK}}};
// Norman Rematch 4
static const struct TrainerMon sParty_Norman5[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_QUICK_CLAW,
     .evs = {252, 0, 252, 0, 0, 0},
     .moves = {MOVE_SEISMIC_TOSS, MOVE_HEAL_BELL, MOVE_SKILL_SWAP,
               MOVE_THUNDER_WAVE}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_TAUROS,
     .heldItem = ITEM_LUM_BERRY,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_IRON_TAIL,
               MOVE_PURSUIT}},
    {.iv = 255,
     .lvl = 65,
...
static const struct TrainerMon sParty_Winona2[] = {
    {.iv = 250,
     ...
     .species = SPECIES_CROBAT,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_AERIAL_ACE, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN,
               MOVE_DOUBLE_EDGE}},
    {.iv = 255,
     .lvl = 49,
     .species = SPECIES_SKARMORY,
    ...
    {.iv = 250,
     ...
     .species = SPECIES_TROPIUS,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_ROCK_SMASH, MOVE_GIGA_DRAIN, MOVE_EARTHQUAKE,
               MOVE_WHIRLWIND}},
    {.iv = 250,
     .lvl = 49,
     .species = SPECIES_SWELLOW,
...
static const struct TrainerMon sParty_Winona3[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_MASQUERAIN,
     .heldItem = ITEM_MYSTIC_WATER,
     .moves = {MOVE_STUN_SPORE, MOVE_HYDRO_PUMP, MOVE_GIGA_DRAIN,
               MOVE_SHADOW_BALL}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_MURKROW,
     .heldItem = ITEM_SHARP_BEAK,
     .moves = {MOVE_SKY_ATTACK, MOVE_DOUBLE_EDGE, MOVE_FAINT_ATTACK,
               MOVE_STEEL_WING}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_PIDGEOT,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_SKY_ATTACK, MOVE_EXTREME_SPEED, MOVE_PROTECT,
               MOVE_PURSUIT}},
    {.iv = 255,
     .lvl = 55,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_CHOICE_BAND,
     .moves = {MOVE_SKY_ATTACK, MOVE_DOUBLE_EDGE, MOVE_IRON_TAIL,
               MOVE_EARTHQUAKE}}};
// Winona Rematch 3
static const struct TrainerMon sParty_Winona4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_TROPIUS,
     .heldItem = ITEM_SOFT_SAND,
     .moves = {MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_FACADE,
               MOVE_STEEL_WING}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_DRAGONITE,
     .heldItem = ITEM_KINGS_ROCK,
     .moves = {MOVE_THUNDER_WAVE, MOVE_WATERFALL, MOVE_EARTHQUAKE,
               MOVE_THUNDERBOLT}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_SWELLOW,
     .heldItem = ITEM_FOCUS_BAND,
     .moves = {MOVE_SKY_ATTACK, MOVE_STEEL_WING, MOVE_AGILITY,
               MOVE_BATON_PASS}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_ALTARIA,
...
static const struct TrainerMon sParty_Winona5[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_THUNDER_WAVE, MOVE_EARTHQUAKE, MOVE_DYNAMIC_PUNCH,
               MOVE_THUNDERBOLT}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_YANMA,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_FOCUS_BAND,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_FIRE_BLAST, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_SWELLOW,
     .heldItem = ITEM_STARF_BERRY,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_SUBSTITUTE, MOVE_ENDEAVOR, MOVE_QUICK_ATTACK,
               MOVE_BATON_PASS}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_TROPIUS,
     .heldItem = ITEM_SOFT_SAND,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_GIGA_DRAIN,
               MOVE_SYNTHESIS}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_LUM_BERRY,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_SKY_ATTACK, MOVE_DRAGON_DANCE, MOVE_PURSUIT,
               MOVE_EARTHQUAKE}}};
...
static const struct TrainerMon sParty_TateAndLiza3[] = {
    {.iv = 250,
     ...
     .species = SPECIES_MEDICHAM,
     .heldItem = ITEM_BLACK_BELT,
     .moves = {MOVE_SUNNY_DAY, MOVE_FIRE_PUNCH, MOVE_FAKE_OUT,
               MOVE_HI_JUMP_KICK}},
    {.iv = 250,
     .lvl = 55,
     .species = SPECIES_CLAYDOL,
    ...
    {.iv = 250,
     ...
     .species = SPECIES_GARDEVOIR,
     .heldItem = ITEM_TWISTED_SPOON,
     .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_FIRE_PUNCH,
               MOVE_THUNDERBOLT}},
    {.iv = 250,
     .lvl = 55,
     .species = SPECIES_EXEGGUTOR,
     .heldItem = ITEM_LUM_BERRY,
     .moves = {MOVE_SYNTHESIS, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY,
               MOVE_SLEEP_POWDER}},
    {.iv = 250,
     .lvl = 55,
     .species = SPECIES_LUNATONE,
...
static const struct TrainerMon sParty_TateAndLiza4[] = {
    ...
    {.iv = 250,
     ...
     .species = SPECIES_ALAKAZAM,
     .heldItem = ITEM_CHOICE_BAND,
     .moves = {MOVE_PSYCHIC, MOVE_TRICK, MOVE_THUNDER_PUNCH,
               MOVE_THUNDER_WAVE}},
    {.iv = 250,
     .lvl = 60,
     .species = SPECIES_LUNATONE,
...
static const struct TrainerMon sParty_TateAndLiza5[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_QUICK_CLAW,
     .evs = {0, 0, 252, 0, 0, 252},
     .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_SKILL_SWAP,
               MOVE_LIGHT_SCREEN}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_UMBREON,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_STARF_BERRY,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_BATON_PASS, MOVE_CALM_MIND, MOVE_SHADOW_BALL,
               MOVE_PSYCHIC}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_LUNATONE,
     .heldItem = ITEM_LEFTOVERS,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_BATON_PASS,
               MOVE_COSMIC_POWER}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_SOLROCK,
     .heldItem = ITEM_LUM_BERRY,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_CALM_MIND,
               MOVE_BATON_PASS}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_METAGROSS,
     .heldItem = ITEM_WIKI_BERRY,
     .evs = {0, 252, 0, 0, 252, 0},
     .moves = {MOVE_PSYCHIC, MOVE_METEOR_MASH, MOVE_ICE_PUNCH,
               MOVE_ROCK_SLIDE}}};
...
static const struct TrainerMon sParty_Juan3[] = {
    {.iv = 255,
     ...
     .species = SPECIES_HUNTAIL,
     .heldItem = ITEM_FOCUS_BAND,
     .moves = {MOVE_CRUNCH, MOVE_DRAGON_DANCE, MOVE_BATON_PASS,
               MOVE_HYDRO_PUMP}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_GOREBYSS,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_RELICANTH,
     .heldItem = ITEM_HARD_STONE,
     .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE,
               MOVE_RAIN_DANCE}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_KINGDRA,
...
static const struct TrainerMon sParty_Juan4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_AZUMARILL,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_SUPERPOWER, MOVE_DOUBLE_EDGE, MOVE_IRON_TAIL,
               MOVE_HYDRO_PUMP}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_LANTURN,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_RAIN_DANCE, MOVE_HYDRO_PUMP, MOVE_THUNDER,
               MOVE_THUNDER_WAVE}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_KINGDRA,
...
static const struct TrainerMon sParty_Juan5[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_SCOPE_LENS,
     .evs = {0, 252, 0, 0, 252, 0},
     .moves = {MOVE_CRABHAMMER, MOVE_RAIN_DANCE, MOVE_ANCIENT_POWER,
               MOVE_CRUNCH}},
    {.iv = 255,
     .lvl = 65,
     .species = SPECIES_BLASTOISE,
...
static const struct TrainerMon sParty_Angelo[] = {
    ...
    {.iv = 100,
     ...
     .species = SPECIES_VOLBEAT,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY,
               MOVE_NONE}}};
...
static const struct TrainerMon sParty_Steven1[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_CLAYDOL,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_PSYCHIC, MOVE_EARTHQUAKE, MOVE_LIGHT_SCREEN,
               MOVE_EXPLOSION}},
    {.iv = 255,
     .lvl = 56,
     .species = SPECIES_AGGRON,
     .heldItem = ITEM_SALAC_BERRY,
     .moves = {MOVE_THUNDER_WAVE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE,
               MOVE_IRON_TAIL}},
    {.iv = 255,
     .lvl = 57,
     .species = SPECIES_CRADILY,
...
static const struct TrainerMon sParty_Steven2[] = {
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_SALAC_BERRY,
     .evs = {0, 252, 252, 0, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_CRUNCH,
               MOVE_THUNDERBOLT}},
    {.iv = 255,
     .lvl = 77,
     .species = SPECIES_AERODACTYL,
     .heldItem = ITEM_CHOICE_BAND,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SKY_ATTACK,
               MOVE_DOUBLE_EDGE}},
    {.iv = 255,
     .lvl = 76,
     .species = SPECIES_CRADILY,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_LUM_BERRY,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_METEOR_MASH,
               MOVE_FIRE_PUNCH}}};
...
static const struct TrainerMon sParty_Andres5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_2,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_SANDSTORM, MOVE_SLUDGE_BOMB,
               MOVE_ROCK_TOMB}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_DUGTRIO,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_TRI_ATTACK, MOVE_ROCK_SLIDE,
               MOVE_AERIAL_ACE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_STEELIX,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .moves = {MOVE_MIRROR_COAT, MOVE_EARTHQUAKE, MOVE_MUDDY_WATER,
               MOVE_COUNTER}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_FLYGON,
     ...
     .moves = {MOVE_EARTHQUAKE, MOVE_GIGA_DRAIN, MOVE_FIRE_BLAST,
               MOVE_ROCK_SLIDE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
...
static const struct TrainerMon sParty_Cristin5[] = {
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 0, 252, 0},
     .moves = {MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_IRON_TAIL,
               MOVE_SUBSTITUTE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_MILTANK,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_MEGA_KICK, MOVE_IRON_TAIL, MOVE_ROCK_SLIDE,
               MOVE_DYNAMIC_PUNCH}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_GRANBULL,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_THUNDER_WAVE, MOVE_SMELLING_SALT, MOVE_CRUNCH,
               MOVE_BULK_UP}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_SNORLAX,
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_FACADE,
               MOVE_THUNDER_WAVE}},
    {.ivs = BEST_IV_SPREAD,
     .lvl = 65,
     .species = SPECIES_PORYGON2,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_SUBSTITUTE, MOVE_RECYCLE, MOVE_TRI_ATTACK,
               MOVE_THUNDER_WAVE}}};

static const struct TrainerMon sParty_Fernando2[] = {
    {.iv = 10, .lvl = 35, .species = SPECIES_ELECTRODE},
    {
        .iv = 10,
        .lvl = 35,
        .species = SPECIES_MANECTRIC,
...
static const struct TrainerMon sParty_Sawyer4[] = {
    ...
    {.iv = 30, .lvl = 46, .species = SPECIES_CAMERUPT},
    {
        .iv = 30,
        .lvl = 46,
        .species = SPECIES_GRAVELER,
...
static const struct TrainerMon sParty_WallyPetalburg[] = {
    ...
    {.iv = 100,
     .lvl = 29,
     .species = SPECIES_KIRLIA,
     .moves = {MOVE_PSYCHIC, MOVE_DOUBLE_TEAM, MOVE_SHOCK_WAVE,
               MOVE_CALM_MIND}}};
...
static const struct TrainerMon sParty_Courtney1[] = {
    {.iv = 100,
     ...
     .species = SPECIES_MURKROW,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_WING_ATTACK, MOVE_FAINT_ATTACK, MOVE_ICY_WIND,
               MOVE_STEEL_WING}},
    {.iv = 100,
     .lvl = 37,
     .species = SPECIES_ROSELIA,
     .heldItem = ITEM_PERSIM_BERRY,
     .moves = {MOVE_PETAL_DANCE, MOVE_SLUDGE_BOMB, MOVE_GRASS_WHISTLE,
               MOVE_SYNTHESIS}},
    {.iv = 100,
     .lvl = 37,
     .species = SPECIES_CLAYDOL,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_PSYCHIC, MOVE_ANCIENT_POWER, MOVE_LIGHT_SCREEN,
               MOVE_REFLECT}},
    {.iv = 150,
     .lvl = 38,
     .species = SPECIES_NINETALES,
...
static const struct TrainerMon sParty_Courtney2[] = {
    {.iv = 100,
     ...
     .species = SPECIES_MURKROW,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_DRILL_PECK, MOVE_FAINT_ATTACK, MOVE_ICY_WIND,
               MOVE_STEEL_WING}},
    {.iv = 100,
     .lvl = 43,
     .species = SPECIES_ROSELIA,
...
static const struct TrainerMon sParty_MattMyPyre[] = {
    {.iv = 150,
     ...
     .species = SPECIES_ELECTRODE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_LIGHT_SCREEN,
               MOVE_MIRROR_COAT}},
    {.iv = 150,
     .lvl = 36,
     .species = SPECIES_CRAWDAUNT,
...
static const struct TrainerMon sParty_ArchieMarineCave[] = {
    ...
    {.iv = 150,
     ...
     .species = SPECIES_MACHAMP,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_BULK_UP, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE,
               MOVE_CROSS_CHOP}},
    {.iv = 150,
     .lvl = 67,
     .species = SPECIES_WAILORD,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_WATER_SPOUT, MOVE_RAIN_DANCE, MOVE_EARTHQUAKE,
               MOVE_ICE_BEAM}},
    {.iv = 150,
     .lvl = 66,
     .species = SPECIES_MUK,
...
static const struct TrainerMon sParty_MaxieTerraCave[] = {
    ...
    {.iv = 150,
     ...
     .species = SPECIES_SHIFTRY,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_LEAF_BLADE, MOVE_EXPLOSION, MOVE_FAINT_ATTACK,
               MOVE_EXTRASENSORY}},
    {.iv = 150,
     .lvl = 66,
     .species = SPECIES_HOUNDOOM,
    ...
    {.iv = 150,
     ...
     .species = SPECIES_WEEZING,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_EXPLOSION, MOVE_SUNNY_DAY, MOVE_SHADOW_BALL,
               MOVE_FIRE_BLAST}},
    {.iv = 150,
     .lvl = 65,
     .species = SPECIES_STEELIX,
     .heldItem = ITEM_SALAC_BERRY,
     .moves = {MOVE_SUNNY_DAY, MOVE_EXPLOSION, MOVE_ROCK_SLIDE,
               MOVE_EARTHQUAKE}},
    {.iv = 220,
     .lvl = 67,
     .species = SPECIES_CAMERUPT,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_ERUPTION, MOVE_EARTHQUAKE, MOVE_HEAT_WAVE,
               MOVE_ROCK_SLIDE}}};
...
static const struct TrainerMon sParty_Zinnia[] = {
    ...
    {.iv = 150,
     ...
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_FIRE_PUNCH,
               MOVE_HEAL_BELL}},
    {.iv = 150,
     .lvl = 70,
     .species = SPECIES_SCEPTILE,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_LEECH_SEED, MOVE_DRAGON_CLAW, MOVE_LEAF_BLADE,
               MOVE_DOUBLE_TEAM}},
    {.iv = 150,
     .lvl = 70,
     .species = SPECIES_FLYGON,
     .heldItem = ITEM_CHOICE_BAND,
     .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_SIGNAL_BEAM,
               MOVE_CRUNCH}},
    {.iv = 150,
     .lvl = 70,
     .species = SPECIES_CHARIZARD,
     .heldItem = ITEM_PETAYA_BERRY,
     .moves = {MOVE_ENDURE, MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW,
               MOVE_HEAT_WAVE}},
    {.iv = 220,
     .lvl = 70,
     .species = SPECIES_SALAMENCE,
...
static const struct TrainerMon sParty_Sidney2[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_PETAYA_BERRY,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_PROTECT, MOVE_SUBSTITUTE, MOVE_BATON_PASS,
               MOVE_AERIAL_ACE}},
    {.iv = 255,
     .lvl = 68,
     .species = SPECIES_SHIFTRY,
...
static const struct TrainerMon sParty_Phoebe2[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_QUICK_CLAW,
     .evs = {252, 0, 252, 0, 0, 0},
     .moves = {MOVE_PERISH_SONG, MOVE_PROTECT, MOVE_PAIN_SPLIT,
               MOVE_DESTINY_BOND}},
    {.iv = 255,
     .lvl = 68,
     .species = SPECIES_WOBBUFFET,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_CHOICE_BAND,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_HI_JUMP_KICK, MOVE_MEGA_KICK, MOVE_REVERSAL,
               MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 70,
     .species = SPECIES_GENGAR,
     .heldItem = ITEM_SPELL_TAG,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_EXPLOSION,
               MOVE_FIRE_PUNCH}},
    {.iv = 255,
     .lvl = 70,
     .species = SPECIES_DUSCLOPS,
     .heldItem = ITEM_LEFTOVERS,
     .evs = {252, 0, 0, 0, 0, 252},
     .moves = {MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_CALM_MIND,
               MOVE_PAIN_SPLIT}}};
...
static const struct TrainerMon sParty_Glacia2[] = {
    ...
    {.iv = 255,
     ...
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_BLIZZARD, MOVE_WATER_PULSE, MOVE_SHADOW_BALL,
               MOVE_EXPLOSION}},
    {.iv = 255,
     .lvl = 72,
     .species = SPECIES_JYNX,
...
static const struct TrainerMon sParty_Drake2[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_QUICK_CLAW,
     .evs = {252, 252, 0, 0, 0, 0},
     .moves = {MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE,
               MOVE_CRUNCH}},
    {.iv = 255,
     .lvl = 73,
     .species = SPECIES_DRAGONITE,
     .heldItem = ITEM_BLACK_BELT,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_THUNDERBOLT, MOVE_DYNAMIC_PUNCH, MOVE_FLAMETHROWER,
               MOVE_EARTHQUAKE}},
    {.iv = 255,
     .lvl = 72,
     .species = SPECIES_CHARIZARD,
     .heldItem = ITEM_SALAC_BERRY,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_FIRE_BLAST, MOVE_BELLY_DRUM, MOVE_EARTHQUAKE,
               MOVE_DOUBLE_EDGE}},
    {.iv = 255,
     .lvl = 72,
     .species = SPECIES_SCEPTILE,
     .heldItem = ITEM_PETAYA_BERRY,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_LEAF_BLADE, MOVE_DRAGON_CLAW, MOVE_THUNDER_PUNCH,
               MOVE_ENDURE}},
    {.iv = 255,
     .lvl = 73,
     .species = SPECIES_KINGDRA,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_LUM_BERRY,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_IRON_TAIL, MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE,
               MOVE_EARTHQUAKE}}};
...
static const struct TrainerMon sParty_Smith[] = {
    ...
    {.ivs = BEST_IV_SPREAD,
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_SHADOW_BALL, MOVE_ICE_PUNCH, MOVE_THUNDER,
               MOVE_GIGA_DRAIN}}};
...
static const struct TrainerMon sParty_Craig[] = {
    {.nickname = _("MEGANIUM"),
     ...
     .moves = {MOVE_GRASS_WHISTLE, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED,
               MOVE_REFLECT}},
    {.nickname = _("AERODACTYL"),
     ...
     .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE,
               MOVE_AERIAL_ACE}},
    {.nickname = _("MILOTIC"),
     .ivs = BEST_IV_SPREAD,
     .lvl = 70,
    ...
    {.nickname = _("RAYQUAZA"),
     ...
     .moves = {MOVE_CRUNCH, MOVE_DRAGON_CLAW, MOVE_THUNDERBOLT,
               MOVE_BRICK_BREAK}},
    {.nickname = _("JOLTEON"),
     .ivs = BEST_IV_SPREAD_HIDDEN_POWER_ICE,
     .lvl = 70,
     ...
     .moves = {MOVE_THUNDERBOLT, MOVE_HELPING_HAND, MOVE_SHADOW_BALL,
               MOVE_HIDDEN_POWER}},
    {.nickname = _("FURBALL"),
     .ivs = BEST_IV_SPREAD,
     .lvl = 70,
     ...
     .moves = {MOVE_OVERHEAT, MOVE_HELPING_HAND, MOVE_EXTREME_SPEED,
               MOVE_PROTECT}}};
...
static const struct TrainerMon sParty_Weebra[] = {
    {.nickname = _("JIRACHI"),
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 0, 0, 252, 252, 0},
     .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_SECRET_POWER,
               MOVE_ICE_PUNCH}},
    {.nickname = _("LUDICOLO"),
     .ivs = BEST_IV_SPREAD,
     .lvl = 70,
    ...
    {.nickname = _("METAGROSS"),
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {0, 252, 0, 252, 0, 0},
     .moves = {MOVE_EXPLOSION, MOVE_BRICK_BREAK, MOVE_METEOR_MASH,
               MOVE_EARTHQUAKE}},
    {.nickname = _("LATIOS"),
     .ivs = BEST_IV_SPREAD,
     .lvl = 70,
    ...
    {.nickname = _("CINDERELLA"),
     ...
     .ability = ABILITY_SLOT_1,
     .evs = {252, 0, 0, 252, 0, 0},
     .moves = {MOVE_FAKE_OUT, MOVE_TRIPLE_KICK, MOVE_BULK_UP,
               MOVE_ROCK_SLIDE}}};
