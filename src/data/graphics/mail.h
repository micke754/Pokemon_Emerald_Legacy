const u16 gMailPalette_Orange[] =
    INCBIN_U16("graphics/mail/orange/palette.gbapal");
const u16 gMailPalette_Harbor[] =
    INCBIN_U16("graphics/mail/harbor/palette.gbapal");
const u16 gMailPalette_Glitter[] =
    INCBIN_U16("graphics/mail/glitter/palette.gbapal");
...
const u16 gMailPalette_Shadow[] =
    INCBIN_U16("graphics/mail/shadow/palette.gbapal");
const u16 gMailPalette_Tropic[] =
    INCBIN_U16("graphics/mail/tropic/palette.gbapal");
const u16 gMailPalette_Dream[] =
    INCBIN_U16("graphics/mail/dream/palette.gbapal");
const u16 gMailPalette_Fab[] = INCBIN_U16("graphics/mail/fab/palette.gbapal");
const u16 gMailPalette_Retro[] =
    INCBIN_U16("graphics/mail/retro/palette.gbapal");

const u32 gMailTiles_Orange[] =
    INCBIN_U32("graphics/mail/orange/tiles.4bpp.lz");
const u32 gMailTiles_Harbor[] =
    INCBIN_U32("graphics/mail/harbor/tiles.4bpp.lz");
const u32 gMailTiles_Glitter[] =
    INCBIN_U32("graphics/mail/glitter/tiles.4bpp.lz");
...
const u32 gMailTiles_Shadow[] =
    INCBIN_U32("graphics/mail/shadow/tiles.4bpp.lz");
const u32 gMailTiles_Tropic[] =
    INCBIN_U32("graphics/mail/tropic/tiles.4bpp.lz");
...
const u32 gMailTilemap_Glitter[] =
    INCBIN_U32("graphics/mail/glitter/map.bin.lz");
