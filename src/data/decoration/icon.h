const u32 *const gDecorIconTable[][2] = {
    ...
    [DECOR_COMFORT_DESK] = {gDecorIcon_ComfortDesk,
                            gDecorIconPalette_ComfortDesk},
    ...
    [DECOR_TROPICAL_PLANT] = {gDecorIcon_TropicalPlant,
                              gDecorIconPalette_TropicalPlant},
    [DECOR_PRETTY_FLOWERS] = {gDecorIcon_PrettyFlowers,
                              gDecorIconPalette_PrettyFlowers},
    [DECOR_COLORFUL_PLANT] = {gDecorIcon_ColorfulPlant,
                              gDecorIconPalette_ColorfulPlant},
    [DECOR_BIG_PLANT] = {gDecorIcon_BigPlant, gDecorIconPalette_BigPlant},
    [DECOR_GORGEOUS_PLANT] = {gDecorIcon_GorgeousPlant,
                              gDecorIconPalette_GorgeousPlant},
    [DECOR_RED_BRICK] = {gDecorIcon_RedBrick, gDecorIconPalette_RedBrick},
    [DECOR_YELLOW_BRICK] = {gDecorIcon_YellowBrick,
                            gDecorIconPalette_YellowBrick},
    ...
    [DECOR_BREAKABLE_DOOR] = {gDecorIcon_BreakableDoor,
                              gDecorIconPalette_BreakableDoor},
    [DECOR_SAND_ORNAMENT] = {gDecorIcon_SandOrnament,
                             gDecorIconPalette_SandOrnament},
    [DECOR_SILVER_SHIELD] = {NULL, NULL},
    [DECOR_GOLD_SHIELD] = {NULL, NULL},
    [DECOR_GLASS_ORNAMENT] = {gDecorIcon_GlassOrnament,
                              gDecorIconPalette_GlassOrnament},
    [DECOR_TV] = {NULL, NULL},
    ...
    [DECOR_FIRE_BLAST_MAT] = {gDecorIcon_FireBlastMat,
                              gDecorIconPalette_FireBlastMat},
    [DECOR_POWDER_SNOW_MAT] = {gDecorIcon_PowderSnowMat,
                               gDecorIconPalette_PowderSnowMat},
    ...
    [DECOR_SNORLAX_DOLL] = {gDecorIcon_SnorlaxDoll,
                            gDecorIconPalette_SnorlaxDoll},
    ...
    [DECOR_VENUSAUR_DOLL] = {gDecorIcon_VenusaurDoll,
                             gDecorIconPalette_VenusaurDoll},
    [DECOR_CHARIZARD_DOLL] = {gDecorIcon_CharizardDoll,
                              gDecorIconPalette_CharizardDoll},
    [DECOR_BLASTOISE_DOLL] = {gDecorIcon_BlastoiseDoll,
                              gDecorIconPalette_BlastoiseDoll},
    [DECOR_WAILMER_DOLL] = {gDecorIcon_WailmerDoll,
                            gDecorIconPalette_WailmerDoll},
    [DECOR_REGIROCK_DOLL] = {gDecorIcon_RegirockDoll,
                             gDecorIconPalette_RegirockDoll},
    [DECOR_REGICE_DOLL] = {gDecorIcon_RegiceDoll, gDecorIconPalette_RegiceDoll},
    [DECOR_REGISTEEL_DOLL] = {gDecorIcon_RegisteelDoll,
                              gDecorIconPalette_RegisteelDoll}};
