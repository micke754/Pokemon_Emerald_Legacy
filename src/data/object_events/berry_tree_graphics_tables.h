...
const u16 gDeadBerryTreeObjectEventGraphicsIdTable[] = {
...
const u16 *const gBerryTreeObjectEventGraphicsIdTablePointers[] = {
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
        gBerryTreeObjectEventGraphicsIdTable,
    ...
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX] =
        gBerryTreeObjectEventGraphicsIdTable,
    // 3 unused berries.
    [ITEM_UNUSED_BERRY_1 - FIRST_BERRY_INDEX] =
        gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_UNUSED_BERRY_2 - FIRST_BERRY_INDEX] =
        gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_UNUSED_BERRY_3 - FIRST_BERRY_INDEX] =
        gBerryTreeObjectEventGraphicsIdTable,
};
