    ...
    [TRAINER_BACK_PIC_BRENDAN] =
        {
            ...
            .size =
                TRAINER_PIC_SIZE * ARRAY_COUNT(gTrainerBackPicTable_Brendan),
...
const struct CompressedSpritePalette gTrainerBackPicPaletteTable[] = {
    ...
    TRAINER_BACK_PAL(RUBY_SAPPHIRE_BRENDAN,
                     gTrainerPalette_RubySapphireBrendan),
