...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] = {
    ...
    TRAINER_SPRITE(CHAMPION_WALLACE, gTrainerFrontPic_ChampionWallace,
                   TRAINER_PIC_SIZE * 2),
    TRAINER_SPRITE(FISHERMAN, gTrainerFrontPic_Fisherman, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_M, gTrainerFrontPic_CyclingTriathleteM,
                   TRAINER_PIC_SIZE * 2),
    ...
    TRAINER_SPRITE(BATTLE_GIRL, gTrainerFrontPic_BattleGirl,
                   TRAINER_PIC_SIZE * 2),
    ...
    TRAINER_SPRITE(PALACE_MAVEN_SPENSER, gTrainerFrontPic_PalaceMavenSpenser,
                   TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ARENA_TYCOON_GRETA, gTrainerFrontPic_ArenaTycoonGreta,
                   TRAINER_PIC_SIZE * 2),
    ...
    TRAINER_SPRITE(MAGMA_ADMIN_F, gTrainerFrontPic_MagmaAdminF,
                   TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ARCHIE_AND_MATT, gTrainerFrontPic_ArchieAndMatt,
                   TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ZINNIA, gTrainerFrontPic_Zinnia, TRAINER_PIC_SIZE),
};

#define TRAINER_PAL(trainerPic, pal)                                           \
  [TRAINER_PIC_##trainerPic] = {pal, TRAINER_PIC_##trainerPic}
