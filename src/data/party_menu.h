    ...
    [PARTY_BOX_LEFT_COLUMN] =
        {
            ...
            {
                // The below are the x, y, width, and height for each of the
                // following info
...
// The array for each slot has the sprite coords of its various sprites in the
// following order Pokémon icon (x, y), held item (x, y), status condition (x,
// y), menu Poké Ball (x, y)
...
static const u32 sConfirmButton_Tilemap[] =
    INCBIN_U32("graphics/party_menu/confirm_button.bin");
static const u32 sCancelButton_Tilemap[] =
    INCBIN_U32("graphics/party_menu/cancel_button.bin");

// Text colors for BG, FG, and Shadow in that order
static const u8 sFontColorTable[][3] = {
    {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_LIGHT_GRAY,
     TEXT_COLOR_DARK_GRAY},                                       // Default
    {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_WHITE, TEXT_COLOR_GREEN}, // Unused
    {TEXT_COLOR_TRANSPARENT, TEXT_DYNAMIC_COLOR_2,
     TEXT_DYNAMIC_COLOR_3}, // Gender symbol
...
// The versions with no HP bar are used by eggs, and in certain displays like
// registering at a battle facility. There is no empty version of the main slot
// because it shouldn't ever be empty.
static const u8 sSlotTilemap_Main[] =
    INCBIN_U8("graphics/party_menu/slot_main.bin");
static const u8 sSlotTilemap_MainNoHP[] =
    INCBIN_U8("graphics/party_menu/slot_main_no_hp.bin");
static const u8 sSlotTilemap_Wide[] =
    INCBIN_U8("graphics/party_menu/slot_wide.bin");
static const u8 sSlotTilemap_WideNoHP[] =
    INCBIN_U8("graphics/party_menu/slot_wide_no_hp.bin");
static const u8 sSlotTilemap_WideEmpty[] =
    INCBIN_U8("graphics/party_menu/slot_wide_empty.bin");
...
static const u16 sUnusedData[] = {
    0x0108, 0x0151, 0x0160, 0x015b, 0x002e, 0x005c, 0x0102, 0x0153, 0x014b,
    0x00ed, 0x00f1, 0x010d, 0x003a, 0x003b, 0x003f, 0x0071, 0x00b6, 0x00f0,
    0x00ca, 0x00db, 0x00da, 0x004c, 0x00e7, 0x0055, 0x0057, 0x0059, 0x00d8,
    0x005b, 0x005e, 0x00f7, 0x0118, 0x0068, 0x0073, 0x015f, 0x0035, 0x00bc,
    0x00c9, 0x007e, 0x013d, 0x014c, 0x0103, 0x0107, 0x0122, 0x009c, 0x00d5,
    0x00a8, 0x00d3, 0x011d, 0x0121, 0x013b, 0x000f, 0x0013, 0x0039, 0x0046,
    0x0094, 0x00f9, 0x007f, 0x0123,
};
...
struct {
  ...
  TaskFunc func;
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH] = {gMoveNames[MOVE_ROCK_SMASH],
                                                  CursorCb_FieldMove},
    [MENU_FIELD_MOVES +
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_WATERFALL] = {gMoveNames[MOVE_WATERFALL],
                                                 CursorCb_FieldMove},
    [MENU_FIELD_MOVES +
    ...
    [MENU_FIELD_MOVES +
        FIELD_MOVE_SECRET_POWER] = {gMoveNames[MOVE_SECRET_POWER],
                                    CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_MILK_DRINK] = {gMoveNames[MOVE_MILK_DRINK],
                                                  CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SOFT_BOILED] = {gMoveNames[MOVE_SOFT_BOILED],
                                                   CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SWEET_SCENT] = {gMoveNames[MOVE_SWEET_SCENT],
                                                   CursorCb_FieldMove},
};

static const u8 sPartyMenuAction_SummarySwitchCancel[] = {
    MENU_SUMMARY, MENU_SWITCH, MENU_CANCEL1};
static const u8 sPartyMenuAction_ShiftSummaryCancel[] = {
    MENU_SHIFT, MENU_SUMMARY, MENU_CANCEL1};
...
static const u8 sPartyMenuAction_EnterSummaryCancel[] = {
    MENU_ENTER, MENU_SUMMARY, MENU_CANCEL1};
static const u8 sPartyMenuAction_NoEntrySummaryCancel[] = {
    MENU_NO_ENTRY, MENU_SUMMARY, MENU_CANCEL1};
static const u8 sPartyMenuAction_StoreSummaryCancel[] = {
    MENU_STORE, MENU_SUMMARY, MENU_CANCEL1};
static const u8 sPartyMenuAction_GiveTakeItemCancel[] = {
    MENU_GIVE, MENU_TAKE_ITEM, MENU_CANCEL2};
static const u8 sPartyMenuAction_ReadTakeMailCancel[] = {
    MENU_READ, MENU_TAKE_MAIL, MENU_CANCEL2};
...
static const u8 sPartyMenuAction_TakeItemTossCancel[] = {
    MENU_TAKE_ITEM, MENU_TOSS, MENU_CANCEL1};
...
static const u16 sFieldMoves[FIELD_MOVES_COUNT + 1] = {
    ...
    // NOTE: This value is used as the terminal value for the table. There's no
    // reason to do this, as the size of the table is known.
    //       Whichever move shares this value (MOVE_SWORDS_DANCE by default) if
    //       present will be treated as the end of the array rather than a field
    //       move.
...
struct {
  ...
  u8 msgId;
    ...
    [FIELD_MOVE_SECRET_POWER] = {SetUpFieldMove_SecretPower,
                                 PARTY_MSG_CANT_USE_HERE},
    [FIELD_MOVE_MILK_DRINK] = {SetUpFieldMove_SoftBoiled,
                               PARTY_MSG_NOT_ENOUGH_HP},
    [FIELD_MOVE_SOFT_BOILED] = {SetUpFieldMove_SoftBoiled,
                                PARTY_MSG_NOT_ENOUGH_HP},
    [FIELD_MOVE_SWEET_SCENT] = {SetUpFieldMove_SweetScent,
                                PARTY_MSG_CANT_USE_HERE},
};
...
static const u32 sHeldItemGfx[] =
    INCBIN_U32("graphics/party_menu/hold_icons.4bpp");
static const u16 sHeldItemPalette[] =
    INCBIN_U16("graphics/party_menu/hold_icons.gbapal");
...
static const union AnimCmd sSpriteAnim_HeldItem[] = {ANIMCMD_FRAME(0, 1),
                                                     ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HeldMail[] = {ANIMCMD_FRAME(1, 1),
                                                     ANIMCMD_END};
...
static const union AnimCmd sPokeballAnim_Closed[] = {ANIMCMD_FRAME(0, 0),
                                                     ANIMCMD_END};

static const union AnimCmd sPokeballAnim_Open[] = {ANIMCMD_FRAME(16, 0),
                                                   ANIMCMD_END};

static const union AnimCmd *const sSpriteAnimTable_MenuPokeball[] = {
    sPokeballAnim_Closed, sPokeballAnim_Open};
...
static const union AnimCmd sSmallPokeballAnim_Closed[] = {ANIMCMD_FRAME(0, 0),
                                                          ANIMCMD_END};

static const union AnimCmd sSmallPokeballAnim_Open[] = {ANIMCMD_FRAME(4, 0),
                                                        ANIMCMD_END};

static const union AnimCmd sSmallPokeballAnim_Blank1[] = {ANIMCMD_FRAME(8, 0),
                                                          ANIMCMD_END};

static const union AnimCmd sSmallPokeballAnim_Blank2[] = {ANIMCMD_FRAME(12, 0),
                                                          ANIMCMD_END};

static const union AnimCmd sSmallPokeballAnim_Blank3[] = {ANIMCMD_FRAME(16, 0),
                                                          ANIMCMD_END};

static const union AnimCmd sSmallPokeballAnim_Blank4[] = {ANIMCMD_FRAME(20, 0),
                                                          ANIMCMD_END};

// The blanks below are never used. See SpriteCB_BounceConfirmCancelButton,
// where they were intended to be used
static const union AnimCmd *const sSpriteAnimTable_MenuPokeballSmall[] = {
    sSmallPokeballAnim_Closed, sSmallPokeballAnim_Open,
    sSmallPokeballAnim_Blank1, sSmallPokeballAnim_Blank2,
    sSmallPokeballAnim_Blank3, sSmallPokeballAnim_Blank4};
...
// Used for the pokeball sprite next to Cancel and Confirm when both are
// present, otherwise sSpriteTemplate_MenuPokeball is used
...
static const union AnimCmd sSpriteAnim_StatusPoison[] = {ANIMCMD_FRAME(0, 0),
                                                         ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StatusParalyzed[] = {ANIMCMD_FRAME(4, 0),
                                                            ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StatusSleep[] = {ANIMCMD_FRAME(8, 0),
                                                        ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StatusFrozen[] = {ANIMCMD_FRAME(12, 0),
                                                         ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StatusBurn[] = {ANIMCMD_FRAME(16, 0),
                                                       ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StatusPokerus[] = {ANIMCMD_FRAME(20, 0),
                                                          ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StatusFaint[] = {ANIMCMD_FRAME(24, 0),
                                                        ANIMCMD_END};

static const union AnimCmd sSpriteAnim_Blank[] = {ANIMCMD_FRAME(28, 0),
                                                  ANIMCMD_END};
...
static const union AnimCmd *const sSpriteTemplate_StatusCondition[] = {
    ...
    sSpriteAnim_StatusFaint,  sSpriteAnim_Blank};
...
// Mask for the partners party in a multi battle. TRUE if in the partners party,
// FALSE otherwise The 7th slot is Cancel, and the 8th slot is unreachable Used
// only to determine whether or not to show the Deoxys form icon sprite
static const bool8 sMultiBattlePartnersPartyMask[PARTY_SIZE + 2] = {
    FALSE, TRUE, FALSE, FALSE, TRUE, TRUE, FALSE};

static const u8 *const sUnused_StatStrings[] = {gText_HP4,      gText_Attack3,
                                                gText_Defense3, gText_SpAtk4,
                                                gText_SpDef4,   gText_Speed2};
