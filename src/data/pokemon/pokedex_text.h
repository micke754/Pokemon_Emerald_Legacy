...
const u8 gIvysaurPokedexText[] =
    _("To support its bulb, IVYSAUR's legs\n"
      "grow sturdy. If it spends more time lying in\n"
      "the sunlight, the bud will soon bloom into\n"
      "a large flower.");

const u8 gVenusaurPokedexText[] =
    _("VENUSAUR's flower is said to take on vivid\n"
...
const u8 gButterfreePokedexText[] =
    _("It has a superior ability to search for\n"
      "delicious honey from flowers. It can seek,\n"
      "extract, and carry honey from flowers\n"
      "blooming over six miles away.");

const u8 gWeedlePokedexText[] =
    _("A WEEDLE has an extremely acute sense\n"
...
const u8 gSpearowPokedexText[] =
    _("Its loud cry can be heard over half a mile\n"
...
const u8 gEkansPokedexText[] =
    _("An EKANS curls itself up in a spiral while\n"
...
const u8 gPikachuPokedexText[] =
    _("It stores electricity in the electric sacs\n"
...
const u8 gSandshrewPokedexText[] =
    _("When it curls up in a ball, it can make any\n"
      "attack bounce off harmlessly. Its hide has\n"
      "turned tough and solid as a result of\n"
      "living in the desert.");

const u8 gSandslashPokedexText[] =
    _("It curls up in a ball to protect itself from\n"
      "enemy attacks. It also curls up to prevent\n"
      "heatstroke during the daytime when\n"
      "temperatures rise sharply.");

const u8 gNidoranFPokedexText[] =
    _("Its highly toxic barbs are thought to have\n"
...
const u8 gClefairyPokedexText[] =
    _("On every night of a full moon, they come\n"
      "out to play. When dawn arrives, the tired\n"
      "CLEFAIRY go to sleep nestled up against\n"
      "each other in deep and quiet mountains.");

const u8 gClefablePokedexText[] =
    _("A CLEFABLE uses its wings to skip lightly \n"
...
const u8 gNinetalesPokedexText[] =
    _("It has long been said that each of the\n"
      "nine tails embody an enchanted power.\n"
      "A long-lived NINETALES will have fur that\n"
      "shines like gold.");

const u8 gJigglypuffPokedexText[] =
    _("Nothing can avoid falling asleep hearing a\n"
      "JIGGLYPUFF's song. The sound waves of its\n"
      "singing voice match the brain waves of\n"
      "someone in a deep sleep.");

const u8 gWigglytuffPokedexText[] =
    _("Its fur is the ultimate in luxuriousness.\n"
...
const u8 gGolbatPokedexText[] =
    _("Its fangs easily puncture even thick\n"
      "animal hide. It loves to feast on the blood\n"
      "of people and POKéMON. It flits about in\n"
      "darkness and strikes from behind.");

const u8 gOddishPokedexText[] =
    _("This POKéMON grows by absorbing moonlight.\n"
...
const u8 gVileplumePokedexText[] =
    _("In seasons when it produces more pollen,\n"
...
const u8 gParasectPokedexText[] =
    _("PARASECT are known to infest the roots of\n"
...
const u8 gDugtrioPokedexText[] =
    _("Because the triplets originally split from\n"
...
const u8 gAlakazamPokedexText[] =
    _("While it has strong psychic abilities and\n"
...
const u8 gRapidashPokedexText[] =
    _("It usually canters casually in the fields\n"
      "and plains. But once a RAPIDASH turns\n"
      "serious, its fiery manes flare and blaze\n"
      "as it gallops its way up to 150 mph.");

const u8 gSlowpokePokedexText[] =
    _("It catches prey by dipping its tail in\n"
      "water at the side of a river. But it often\n"
      "forgets what it is doing and spends entire\n"
      "days just loafing at water's edge.");

const u8 gSlowbroPokedexText[] =
    _("Its tail has a SHELLDER firmly attached\n"
...
const u8 gMagnetonPokedexText[] =
    _("It is actually three MAGNEMITE linked\n"
      "by magnetism. It generates powerful radio\n"
      "waves that raise temperatures by 3.6\n"
      "degrees F within a 3,300-foot radius.");

const u8 gFarfetchdPokedexText[] =
    _("It is always seen with a stick from a plant.\n"
...
const u8 gShellderPokedexText[] =
    _("At night, it burrows a hole in the seafloor\n"
...
const u8 gHaunterPokedexText[] =
    _("If a HAUNTER beckons you while it is\n"
...
const u8 gDrowzeePokedexText[] =
    _("If your nose becomes itchy while you are\n"
...
const u8 gElectrodePokedexText[] =
    _("They appear in great numbers at electric\n"
      "power plants. Because they feed on\n"
      "electricity, they cause massive and\n"
      "chaotic blackouts in nearby cities.");

const u8 gExeggcutePokedexText[] =
    _("It consists of six eggs that care for each\n"
      "other. The eggs attract each other and\n"
      "spin around. When cracks increasingly\n"
      "appear, it is close to evolution.");

const u8 gExeggutorPokedexText[] =
    _("Originally from the tropics, EXEGGUTOR's\n"
...
const u8 gHitmonleePokedexText[] =
    _("Its legs freely stretch and contract.\n"
      "Using these springlike limbs, it bowls over\n"
      "foes with devastating kicks. After battle,\n"
      "it rubs down its tired legs.");

const u8 gHitmonchanPokedexText[] =
    _("A HITMONCHAN is said to possess the\n"
...
const u8 gWeezingPokedexText[] =
    _("By diluting its toxic gases with a special\n"
...
const u8 gMrMimePokedexText[] =
    _("A MR. MIME is a master of pantomime. It can\n"
...
const u8 gElectabuzzPokedexText[] =
    _("When a storm approaches, it competes with\n"
      "others to scale heights that are likely to\n"
      "be stricken by lightning. Some towns use\n"
      "ELECTABUZZ in place of lightning rods.");

const u8 gMagmarPokedexText[] =
    _("In battle, it blows out intense flames from\n"
...
const u8 gMagikarpPokedexText[] =
    _("Its swimming muscles are weak, so it is\n"
      "easily washed away by currents. In places\n"
      "where water pools, you can see many\n"
      "MAGIKARP deposited there by the flow.");

const u8 gGyaradosPokedexText[] =
    _("It is an extremely vicious and violent\n"
...
const u8 gJolteonPokedexText[] =
    _("Its cells generate weak power that is\n"
...
const u8 gPorygonPokedexText[] =
    _("It is capable of reverting itself entirely\n"
...
const u8 gKabutoPokedexText[] =
    _("It is a POKéMON that has been regenerated\n"
      "from a fossil. However, in rare cases, living\n"
      "examples have been discovered. KABUTO\n"
      "have not changed for 300 million years.");

const u8 gKabutopsPokedexText[] =
    _("KABUTOPS once swam underwater to hunt \n"
...
const u8 gAerodactylPokedexText[] =
    _("AERODACTYL is a POKéMON from the age\n"
...
const u8 gArticunoPokedexText[] =
    _("ARTICUNO is a legendary bird POKéMON that\n"
...
const u8 gChikoritaPokedexText[] =
    _("It waves its leaf around to keep foes\n"
...
const u8 gCyndaquilPokedexText[] =
    _("It flares flames from its back to protect\n"
...
const u8 gNoctowlPokedexText[] =
    _("It unfailingly catches prey in darkness.\n"
...
const u8 gAriadosPokedexText[] =
    _("Its feet are tipped with tiny hooked claws\n"
      "that enable it to scuttle on ceilings and\n"
      "vertical walls. It constricts its foe with\n"
      "thin and strong silk webbing.");

const u8 gCrobatPokedexText[] =
    _("Over the course of evolution, its hind legs\n"
      "turned into wings. By alternately resting\n"
      "its front and rear wings, it can fly all day\n"
      "without having to stop.");

const u8 gChinchouPokedexText[] =
    _("When it senses danger, it discharges\n"
      "positive and negative electricity from its\n"
      "two antennae. It lives in depths beyond\n"
      "sunlight's reach.");

const u8 gLanturnPokedexText[] =
    _("The light-emitting orbs on its back are\n"
...
const u8 gIgglybuffPokedexText[] =
    _("Its soft and pliable body is very bouncy.\n"
      "When it sings continuously with all its\n"
      "might, its body steadily turns a deepening\n"
      "pink color.");

const u8 gTogepiPokedexText[] =
    _("As its energy, it uses the feelings of\n"
      "compassion and pleasure exuded by\n"
      "people and POKéMON. It stores up happy\n"
      "feelings in its shell, then shares them out.");

const u8 gTogeticPokedexText[] =
    _("It is said to be a POKéMON that brings good\n"
...
const u8 gAzumarillPokedexText[] =
    _("It lives in water virtually all day long.\n"
      "Its body color and pattern act as\n"
      "camouflage that makes it tough for\n"
      "enemies to spot in water.");

const u8 gSudowoodoPokedexText[] =
    _("It mimics a tree to avoid being attacked\n"
...
const u8 gQuagsirePokedexText[] =
    _("A QUAGSIRE hunts by leaving its mouth wide\n"
...
const u8 gUmbreonPokedexText[] =
    _("UMBREON evolved from exposure to the\n"
...
const u8 gWobbuffetPokedexText[] =
    _("Usually docile, a WOBBUFFET strikes back\n"
      "ferociously if its black tail is attacked.\n"
      "It makes its lair in caves where it waits\n"
      "for nightfall.");

const u8 gGirafarigPokedexText[] =
    _("A GIRAFARIG is an herbivore--it eats\n"
...
const u8 gForretressPokedexText[] =
    _("It keeps itself inside its steel shell.\n"
      "The shell is opened when it is catching\n"
      "prey, but it is so quick that the shell's\n"
      "inside cannot be seen.");

const u8 gDunsparcePokedexText[] =
    _("Its drill-tipped tail is used to burrow into\n"
...
const u8 gGranbullPokedexText[] =
    _("It has a particularly well-developed lower\n"
...
const u8 gShucklePokedexText[] =
    _("A SHUCKLE hides under rocks, keeping its\n"
      "body concealed inside its shell while\n"
      "eating stored berries. The berries mix with\n"
      "its body fluids to become a juice.");

const u8 gHeracrossPokedexText[] =
    _("They gather in forests seeking the sweet\n"
...
const u8 gHoundoomPokedexText[] =
    _("In a HOUNDOOM pack, the one with its horns\n"
...
const u8 gPorygon2PokedexText[] =
    _("It was created by humans using the power\n"
      "of science. It has been given artificial\n"
      "intelligence that enables it to learn new\n"
      "gestures and emotions on its own.");

const u8 gStantlerPokedexText[] =
    _("STANTLER's magnificent antlers were\n"
      "once traded at high prices as works of art.\n"
      "As a result, this POKéMON was hunted\n"
      "close to extinction.");

const u8 gSmearglePokedexText[] =
    _("A SMEARGLE marks its territory using a\n"
...
const u8 gHitmontopPokedexText[] =
    _("Its technique of kicking while spinning is\n"
      "a remarkable mix of both offense and\n"
      "defense. HITMONTOP travel faster\n"
      "spinning than they do walking.");

const u8 gSmoochumPokedexText[] =
    _("It actively runs about, but also falls\n"
...
const u8 gMiltankPokedexText[] =
    _("It gives over five gallons of milk daily.\n"
...
const u8 gBlisseyPokedexText[] =
    _("If it senses sadness with its fluffy fur,\n"
...
const u8 gTreeckoPokedexText[] =
    _("It makes its nest in a giant tree in the\n"
...
const u8 gSceptilePokedexText[] =
    _("In the jungle, its power is without equal.\n"
...
const u8 gMudkipPokedexText[] =
    _("On land, it can powerfully lift large\n"
      "boulders by planting its four feet and\n"
      "heaving. It sleeps by burying itself in soil\n"
      "at the water's edge.");

const u8 gMarshtompPokedexText[] =
    _("Its toughened hind legs enable it to stand\n"
      "upright. Because it weakens if its skin\n"
      "dries out, it replenishes fluids by playing\n"
      "in mud.");

const u8 gSwampertPokedexText[] =
    _("If it senses the approach of a storm and\n"
...
const u8 gBeautiflyPokedexText[] =
    _("Its colorfully patterned wings are its\n"
      "most prominent feature. It flies through\n"
      "flower-covered fields collecting pollen.\n"
      "It attacks ferociously when angered.");

const u8 gCascoonPokedexText[] =
    _("To avoid detection by its enemies, it hides\n"
...
const u8 gLombrePokedexText[] =
    _("In the evening, it takes great delight in\n"
      "popping out of rivers and startling people.\n"
      "It feeds on aquatic moss that grows on\n"
      "rocks in the riverbed.");

const u8 gLudicoloPokedexText[] =
    _("When it hears festive music, all the cells\n"
...
const u8 gShiftryPokedexText[] =
    _("It is said to arrive on chilly, wintry winds.\n"
      "Feared from long ago as the guardian of\n"
      "forests, this POKéMON lives in a deep\n"
      "forest where people do not venture.");

const u8 gTaillowPokedexText[] =
    _("Although it is small, it is very courageous.\n"
...
const u8 gPelipperPokedexText[] =
    _("It skims the tops of waves as it flies.\n"
...
const u8 gMasquerainPokedexText[] =
    _("It intimidates foes with the large eyelike\n"
...
const u8 gExploudPokedexText[] =
    _("It has sound-generating organs all over\n"
      "its body. It communicates with others by\n"
      "adjusting the tone and volume of the cries\n"
      "it emits.");

const u8 gMakuhitaPokedexText[] =
    _("It loves to toughen up its body above all\n"
...
const u8 gAzurillPokedexText[] =
    _("Its tail, which is packed with nutrition,\n"
      "is very bouncy like a rubber ball. On sunny\n"
      "days they gather at the edge of water and\n"
      "splash about for fun.");

const u8 gNosepassPokedexText[] =
    _("Its body emits a powerful magnetism.\n"
      "It feeds on prey that is pulled in by the\n"
      "force. Its magnetism is stronger in cold\n"
      "seasons.");

const u8 gSkittyPokedexText[] =
    _("A SKITTY's adorably cute behavior makes it\n"
      "highly popular. In battle, it makes its tail\n"
      "puff out. It threatens foes with a sharp\n"
      "growl.");

const u8 gDelcattyPokedexText[] =
    _("Rather than keeping a permanent lair,\n"
      "it habitually seeks comfortable spots and\n"
      "sleeps there. It is nocturnal and becomes\n"
      "active at dusk.");

const u8 gSableyePokedexText[] =
    _("It digs branching holes in caves using its\n"
...
const u8 gIllumisePokedexText[] =
    _("A nocturnal POKéMON that becomes active\n"
...
const u8 gSpoinkPokedexText[] =
    _("A POKéMON that manipulates psychic power\n"
      "at will. It doesn't stop bouncing even when\n"
      "it is asleep. It loves eating mushrooms\n"
      "that grow underground.");

const u8 gGrumpigPokedexText[] =
    _("It stores power in the black pearls on its\n"
...
const u8 gTrapinchPokedexText[] =
    _("Its big jaws crunch through boulders.\n"
      "Because its head is so big, it has a hard\n"
      "time getting back upright if it tips over\n"
      "onto its back.");

const u8 gVibravaPokedexText[] =
    _("It looses ultrasonic waves by rubbing its\n"
...
const u8 gCacneaPokedexText[] =
    _("CACNEA live in deserts with virtually no\n"
      "rainfall. It battles by swinging its thick,\n"
      "spiked arms. Once a year, a yellow flower\n"
      "blooms.");

const u8 gCacturnePokedexText[] =
    _("After spending thousands of years in\n"
...
const u8 gZangoosePokedexText[] =
    _("When it battles, it stands on its hind legs\n"
...
const u8 gBarboachPokedexText[] =
    _("Its body is covered with a slimy film.\n"
      "The film acts as a barrier to prevent germs\n"
      "in muddy water from entering the\n"
      "BARBOACH's body.");

const u8 gWhiscashPokedexText[] =
    _("Mysteriously, it can foretell earthquakes.\n"
      "In the daytime, it sleeps in mud at the\n"
      "bottom of a pond. When it awakens, it\n"
      "continually feeds throughout the night.");

const u8 gCorphishPokedexText[] =
    _("Once it grips prey with its large pincers,\n"
      "it will never let go, no matter what.\n"
      "It is a hardy POKéMON that can thrive\n"
      "in any environment.");

const u8 gCrawdauntPokedexText[] =
    _("A brutish POKéMON that loves to battle.\n"
...
const u8 gClaydolPokedexText[] =
    _("A CLAYDOL sleeps while hovering in midair.\n"
...
const u8 gCradilyPokedexText[] =
    _("It drags its heavy body along the\n"
      "seafloor. It makes its nest in the shallows\n"
      "of warm seas. CRADILY can be seen on\n"
      "beaches when the tide goes out.");

const u8 gAnorithPokedexText[] =
    _("It was resurrected from a fossil using the\n"
...
const u8 gKecleonPokedexText[] =
    _("A POKéMON that has the ability to alter its\n"
...
const u8 gDuskullPokedexText[] =
    _("A glare from its single scarlet eye makes\n"
      "even burly grown-ups freeze in utter fear.\n"
      "It is a nocturnal POKéMON that roams\n"
      "about under the cloak of darkness.");

const u8 gDusclopsPokedexText[] =
    _("It is thought that its body is hollow with\n"
...
const u8 gChimechoPokedexText[] =
    _("They fly about very actively when the hot\n"
...
const u8 gSnoruntPokedexText[] =
    _("They tend to move about in groups of\n"
...
const u8 gSealeoPokedexText[] =
    _("SEALEO live in herds on ice floes. Using its\n"
      "powerful flippers, it shatters ice.\n"
      "It dives into the sea to hunt prey five\n"
      "times a day.");

const u8 gWalreinPokedexText[] =
    _("To protect its herd, the leader battles\n"
      "anything that invades its territory, even\n"
      "at the cost of its life. Its tusks may snap\n"
      "off in battle.");

const u8 gClamperlPokedexText[] =
    _("A CLAMPERL slams its shell closed on prey\n"
      "to prevent escape. The pearl it creates\n"
      "upon evolution is said to be infused with\n"
      "a mysterious energy.");

const u8 gHuntailPokedexText[] =
    _("To withstand the crushing pressure of\n"
...
const u8 gGorebyssPokedexText[] =
    _("A GOREBYSS siphons the body fluids of prey\n"
      "through its thin, tubular mouth. Its light\n"
      "pink body color turns vivid when it\n"
      "finishes feeding.");

const u8 gRelicanthPokedexText[] =
    _("A POKéMON that was once believed to have\n"
...
const u8 gSalamencePokedexText[] =
    _("After many long years, its cellular\n"
...
const u8 gMetagrossPokedexText[] =
    _("METAGROSS has four brains that are joined\n"
      "by a complex neural network. As a result of\n"
      "integration, this POKéMON is smarter than\n"
      "a supercomputer.");

const u8 gRegirockPokedexText[] =
    _("A POKéMON that is made entirely of rocks\n"
...
const u8 gRegisteelPokedexText[] =
    _("Its body is harder than any other kind of\n"
...
const u8 gLatiosPokedexText[] =
    _("Even in hiding, it can detect the locations\n"
...
const u8 gJirachiPokedexText[] =
    _("JIRACHI is said to make wishes come true.\n"
