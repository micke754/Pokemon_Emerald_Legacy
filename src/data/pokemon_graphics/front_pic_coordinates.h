...
// frame the sprite's non-transparent pixels actually are. .size is the
// dimensions of this drawn pixel area. .y_offset is the number of pixels
// between the drawn pixel area and the bottom edge.
