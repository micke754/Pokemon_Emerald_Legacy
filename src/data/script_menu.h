...
static const struct MenuAction MultichoiceList_StatusInfo[] = {
    {gText_Psn}, {gText_Par}, {gText_Slp},
    {gText_Brn}, {gText_Frz}, {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_UnusedAshVendor[] = {
    {gText_BlueFlute2},  {gText_YellowFlute2}, {gText_RedFlute2},
    {gText_WhiteFlute2}, {gText_BlackFlute2},  {gText_GlassChair},
    {gText_GlassDesk},   {gText_Cancel2},
};
...
static const struct MenuAction MultichoiceList_ShardsRYBG[] = {
    {gText_RedShard},   {gText_YellowShard}, {gText_BlueShard},
    {gText_GreenShard}, {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_BattleMode[] = {
    {gText_SingleBattle}, {gText_DoubleBattle}, {gText_MultiBattle},
    {gText_Info2},        {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_LinkServicesAll[] = {
    {gText_TradeCenter}, {gText_Colosseum}, {gText_RecordCorner},
    {gText_BerryCrush3}, {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_ContestRank[] = {
    {gText_NormalRank}, {gText_SuperRank}, {gText_HyperRank},
    {gText_MasterRank}, {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_FossilPostGame[] = {
    {gText_ClawFossil}, {gText_RootFossil}, {gText_HelixFossil},
    {gText_DomeFossil}, {gText_OldAmber},   {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_BattleArenaRules[] = {
    {gText_BattleRules}, {gText_JudgeMind}, {gText_JudgeSkill},
    {gText_JudgeBody},   {gText_Exit},
};

static const struct MenuAction MultichoiceList_BattleTowerRules[] = {
    {gText_TowerInfo},  {gText_BattleMon}, {gText_BattleSalon},
    {gText_MultiLink2}, {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_BattlePyramidRules[] = {
    {gText_PyramidPokemon}, {gText_PyramidTrainers},
    {gText_PyramidMaze},    {gText_BattleBag2},
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_TagMatchType[] = {
    {gText_NormalTagMatch}, {gText_VarietyTagMatch},
    {gText_UniqueTagMatch}, {gText_ExpertTagMatch},
    {gText_Exit},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] = {
    ...
    [MULTI_BASE_PC_WITH_REGISTRY] =
        MULTICHOICE(MultichoiceList_BasePCWithRegistry),
    ...
    [MULTI_SSTIDAL_SLATEPORT_WITH_BF] =
        MULTICHOICE(MultichoiceList_SSTidalSlateportWithBF),
    [MULTI_SSTIDAL_BATTLE_FRONTIER] =
        MULTICHOICE(MultichoiceList_SSTidalBattleFrontier),
    ...
    [MULTI_SSTIDAL_SLATEPORT_NO_BF] =
        MULTICHOICE(MultichoiceList_SSTidalSlateportNoBF),
    ...
    [MULTI_TOURNEY_WITH_RECORD] =
        MULTICHOICE(MultichoiceList_TourneyWithRecord),
    [MULTI_CABLE_CLUB_NO_RECORD_MIX] =
        MULTICHOICE(MultichoiceList_LinkServicesNoRecordBerry),
    [MULTI_WIRELESS_NO_RECORD_BERRY] =
        MULTICHOICE(MultichoiceList_LinkServicesNoRecordBerry),
    [MULTI_CABLE_CLUB_WITH_RECORD_MIX] =
        MULTICHOICE(MultichoiceList_LinkServicesNoBerry),
    [MULTI_WIRELESS_NO_BERRY] =
        MULTICHOICE(MultichoiceList_LinkServicesNoBerry),
    [MULTI_WIRELESS_NO_RECORD] =
        MULTICHOICE(MultichoiceList_LinkServicesNoRecord),
    [MULTI_WIRELESS_ALL_SERVICES] =
        MULTICHOICE(MultichoiceList_LinkServicesAll),
    ...
    [MULTI_FRONTIER_ITEM_CHOOSE] =
        MULTICHOICE(MultichoiceList_FrontierItemChoose),
    ...
    [MULTI_FRONTIER_GAMBLER_BET] =
        MULTICHOICE(MultichoiceList_FrontierGamblerBet),
    ...
    [MULTI_BATTLE_FACTORY_RULES] =
        MULTICHOICE(MultichoiceList_BattleFactoryRules),
    [MULTI_BATTLE_PALACE_RULES] =
        MULTICHOICE(MultichoiceList_BattlePalaceRules),
    [MULTI_BATTLE_PYRAMID_RULES] =
        MULTICHOICE(MultichoiceList_BattlePyramidRules),
    [MULTI_BATTLE_PIKE_RULES] = MULTICHOICE(MultichoiceList_BattlePikeRules),
    [MULTI_GO_ON_RECORD_REST_RETIRE] =
        MULTICHOICE(MultichoiceList_GoOnRecordRestRetire),
    ...
    [MULTI_BATTLE_TOWER_FEELINGS] =
        MULTICHOICE(MultichoiceList_BattleTowerFeelings),
    [MULTI_WHERES_RAYQUAZA] = MULTICHOICE(MultichoiceList_WheresRayquaza),
    [MULTI_SLATEPORT_TENT_RULES] =
        MULTICHOICE(MultichoiceList_SlateportTentRules),
    [MULTI_FALLARBOR_TENT_RULES] =
        MULTICHOICE(MultichoiceList_FallarborTentRules),
...
static const u8 sLinkServicesMultichoiceIds[] = {
    MULTI_CABLE_CLUB_NO_RECORD_MIX,   MULTI_WIRELESS_NO_RECORD_BERRY,
...
static const u8 *const sWirelessOptions_AllServices[] = {
    CableClub_Text_YouMayTradeHere,    CableClub_Text_YouMayBattleHere,
    CableClub_Text_CanMixRecords,      CableClub_Text_CanMakeBerryPowder,
    CableClub_Text_CancelSelectedItem,
};
