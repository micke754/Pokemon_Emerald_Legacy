...
static void WallyHandleGetRawMonData(void) { PlayerHandleGetRawMonData(); }
...
static void WallyHandleSetRawMonData(void) { WallyBufferExecCompleted(); }

static void WallyHandleLoadMonSprite(void) { WallyBufferExecCompleted(); }

static void WallyHandleSwitchInAnim(void) { WallyBufferExecCompleted(); }

static void WallyHandleReturnMonToBall(void) {
  if (gBattleBufferA[gActiveBattler][1] == 0) {
    InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler,
                                  gActiveBattler, B_ANIM_SWITCH_OUT_PLAYER_MON);
...
static void WallyHandleDrawTrainerPic(void) {
  ...
  SetMultiuseSpriteTemplateToTrainerBack(TRAINER_BACK_PIC_WALLY,
                                         GetBattlerPosition(gActiveBattler));
  gBattlerSpriteIds[gActiveBattler] = CreateSprite(
      &gMultiuseSpriteTemplate, 80,
      80 + 4 * (8 - gTrainerBackPicCoords[TRAINER_BACK_PIC_WALLY].size), 30);
...
static void WallyHandleTrainerSlideBack(void) { WallyBufferExecCompleted(); }

static void WallyHandleFaintAnimation(void) { WallyBufferExecCompleted(); }

static void WallyHandlePaletteFade(void) { WallyBufferExecCompleted(); }
...
static void WallyHandlePause(void) { WallyBufferExecCompleted(); }
...
static void WallyHandleYesNoBox(void) { WallyBufferExecCompleted(); }
...
static void WallyHandleChoosePokemon(void) { WallyBufferExecCompleted(); }

static void WallyHandleCmd23(void) { WallyBufferExecCompleted(); }
...
static void WallyHandleExpUpdate(void) { WallyBufferExecCompleted(); }

static void WallyHandleStatusIconUpdate(void) { WallyBufferExecCompleted(); }

static void WallyHandleStatusAnimation(void) { WallyBufferExecCompleted(); }

static void WallyHandleStatusXor(void) { WallyBufferExecCompleted(); }

static void WallyHandleDataTransfer(void) { WallyBufferExecCompleted(); }

static void WallyHandleDMA3Transfer(void) { WallyBufferExecCompleted(); }

static void WallyHandlePlayBGM(void) { WallyBufferExecCompleted(); }

static void WallyHandleCmd32(void) { WallyBufferExecCompleted(); }

static void WallyHandleTwoReturnValues(void) { WallyBufferExecCompleted(); }

static void WallyHandleChosenMonReturnValue(void) {
  WallyBufferExecCompleted();
}

static void WallyHandleOneReturnValue(void) { WallyBufferExecCompleted(); }

static void WallyHandleOneReturnValue_Duplicate(void) {
  WallyBufferExecCompleted();
}

static void WallyHandleClearUnkVar(void) { WallyBufferExecCompleted(); }

static void WallyHandleSetUnkVar(void) { WallyBufferExecCompleted(); }

static void WallyHandleClearUnkFlag(void) { WallyBufferExecCompleted(); }

static void WallyHandleToggleUnkFlag(void) { WallyBufferExecCompleted(); }
...
static void WallyHandleCantSwitch(void) { WallyBufferExecCompleted(); }

static void WallyHandlePlaySE(void) {
  PlaySE(gBattleBufferA[gActiveBattler][1] |
         (gBattleBufferA[gActiveBattler][2] << 8));
  WallyBufferExecCompleted();
}
...
static void WallyHandleIntroTrainerBallThrow(void) {
  ...
  LoadCompressedPalette(
      gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_WALLY].data,
...
static void WallyHandleEndBounceEffect(void) { WallyBufferExecCompleted(); }

static void WallyHandleSpriteInvisibility(void) { WallyBufferExecCompleted(); }
...
static void WallyHandleLinkStandbyMsg(void) { WallyBufferExecCompleted(); }
