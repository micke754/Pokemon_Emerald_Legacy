...
static const struct PikeWildMon sLvl50_Mons1[] = {
    ...
    {.species = SPECIES_DUSCLOPS,
     .levelDelta = 5,
     .moves = {MOVE_WILL_O_WISP, MOVE_MEAN_LOOK, MOVE_TOXIC,
               MOVE_SHADOW_PUNCH}}};
...
static const struct PikeWildMon sLvl50_Mons3[] = {
    ...
    {.species = SPECIES_BRELOOM,
     .levelDelta = 5,
     .moves = {MOVE_SPORE, MOVE_STUN_SPORE, MOVE_POISON_POWDER,
               MOVE_HIDDEN_POWER}}};
...
static const struct PikeWildMon sLvl50_Mons4[] = {
    ...
    {.species = SPECIES_WOBBUFFET,
     .levelDelta = 5,
     .moves = {MOVE_COUNTER, MOVE_MIRROR_COAT, MOVE_SAFEGUARD,
               MOVE_DESTINY_BOND}}};
...
static const u16 sNPCSpeeches[][EASY_CHAT_BATTLE_WORDS_COUNT] = {
    {EC_WORD_I_AM, EC_WORD_LOST, EC_WORD_I, EC_WORD_NEED, EC_WORD_A,
     EC_MOVE2(HELPING_HAND)},
    {EC_WORD_I_VE, EC_WORD_NO, EC_WORD_SENSE, EC_WORD_OF, EC_WORD_WHERE,
     EC_WORD_I_AM},
    {EC_WORD_WHAT, EC_WORD_SHOULD, EC_WORD_I, EC_WORD_DO, EC_WORD_NOW,
     EC_WORD_QUES},
    {EC_WORD_THIS, EC_WORD_IS, EC_WORD_TOO, EC_WORD_EXCITING, EC_WORD_FOR,
     EC_WORD_ME},
    {EC_WORD_DID, EC_WORD_YOU, EC_WORD_MAKE, EC_WORD_A, EC_WORD_MISTAKE,
     EC_WORD_QUES},
    {EC_WORD_IT_S, EC_WORD_MEAN, EC_WORD_AND, EC_WORD_AWFUL, EC_WORD_IN,
     EC_WORD_HERE},
    {EC_WORD_I_AM, EC_WORD_SO, EC_WORD_TIRED, EC_WORD_OF, EC_WORD_THIS,
     EC_WORD_PLACE},
    {EC_WORD_I, EC_WORD_QUITE, EC_WORD_ENJOY, EC_WORD_THIS, EC_WORD_CHALLENGE,
     EC_EMPTY_WORD},
    {EC_WORD_LOOK, EC_WORD_AT, EC_WORD_HOW, EC_WORD_I, EC_MOVE2(TACKLE),
     EC_WORD_THIS},
    {EC_WORD_READY, EC_WORD_TO, EC_WORD_GIVE_UP, EC_WORD_YET, EC_WORD_QUES,
     EC_EMPTY_WORD},
    {EC_WORD_OH, EC_WORD_NO, EC_WORD_WHO, EC_WORD_ARE, EC_WORD_YOU,
     EC_WORD_QUES},
    {EC_WORD_I_VE, EC_WORD_BEEN, EC_WORD_WANDERING, EC_WORD_ABOUT,
     EC_WORD_FOREVER, EC_WORD_ELLIPSIS},
    {EC_WORD_I, EC_WORD_THINK, EC_WORD_I, EC_WORD_WILL, EC_WORD_GIVE_UP,
     EC_EMPTY_WORD},
    {EC_WORD_WHAT, EC_WORD_SHOULD, EC_WORD_I, EC_WORD_DO, EC_WORD_NEXT,
     EC_WORD_QUES},
    {EC_WORD_I, EC_WORD_CAN_WIN, EC_WORD_WITH, EC_WORD_MY, EC_MOVE(SHEER_COLD),
     EC_WORD_GENIUS},
    {EC_WORD_WON_T, EC_WORD_SOMEONE, EC_WORD_COOL, EC_WORD_SHOW, EC_WORD_UP,
     EC_WORD_QUES},
    {EC_WORD_BATTLE, EC_WORD_GAME, EC_WORD_IS, EC_WORD_AWESOME, EC_WORD_EXCL,
     EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_CAN_T, EC_WORD_TAKE, EC_WORD_THIS, EC_WORD_ANY,
     EC_WORD_MORE},
    {EC_WORD_I, EC_WORD_DON_T, EC_WORD_KNOW, EC_WORD_IF, EC_WORD_IT_S,
     EC_WORD_OKAY},
    {EC_WORD_OH, EC_WORD_NO, EC_WORD_EXCL, EC_WORD_NOT, EC_WORD_ANOTHER,
     EC_WORD_TRAINER},
    {EC_WORD_IT, EC_WORD_HAS, EC_WORD_TO, EC_WORD_BE, EC_WORD_LEFT,
     EC_WORD_NEXT},
    {EC_WORD_IT, EC_WORD_MUST_BE, EC_WORD_OVER, EC_WORD_SOON, EC_WORD_RIGHT,
     EC_WORD_QUES},
    {EC_WORD_THIS, EC_WORD_IS, EC_WORD_TOTALLY, EC_WORD_EASY,
     EC_WORD_ISN_T_IT_QUES, EC_EMPTY_WORD},
    {EC_WORD_I_AM, EC_WORD_GOING, EC_WORD_TO, EC_WORD_POWER, EC_WORD_ON,
     EC_EMPTY_WORD},
    {EC_WORD_THERE, EC_WORD_IS, EC_WORD_NO, EC_WORD_GIVE_UP, EC_WORD_IN,
     EC_WORD_ME},
    {EC_WORD_I_AM, EC_WORD_NOT, EC_WORD_GOING, EC_WORD_TO, EC_WORD_MAKE,
     EC_WORD_IT},
    {EC_WORD_GO, EC_WORD_ON, EC_WORD_I, EC_WORD_CAN_T, EC_WORD_ANY,
     EC_WORD_MORE},
    {EC_WORD_A, EC_WORD_TRAINER, EC_WORD_AFTER, EC_WORD_ANOTHER,
     EC_WORD_ELLIPSIS, EC_EMPTY_WORD},
    {EC_WORD_DO, EC_WORD_YOU, EC_WORD_LIKE, EC_WORD_STEEL, EC_WORD_POKEMON,
     EC_WORD_QUES},
    {EC_WORD_EVERY, EC_WORD_TRAINER, EC_WORD_HERE, EC_WORD_IS, EC_WORD_TOO_WEAK,
     EC_EMPTY_WORD},
    {EC_WORD_YOU, EC_WORD_THINK, EC_WORD_THIS, EC_WORD_IS, EC_WORD_EASY,
     EC_WORD_QUES},
    {EC_WORD_WHAT, EC_WORD_WILL, EC_WORD_COME, EC_WORD_AFTER, EC_WORD_THIS,
     EC_WORD_QUES},
    {EC_WORD_I_AM, EC_WORD_JUST, EC_WORD_SO, EC_WORD_CONFUSED, EC_WORD_EXCL,
     EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_JUST, EC_WORD_WANT, EC_WORD_TO, EC_WORD_GO_HOME,
     EC_WORD_ELLIPSIS},
    {EC_WORD_YEEHAW_EXCL, EC_WORD_THIS, EC_WORD_PLACE, EC_WORD_IS, EC_WORD_A,
     EC_WORD_PUSHOVER},
    {EC_WORD_I, EC_WORD_HAVEN_T, EC_WORD_BEEN, EC_WORD_IN, EC_WORD_A,
     EC_WORD_BATTLE},
    {EC_WORD_MAYBE, EC_WORD_IT_S, EC_WORD_RIGHT, EC_WORD_NEXT, EC_WORD_I,
     EC_WORD_THINK},
    {EC_WORD_WAAAH, EC_WORD_EXCL, EC_WORD_IT, EC_WORD_WASN_T, EC_WORD_THIS,
     EC_WORD_WAY},
    {EC_WORD_MY, EC_WORD_POKEMON, EC_WORD_ARE, EC_WORD_TOO, EC_WORD_TIRED,
     EC_WORD_ELLIPSIS},
    {EC_WORD_MY, EC_WORD_POKEMON, EC_WORD_ARE, EC_WORD_STRONG, EC_WORD_TO,
     EC_WORD_POISON},
    {EC_WORD_LALALA, EC_WORD_LALALA, EC_WORD_EXCL, EC_WORD_I_AM,
     EC_WORD_AWESOME, EC_WORD_LALALA},
    {EC_MOVE2(TOXIC), EC_WORD_IS, EC_WORD_A, EC_WORD_TERRIBLE, EC_WORD_THING,
...
static void GetBattlePikeData(void) {
  ...
  case PIKE_DATA_WIN_STREAK:
    gSpecialVar_Result = gSaveBlock2Ptr->frontier
                             .pikeWinStreaks[gSaveBlock2Ptr->frontier.lvlMode];
    break;
  case PIKE_DATA_RECORD_STREAK:
    gSpecialVar_Result =
        gSaveBlock2Ptr->frontier
            .pikeRecordStreaks[gSaveBlock2Ptr->frontier.lvlMode];
    break;
  case PIKE_DATA_TOTAL_STREAKS:
    gSpecialVar_Result =
        gSaveBlock2Ptr->frontier
            .pikeTotalStreaks[gSaveBlock2Ptr->frontier.lvlMode];
    break;
...
static void GetRoomType(void) { gSpecialVar_Result = sRoomType; }

static void SetInWildMonRoom(void) { sInWildMonRoom = TRUE; }

static void ClearInWildMonRoom(void) { sInWildMonRoom = FALSE; }
...
static void GetRoomInflictedStatusMon(void) { gSpecialVar_Result = sStatusMon; }
  ...
  do {
    ...
    if (status != sStatusFlags) {
      ...
      for (i = 0; i < FRONTIER_PARTY_SIZE; i++) {
        ...
        if (GetAilmentFromStatus(GetMonData(mon, MON_DATA_STATUS)) ==
                AILMENT_NONE &&
...
static u8 GetNextRoomType(void) {
  bool8 roomTypesDisabled[NUM_PIKE_ROOM_TYPES -
                          1]; // excludes Brain room, which cant be disabled
  u8 i;
  u8 nextRoomType;
  u8 roomHint;
  ...
  // Check if the player walked into the same room that the lady gave a hint
  // about.
  ...
  // The other two room types cannot be the same type as the one associated with
  // the lady's hint
  ...
  // Remove room type candidates that would have no effect on the player's
  // party.
  if (roomTypesDisabled[PIKE_ROOM_DOUBLE_BATTLE] != TRUE &&
      !AtLeastTwoAliveMons()) {
...
static bool8 UNUSED GetInWildMonRoom(void) { return sInWildMonRoom; }
...
bool32 TryGenerateBattlePikeWildMon(bool8 checkKeenEyeIntimidate) {
  ...
  SetMonData(
      &gEnemyParty[0], MON_DATA_EXP,
      &gExperienceTables[gSpeciesInfo[wildMons[headerId][pikeMonId].species]
                             .growthRate][monLevel]);
...
static void DoStatusInflictionScreenFlash(u8 taskId) {
  while (sStatusInflictionScreenFlashFuncs[gTasks[taskId].data[0]](
      &gTasks[taskId]))
    ;
}
...
static void StartStatusInflictionScreenFlash(s16 fadeOutDelay, s16 fadeInDelay,
                                             s16 numFades, s16 fadeOutSpeed,
                                             s16 fadeInSpped) {
...
static void TryHealMons(u8 healCount) {
  ...
  for (i = 0; i < FRONTIER_PARTY_SIZE; i++) {
    ...
    if (curr < max) {
      canBeHealed = TRUE;
    } else if (GetAilmentFromStatus(GetMonData(mon, MON_DATA_STATUS)) !=
               AILMENT_NONE) {
      canBeHealed = TRUE;
    } else {
...
static void GetInBattlePike(void) { gSpecialVar_Result = InBattlePike(); }
...
static void SetHintedRoom(void) {
  ...
  if (GetPikeQueenFightType(1)) {
    ...
    gSaveBlock2Ptr->frontier.pikeHintedRoomType =
        roomCandidates[Random() % count];
    Free(roomCandidates);
    if (gSaveBlock2Ptr->frontier.pikeHintedRoomType == PIKE_ROOM_STATUS &&
        !AtLeastOneHealthyMon())
      gSaveBlock2Ptr->frontier.pikeHintedRoomType = PIKE_ROOM_NPC;
    if (gSaveBlock2Ptr->frontier.pikeHintedRoomType ==
...
static void GetRoomTypeHint(void) {
  gSpecialVar_Result =
      sRoomTypeHints[gSaveBlock2Ptr->frontier.pikeHintedRoomType];
}
...
static void PrepareOneTrainer(bool8 difficult) {
  ...
  if (gSaveBlock2Ptr->frontier.curChallengeBattleNum < NUM_PIKE_ROOMS)
    gSaveBlock2Ptr->frontier
        .trainerIds[gSaveBlock2Ptr->frontier.curChallengeBattleNum - 1] =
...
static void PrepareTwoTrainers(void) {
  ...
  gFacilityTrainers = gBattleFrontierTrainers;
  do {
    // Pick the 1st trainer, making sure it's not one that's been encountered
    // yet in this challenge.
  ...
  do {
    // Pick the 2nd trainer, making sure it's not one that's been encountered
    // yet in this challenge.
    trainerId = GetRandomScaledFrontierTrainerId(challengeNum, 1);
  ...
  if (gSaveBlock2Ptr->frontier.curChallengeBattleNum < NUM_PIKE_ROOMS)
    gSaveBlock2Ptr->frontier
        .trainerIds[gSaveBlock2Ptr->frontier.curChallengeBattleNum - 2] =
  ...
  if (gSpecialVar_0x8005 == 0) {
    if (gTrainerBattleOpponent_A < FRONTIER_TRAINERS_COUNT)
      FrontierSpeechToString(
          gFacilityTrainers[gTrainerBattleOpponent_A].speechBefore);
  } else if (gSpecialVar_0x8005 == 1) {
    if (gTrainerBattleOpponent_B < FRONTIER_TRAINERS_COUNT)
      FrontierSpeechToString(
          gFacilityTrainers[gTrainerBattleOpponent_B].speechBefore);
  }
}
...
static void HealSomeMonsBeforePikeQueen(void) {
  u8 toHealCount = sNumMonsToHealBeforePikeQueen
...
static void IsPartyFullHealed(void) {
  ...
  for (i = 0; i < FRONTIER_PARTY_SIZE; i++) {
    ...
    u16 curr = GetMonData(mon, MON_DATA_HP);
    u16 max = GetMonData(mon, MON_DATA_MAX_HP);
    if (curr >= max && GetAilmentFromStatus(GetMonData(mon, MON_DATA_STATUS)) ==
                           AILMENT_NONE) {
      u8 ppBonuses = GetMonData(mon, MON_DATA_PP_BONUSES);
      for (j = 0; j < MAX_MON_MOVES; j++) {
        u16 move = GetMonData(mon, MON_DATA_MOVE1 + j);
...
static bool8 CanEncounterWildMon(u8 enemyMonLevel) {
  if (!GetMonData(&gPlayerParty[0], MON_DATA_SANITY_IS_EGG)) {
    ...
    if (monAbility == ABILITY_KEEN_EYE || monAbility == ABILITY_INTIMIDATE) {
      ...
      if (playerMonLevel > 5 && enemyMonLevel <= playerMonLevel - 5 &&
          Random() % 2 == 0)
        return FALSE;
    }
  }
