...
EWRAM_DATA static u16
    sStatsMovesTMHM[NUM_TECHNICAL_MACHINES + NUM_HIDDEN_MACHINES] = {0};
EWRAM_DATA static u16
    sStatsMovesTMHM_ID[NUM_TECHNICAL_MACHINES + NUM_HIDDEN_MACHINES] = {0};
...
static void PrintMonStats(u8 taskId, u32 num, u32 value, u32 owned,
                          u32 newEntry);
...
//  static const u16 sSplitIcons_Pal[] =
//  INCBIN_U16("graphics/interface/split_icons.gbapal"); static const u32
//  sSplitIcons_Gfx[] = INCBIN_U32("graphics/interface/split_icons.4bpp.lz");
...
static const union AnimCmd sSpriteAnim_ScrollBar[] = {ANIMCMD_FRAME(3, 30),
                                                      ANIMCMD_END};

static const union AnimCmd sSpriteAnim_ScrollArrow[] = {ANIMCMD_FRAME(1, 30),
                                                        ANIMCMD_END};

static const union AnimCmd sSpriteAnim_RotatingPokeBall[] = {
    ANIMCMD_FRAME(16, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_StartButton[] = {ANIMCMD_FRAME(48, 30),
                                                        ANIMCMD_END};

static const union AnimCmd sSpriteAnim_SearchText[] = {ANIMCMD_FRAME(40, 30),
                                                       ANIMCMD_END};

static const union AnimCmd sSpriteAnim_SelectButton[] = {ANIMCMD_FRAME(32, 30),
                                                         ANIMCMD_END};

static const union AnimCmd sSpriteAnim_MenuText[] = {ANIMCMD_FRAME(56, 30),
                                                     ANIMCMD_END};

static const union AnimCmd sSpriteAnim_SeenText[] = {ANIMCMD_FRAME(64, 30),
                                                     ANIMCMD_END};

static const union AnimCmd sSpriteAnim_OwnText[] = {ANIMCMD_FRAME(96, 30),
                                                    ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennText[] = {ANIMCMD_FRAME(160, 30),
                                                      ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalText[] = {ANIMCMD_FRAME(168, 30),
                                                         ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit0[] = {
    ANIMCMD_FRAME(128, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit1[] = {
    ANIMCMD_FRAME(130, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit2[] = {
    ANIMCMD_FRAME(132, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit3[] = {
    ANIMCMD_FRAME(134, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit4[] = {
    ANIMCMD_FRAME(136, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit5[] = {
    ANIMCMD_FRAME(138, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit6[] = {
    ANIMCMD_FRAME(140, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit7[] = {
    ANIMCMD_FRAME(142, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit8[] = {
    ANIMCMD_FRAME(144, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_HoennSeenOwnDigit9[] = {
    ANIMCMD_FRAME(146, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit0[] = {
    ANIMCMD_FRAME(176, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit1[] = {
    ANIMCMD_FRAME(178, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit2[] = {
    ANIMCMD_FRAME(180, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit3[] = {
    ANIMCMD_FRAME(182, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit4[] = {
    ANIMCMD_FRAME(184, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit5[] = {
    ANIMCMD_FRAME(186, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit6[] = {
    ANIMCMD_FRAME(188, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit7[] = {
    ANIMCMD_FRAME(190, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit8[] = {
    ANIMCMD_FRAME(192, 30), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_NationalSeenOwnDigit9[] = {
    ANIMCMD_FRAME(194, 30), ANIMCMD_END};
...
static const union AnimCmd *const sSpriteAnimTable_InterfaceText[] = {
    sSpriteAnim_StartButton, sSpriteAnim_SearchText, sSpriteAnim_SelectButton,
    sSpriteAnim_MenuText};

static const union AnimCmd *const sSpriteAnimTable_SeenOwnText[] = {
    sSpriteAnim_SeenText, sSpriteAnim_OwnText};

static const union AnimCmd *const sSpriteAnimTable_HoennNationalText[] = {
    sSpriteAnim_HoennText, sSpriteAnim_NationalText};

static const union AnimCmd *const sSpriteAnimTable_HoennSeenOwnNumber[] = {
    sSpriteAnim_HoennSeenOwnDigit0, sSpriteAnim_HoennSeenOwnDigit1,
    sSpriteAnim_HoennSeenOwnDigit2, sSpriteAnim_HoennSeenOwnDigit3,
    sSpriteAnim_HoennSeenOwnDigit4, sSpriteAnim_HoennSeenOwnDigit5,
    sSpriteAnim_HoennSeenOwnDigit6, sSpriteAnim_HoennSeenOwnDigit7,
    sSpriteAnim_HoennSeenOwnDigit8, sSpriteAnim_HoennSeenOwnDigit9};

static const union AnimCmd *const sSpriteAnimTable_NationalSeenOwnNumber[] = {
    sSpriteAnim_NationalSeenOwnDigit0, sSpriteAnim_NationalSeenOwnDigit1,
    sSpriteAnim_NationalSeenOwnDigit2, sSpriteAnim_NationalSeenOwnDigit3,
    sSpriteAnim_NationalSeenOwnDigit4, sSpriteAnim_NationalSeenOwnDigit5,
    sSpriteAnim_NationalSeenOwnDigit6, sSpriteAnim_NationalSeenOwnDigit7,
    sSpriteAnim_NationalSeenOwnDigit8, sSpriteAnim_NationalSeenOwnDigit9};

static const union AnimCmd *const sSpriteAnimTable_DexListStartMenuCursor[] = {
    sSpriteAnim_DexListStartMenuCursor};

#define TAG_DEX_INTERFACE                                                      \
  4096 // Tile and pal tag used for all interface sprites.
...
static const u8 sCaughtBall_Gfx[] =
    INCBIN_U8("graphics/pokedex/caught_ball.4bpp");
...
// First character in range followed by number of characters in range for upper
// and lowercase
...
static const struct SearchMenuTopBarItem
    sSearchMenuTopBarItems[SEARCH_TOPBAR_COUNT] = {
        [SEARCH_TOPBAR_SEARCH] =
            {
...
static const struct SearchOptionText sDexOrderOptions[] = {
    [ORDER_NUMERICAL] = {gText_DexSortNumericalDescription,
                         gText_DexSortNumericalTitle},
    [ORDER_ALPHABETICAL] = {gText_DexSortAtoZDescription,
                            gText_DexSortAtoZTitle},
    [ORDER_HEAVIEST] = {gText_DexSortHeaviestDescription,
                        gText_DexSortHeaviestTitle},
    [ORDER_LIGHTEST] = {gText_DexSortLightestDescription,
                        gText_DexSortLightestTitle},
    [ORDER_TALLEST] = {gText_DexSortTallestDescription,
                       gText_DexSortTallestTitle},
    [ORDER_SMALLEST] = {gText_DexSortSmallestDescription,
...
static const struct SearchOptionText sDexSearchColorOptions[] = {
    ...
    [BODY_COLOR_YELLOW + 1] = {gText_DexEmptyString,
...
static const u8 sOrderOptions[] = {
    ORDER_NUMERICAL, ORDER_ALPHABETICAL, ORDER_HEAVIEST,
    ORDER_LIGHTEST,  ORDER_TALLEST,      ORDER_SMALLEST,
};
...
// Number pairs are the task data for tracking the cursor pos and scroll offset
// of each option list See task data defines above Task_LoadSearchMenu
static const struct SearchOption sSearchOptions[] = {
    [SEARCH_NAME] = {sDexSearchNameOptions, 6, 7,
                     ARRAY_COUNT(sDexSearchNameOptions) - 1},
    [SEARCH_COLOR] = {sDexSearchColorOptions, 8, 9,
                      ARRAY_COUNT(sDexSearchColorOptions) - 1},
    [SEARCH_TYPE_LEFT] = {sDexSearchTypeOptions, 10, 11,
                          ARRAY_COUNT(sDexSearchTypeOptions) - 1},
    [SEARCH_TYPE_RIGHT] = {sDexSearchTypeOptions, 12, 13,
                           ARRAY_COUNT(sDexSearchTypeOptions) - 1},
    [SEARCH_ORDER] = {sDexOrderOptions, 4, 5,
                      ARRAY_COUNT(sDexOrderOptions) - 1},
  ...
  if (sPokedexView->menuY) {
    ...
    if ((JOY_NEW(A_BUTTON)) &&
      ...
      BeginNormalPaletteFade(
          ~(1 << (gSprites[sPokedexView->selectedMonSpriteId].oam.paletteNum +
                  16)),
          0, 0, 0x10, RGB_BLACK);
...
static void Task_OpenInfoScreenAfterMonMovement(u8 taskId) {
  if (gSprites[sPokedexView->selectedMonSpriteId].x == 48 &&
      gSprites[sPokedexView->selectedMonSpriteId].y == 56) {
    sPokedexView->currentPageBackup = sPokedexView->currentPage;
    gTasks[taskId].tTaskId = LoadInfoScreen(
        &sPokedexView->pokedexList[sPokedexView->selectedPokemon],
...
static void Task_WaitForExitInfoScreen(u8 taskId) {
  if (gTasks[gTasks[taskId].tTaskId].isActive) {
    if (sPokedexView->currentPage == PAGE_INFO &&
        !IsInfoScreenScrolling(gTasks[taskId].tTaskId) &&
        TryDoInfoScreenScroll())
      sub_80BE9F8(&sPokedexView->pokedexList[sPokedexView->selectedPokemon],
...
static void Task_HandleSearchResultsInput(u8 taskId) {
  ...
  if (sPokedexView->menuY) {
    ...
    if ((JOY_NEW(A_BUTTON)) &&
      ...
      UpdateSelectedMonSpriteId();
      a = (1 << (gSprites[sPokedexView->selectedMonSpriteId].oam.paletteNum +
                 16));
      gSprites[sPokedexView->selectedMonSpriteId].callback =
          SpriteCB_MoveMonForInfoScreen;
...
static bool8 LoadPokedexListPage(u8 page) {
  ...
  default:
    ...
    InitBgsFromTemplates(0, sPokedex_BgTemplate,
                         ARRAY_COUNT(sPokedex_BgTemplate));
    ...
    if (page == PAGE_MAIN)
      ...
      CopyToBgTilemapBuffer(0, gPokedexStartMenuSearchResults_Tilemap, 0,
                            0x280);
    ResetPaletteFade();
    if (page == PAGE_MAIN)
      sPokedexView->isSearchResults = FALSE;
...
static void CreatePokedexList(u8 dexMode, u8 order) {
  u16 vars[3]; // I have no idea why three regular variables are stored in an
               // array, but whatever.
  ...
  case ORDER_ALPHABETICAL:
    for (i = 0; i < NUM_SPECIES - 1; i++) {
      ...
      if (NationalToHoennOrder(temp_dexNum) <= temp_dexCount &&
          GetSetPokedexFlag(temp_dexNum, FLAG_GET_SEEN)) {
        sPokedexView->pokedexList[sPokedexView->pokemonListCount].dexNum =
            temp_dexNum;
...
static void PrintMonDexNumAndName(u8 windowId, u8 fontId, const u8 *str,
                                  u8 left, u8 top) {
  u8 color[3];
  ...
  AddTextPrinterParameterized4(windowId, fontId, left * 8, (top * 8) + 1, 0, 0,
                               color, -1, str);
}
    ...
    if (entryNum < 0 || entryNum >= NATIONAL_DEX_COUNT ||
      ...
      if (sPokedexView->pokedexList[entryNum].seen) {
        CreateMonDexNum(entryNum, MON_LIST_X + 1, sPokedexView->listVOffset * 2,
                        ignored);
        CreateCaughtBall(sPokedexView->pokedexList[entryNum].owned, MON_LIST_X,
                         sPokedexView->listVOffset * 2, ignored);
        CreateMonName(sPokedexView->pokedexList[entryNum].dexNum,
                      MON_LIST_X + 5, sPokedexView->listVOffset * 2);
      } else {
        CreateMonDexNum(entryNum, MON_LIST_X + 1, sPokedexView->listVOffset * 2,
                        ignored);
...
static bool8 UpdateDexListScroll(u8 direction, u8 monMoveIncrement,
                                 u8 scrollTimerMax) {
  u16 i;
  u8 step;
  ...
  if (sPokedexView->scrollTimer) {
    ...
    SetGpuReg(REG_OFFSET_BG2VOFS,
              sPokedexView->initialVOffset +
                  sPokedexView->listVOffset * LIST_SCROLL_STEP);
    return TRUE;
  }
}
...
static u16 TryDoPokedexScroll(u16 selectedMon, u16 ignored) {
  ...
  if ((JOY_HELD(DPAD_UP)) && (selectedMon > 0)) {
    scrollDir = 1;
    selectedMon =
        GetNextPosition(1, selectedMon, 0, sPokedexView->pokemonListCount - 1);
    ...
    scrollDir = 2;
    selectedMon =
        GetNextPosition(0, selectedMon, 0, sPokedexView->pokemonListCount - 1);
    ...
    for (i = 0; i < 7; i++)
      selectedMon = GetNextPosition(1, selectedMon, 0,
    ...
    startingPos = selectedMon;
    for (i = 0; i < 7; i++)
      selectedMon = GetNextPosition(0, selectedMon, 0,
                                    sPokedexView->pokemonListCount - 1);
    sPokedexView->pokeBallRotation += 16 * (selectedMon - startingPos);
    ClearMonSprites();
    CreateMonSpritesAtPos(selectedMon, 0xE);
...
static void UpdateSelectedMonSpriteId(void) {
  ...
  for (i = 0; i < MAX_MONS_ON_SCREEN; i++) {
    ...
    if (gSprites[spriteId].x2 == 0 && gSprites[spriteId].y2 == 0 &&
        spriteId != 0xFFFF)
...
static bool8 TryDoInfoScreenScroll(void) {
  ...
  if ((JOY_NEW(DPAD_UP)) && selectedPokemon) {
    ...
    while (nextPokemon != 0) {
      nextPokemon = GetNextPosition(1, nextPokemon, 0,
                                    sPokedexView->pokemonListCount - 1);
    ...
    if (sPokedexView->selectedPokemon == selectedPokemon)
      ...
      return TRUE;
             ...
             selectedPokemon < sPokedexView->pokemonListCount - 1) {
    nextPokemon = selectedPokemon;
    while (nextPokemon < sPokedexView->pokemonListCount - 1) {
      nextPokemon = GetNextPosition(0, nextPokemon, 0,
                                    sPokedexView->pokemonListCount - 1);
...
static u16 GetPokemonSpriteToDisplay(u16 species) {
  if (species >= NATIONAL_DEX_COUNT ||
      sPokedexView->pokedexList[species].dexNum == 0xFFFF)
    return 0xFFFF;
...
static void CreateInterfaceSprites(u8 page) {
  ...
  if (page == PAGE_MAIN) {
    ...
    if (!IsNationalPokedexEnabled()) {
      ...
      // // Seen value - 100s
      // drawNextDigit = FALSE;
      // spriteId = CreateSprite(&sHoennDexSeenOwnNumberSpriteTemplate, 24, 48,
      // 1); digitNum = sPokedexView->seenCount / 100;
      ...
      // // Seen value - 10s
      // spriteId = CreateSprite(&sHoennDexSeenOwnNumberSpriteTemplate, 32, 48,
      // 1); digitNum = (sPokedexView->seenCount % 100) / 10; if (digitNum != 0
      // || drawNextDigit)
      //     StartSpriteAnim(&gSprites[spriteId], digitNum);
      // else
      //     gSprites[spriteId].invisible = TRUE;
      ...
      // // Seen value - 1s
      // spriteId = CreateSprite(&sHoennDexSeenOwnNumberSpriteTemplate, 40, 48,
      // 1); digitNum = (sPokedexView->seenCount % 100) % 10;
      // StartSpriteAnim(&gSprites[spriteId], digitNum);

      // // Owned value - 100s
      // drawNextDigit = FALSE;
      // spriteId = CreateSprite(&sHoennDexSeenOwnNumberSpriteTemplate, 24, 80,
      // 1); digitNum = sPokedexView->ownCount / 100;
      // StartSpriteAnim(&gSprites[spriteId], digitNum);
      // if (digitNum != 0)
      //     drawNextDigit = TRUE;
      // else
      ...
      // // Owned value - 10s
      // spriteId = CreateSprite(&sHoennDexSeenOwnNumberSpriteTemplate, 32, 80,
      // 1); digitNum = (sPokedexView->ownCount % 100) / 10; if (digitNum != 0
      // || drawNextDigit)
      //     StartSpriteAnim(&gSprites[spriteId], digitNum);
      // else
      //     gSprites[spriteId].invisible = TRUE;
      ...
      // // Owned value - 1s
      // spriteId = CreateSprite(&sHoennDexSeenOwnNumberSpriteTemplate, 40, 80,
      // 1); digitNum = (sPokedexView->ownCount % 100) % 10;
      // StartSpriteAnim(&gSprites[spriteId], digitNum);

      // Hoenn text
      CreateSprite(&sHoennNationalTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X,
                   40 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET - 6, 1);
      // Hoenn seen
      CreateSprite(&sSeenOwnTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X,
                   45 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET + 6, 1);
      // Hoenn own
      spriteId =
          CreateSprite(&sSeenOwnTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X,
                       55 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET + 7, 1);
      StartSpriteAnim(&gSprites[spriteId], 1);

      // Hoenn seen value - 100s
      drawNextDigit = FALSE;
      spriteId =
          CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate,
                       LIST_RIGHT_SIDE_TEXT_X + LIST_RIGHT_SIDE_TEXT_X_OFFSET,
                       45 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
      ...
      spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate,
                              LIST_RIGHT_SIDE_TEXT_X +
                                  LIST_RIGHT_SIDE_TEXT_X_OFFSET + 8,
                              45 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
      ...
      spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate,
                              LIST_RIGHT_SIDE_TEXT_X +
                                  LIST_RIGHT_SIDE_TEXT_X_OFFSET + 16,
                              45 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
      digitNum = (sPokedexView->seenCount % 100) % 10;
      StartSpriteAnim(&gSprites[spriteId], digitNum);
      ...
      spriteId =
          CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate,
                       LIST_RIGHT_SIDE_TEXT_X + LIST_RIGHT_SIDE_TEXT_X_OFFSET,
                       55 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
      ...
      // National text
      spriteId = CreateSprite(&sHoennNationalTextSpriteTemplate,
                              LIST_RIGHT_SIDE_TEXT_X,
                              73 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET - 6, 1);
      StartSpriteAnim(&gSprites[spriteId], 1);
      // National seen
      CreateSprite(&sSeenOwnTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X,
                   78 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET + 6, 1);
      // National own
      spriteId =
          CreateSprite(&sSeenOwnTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X,
                       88 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET + 6, 1);
      StartSpriteAnim(&gSprites[spriteId], 1);
      ...
      spriteId =
          CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate,
                       LIST_RIGHT_SIDE_TEXT_X + LIST_RIGHT_SIDE_TEXT_X_OFFSET,
                       78 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
      digitNum = sPokedexView->seenCount / 100;
      StartSpriteAnim(&gSprites[spriteId], digitNum);
      if (digitNum != 0)
        drawNextDigit = TRUE;
      ...
      spriteId =
          CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate,
                       LIST_RIGHT_SIDE_TEXT_X + LIST_RIGHT_SIDE_TEXT_X_OFFSET,
                       88 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
      digitNum = sPokedexView->ownCount / 100;
      StartSpriteAnim(&gSprites[spriteId], digitNum);
      if (digitNum != 0)
        drawNextDigit = TRUE;
...
static void SpriteCB_Scrollbar(struct Sprite *sprite) {
  if (sPokedexView->currentPage != PAGE_MAIN &&
    ...
    sprite->y2 = sPokedexView->selectedPokemon * 120 /
                 (sPokedexView->pokemonListCount - 1);
}
...
static u8 LoadInfoScreen(struct PokedexListItem *item, u8 monSpriteId) {
  ...
  InitBgsFromTemplates(0, sInfoScreen_BgTemplate,
                       ARRAY_COUNT(sInfoScreen_BgTemplate));
  SetBgTilemapBuffer(3, AllocZeroed(BG_SCREEN_SIZE));
  SetBgTilemapBuffer(2, AllocZeroed(BG_SCREEN_SIZE));
  SetBgTilemapBuffer(1, AllocZeroed(BG_SCREEN_SIZE));
  SetBgTilemapBuffer(0, AllocZeroed(BG_SCREEN_SIZE));
...
static void Task_LoadInfoScreen(u8 taskId) {
  ...
  case 5:
    if (gTasks[taskId].data[1] == 0) {
      gTasks[taskId].tMonSpriteId = (u16)CreateMonSpriteFromNationalDexNumber(
          sPokedexListItem->dexNum, 48, 56, 0);
  ...
  case 8:
    if (!gPaletteFade.active) {
      ...
      //     PlayCry2(NationalPokedexNumToSpecies(sPokedexListItem->dexNum), 0,
      //     0x7D, 0xA);
      // }
      // else
      // {
...
static void Task_HandleInfoScreenInput(u8 taskId) {
  ...
  //  || (JOY_NEW(L_BUTTON) && gSaveBlock2Ptr->optionsButtonMode ==
  ...
  //  || (JOY_NEW(R_BUTTON) && gSaveBlock2Ptr->optionsButtonMode ==
  //  OPTIONS_BUTTON_MODE_LR))
...
static void Task_LoadAreaScreen(u8 taskId) {
  ...
  case 1:
    ...
    LoadPokedexBgPalette(sPokedexView->isSearchResults);
    SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) |
                                     BGCNT_SCREENBASE(13) | BGCNT_16COLOR |
                                     BGCNT_TXT256x256);
    gMain.state++;
    break;
  case 2:
...
static void Task_LoadCryScreen(u8 taskId) {
  ...
  case 4:
    ...
    break;
  case 5:
    gTasks[taskId].tMonSpriteId = CreateMonSpriteFromNationalDexNumber(
        sPokedexListItem->dexNum, 48, 56, 0);
    gSprites[gTasks[taskId].tMonSpriteId].oam.priority = 0;
...
static void Task_LoadSizeScreen(u8 taskId) {
  ...
  case 3: {
    ...
    PrintInfoScreenText(string, GetStringCenterAlignXOffset(1, string, 0xF0),
                        0x79);
    gMain.state++;
  } break;
  case 4:
  ...
  case 5:
    spriteId = CreateSizeScreenTrainerPic(
        PlayerGenderToFrontTrainerPicId(gSaveBlock2Ptr->playerGender), 152, 56,
        0);
    gSprites[spriteId].oam.affineMode = ST_OAM_AFFINE_NORMAL;
    gSprites[spriteId].oam.matrixNum = 1;
    gSprites[spriteId].oam.priority = 0;
    gSprites[spriteId].y2 =
        gPokedexEntries[sPokedexListItem->dexNum].trainerOffset;
    SetOamMatrix(1, gPokedexEntries[sPokedexListItem->dexNum].trainerScale, 0,
                 0, gPokedexEntries[sPokedexListItem->dexNum].trainerScale);
    LoadPalette(sSizeScreenSilhouette_Pal,
                (gSprites[spriteId].oam.paletteNum + 16) * 16, 0x20);
    gTasks[taskId].data[5] = spriteId;
    gMain.state++;
    break;
  case 6:
    spriteId = CreateMonSpriteFromNationalDexNumber(sPokedexListItem->dexNum,
                                                    88, 56, 1);
    gSprites[spriteId].oam.affineMode = ST_OAM_AFFINE_NORMAL;
    gSprites[spriteId].oam.matrixNum = 2;
    gSprites[spriteId].oam.priority = 0;
    gSprites[spriteId].y2 =
        gPokedexEntries[sPokedexListItem->dexNum].pokemonOffset;
    SetOamMatrix(2, gPokedexEntries[sPokedexListItem->dexNum].pokemonScale, 0,
                 0, gPokedexEntries[sPokedexListItem->dexNum].pokemonScale);
    LoadPalette(sSizeScreenSilhouette_Pal,
                (gSprites[spriteId].oam.paletteNum + 16) * 16, 0x20);
...
static void Task_DisplayCaughtMonDexPage(u8 taskId) {
  ...
  default:
    if (!gPaletteFade.active) {
      ...
      ResetBgsAndClearDma3BusyFlags(0);
      InitBgsFromTemplates(0, sNewEntryInfoScreen_BgTemplate,
                           ARRAY_COUNT(sNewEntryInfoScreen_BgTemplate));
      SetBgTilemapBuffer(3, AllocZeroed(BG_SCREEN_SIZE));
      SetBgTilemapBuffer(2, AllocZeroed(BG_SCREEN_SIZE));
...
static void Task_HandleCaughtMonPageInput(u8 taskId) {
  if (JOY_NEW(A_BUTTON | B_BUTTON)) {
    ...
    gSprites[gTasks[taskId].tMonSpriteId].callback =
...
static void Task_ExitCaughtMonPage(u8 taskId) {
  if (!gPaletteFade.active) {
    ...
    personality = ((u16)gTasks[taskId].tPersonalityHi << 16) |
                  (u16)gTasks[taskId].tPersonalityLo;
...
// Type Icon
static void SetSpriteInvisibility(u8 spriteArrayId, bool8 invisible) {
  gSprites[sPokedexView->typeIconSpriteIds[spriteArrayId]].invisible =
      invisible;
}
...
static const u8
    sMoveTypeToOamPaletteNum[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] = {
...
static void CreateTypeIconSprites(void) {
  ...
  for (i = 0; i < 2; i++) {
    if (sPokedexView->typeIconSpriteIds[i] == 0xFF)
      sPokedexView->typeIconSpriteIds[i] =
          CreateSprite(&sSpriteTemplate_MoveTypes, 10, 10, 2);

    SetSpriteInvisibility(i, TRUE);
  }
}

// u32 value is re-used, but passed as a bool that's TRUE if national dex is
// enabled
static void PrintMonInfo(u32 num, u32 value, u32 owned, u32 newEntry) {
  ...
  //     GetStringCenterAlignXOffset(1, gText_PokedexRegistration, 0xF0), 0);
  if (value == 0)
    value = NationalToHoennOrder(num);
  else
    value = num;
  ConvertIntToDecimalStringN(StringCopy(str, gText_NumberClear01), value,
  ...
  PrintInfoScreenText(description,
                      GetStringCenterAlignXOffset(1, description, 0xF0),
                      93); // HGSS_Ui
...
static void UnusedPrintMonName(u8 windowId, const u8 *name, u8 left, u8 top) {
  ...
  for (i = 0; i < ARRAY_COUNT(str); i++)
    str[i] = CHAR_SPACE;
  for (nameLength = 0;
       name[nameLength] != CHAR_SPACE && nameLength < ARRAY_COUNT(str);
       nameLength++)
    ;
...
// Unown and Spinda use the personality of the first seen individual of that
// species All others use personality 0
...
u16 CreateMonSpriteFromNationalDexNumber(u16 nationalNum, s16 x, s16 y,
                                         u16 paletteSlot) {
  nationalNum = NationalPokedexNumToSpecies(nationalNum);
  return CreateMonPicSprite_HandleDeoxys(nationalNum, SHINY_ODDS,
                                         GetPokedexMonPersonality(nationalNum),
                                         TRUE, x, y, paletteSlot, 0xFFFF);
}

static u16 CreateSizeScreenTrainerPic(u16 species, s16 x, s16 y,
                                      s8 paletteSlot) {
  return CreateTrainerPicSprite(species, TRUE, x, y, paletteSlot, 0xFFFF);
}

bool8 SpeciesCanLearnLvlUpMove(u16 species,
                               u16 move) // Move search PokedexPlus HGSS_Ui
{
  u16 j;
  for (j = 0;
       j < MAX_LEVEL_UP_MOVES && gLevelUpLearnsets[species][j] != LEVEL_UP_END;
       j++) {
...
static int DoPokedexSearch(u8 dexMode, u8 order, u8 abcGroup, u8 bodyColor,
                           u8 type1, u8 type2) // ,u16 move)
{
  u16 species;
  u16 i, j;
  u16 resultsCount;
  ...
  if (abcGroup != 0xFF) {
    for (i = 0, resultsCount = 0; i < sPokedexView->pokemonListCount; i++) {
      ...
      species =
          NationalPokedexNumToSpecies(sPokedexView->pokedexList[i].dexNum);
      ...
      for (i = 0, resultsCount = 0; i < sPokedexView->pokemonListCount; i++) {
        if (sPokedexView->pokedexList[i].owned) {
          ...
          if (types[0] == type1 || types[1] == type1) {
            sPokedexView->pokedexList[resultsCount] =
...
static u8 LoadSearchMenu(void) { return CreateTask(Task_LoadSearchMenu, 0); }
...
static void Task_LoadSearchMenu(u8 taskId) {
  ...
  case 0:
    if (!gPaletteFade.active) {
      ...
      ResetOtherVideoRegisters(0);
      ResetBgsAndClearDma3BusyFlags(0);
      InitBgsFromTemplates(0, sSearchMenu_BgTemplate,
                           ARRAY_COUNT(sSearchMenu_BgTemplate));
      SetBgTilemapBuffer(3, AllocZeroed(BG_SCREEN_SIZE));
      SetBgTilemapBuffer(2, AllocZeroed(BG_SCREEN_SIZE));
      SetBgTilemapBuffer(1, AllocZeroed(BG_SCREEN_SIZE));
      SetBgTilemapBuffer(0, AllocZeroed(BG_SCREEN_SIZE));
...
static void Task_HandleSearchTopBarInput(u8 taskId) {
  ...
  if ((JOY_NEW(DPAD_LEFT)) &&
      gTasks[taskId].tTopBarItem > SEARCH_TOPBAR_SEARCH) {
    PlaySE(SE_DEX_PAGE);
  ...
  if ((JOY_NEW(DPAD_RIGHT)) &&
      gTasks[taskId].tTopBarItem < SEARCH_TOPBAR_CANCEL) {
    PlaySE(SE_DEX_PAGE);
    gTasks[taskId].tTopBarItem++;
    HighlightSelectedSearchTopBarItem(gTasks[taskId].tTopBarItem);
    CopyWindowToVram(0, 2);
...
static void Task_SwitchToSearchMenu(u8 taskId) {
  HighlightSelectedSearchMenuItem(gTasks[taskId].tTopBarItem,
                                  gTasks[taskId].tMenuItem);
  PrintSelectedSearchParameters(taskId);
  CopyWindowToVram(0, 2);
  CopyBgTilemapBufferToVram(3);
...
static void Task_HandleSearchMenuInput(u8 taskId) {
  ...
  if (JOY_NEW(A_BUTTON)) {
    if (gTasks[taskId].tMenuItem == SEARCH_OK) {
      if (gTasks[taskId].tTopBarItem != SEARCH_TOPBAR_SEARCH) {
        ...
        gSaveBlock2Ptr->pokedex.mode =
            GetSearchModeSelection(taskId, SEARCH_MODE);
        if (!IsNationalPokedexEnabled())
          gSaveBlock2Ptr->pokedex.mode = DEX_MODE_HOENN;
        sPokedexView->dexModeBackup = gSaveBlock2Ptr->pokedex.mode;
        gSaveBlock2Ptr->pokedex.order =
            GetSearchModeSelection(taskId, SEARCH_ORDER);
  ...
  if ((JOY_NEW(DPAD_LEFT)) &&
      movementMap[gTasks[taskId].tMenuItem][0] != 0xFF) {
    PlaySE(SE_SELECT);
  ...
  if ((JOY_NEW(DPAD_DOWN)) &&
      movementMap[gTasks[taskId].tMenuItem][3] != 0xFF) {
    PlaySE(SE_SELECT);
...
static void Task_SelectSearchMenuItem(u8 taskId) {
  ...
  cursorPos =
      (u16 *)&gTasks[taskId].data[sSearchOptions[menuItem].taskDataCursorPos];
  scrollOffset = (u16 *)&gTasks[taskId]
                     .data[sSearchOptions[menuItem].taskDataScrollOffset];
...
void SetSearchRectHighlight(u8 flags, u8 x, u8 y, u8 width) {
  ...
  u32 ptr = (u32)GetBgTilemapBuffer(
      3); // This should be a pointer, but this only matches as a u32.
...
static void DrawSearchMenuItemBgHighlight(u8 searchBg, bool8 unselected,
                                          bool8 disabled) {
...
// Prints the currently selected search parameters in the search menu selection
// boxes
static void PrintSelectedSearchParameters(u8 taskId) {
  ...
  searchParamId =
      gTasks[taskId].tCursorPos_Name + gTasks[taskId].tScrollOffset_Name;
  PrintSearchText(sDexSearchNameOptions[searchParamId].title, 0x2D, 0x11);

  searchParamId =
      gTasks[taskId].tCursorPos_Color + gTasks[taskId].tScrollOffset_Color;
  PrintSearchText(sDexSearchColorOptions[searchParamId].title, 0x2D, 0x21);

  searchParamId = gTasks[taskId].tCursorPos_TypeLeft +
                  gTasks[taskId].tScrollOffset_TypeLeft;
  PrintSearchText(sDexSearchTypeOptions[searchParamId].title, 0x2D, 0x31);

  searchParamId = gTasks[taskId].tCursorPos_TypeRight +
                  gTasks[taskId].tScrollOffset_TypeRight;
  PrintSearchText(sDexSearchTypeOptions[searchParamId].title, 0x5D, 0x31);

  searchParamId =
      gTasks[taskId].tCursorPos_Order + gTasks[taskId].tScrollOffset_Order;
  PrintSearchText(sDexOrderOptions[searchParamId].title, 0x2D, 0x41);

  if (IsNationalPokedexEnabled()) {
    searchParamId =
        gTasks[taskId].tCursorPos_Mode + gTasks[taskId].tScrollOffset_Mode;
...
// Prints the currently viewable search parameter titles in the right-hand text
// box and the currently selected search parameter description in the bottom
// text box
static void PrintSearchParameterText(u8 taskId) {
  const struct SearchOptionText *texts =
      sSearchOptions[gTasks[taskId].tMenuItem].texts;
  const u16 *cursorPos =
      &gTasks[taskId]
           .data[sSearchOptions[gTasks[taskId].tMenuItem].taskDataCursorPos];
  const u16 *scrollOffset =
      &gTasks[taskId]
           .data[sSearchOptions[gTasks[taskId].tMenuItem].taskDataScrollOffset];

  u16 i, j;

  ClearSearchParameterBoxText();

  for (i = 0, j = *scrollOffset;
       i < MAX_SEARCH_PARAM_ON_SCREEN && texts[j].title != NULL; i++, j++)
...
static u8 GetSearchModeSelection(u8 taskId, u8 option) {
  const u16 *cursorPos =
      &gTasks[taskId].data[sSearchOptions[option].taskDataCursorPos];
  const u16 *scrollOffset =
      &gTasks[taskId].data[sSearchOptions[option].taskDataScrollOffset];
...
static void Task_LoadStatsScreen(u8 taskId) {
  ...
  case 3:
    ...
    sPokedexView->typeIconSpriteIds[1] = 0xFF;
    CreateTypeIconSprites();
    // sMonSummaryScreen->splitIconSpriteId = 0xFF; //Physical/Special Split
    // from BE LoadCompressedPalette(gMoveTypes_Pal, 0x1D0, 0x60);
    // //Physical/Special Split from BE
    // LoadCompressedSpriteSheet(&sSpriteSheet_SplitIcons); //Physical/Special
    // Split from BE LoadSpritePalette(&sSpritePal_SplitIcons);
    // //Physical/Special Split from BE
    gMain.state++;
    break;
  case 4:
  ...
  case 5:
    if (gTasks[taskId].data[1] == 0) {
      ...
      LoadMonIconPalette(NationalPokedexNumToSpecies(
          sPokedexListItem->dexNum)); // Loads pallete for current mon
      gTasks[taskId].data[4] = CreateMonIcon(
          NationalPokedexNumToSpecies(sPokedexListItem->dexNum),
          SpriteCB_MonIcon, 17, 31, 4, 0, TRUE); // Create pokemon sprite
  ...
  case 6:
    ...
    PrintMonStats(taskId, sPokedexListItem->dexNum,
                  sPokedexView->dexMode == DEX_MODE_HOENN ? FALSE : TRUE,
                  sPokedexListItem->owned, 0);
...
static bool8 CalculateMoves(void) {
  ...
  // sTutorLearnsets
  for (i = 0; i < TUTOR_MOVE_COUNT; i++) {
    if (CanLearnTutorMove(species,
                          i)) // if (sTutorLearnsets[species] & (1 << i))
    {
...
static void PrintMoveNameAndInfo(u8 taskId, bool8 toggle) {
  ...
  if (selected < numEggMoves) {
    ...
    while (((gLevelUpLearnsets[species][(selected - numEggMoves)] &
             LEVEL_UP_MOVE_LV) != (level << 9)) &&
           level < 0xFF) {
      level++;
      if (gLevelUpLearnsets[species][(selected - numEggMoves)] == LEVEL_UP_END)
        level = 0xFF;
    }
    ConvertIntToDecimalStringN(gStringVar1, level, STR_CONV_MODE_LEFT_ALIGN,
                               3); // Move learn lvl
    PrintInfoScreenTextSmall(gText_Stats_MoveLevel, moves_x + 113,
                             moves_y + 3); // Level text
    PrintInfoScreenTextSmall(gStringVar1, moves_x + 113,
                             moves_y + 14); // Print level
    item = ITEM_EXP_SHARE;
  } else if (selected < (numEggMoves + numLevelUpMoves + numTMHMMoves)) {
    move = sStatsMovesTMHM[sPokedexView->moveSelected - numEggMoves -
                           numLevelUpMoves];
    StringCopy(gStringVar3, gMoveNames[move]);
    StringCopy(gStringVar4, gMoveDescriptionPointers[(move - 1)]);
    CopyItemName(sStatsMovesTMHM_ID[(selected - numEggMoves - numLevelUpMoves)],
                 gStringVar1); // TM name
    PrintInfoScreenTextSmall(gStringVar1, moves_x + 113, moves_y + 9);
    item = sStatsMovesTMHM_ID[(selected - numEggMoves - numLevelUpMoves)];
  } else if (selected <
             (numEggMoves + numLevelUpMoves + numTMHMMoves + numTutorMoves)) {
    move = sStatsMovesTutor[sPokedexView->moveSelected - numEggMoves -
                            numLevelUpMoves - numTMHMMoves];
    StringCopy(gStringVar3, gMoveNames[move]);
    StringCopy(gStringVar4, gMoveDescriptionPointers[(move - 1)]);
    PrintInfoScreenTextSmall(gText_ThreeDashes, moves_x + 113, moves_y + 9);
    item = ITEM_TEACHY_TV;
  ...
  if (gTasks[taskId].data[5] == 0)
    ...
    PrintInfoScreenTextSmall(
        gContestEffectDescriptionPointers[gContestMoves[move].effect], moves_x,
        moves_y + 34);
  ...
  ConvertIntToDecimalStringN(gStringVar1, (selected + 1),
  ...
  if (gTasks[taskId].data[5] == 0) {
    ...
    if (gBattleMoves[move].power < 2)
      ...
      ConvertIntToDecimalStringN(gStringVar1, gBattleMoves[move].power,
                                 STR_CONV_MODE_RIGHT_ALIGN, 3);
    ...
    if (gBattleMoves[move].accuracy == 0)
      ...
      ConvertIntToDecimalStringN(gStringVar1, gBattleMoves[move].accuracy,
                                 STR_CONV_MODE_RIGHT_ALIGN, 3);
    ...
    ConvertIntToDecimalStringN(gStringVar1, contest_appeal,
    ...
    ConvertIntToDecimalStringN(gStringVar1, contest_jam,
                               STR_CONV_MODE_RIGHT_ALIGN, 1);
...
static void PrintMonStatsToggle(u8 taskId) {
  ...
  // Clear old text
  FillWindowPixelRect(0, PIXEL_FILL(0), base_x, base_y, 90, 100); // bottom
                                                                  // stats
  FillWindowPixelRect(0, PIXEL_FILL(0), abilities_x, 99, 130, 58); // abilities

  // Base stats
  if (gTasks[taskId].data[5] == 0) {
    PrintInfoScreenTextSmall(gText_Stats_HP, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].baseHP,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_first_row,
                             base_y + base_offset * base_i);

    PrintInfoScreenTextSmall(gText_Stats_Speed, base_x + base_x_second_row,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].baseSpeed,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_offset,
                             base_y + base_offset * base_i);

    base_i++;
    PrintInfoScreenTextSmall(gText_Stats_Attack, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].baseAttack,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_first_row,
                             base_y + base_offset * base_i);

    PrintInfoScreenTextSmall(gText_Stats_SpAtk, base_x + base_x_second_row,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].baseSpAttack,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_offset,
                             base_y + base_offset * base_i);

    base_i++;
    PrintInfoScreenTextSmall(gText_Stats_Defense, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].baseDefense,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_first_row,
                             base_y + base_offset * base_i);

    PrintInfoScreenTextSmall(gText_Stats_SpDef, base_x + base_x_second_row,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].baseSpDefense,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_offset,
                             base_y + base_offset * base_i);
    base_i++;
  ...
  {
    PrintInfoScreenTextSmall(gText_Stats_EVHP, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].evYield_HP,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_first_row,
                             base_y + base_offset * base_i);

    PrintInfoScreenTextSmall(gText_Stats_EVSpeed, base_x + base_x_second_row,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].evYield_Speed,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_offset,
                             base_y + base_offset * base_i);

    base_i++;
    PrintInfoScreenTextSmall(gText_Stats_EVAttack, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].evYield_Attack,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_first_row,
                             base_y + base_offset * base_i);

    PrintInfoScreenTextSmall(gText_Stats_EVSpAtk, base_x + base_x_second_row,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].evYield_SpAttack,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_offset,
                             base_y + base_offset * base_i);

    base_i++;
    PrintInfoScreenTextSmall(gText_Stats_EVDefense, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].evYield_Defense,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_first_row,
                             base_y + base_offset * base_i);

    PrintInfoScreenTextSmall(gText_Stats_EVSpDef, base_x + base_x_second_row,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strBase, gSpeciesInfo[species].evYield_SpDefense,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(strBase, base_x + base_x_offset,
                             base_y + base_offset * base_i);
    base_i++;
  ...
  if (gTasks[taskId].data[5] == 0) {
    // Exp
    PrintInfoScreenTextSmall(gText_Stats_Exp, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(gStringVar1, gSpeciesInfo[species].expYield,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(gStringVar1, base_x + base_x_offset,
                             base_y + base_offset * base_i);
    base_i++;

    // friendship
    PrintInfoScreenTextSmall(gText_Stats_Friendship, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(strEV, gSpeciesInfo[species].friendship,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    ...
    if (gSpeciesInfo[species].eggGroups[0] == EGG_GROUP_NO_EGGS_DISCOVERED ||
        gSpeciesInfo[species].eggGroups[2] == EGG_GROUP_NO_EGGS_DISCOVERED) {
      PrintInfoScreenTextSmall(gText_Stats_EggCycles, base_x,
                               base_y + base_offset * base_i);
      PrintInfoScreenTextSmall(gText_ThreeDashes, 78,
                               base_y + base_offset * base_i);
    } else {
      PrintInfoScreenTextSmall(gText_Stats_EggCycles, base_x,
                               base_y + base_offset * base_i);
      ConvertIntToDecimalStringN(strEV, gSpeciesInfo[species].eggCycles,
    ...
    // Catch rate
    PrintInfoScreenTextSmall(gText_Stats_Catch, base_x,
                             base_y + base_offset * base_i);
    ConvertIntToDecimalStringN(gStringVar1, gSpeciesInfo[species].catchRate,
                               STR_CONV_MODE_RIGHT_ALIGN, 3);
    PrintInfoScreenTextSmall(gStringVar1, base_x + base_x_offset,
                             base_y + base_offset * base_i);
    base_i++;
    ...
    // Growth rate
    PrintInfoScreenTextSmall(gText_Stats_Growthrate, base_x,
                             base_y + base_offset * base_i);
    ...
    base_i = 0;
    // Egg group 1
    PrintInfoScreenTextSmall(gText_Stats_eggGroup_g1, base_x,
                             base_y + base_offset * base_i);
    ...
    PrintInfoScreenTextSmall(gStringVar1, base_x + 37,
                             base_y + base_offset * base_i);
    base_i++;

    // Egg group 2
    PrintInfoScreenTextSmall(gText_Stats_eggGroup_g2, base_x,
                             base_y + base_offset * base_i);
  ...
  if (gTasks[taskId].data[5] == 0) {
    ...
    PrintInfoScreenTextSmallWhite(gAbilityNames[ability0], abilities_x,
                                  abilities_y);
    PrintInfoScreenTextSmall(gAbilityDescriptionPointers[ability0], abilities_x,
                             abilities_y + 14);

    if (gSpeciesInfo[species].abilities[1] != ABILITY_NONE) {
      PrintInfoScreenTextSmallWhite(
          gAbilityNames[gSpeciesInfo[species].abilities[1]], abilities_x,
          abilities_y + 30);
      PrintInfoScreenTextSmall(
          gAbilityDescriptionPointers[gSpeciesInfo[species].abilities[1]],
          abilities_x, abilities_y + 44);
    }
    // }else{ //For PokemonExpansion
    // ability0 = gSpeciesInfo[species].abilityHidden;
    // PrintInfoScreenTextSmallWhite(gAbilityNames[ability0], abilities_x,
    // abilities_y);
    // PrintInfoScreenTextSmall(gAbilityDescriptionPointers[ability0],
    // abilities_x, abilities_y + 14);
  }
}
static void Task_SwitchScreensFromStatsScreen(u8 taskId) {
  if (!gPaletteFade.active) {
    ...
    FreeAndDestroyMonIconSprite(
        &gSprites[gTasks[taskId].data[4]]); // Destroy pokemon icon sprite
...
//          CreateSprite(&sSpriteTemplate_SplitIcons, 48, 129, 0);
