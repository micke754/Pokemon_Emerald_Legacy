...
static const struct UnknownStruct sBigMonSizeTable[] = {
    {290, 1, 0},         {300, 1, 10},      {400, 2, 110},
    {500, 4, 310},       {600, 20, 710},    {700, 50, 2710},
    {800, 100, 7710},    {900, 150, 17710}, {1000, 150, 32710},
    {1100, 100, -17826}, {1200, 50, -7826}, {1300, 20, -2826},
    {1400, 5, -826},     {1500, 2, -326},   {1600, 1, -126},
    {1700, 1, -26},
};
...
static void FormatMonSizeRecord(u8 *string, u32 size) {
  ...
  string = ConvertIntToDecimalStringN(string, size / 10,
                                      STR_CONV_MODE_LEFT_ALIGN, 8);
...
// Stores species name in gStringVar1, trainer's name in gStringVar2, and size
// in gStringVar3
