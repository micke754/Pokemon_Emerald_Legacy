...
static const struct FrontierBrainMon
    sFrontierBrainsMons[][2][FRONTIER_PARTY_SIZE] =
        {
                    ...
                    {
                        {
                            ...
                            .evs = {6, 0, 0, 252, 252, 0},
                            .moves = {MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH,
                                      MOVE_ICE_PUNCH, MOVE_PSYCHIC},
                        },
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {0, 0, 6, 252, 252, 0},
                            .moves = {MOVE_SUNNY_DAY, MOVE_FIRE_BLAST,
                                      MOVE_SOLAR_BEAM, MOVE_WILL_O_WISP},
                        },
                        {
                            ...
                            .evs = {252, 0, 252, 0, 0, 6},
                            .moves = {MOVE_BODY_SLAM, MOVE_CRUNCH,
                                      MOVE_ROCK_SLIDE, MOVE_DYNAMIC_PUNCH},
                        },
                    },
                    // Gold Symbol.
                    {
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {0, 0, 0, 252, 252, 0},
                            .moves = {MOVE_THUNDERBOLT, MOVE_CALM_MIND,
                                      MOVE_THUNDER_WAVE, MOVE_SHADOW_BALL},
                        },
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {6, 0, 0, 252, 252, 0},
                            .moves = {MOVE_ICE_BEAM, MOVE_LUSTER_PURGE,
                                      MOVE_RECOVER, MOVE_DRAGON_CLAW},
                        },
                        {
                            .species = SPECIES_SNORLAX,
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {252, 252, 0, 0, 6, 0},
                            .moves = {MOVE_CURSE, MOVE_RETURN, MOVE_REST,
                                      MOVE_EARTHQUAKE},
                        },
                    },
                },
                    ...
                    {
                        {
                            ...
                            .moves = {MOVE_MUDDY_WATER, MOVE_EARTHQUAKE,
                                      MOVE_ICE_BEAM, MOVE_REFRESH},
                        },
                        {
                            ...
                            .moves = {MOVE_EARTHQUAKE, MOVE_FIRE_BLAST,
                                      MOVE_DRAGON_CLAW, MOVE_HYDRO_PUMP},
                        },
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {0, 0, 0, 252, 252, 6},
                            .moves = {MOVE_ERUPTION, MOVE_REST, MOVE_SLEEP_TALK,
                                      MOVE_THUNDER_PUNCH},
                        },
                    },
                    // Gold Symbol.
                    {
                        {
                            ...
                            .evs = {252, 252, 6, 0, 0, 0},
                            .moves = {MOVE_MUDDY_WATER, MOVE_EARTHQUAKE,
                                      MOVE_ICE_BEAM, MOVE_MIRROR_COAT},
                        },
                        {
                            ...
                            .nature = NATURE_BRAVE,
                            .evs = {252, 252, 6, 0, 0, 0},
                            .moves = {MOVE_DYNAMIC_PUNCH, MOVE_METEOR_MASH,
                                      MOVE_EARTHQUAKE, MOVE_AGILITY},
                        },
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {6, 0, 0, 252, 252, 0},
                            .moves = {MOVE_THUNDERBOLT, MOVE_MIST_BALL,
                                      MOVE_CALM_MIND, MOVE_REST},
                        },
                    },
                },
                    ...
                    {
                        {
                            ...
                            .moves = {MOVE_SHEER_COLD, MOVE_SURF, MOVE_PSYCHIC,
                                      MOVE_ICE_BEAM},
                        },
                        {
                            ...
                            .moves = {MOVE_EARTHQUAKE, MOVE_REST,
                                      MOVE_CRUSH_CLAW, MOVE_FOCUS_PUNCH},
                        },
                        {
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {152, 0, 0, 152, 100, 106},
                            .moves = {MOVE_CONFUSE_RAY, MOVE_DOUBLE_TEAM,
                                      MOVE_TOXIC, MOVE_FLY},
                        },
                    },
                    // Gold Symbol.
                    {
                        {
                            ...
                            .nature = NATURE_HASTY,
                            .evs = {252, 0, 0, 0, 252, 0},
                            .moves = {MOVE_OVERHEAT, MOVE_EXTREME_SPEED,
                                      MOVE_ROAR, MOVE_PROTECT},
                        },
                        {
                            .species = SPECIES_SLAKING,
                            .heldItem = ITEM_SCOPE_LENS,
                            ...
                            .nature = NATURE_HARDY,
                            .evs = {6, 252, 0, 252, 0, 0},
                            .moves = {MOVE_HYPER_BEAM, MOVE_EARTHQUAKE,
                                      MOVE_FOCUS_PUNCH, MOVE_YAWN},
                        },
                        {
                            ...
                            .nature = NATURE_HASTY,
                            .evs = {252, 0, 252, 6, 0, 0},
                            .moves = {MOVE_ICE_BEAM, MOVE_WATERFALL, MOVE_TOXIC,
                                      MOVE_CALM_MIND},
                        },
                    },
                },
                    ...
                    {
                        {
                            ...
                            .moves = {MOVE_SPORE, MOVE_SLUDGE_BOMB,
                                      MOVE_FOCUS_PUNCH, MOVE_GIGA_DRAIN},
                        },
                        {
                            ...
                            .moves = {MOVE_BODY_SLAM, MOVE_CONFUSE_RAY,
                                      MOVE_PSYCHIC, MOVE_FAINT_ATTACK},
                        },
                        {
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {0, 252, 6, 252, 0, 0},
                            .moves = {MOVE_SHADOW_BALL, MOVE_MUD_SLAP,
                                      MOVE_GIGA_DRAIN, MOVE_SILVER_WIND},
                        },
                    },
                    // Gold Symbol.
                    {
                        {
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {0, 252, 0, 252, 0, 6},
                            .moves = {MOVE_MEGAHORN, MOVE_ENDURE, MOVE_REVERSAL,
                                      MOVE_EARTHQUAKE},
                        },
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {0, 252, 0, 0, 252, 6},
                            .moves = {MOVE_PSYCHO_BOOST, MOVE_SUPERPOWER,
                                      MOVE_ZAP_CANNON, MOVE_SHADOW_BALL},
                        },
                        {
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {252, 252, 0, 0, 0, 6},
                            .moves = {MOVE_CRUNCH, MOVE_ROCK_SLIDE,
                                      MOVE_BRICK_BREAK, MOVE_EARTHQUAKE},
                        },
                    },
                },
            [FRONTIER_FACILITY_FACTORY] =
                {
                    // Because Factory's Pokémon are random, this facility's
                    // Brain also uses random Pokémon. What is interesting, this
                    // team is actually the one Steven uses in the multi tag
                    // battle alongside the player.
                    {
                        {
                            ...
                            .nature = NATURE_BRAVE,
                            .evs = {0, 252, 252, 0, 6, 0},
                            .moves = {MOVE_LIGHT_SCREEN, MOVE_PSYCHIC,
                                      MOVE_REFLECT, MOVE_METAL_CLAW},
                        },
                        {
                            ...
                            .evs = {252, 0, 0, 0, 6, 252},
                            .moves = {MOVE_TOXIC, MOVE_AERIAL_ACE, MOVE_PROTECT,
                                      MOVE_STEEL_WING},
                        },
                        {
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {0, 252, 0, 0, 252, 6},
                            .moves = {MOVE_THUNDERBOLT, MOVE_PROTECT,
                                      MOVE_SOLAR_BEAM, MOVE_DRAGON_CLAW},
                        },
                    },
                    {
                        {
                    ...
                    {
                        {
                            ...
                            .moves = {MOVE_SUPER_FANG, MOVE_CRUNCH,
                                      MOVE_POISON_FANG, MOVE_FLAMETHROWER},
                        },
                        {
                            ...
                            .moves = {MOVE_REST, MOVE_DOUBLE_TEAM,
                                      MOVE_SANDSTORM, MOVE_TOXIC},
                        },
                        {
                            ...
                            .nature = NATURE_BRAVE,
                            .evs = {252, 0, 0, 0, 6, 252},
                            .moves = {MOVE_REST, MOVE_DRAGON_DANCE,
                                      MOVE_EARTHQUAKE, MOVE_BODY_SLAM},
                        },
                    },
                    // Gold Symbol.
                    {
                        {
                            ...
                            .nature = NATURE_BOLD,
                            .evs = {252, 252, 0, 0, 0, 6},
                            .moves = {MOVE_SWAGGER, MOVE_CRUNCH,
                                      MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN},
                        },
                        {
                            ...
                            .nature = NATURE_BOLD,
                            .evs = {252, 0, 252, 0, 6, 0},
                            .moves = {MOVE_SURF, MOVE_REFRESH, MOVE_RECOVER,
                                      MOVE_TOXIC},
                        },
                        {
                            ...
                            .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE,
                                      MOVE_OUTRAGE, MOVE_DYNAMIC_PUNCH},
                        },
                    },
                },
                    ...
                    {
                        {
                            ...
                            .moves = {MOVE_ZAP_CANNON, MOVE_ICE_BEAM,
                                      MOVE_AMNESIA, MOVE_REST},
                        },
                        {
                            ...
                            .moves = {MOVE_EARTHQUAKE, MOVE_EXPLOSION,
                                      MOVE_CURSE, MOVE_METEOR_MASH},
                        },
                        {
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {252, 252, 0, 0, 0, 6},
                            .moves = {MOVE_DYNAMIC_PUNCH, MOVE_ROCK_BLAST,
                                      MOVE_SANDSTORM, MOVE_EARTHQUAKE},
                        },
                    },
                    // Gold Symbol.
                    {
                        {
                            ...
                            .nature = NATURE_MILD,
                            .evs = {6, 0, 0, 252, 252, 0},
                            .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE,
                                      MOVE_SKY_ATTACK, MOVE_EXTRASENSORY},
                        },
                        {
                            ...
                            .nature = NATURE_MODEST,
                            .evs = {6, 0, 0, 252, 252, 0},
                            .moves = {MOVE_CALM_MIND, MOVE_FIRE_BLAST,
                                      MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM},
                        },
                        {
                            .species = SPECIES_REGIROCK,
                            .heldItem = ITEM_WHITE_HERB,
                            ...
                            .nature = NATURE_ADAMANT,
                            .evs = {252, 252, 0, 0, 0, 6},
                            .moves = {MOVE_SUPERPOWER, MOVE_ROCK_SLIDE,
                                      MOVE_EARTHQUAKE, MOVE_EXPLOSION},
                        },
                    },
                },
};
...
static const u8
    sBattlePointAwards[][NUM_FRONTIER_FACILITIES][FRONTIER_MODE_COUNT] = {
...
// Flags to change the conversation when the Frontier Brain is encountered for a
// battle First bit is has battled them before and not won yet, second bit is
// has battled them and won (obtained a Symbol)
...
const u16 gFrontierBannedSpecies[] = {
    ...
    SPECIES_DEOXYS, SPECIES_DEOXYS_ATTACK, 0xFFFF};
...
static const u8
    *const sFrontierBrainPlayerLostSilverTexts[NUM_FRONTIER_FACILITIES] = {
...
static const u8
    *const sFrontierBrainPlayerWonSilverTexts[NUM_FRONTIER_FACILITIES] = {
...
static const u8
    *const sFrontierBrainPlayerLostGoldTexts[NUM_FRONTIER_FACILITIES] = {
...
static const u8
    *const sFrontierBrainPlayerWonGoldTexts[NUM_FRONTIER_FACILITIES] = {
...
// code
void CallFrontierUtilFunc(void) { sFrontierUtilFuncs[gSpecialVar_0x8004](); }

// VAR_TEMP_CHALLENGE_STATUS is used to react to the status in OnFrame map
// scripts
static void GetChallengeStatus(void) {
...
static void SetFrontierData(void) {
  ...
  case FRONTIER_DATA_SELECTED_MON_ORDER:
    for (i = 0; i < MAX_FRONTIER_PARTY_SIZE; i++)
      gSaveBlock2Ptr->frontier.selectedPartyMons[i] =
...
static void DoSoftReset_(void) { DoSoftReset(); }
...
static void PrintAligned(const u8 *str, s32 y) {
  ...
  y = (y * 8) + 1;
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x, y,
                              TEXT_SKIP_DRAW, NULL);
}
...
static void PrintHyphens(s32 y) {
  ...
  y = (y * 8) + 1;
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, text, 4, y,
                              TEXT_SKIP_DRAW, NULL);
}

// Battle Tower records.
static void TowerPrintStreak(const u8 *str, u16 num, u8 x1, u8 x2, u8 y) {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x1, y,
                              TEXT_SKIP_DRAW, NULL);
  if (num > MAX_STREAK)
    num = MAX_STREAK;
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gStringVar4, x2, y,
                              TEXT_SKIP_DRAW, NULL);
}

static void TowerPrintRecordStreak(u8 battleMode, u8 lvlMode, u8 x1, u8 x2,
                                   u8 y) {
...
static void TowerPrintPrevOrCurrentStreak(u8 battleMode, u8 lvlMode, u8 x1,
                                          u8 x2, u8 y) {
  bool8 isCurrent;
...
static void ShowTowerResultsWindow(u8 battleMode) {
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Lv502, 16,
                              49, TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_OpenLv, 16,
                              97, TEXT_SKIP_DRAW, NULL);
  PrintHyphens(10);
...
static void PrintTwoStrings(const u8 *str1, const u8 *str2, u16 num, u8 x1,
                            u8 x2, u8 y) {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str1, x1, y,
                              TEXT_SKIP_DRAW, NULL);
  ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
...
static void DomePrintPrevOrCurrentStreak(u8 battleMode, u8 lvlMode, u8 x1,
                                         u8 x2, u8 y) {
  bool8 isCurrent;
...
static void ShowDomeResultsWindow(u8 battleMode) {
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Lv502, 8, 33,
                              TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_OpenLv, 8,
                              97, TEXT_SKIP_DRAW, NULL);
  PrintHyphens(10);
  ...
  PrintTwoStrings(gText_Record, gText_ClearStreak,
                  gSaveBlock2Ptr->frontier
                      .domeRecordWinStreaks[battleMode][FRONTIER_LVL_50],
                  64, 121, 49);
  PrintTwoStrings(gText_Total, gText_Championships,
                  gSaveBlock2Ptr->frontier
                      .domeTotalChampionships[battleMode][FRONTIER_LVL_50],
                  64, 112, 65);
  DomePrintPrevOrCurrentStreak(battleMode, FRONTIER_LVL_OPEN, 64, 121, 97);
  PrintTwoStrings(gText_Record, gText_ClearStreak,
                  gSaveBlock2Ptr->frontier
                      .domeRecordWinStreaks[battleMode][FRONTIER_LVL_OPEN],
                  64, 121, 113);
  PrintTwoStrings(gText_Total, gText_Championships,
                  gSaveBlock2Ptr->frontier
                      .domeTotalChampionships[battleMode][FRONTIER_LVL_OPEN],
                  64, 112, 129);
  PutWindowTilemap(gRecordsWindowId);
  CopyWindowToVram(gRecordsWindowId, COPYWIN_FULL);
}
...
static void PalacePrintRecordStreak(u8 battleMode, u8 lvlMode, u8 x1, u8 x2,
                                    u8 y) {
  u16 num =
...
static void PalacePrintPrevOrCurrentStreak(u8 battleMode, u8 lvlMode, u8 x1,
                                           u8 x2, u8 y) {
  bool8 isCurrent;
...
static void PikePrintCleared(const u8 *str1, const u8 *str2, u16 num, u8 x1,
                             u8 x2, u8 y) {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str1, x1, y,
                              TEXT_SKIP_DRAW, NULL);
  ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
...
static void ShowPikeResultsWindow(void) {
  ...
  PikePrintCleared(gText_Record, gText_RoomsCleared,
                   gSaveBlock2Ptr->frontier.pikeRecordStreaks[FRONTIER_LVL_50],
                   64, 114, 49);
  PikePrintCleared(gText_Total, gText_TimesCleared,
                   gSaveBlock2Ptr->frontier.pikeTotalStreaks[FRONTIER_LVL_50],
                   64, 114, 65);
  PikePrintPrevOrCurrentStreak(FRONTIER_LVL_OPEN, 64, 114, 97);
  PikePrintCleared(
      gText_Record, gText_RoomsCleared,
      gSaveBlock2Ptr->frontier.pikeRecordStreaks[FRONTIER_LVL_OPEN], 64, 114,
      113);
  PikePrintCleared(gText_Total, gText_TimesCleared,
...
static void FactoryPrintStreak(const u8 *str, u16 num1, u16 num2, u8 x1, u8 x2,
                               u8 x3, u8 y) {
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x1, y,
                              TEXT_SKIP_DRAW, NULL);
  if (num1 > MAX_STREAK)
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gStringVar4, x3, y,
                              TEXT_SKIP_DRAW, NULL);
}

static void FactoryPrintRecordStreak(u8 battleMode, u8 lvlMode, u8 x1, u8 x2,
                                     u8 x3, u8 y) {
  u16 num1 =
...
static void FactoryPrintPrevOrCurrentStreak(u8 battleMode, u8 lvlMode, u8 x1,
                                            u8 x2, u8 x3, u8 y) {
  bool8 isCurrent;
...
static void ShowFactoryResultsWindow(u8 battleMode) {
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Lv502, 8, 33,
                              TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_RentalSwap,
                              152, 33, TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_OpenLv, 8,
                              97, TEXT_SKIP_DRAW, NULL);
  PrintHyphens(10);
  ...
  FactoryPrintPrevOrCurrentStreak(battleMode, FRONTIER_LVL_OPEN, 8, 64, 158,
                                  113);
...
static void ShowPyramidResultsWindow(void) {
  ...
  PrintAligned(gStringVar4, 2);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Lv502, 8, 49,
                              TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_OpenLv, 8,
                              97, TEXT_SKIP_DRAW, NULL);
  PrintHyphens(10);
...
static void ShowLinkContestResultsWindow(void) {
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gStringVar4, x, 1,
                              TEXT_SKIP_DRAW, NULL);

  str = gText_1st;
  x = GetStringRightAlignXOffset(FONT_NORMAL, str, 38) + 50;
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, str, x, 25,
                              TEXT_SKIP_DRAW, NULL);
  ...
  x = 6;
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Cool, x, 41,
                              TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Beauty, x,
                              57, TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Cute, x, 73,
                              TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Smart, x, 89,
                              TEXT_SKIP_DRAW, NULL);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gText_Tough, x,
                              105, TEXT_SKIP_DRAW, NULL);
  ...
  for (i = 0; i < CONTEST_CATEGORIES_COUNT; i++) {
    for (j = 0; j < CONTESTANT_COUNT; j++) {
      ...
      AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gStringVar4,
                                  (j * 38) + 64, (i * 16) + 41, TEXT_SKIP_DRAW,
                                  NULL);
    }
  }
...
u8 GetFrontierBrainStatus(void) {
  ...
  s32 winStreak =
      winStreakNoModifier + sFrontierBrainStreakAppearances[facility][3];
  s32 symbolsCount;
  ...
  case 1:
    if (winStreak == sFrontierBrainStreakAppearances[facility][symbolsCount])
      status =
          symbolsCount + 1; // FRONTIER_BRAIN_SILVER and FRONTIER_BRAIN_GOLD
    break;
...
void CopyFrontierTrainerText(u8 whichText, u16 trainerId) {
  ...
  case FRONTIER_PLAYER_LOST_TEXT:
    if (trainerId == TRAINER_EREADER) {
      FrontierSpeechToString(
          gSaveBlock2Ptr->frontier.ereaderTrainer.farewellPlayerLost);
    } else if (trainerId == TRAINER_FRONTIER_BRAIN) {
      CopyFrontierBrainText(FALSE);
    } else if (trainerId < FRONTIER_TRAINERS_COUNT) {
  ...
  case FRONTIER_PLAYER_WON_TEXT:
    if (trainerId == TRAINER_EREADER) {
      FrontierSpeechToString(
          gSaveBlock2Ptr->frontier.ereaderTrainer.farewellPlayerWon);
    } else if (trainerId == TRAINER_FRONTIER_BRAIN) {
...
static void GiveBattlePoints(void) {
  ...
  case FRONTIER_FACILITY_PALACE:
    ...
    break;
  case FRONTIER_FACILITY_ARENA:
    challengeNum = gSaveBlock2Ptr->frontier.arenaWinStreaks[lvlMode] /
                   FRONTIER_STAGES_PER_CHALLENGE;
    break;
  case FRONTIER_FACILITY_FACTORY:
    challengeNum =
  ...
  case FRONTIER_FACILITY_PIKE:
    challengeNum =
        gSaveBlock2Ptr->frontier.pikeWinStreaks[lvlMode] / NUM_PIKE_ROOMS;
    break;
  case FRONTIER_FACILITY_PYRAMID:
    challengeNum = gSaveBlock2Ptr->frontier.pyramidWinStreaks[lvlMode] /
                   FRONTIER_STAGES_PER_CHALLENGE;
    break;
  }
  ...
  IncrementDailyBattlePoints(
      sBattlePointAwards[challengeNum][facility][battleMode]);
  if (gTrainerBattleOpponent_A == TRAINER_FRONTIER_BRAIN) {
    points += 10;
...
static u8 AppendCaughtBannedMonSpeciesName(u16 species, u8 count,
                                           s32 numBannedMonsCaught) {
...
static void AppendIfValid(u16 species, u16 heldItem, u16 hp, u8 lvlMode,
                          u8 monLevel, u16 *speciesArray, u16 *itemsArray,
                          u8 *count) {
  s32 i = 0;
...
// gSpecialVar_0x8004 is used to store the return value instead (TRUE if there
// are insufficient eligible mons) The names of ineligible Pokémon that have
// been caught are also buffered to print
static void CheckPartyIneligibility(void) {
...
#define numEligibleMons count
    ...
    do {
      ...
      if (VarGet(VAR_FRONTIER_FACILITY) == FRONTIER_FACILITY_PYRAMID) {
        if (heldItem == ITEM_NONE)
          AppendIfValid(species, heldItem, hp, gSpecialVar_Result, level,
                        speciesArray, itemArray, &numEligibleMons);
      } else {
        AppendIfValid(species, heldItem, hp, gSpecialVar_Result, level,
                      speciesArray, itemArray, &numEligibleMons);
      }
  ...
  if (numEligibleMons < toChoose) {
    ...
    for (i = 0; gFrontierBannedSpecies[i] != 0xFFFF; i++)
      count = AppendCaughtBannedMonSpeciesName(gFrontierBannedSpecies[i], count,
                                               caughtBannedMons);
...
static void ValidateVisitingTrainer(void) { ValidateEReaderTrainer(); }
        ...
        for (k = 0; k < MAX_MON_MOVES; k++) {
          if (GetMonData(
                  &gSaveBlock1Ptr->playerParty
                       [gSaveBlock2Ptr->frontier.selectedPartyMons[i] - 1],
                  MON_DATA_MOVE1 + k, NULL) ==
...
static void Print1PRecord(s32 position, s32 x, s32 y,
                          struct RankingHall1P *hallRecord,
                          s32 hallFacilityId) {
  u8 text[32];
  u16 winStreak;

  AddTextPrinterParameterized(
      gRecordsWindowId, FONT_NORMAL, gText_123Dot[position], x * 8,
      (8 * (y + 5 * position)) + 1, TEXT_SKIP_DRAW, NULL);
  hallRecord->name[PLAYER_NAME_LENGTH] = EOS;
  if (hallRecord->winStreak) {
    TVShowConvertInternationalString(text, hallRecord->name,
                                     hallRecord->language);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, text,
                                (x + 2) * 8, (8 * (y + 5 * position)) + 1,
                                TEXT_SKIP_DRAW, NULL);
    winStreak = hallRecord->winStreak;
    if (winStreak > MAX_STREAK)
      winStreak = MAX_STREAK;
    ConvertIntToDecimalStringN(gStringVar2, winStreak,
                               STR_CONV_MODE_RIGHT_ALIGN, 4);
    StringExpandPlaceholders(gStringVar4,
                             sHallFacilityToRecordsText[hallFacilityId]);
    AddTextPrinterParameterized(
        gRecordsWindowId, FONT_NORMAL, gStringVar4,
        GetStringRightAlignXOffset(
            FONT_NORMAL, sHallFacilityToRecordsText[hallFacilityId], 0xC8),
        (8 * (y + 5 * position)) + 1, TEXT_SKIP_DRAW, NULL);
  }
}

static void Print2PRecord(s32 position, s32 x, s32 y,
                          struct RankingHall2P *hallRecord) {
  u8 text[32];
  u16 winStreak;
  ...
  if (hallRecord->winStreak) {
    ...
    TVShowConvertInternationalString(text, hallRecord->name1,
                                     hallRecord->language);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, text,
                                (x + 2) * 8, (8 * (y + 5 * position - 1)) + 1,
                                TEXT_SKIP_DRAW, NULL);
    if (IsStringJapanese(hallRecord->name2))
      TVShowConvertInternationalString(text, hallRecord->name2,
                                       LANGUAGE_JAPANESE);
    else
      StringCopy(text, hallRecord->name2);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, text,
                                (x + 4) * 8, (8 * (y + 5 * position + 1)) + 1,
                                TEXT_SKIP_DRAW, NULL);
    ...
    StringExpandPlaceholders(
        gStringVar4, sHallFacilityToRecordsText[RANKING_HALL_TOWER_LINK]);
    AddTextPrinterParameterized(
        gRecordsWindowId, FONT_NORMAL, gStringVar4,
        GetStringRightAlignXOffset(
            FONT_NORMAL, sHallFacilityToRecordsText[RANKING_HALL_TOWER_LINK],
            0xC8),
        (8 * (y + 5 * position)) + 1, TEXT_SKIP_DRAW, NULL);
  }
}

static void Fill1PRecords(struct RankingHall1P *dst, s32 hallFacilityId,
                          s32 lvlMode) {
  s32 i, j;
  struct RankingHall1P record1P[HALL_RECORDS_COUNT + 1];
  struct PlayerHallRecords *playerHallRecords =
      AllocZeroed(sizeof(struct PlayerHallRecords));
  ...
  record1P[HALL_RECORDS_COUNT] =
      playerHallRecords->onePlayer[hallFacilityId][lvlMode];
...
static void PrintHallRecords(s32 hallFacilityId, s32 lvlMode) {
  ...
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL, gStringVar4, 0, 1,
                              TEXT_SKIP_DRAW, NULL);
  x = GetStringRightAlignXOffset(FONT_NORMAL, sLevelModeText[lvlMode],
                                 DISPLAY_WIDTH - 32);
  AddTextPrinterParameterized(gRecordsWindowId, FONT_NORMAL,
                              sLevelModeText[lvlMode], x, 1, TEXT_SKIP_DRAW,
                              NULL);
...
void CreateFrontierBrainPokemon(void) {
  ...
  if (facility == FRONTIER_FACILITY_DOME)
    selectedMonBits = GetDomeTrainerSelectedMons(
        TrainerIdToDomeTournamentId(TRAINER_FRONTIER_BRAIN));
  else
  ...
  for (i = 0; i < FRONTIER_PARTY_SIZE; selectedMonBits >>= 1, i++) {
    ...
    } while (sFrontierBrainsMons[facility][symbol][i].nature !=
             GetNatureFromPersonality(j));
    CreateMon(&gEnemyParty[monPartyId],
              sFrontierBrainsMons[facility][symbol][i].species, monLevel,
              sFrontierBrainsMons[facility][symbol][i].fixedIV, TRUE, j,
    ...
    for (j = 0; j < NUM_STATS; j++)
      SetMonData(&gEnemyParty[monPartyId], MON_DATA_HP_EV + j,
                 &sFrontierBrainsMons[facility][symbol][i].evs[j]);
    friendship = MAX_FRIENDSHIP;
    for (j = 0; j < MAX_MON_MOVES; j++) {
      SetMonMoveSlot(&gEnemyParty[monPartyId],
                     sFrontierBrainsMons[facility][symbol][i].moves[j], j);
...
// Called for intro speech as well despite the fact that its handled in the map
// scripts files instead
static void CopyFrontierBrainText(bool8 playerWonText) {
  s32 facility;
  s32 symbol;
