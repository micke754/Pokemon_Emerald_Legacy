...
// To avoid a changed section attributes warning it's put in a special
// .text.consts section.
__attribute__((
    section(".text.consts"))) static const struct GFRomHeader sGFRomHeader = {
    ...
    // Two of the below 12s are likely move/ability name length, given their
    ...
    .frontierStatusOffset =
        offsetof(struct SaveBlock2, frontier.challengeStatus),
    .frontierStatusOffset2 =
        offsetof(struct SaveBlock2, frontier.challengeStatus),
