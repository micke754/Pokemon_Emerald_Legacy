...
static const union AnimCmd sAnim_SmokescreenImpact_1[] = {
    ANIMCMD_FRAME(0, 4, .hFlip = TRUE), ANIMCMD_FRAME(4, 4, .hFlip = TRUE),
    ANIMCMD_FRAME(8, 4, .hFlip = TRUE), ANIMCMD_END};

static const union AnimCmd sAnim_SmokescreenImpact_2[] = {
    ANIMCMD_FRAME(0, 4, .vFlip = TRUE), ANIMCMD_FRAME(4, 4, .vFlip = TRUE),
...
static const union AnimCmd sAnim_SmokescreenImpact_3[] = {
    ...
    ANIMCMD_FRAME(8, 4, .hFlip = TRUE, .vFlip = TRUE), ANIMCMD_END};
...
u8 SmokescreenImpact(s16 x, s16 y, bool8 persist) {
  ...
  mainSpriteId =
      CreateInvisibleSpriteWithCallback(SpriteCB_SmokescreenImpactMain);
  mainSprite = &gSprites[mainSpriteId];
  mainSprite->sPersist = persist;

  // Top left sprite
  spriteId1 =
      CreateSprite(&sSmokescreenImpactSpriteTemplate, x - 16, y - 16, 2);
