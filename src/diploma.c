...
static const u32 sDiplomaTilemap[] =
    INCBIN_U32("graphics/diploma/tilemap.bin.lz");
...
static void InitDiplomaBg(void) {
  ...
  InitBgsFromTemplates(0, sDiplomaBgTemplates,
                       ARRAY_COUNT(sDiplomaBgTemplates));
...
static void PrintDiplomaText(u8 *text, u8 var1, u8 var2) {
  ...
  AddTextPrinterParameterized4(0, FONT_NORMAL, var1, var2, 0, 0, color,
                               TEXT_SKIP_DRAW, text);
}
