...
// Save data using TryWriteSpecialSaveSector is allowed to exceed
// SECTOR_DATA_SIZE (up to the counter field)
STATIC_ASSERT(sizeof(struct TrainerHillChallenge) <= SECTOR_COUNTER_OFFSET,
              TrainerHillChallengeFreeSpace);
...
static const struct TrainerHillTrainer sTrainerHillTrainerTemplates_JP[] = {
    [0] = {.name = __("マキエ$$$$$   "),
           ...
           .unused = 0x1,
           .speechBefore = {EC_WORD_PREPOSTEROUS, EC_WORD_CASE, EC_WORD_THERE,
                            EC_WORD_TO_HER, EC_WORD_CHALLENGE, EC_WORD_JOKING},
           .speechWin = {EC_WORD_HERS, EC_WORD_TRUMP_CARD,
                         EC_MOVE2(SECRET_POWER), EC_WORD_USING, EC_WORD_WON,
                         EC_WORD_EXCL_EXCL},
           .speechLose = {EC_WORD_TO_HER, EC_WORD_WIN, EC_WORD_JOKING,
                          EC_WORD_HIGHS, EC_WORD_SCARY, EC_WORD_ELLIPSIS_EXCL},
           .speechAfter = {EC_WORD_IGNORANT, EC_WORD_SO, EC_WORD_TODAY,
                           EC_WORD_NIGHTTIME, EC_WORD_YOU_RE,
           ...
           .mons =
               {
                   ...
                   [1] = DUMMY_HILL_MON,
                   [2] = DUMMY_HILL_MON,
                   [3] = {.species = SPECIES_SWALOT,
                          .heldItem = ITEM_SHELL_BELL,
                          .moves = {MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL,
                                    MOVE_PAIN_SPLIT, MOVE_YAWN},
                          .hpEV = 55,
                          .attackEV = 255,
                          .defenseEV = 100,
                          .speedEV = 0,
                   ...
                   [4] = {.species = SPECIES_DUSTOX,
                          .heldItem = ITEM_BRIGHT_POWDER,
                          .moves = {MOVE_SILVER_WIND, MOVE_SLUDGE_BOMB,
                                    MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN},
                          .hpEV = 0,
                          .attackEV = 255,
                          .defenseEV = 0,
                          .speedEV = 0,
                          ...
                          .nickname = __("ドクケイル$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [5] = {.species = SPECIES_RELICANTH,
                          .heldItem = ITEM_QUICK_CLAW,
                          .moves = {MOVE_ANCIENT_POWER, MOVE_SURF,
                                    MOVE_EARTHQUAKE, MOVE_AMNESIA},
                          .hpEV = 100,
                          .attackEV = 0,
                          .defenseEV = 0,
                          .speedEV = 0,
    ...
    [1] = {.name = __("ハルヒト$$$$   "),
           ...
           .unused = 0x1,
           .speechBefore = {EC_MOVE2(BOUNCE), EC_WORD_AS_MUCH_AS, EC_EMPTY_WORD,
                            EC_WORD_THEY_RE, EC_WORD_STRONG, EC_WORD_EXCL},
           .speechWin = {EC_MOVE(FLY), EC_WORD_AS_MUCH_AS, EC_EMPTY_WORD,
                         EC_WORD_THEY_RE, EC_WORD_HAPPY, EC_WORD_EXCL},
           .speechLose = {EC_MOVE2(MINIMIZE), EC_WORD_AS_MUCH_AS, EC_EMPTY_WORD,
                          EC_WORD_THEY_RE, EC_WORD_SAD, EC_WORD_EXCL},
           .speechAfter = {EC_MOVE(BITE), EC_WORD_AS_MUCH_AS, EC_EMPTY_WORD,
                           EC_WORD_THEY_RE, EC_WORD_ANGRY, EC_WORD_EXCL},
           .mons =
               {
                   [0] = DUMMY_HILL_MON,
                   [1] = DUMMY_HILL_MON,
                   [2] = DUMMY_HILL_MON,
                   [3] = {.species = SPECIES_CACTURNE,
                          .heldItem = ITEM_QUICK_CLAW,
                          .moves = {MOVE_GIGA_DRAIN, MOVE_FAINT_ATTACK,
                                    MOVE_THUNDER_PUNCH, MOVE_GROWTH},
                          .hpEV = 55,
                          .attackEV = 0,
                          .defenseEV = 100,
                          .speedEV = 0,
                          ...
                          .nickname = __("ノクタス$$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [4] = {.species = SPECIES_SWELLOW,
                          .heldItem = ITEM_BRIGHT_POWDER,
                          .moves = {MOVE_FACADE, MOVE_AERIAL_ACE,
                          ...
                          .nickname = __("オオスバメ$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [5] = {.species = SPECIES_WHISCASH,
                          .heldItem = ITEM_CHESTO_BERRY,
                          .moves = {MOVE_SURF, MOVE_EARTHQUAKE, MOVE_AMNESIA,
                                    MOVE_REST},
                          .hpEV = 0,
                          .attackEV = 255,
                          .defenseEV = 0,
    ...
    [2] = {.name = __("メイコ$$$$$   "),
           ...
           .unused = 0x1,
           .speechBefore = {EC_WORD_SHINE, EC_WORD_POKEMON, EC_WORD_RELEASE,
                            EC_WORD_WAS, EC_MOVE2(FRUSTRATION),
                            EC_WORD_WITHOUT},
           .speechWin = {EC_WORD_SHINE, EC_WORD_POKEMON, EC_WORD_TO_HER,
                         EC_MOVE2(PRESENT), EC_WORD_KNOWS, EC_WORD_WITHOUT},
           .speechLose = {EC_WORD_THAT, EC_WORD_ABOVE, EC_WORD_LOST,
                          EC_WORD_STORES, EC_WORD_JOKING,
                          EC_WORD_ELLIPSIS_ELLIPSIS_ELLIPSIS},
           .speechAfter = {EC_WORD_ENTERTAINING, EC_WORD_NONE, EC_WORD_HEY_QUES,
                           EC_WORD_ALMOST, EC_WORD_EXCL, EC_EMPTY_WORD},
           .mons =
               {
                   [0] = DUMMY_HILL_MON,
                   [1] = DUMMY_HILL_MON,
                   [2] = DUMMY_HILL_MON,
                   [3] = {.species = SPECIES_DELCATTY,
                          .heldItem = ITEM_LUM_BERRY,
                          .moves = {MOVE_SING, MOVE_BODY_SLAM, MOVE_SHADOW_BALL,
                                    MOVE_IRON_TAIL},
                          .hpEV = 0,
                          .attackEV = 255,
                          .defenseEV = 0,
                          ...
                          .nickname = __("エネコロロ$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [4] = {.species = SPECIES_ROSELIA,
                          .heldItem = ITEM_LEFTOVERS,
                          .moves = {MOVE_GIGA_DRAIN, MOVE_GRASS_WHISTLE,
                                    MOVE_TOXIC, MOVE_LEECH_SEED},
                          .hpEV = 255,
                          .attackEV = 0,
                          .defenseEV = 0,
                          .speedEV = 0,
                          ...
                          .nickname = __("ロゼリア$$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [5] = {.species = SPECIES_BEAUTIFLY,
                          .heldItem = ITEM_BRIGHT_POWDER,
                          .moves = {MOVE_SILVER_WIND, MOVE_AERIAL_ACE,
                                    MOVE_ATTRACT, MOVE_PSYCHIC},
                          .hpEV = 100,
                          .attackEV = 200,
                          .defenseEV = 0,
                          .speedEV = 0,
    ...
    [3] = {.name = __("ピエール$$$$   "),
           ...
           .unused = 0x1,
           .speechBefore = {EC_WORD_SHE_WAS, EC_WORD_NO_1, EC_WORD_STRONG,
                            EC_WORD_UNCLE, EC_WORD_THERE, EC_WORD_EXCL},
           .speechWin = {EC_WORD_HAHAHA, EC_WORD_TEACHER, EC_WORD_BECOMES,
                         EC_WORD_GIVE, EC_WORD_IS_IT_QUES, EC_EMPTY_WORD},
           .speechLose = {EC_WORD_OUTSIDE, EC_WORD_UNCLE, EC_WORD_SURPRISE,
                          EC_WORD_THESE, EC_WORD_HEY_QUES,
                          EC_WORD_ELLIPSIS_EXCL},
           .speechAfter = {EC_WORD_HE_S, EC_WORD_NO_1, EC_WORD_STRONG,
                           EC_WORD_CHILDREN, EC_WORD_CAN_T, EC_WORD_EXCL_EXCL},
           .mons =
               {
                   [0] = DUMMY_HILL_MON,
                   [1] = DUMMY_HILL_MON,
                   [2] = DUMMY_HILL_MON,
                   [3] = {.species = SPECIES_MAWILE,
                          .heldItem = ITEM_BRIGHT_POWDER,
                          .moves = {MOVE_CRUNCH, MOVE_FLAMETHROWER,
                                    MOVE_THUNDER_PUNCH, MOVE_COMET_PUNCH},
                          .hpEV = 0,
                          .attackEV = 0,
                          .defenseEV = 100,
                          .speedEV = 0,
                          ...
                          .nickname = __("クチート$$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [4] = {.species = SPECIES_SHARPEDO,
                          .heldItem = ITEM_SCOPE_LENS,
                          .moves = {MOVE_SURF, MOVE_CRUNCH, MOVE_DOUBLE_EDGE,
                                    MOVE_EARTHQUAKE},
                          .hpEV = 255,
                          .attackEV = 0,
                          .defenseEV = 0,
                          ...
                          .nickname = __("サメハダー$$$$$$"),
                          .friendship = MAX_FRIENDSHIP},
                   [5] = {.species = SPECIES_BANETTE,
                          .heldItem = ITEM_LUM_BERRY,
                          .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL,
                                    MOVE_THUNDERBOLT, MOVE_WILL_O_WISP},
                          .hpEV = 255,
                          .attackEV = 0,
                          .defenseEV = 0,
                          .speedEV = 0,
...
static bool32
ValidateTrainerChecksum(struct EReaderTrainerHillTrainer *hillTrainer) {
  int checksum = CalcByteArraySum((u8 *)hillTrainer,
                                  offsetof(typeof(*hillTrainer), checksum));
...
bool8 ValidateTrainerHillData(struct EReaderTrainerHillSet *hillSet) {
  ...
  // Validate checksum
  checksum =
      CalcByteArraySum((u8 *)hillSet->trainers,
                       numTrainers * sizeof(struct EReaderTrainerHillTrainer));
...
static bool32
ValidateTrainerHillChecksum(struct EReaderTrainerHillSet *hillSet) {
  u32 checksum;
  int numTrainers = hillSet->numTrainers;
  if (numTrainers < 1 || numTrainers > NUM_TRAINER_HILL_TRAINERS)
    return FALSE;
  ...
  checksum =
      CalcByteArraySum((u8 *)hillSet->trainers,
                       sizeof(struct EReaderTrainerHillSet) -
                           offsetof(struct EReaderTrainerHillSet, trainers));
  if (checksum != hillSet->checksum)
    return FALSE;
...
static bool32
TryWriteTrainerHill_Internal(struct EReaderTrainerHillSet *hillSet,
  ...
  for (i = 0; i < hillSet->numTrainers; i++) {
    if (!(i & 1)) {
      challenge->floors[i / HILL_TRAINERS_PER_FLOOR].trainerNum1 =
          hillSet->trainers[i].trainerNum;
      challenge->floors[i / HILL_TRAINERS_PER_FLOOR].map =
          hillSet->trainers[i].map;
      challenge->floors[i / HILL_TRAINERS_PER_FLOOR].trainers[0] =
          hillSet->trainers[i].trainer;
    } else {
      challenge->floors[i / HILL_TRAINERS_PER_FLOOR].trainerNum2 =
          hillSet->trainers[i].trainerNum;
      challenge->floors[i / HILL_TRAINERS_PER_FLOOR].trainers[1] =
          hillSet->trainers[i].trainer;
    }
  }
  ...
  if (i & 1) {
    challenge->floors[i / HILL_TRAINERS_PER_FLOOR].trainers[1] =
        sTrainerHillTrainerTemplates_JP[i / HILL_TRAINERS_PER_FLOOR];
  }

  challenge->checksum = CalcByteArraySum((u8 *)challenge->floors,
                                         NUM_TRAINER_HILL_FLOORS *
                                             sizeof(struct TrainerHillFloor));
  if (TryWriteSpecialSaveSector(SECTOR_ID_TRAINER_HILL, (u8 *)challenge) !=
      SAVE_STATUS_OK)
    return FALSE;
...
static bool32 TryReadTrainerHill_Internal(struct EReaderTrainerHillSet *dest,
                                          u8 *buffer) {
  if (TryReadSpecialSaveSector(SECTOR_ID_TRAINER_HILL, buffer) !=
      SAVE_STATUS_OK)
    return FALSE;
...
int EReader_Send(int size, const void *src) {
  ...
  while (1) {
    ...
    if ((sSendRecvStatus & EREADER_XFER_MASK) == 0 &&
        sSendRecvStatus & EREADER_CHECKSUM_OK_MASK) {
      result = 0;
      break;
...
int EReaderHandleTransfer(u8 mode, size_t size, const void *data,
                          void *recvBuffer) {
...
static u16 DetermineSendRecvState(u8 mode) {
  bool16 resp;
  if ((*(vu32 *)REG_ADDR_SIOCNT & (SIO_MULTI_SI | SIO_MULTI_SD)) ==
          SIO_MULTI_SD &&
      mode)
...
static void SetUpTransferManager(size_t size, const void *data,
                                 void *recvBuffer) {
...
void EReaderHelper_SerialCallback(void) {
  ...
  case EREADER_XFR_STATE_TRANSFER:
    ...
    if (sSendRecvMgr.isParent == TRUE) {
      ...
      // Receive mode
      if (sSendRecvMgr.cursor > 0 &&
          sSendRecvMgr.cursor < sSendRecvMgr.size + 1) {
  ...
  case EREADER_XFR_STATE_CHECKSUM:
    ...
    *(vu64 *)recv = REG_SIOMLT_RECV;
    if (recv[1] == EREADER_CHECKSUM_OK || recv[1] == EREADER_CHECKSUM_ERR) {
      if (sSendRecvMgr.isParent == TRUE)
        sSendRecvMgr.checksumResult =
            recv[1]; // EReader has (in)validated the payload
...
static void EnableSio(void) { REG_SIOCNT |= SIO_ENABLE; }
