...
static const union AnimCmd sSpriteAnim_MoneyLabel[] = {ANIMCMD_FRAME(0, 0),
                                                       ANIMCMD_END};
...
static const struct CompressedSpritePalette sSpritePalette_MoneyLabel = {
    .data = gShopMenu_Pal, .tag = MONEY_LABEL_TAG};
...
void PrintMoneyAmount(u8 windowId, u8 x, u8 y, int amount, u8 speed) {
  ...
  AddTextPrinterParameterized(windowId, FONT_NORMAL, gStringVar4, x, y, speed,
                              NULL);
}

void PrintMoneyAmountInMoneyBoxWithBorder(u8 windowId, u16 tileStart,
                                          u8 pallete, int amount) {
