...
#define subsprite_table(ptr)                                                   \
  {.subsprites = ptr,                                                          \
   .subspriteCount = (sizeof ptr) / (sizeof(struct Subsprite))}
...
static bool8 WaterfallFieldEffect_WaitForShowMon(struct Task *,
                                                 struct ObjectEvent *);
static bool8 WaterfallFieldEffect_RideUp(struct Task *, struct ObjectEvent *);
static bool8 WaterfallFieldEffect_ContinueRideOrEnd(struct Task *,
                                                    struct ObjectEvent *);
...
static bool8 LavaridgeGymB1FWarpEffect_Init(struct Task *, struct ObjectEvent *,
                                            struct Sprite *);
static bool8 LavaridgeGymB1FWarpEffect_CameraShake(struct Task *,
                                                   struct ObjectEvent *,
                                                   struct Sprite *);
static bool8 LavaridgeGymB1FWarpEffect_Launch(struct Task *,
                                              struct ObjectEvent *,
                                              struct Sprite *);
static bool8 LavaridgeGymB1FWarpEffect_Rise(struct Task *, struct ObjectEvent *,
                                            struct Sprite *);
static bool8 LavaridgeGymB1FWarpEffect_FadeOut(struct Task *,
                                               struct ObjectEvent *,
                                               struct Sprite *);
static bool8 LavaridgeGymB1FWarpEffect_Warp(struct Task *, struct ObjectEvent *,
                                            struct Sprite *);

static void FieldCB_LavaridgeGymB1FWarpExit(void);
static void Task_LavaridgeGymB1FWarpExit(u8);
static bool8 LavaridgeGymB1FWarpExitEffect_Init(struct Task *,
                                                struct ObjectEvent *,
                                                struct Sprite *);
static bool8 LavaridgeGymB1FWarpExitEffect_StartPopOut(struct Task *,
                                                       struct ObjectEvent *,
                                                       struct Sprite *);
static bool8 LavaridgeGymB1FWarpExitEffect_PopOut(struct Task *,
                                                  struct ObjectEvent *,
                                                  struct Sprite *);
static bool8 LavaridgeGymB1FWarpExitEffect_End(struct Task *,
                                               struct ObjectEvent *,
                                               struct Sprite *);

static void Task_LavaridgeGym1FWarp(u8);
static bool8 LavaridgeGym1FWarpEffect_Init(struct Task *, struct ObjectEvent *,
                                           struct Sprite *);
static bool8 LavaridgeGym1FWarpEffect_AshPuff(struct Task *,
                                              struct ObjectEvent *,
                                              struct Sprite *);
static bool8 LavaridgeGym1FWarpEffect_Disappear(struct Task *,
                                                struct ObjectEvent *,
                                                struct Sprite *);
static bool8 LavaridgeGym1FWarpEffect_FadeOut(struct Task *,
                                              struct ObjectEvent *,
                                              struct Sprite *);
static bool8 LavaridgeGym1FWarpEffect_Warp(struct Task *, struct ObjectEvent *,
                                           struct Sprite *);
...
static const u32 sNewGameBirch_Gfx[] =
    INCBIN_U32("graphics/birch_speech/birch.4bpp");
static const u32 sUnusedBirchBeauty[] =
    INCBIN_U32("graphics/birch_speech/unused_beauty.4bpp");
static const u16 sNewGameBirch_Pal[16] =
    INCBIN_U16("graphics/birch_speech/birch.gbapal");

static const u32 sPokeballGlow_Gfx[] =
    INCBIN_U32("graphics/field_effects/pics/pokeball_glow.4bpp");
static const u16 sPokeballGlow_Pal[16] =
    INCBIN_U16("graphics/field_effects/palettes/pokeball_glow.gbapal");
static const u32 sPokecenterMonitor0_Gfx[] =
    INCBIN_U32("graphics/field_effects/pics/pokecenter_monitor/0.4bpp");
static const u32 sPokecenterMonitor1_Gfx[] =
    INCBIN_U32("graphics/field_effects/pics/pokecenter_monitor/1.4bpp");
static const u32 sHofMonitorBig_Gfx[] =
    INCBIN_U32("graphics/field_effects/pics/hof_monitor_big.4bpp");
static const u8 sHofMonitorSmall_Gfx[] =
    INCBIN_U8("graphics/field_effects/pics/hof_monitor_small.4bpp");
static const u16 sHofMonitor_Pal[16] =
    INCBIN_U16("graphics/field_effects/palettes/hof_monitor.gbapal");

// Graphics for the lights streaking past your Pokémon when it uses a field
// move.
static const u32 sFieldMoveStreaksOutdoors_Gfx[] =
    INCBIN_U32("graphics/field_effects/pics/field_move_streaks.4bpp");
static const u16 sFieldMoveStreaksOutdoors_Pal[16] =
    INCBIN_U16("graphics/field_effects/pics/field_move_streaks.gbapal");
static const u16 sFieldMoveStreaksOutdoors_Tilemap[320] =
    INCBIN_U16("graphics/field_effects/pics/field_move_streaks.bin");

// The following light streaks effect is used when the map is indoors
static const u32 sFieldMoveStreaksIndoors_Gfx[] =
    INCBIN_U32("graphics/field_effects/pics/field_move_streaks_indoors.4bpp");
static const u16 sFieldMoveStreaksIndoors_Pal[16] =
    INCBIN_U16("graphics/field_effects/pics/field_move_streaks_indoors.gbapal");
static const u16 sFieldMoveStreaksIndoors_Tilemap[320] =
    INCBIN_U16("graphics/field_effects/pics/field_move_streaks_indoors.bin");

static const u16 sSpotlight_Pal[16] =
    INCBIN_U16("graphics/field_effects/pics/spotlight.gbapal");
static const u8 sSpotlight_Gfx[] =
    INCBIN_U8("graphics/field_effects/pics/spotlight.4bpp");
static const u8 sRockFragment_TopLeft[] =
    INCBIN_U8("graphics/field_effects/pics/deoxys_rock_fragment_top_left.4bpp");
static const u8 sRockFragment_TopRight[] = INCBIN_U8(
    "graphics/field_effects/pics/deoxys_rock_fragment_top_right.4bpp");
static const u8 sRockFragment_BottomLeft[] = INCBIN_U8(
    "graphics/field_effects/pics/deoxys_rock_fragment_bottom_left.4bpp");
static const u8 sRockFragment_BottomRight[] = INCBIN_U8(
...
static const struct SpritePalette sSpritePalette_NewGameBirch = {
    .data = sNewGameBirch_Pal, .tag = 0x1006};

static const union AnimCmd sAnim_NewGameBirch[] = {
    ANIMCMD_FRAME(.imageValue = 0, .duration = 1), ANIMCMD_END};
...
const struct SpritePalette gSpritePalette_PokeballGlow = {
    .data = sPokeballGlow_Pal, .tag = FLDEFF_PAL_TAG_POKEBALL_GLOW};

const struct SpritePalette gSpritePalette_HofMonitor = {
    .data = sHofMonitor_Pal, .tag = FLDEFF_PAL_TAG_HOF_MONITOR};
...
static const union AnimCmd sAnim_Static[] = {
    ANIMCMD_FRAME(.imageValue = 0, .duration = 1), ANIMCMD_JUMP(0)};
...
// Flicker on and off, for the Pokéballs / monitors during the PokéCenter heal
// effect
static const union AnimCmd *const sAnims_Flicker[] = {sAnim_Static,
                                                      sAnim_Flicker};

static const union AnimCmd *const sAnims_HofMonitor[] = {sAnim_Static};
...
static void (*const sHallOfFameRecordEffectFuncs[])(struct Task *) = {
    HallOfFameRecordEffect_Init, HallOfFameRecordEffect_WaitForBallPlacement,
...
static bool8 (*const sFallWarpFieldEffectFuncs[])(struct Task *) = {
    FallWarpEffect_Init, FallWarpEffect_WaitWeather, FallWarpEffect_StartFall,
    FallWarpEffect_Fall, FallWarpEffect_Land,        FallWarpEffect_CameraShake,
    FallWarpEffect_End,
};

static bool8 (*const sEscalatorWarpOutFieldEffectFuncs[])(struct Task *) = {
    EscalatorWarpOut_Init,      EscalatorWarpOut_WaitForPlayer,
    EscalatorWarpOut_Up_Ride,   EscalatorWarpOut_Up_End,
    EscalatorWarpOut_Down_Ride, EscalatorWarpOut_Down_End,
};

static bool8 (*const sEscalatorWarpInFieldEffectFuncs[])(struct Task *) = {
    EscalatorWarpIn_Init,      EscalatorWarpIn_Down_Init,
    EscalatorWarpIn_Down_Ride, EscalatorWarpIn_Up_Init,
    EscalatorWarpIn_Up_Ride,   EscalatorWarpIn_WaitForMovement,
    EscalatorWarpIn_End,
};

static bool8 (*const sWaterfallFieldEffectFuncs[])(struct Task *,
                                                   struct ObjectEvent *) = {
...
static bool8 (*const sLavaridgeGymB1FWarpEffectFuncs[])(struct Task *,
                                                        struct ObjectEvent *,
                                                        struct Sprite *) = {
    LavaridgeGymB1FWarpEffect_Init,    LavaridgeGymB1FWarpEffect_CameraShake,
    LavaridgeGymB1FWarpEffect_Launch,  LavaridgeGymB1FWarpEffect_Rise,
    LavaridgeGymB1FWarpEffect_FadeOut, LavaridgeGymB1FWarpEffect_Warp,
};

static bool8 (*const sLavaridgeGymB1FWarpExitEffectFuncs[])(
...
static bool8 (*const sLavaridgeGym1FWarpEffectFuncs[])(struct Task *,
                                                       struct ObjectEvent *,
                                                       struct Sprite *) = {
    LavaridgeGym1FWarpEffect_Init,      LavaridgeGym1FWarpEffect_AshPuff,
    LavaridgeGym1FWarpEffect_Disappear, LavaridgeGym1FWarpEffect_FadeOut,
...
bool8 FieldEffectCmd_end(u8 **script, u32 *val) { return FALSE; }
...
u32 FieldEffectScript_ReadWord(u8 **script) {
  return (*script)[0] + ((*script)[1] << 8) + ((*script)[2] << 16) +
         ((*script)[3] << 24);
}

void FieldEffectScript_LoadTiles(u8 **script) {
  struct SpriteSheet *sheet =
      (struct SpriteSheet *)FieldEffectScript_ReadWord(script);
...
void FieldEffectScript_LoadFadedPalette(u8 **script) {
  struct SpritePalette *palette =
      (struct SpritePalette *)FieldEffectScript_ReadWord(script);
...
u8 CreateTrainerSprite(u8 trainerSpriteID, s16 x, s16 y, u8 subpriority,
  ...
  LoadCompressedSpriteSheetOverrideBuffer(
      &gTrainerFrontPicTable[trainerSpriteID], buffer);
...
static void UNUSED LoadTrainerGfx_TrainerCard(u8 gender, u16 palOffset,
                                              u8 *dest) {
  LZDecompressVram(gTrainerFrontPicTable[gender].data, dest);
  LoadCompressedPalette(gTrainerFrontPicPaletteTable[gender].data, palOffset,
                        PLTT_SIZE_4BPP);
}
...
u8 CreateMonSprite_PicBox(u16 species, s16 x, s16 y, u8 subpriority) {
  s32 spriteId = CreateMonPicSprite_HandleDeoxys(
      species, 0, 0x8000, TRUE, x, y, 0, gMonPaletteTable[species].tag);
  PreservePaletteInWeather(
      IndexOfSpritePaletteTag(gMonPaletteTable[species].tag) + 0x10);
  if (spriteId == 0xFFFF)
    return MAX_SPRITES;
  else
    return spriteId;
...
u8 CreateMonSprite_FieldMove(u16 species, u32 otId, u32 personality, s16 x,
                             s16 y, u8 subpriority) {
  const struct CompressedSpritePalette *spritePalette =
      GetMonSpritePalStructFromOtIdPersonality(species, otId, personality);
  u16 spriteId = CreateMonPicSprite_HandleDeoxys(
      species, otId, personality, TRUE, x, y, 0, spritePalette->tag);
...
static void PokecenterHealEffect_Init(struct Task *task) {
  ...
  task->tBallSpriteId = CreateGlowingPokeballsEffect(
      task->tNumMons, task->tFirstBallX, task->tFirstBallY, TRUE);
  task->tMonitorSpriteId =
      CreatePokecenterMonitorSprite(task->tMonitorX, task->tMonitorY);
}
...
static void HallOfFameRecordEffect_Init(struct Task *task) {
  ...
  task->tState++;
  task->tBallSpriteId = CreateGlowingPokeballsEffect(
      task->tNumMons, task->tFirstBallX, task->tFirstBallY, FALSE);
...
static u8 CreateGlowingPokeballsEffect(s16 numMons, s16 x, s16 y,
                                       bool16 playHealSe) {
  u8 spriteId;
...
static void PokeballGlowEffect_PlaceBalls(struct Sprite *sprite) {
  ...
  if (sprite->sTimer == 0 || (--sprite->sTimer) == 0) {
    ...
    spriteId = CreateSpriteAtEnd(
        ...
        sPokeballCoordOffsets[sprite->sCounter].y + sprite->y2, 0);
...
static void CreateHofMonitorSprite(s16 taskId, s16 x, s16 y,
                                   bool8 isSmallMonitor) {
  u8 spriteId;
  if (!isSmallMonitor) {
...
static bool8 FallWarpEffect_StartFall(struct Task *task) {
  ...
  sprite->y2 = -(sprite->y + sprite->centerToCornerVecY + gSpriteCoordOffsetY +
                 centerToCornerVecY);
  task->tFallOffset = 1;
  task->tTotalFall = 0;
...
static bool8 EscalatorWarpOut_WaitForPlayer(struct Task *task) {
  ...
  if (!ObjectEventIsMovementOverridden(objectEvent) ||
    ...
    ObjectEventSetHeldMovement(objectEvent, GetFaceDirectionMovementAction(
...
static bool8 EscalatorWarpIn_Init(struct Task *task) {
  ...
  ObjectEventSetHeldMovement(objectEvent,
                             GetFaceDirectionMovementAction(DIR_EAST));
...
static bool8 EscalatorWarpIn_End(struct Task *task) {
  ...
  if (ObjectEventClearHeldMovementIfFinished(objectEvent)) {
    ...
    UnlockPlayerFieldControls();
    ObjectEventSetHeldMovement(objectEvent,
                               GetWalkNormalMovementAction(DIR_EAST));
...
static bool8 WaterfallFieldEffect_Init(struct Task *task,
                                       struct ObjectEvent *objectEvent) {
  LockPlayerFieldControls();
  gPlayerAvatar.preventStep = TRUE;
  task->tState++;
...
static bool8 WaterfallFieldEffect_ShowMon(struct Task *task,
                                          struct ObjectEvent *objectEvent) {
  LockPlayerFieldControls();
  if (!ObjectEventIsMovementOverridden(objectEvent)) {
    ObjectEventClearHeldMovementIfFinished(objectEvent);
...
static bool8
WaterfallFieldEffect_WaitForShowMon(struct Task *task,
                                    struct ObjectEvent *objectEvent) {
...
static bool8 WaterfallFieldEffect_RideUp(struct Task *task,
                                         struct ObjectEvent *objectEvent) {
...
static bool8
WaterfallFieldEffect_ContinueRideOrEnd(struct Task *task,
                                       struct ObjectEvent *objectEvent) {
  if (!ObjectEventClearHeldMovementIfFinished(objectEvent))
    return FALSE;
...
static bool8 LavaridgeGymB1FWarpEffect_Init(struct Task *task,
                                            struct ObjectEvent *objectEvent,
                                            struct Sprite *sprite) {
  FreezeObjectEvents();
  CameraObjectFreeze();
...
static bool8 LavaridgeGymB1FWarpEffect_Launch(struct Task *task,
                                              struct ObjectEvent *objectEvent,
                                              struct Sprite *sprite) {
  sprite->y2 = 0;
  task->data[3] = 1;
...
static bool8 LavaridgeGymB1FWarpEffect_Rise(struct Task *task,
                                            struct ObjectEvent *objectEvent,
                                            struct Sprite *sprite) {
  s16 centerToCornerVecY;
  SetCameraPanning(0, task->data[1]);
  ...
  if (task->data[2] > 6) {
    centerToCornerVecY = -(sprite->centerToCornerVecY << 1);
    if (sprite->y2 > -(sprite->y + sprite->centerToCornerVecY +
                       gSpriteCoordOffsetY + centerToCornerVecY)) {
...
static bool8 LavaridgeGymB1FWarpEffect_FadeOut(struct Task *task,
                                               struct ObjectEvent *objectEvent,
                                               struct Sprite *sprite) {
  TryFadeOutOldMapMusic();
  WarpFadeOutScreen();
...
static bool8 LavaridgeGymB1FWarpEffect_Warp(struct Task *task,
                                            struct ObjectEvent *objectEvent,
                                            struct Sprite *sprite) {
  if (!gPaletteFade.active && BGMusicStopped() == TRUE) {
    WarpIntoMap();
...
static bool8 LavaridgeGymB1FWarpExitEffect_Init(struct Task *task,
                                                struct ObjectEvent *objectEvent,
                                                struct Sprite *sprite) {
  CameraObjectFreeze();
  FreezeObjectEvents();
...
static bool8 LavaridgeGymB1FWarpExitEffect_End(struct Task *task,
                                               struct ObjectEvent *objectEvent,
                                               struct Sprite *sprite) {
  if (ObjectEventClearHeldMovementIfFinished(objectEvent)) {
    gPlayerAvatar.preventStep = FALSE;
...
u8 FldEff_AshLaunch(void) {
  u8 spriteId;
  SetSpritePosToOffsetMapCoords((s16 *)&gFieldEffectArguments[0],
                                (s16 *)&gFieldEffectArguments[1], 8, 8);
  spriteId = CreateSpriteAtEnd(
      gFieldEffectObjectTemplatePointers[FLDEFFOBJ_ASH_LAUNCH],
      gFieldEffectArguments[0], gFieldEffectArguments[1],
...
static bool8 LavaridgeGym1FWarpEffect_Init(struct Task *task,
                                           struct ObjectEvent *objectEvent,
                                           struct Sprite *sprite) {
  FreezeObjectEvents();
  CameraObjectFreeze();
...
static bool8 LavaridgeGym1FWarpEffect_AshPuff(struct Task *task,
                                              struct ObjectEvent *objectEvent,
                                              struct Sprite *sprite) {
  if (ObjectEventClearHeldMovementIfFinished(objectEvent)) {
    if (task->data[1] > 3) {
...
static bool8 LavaridgeGym1FWarpEffect_Disappear(struct Task *task,
                                                struct ObjectEvent *objectEvent,
                                                struct Sprite *sprite) {
...
static bool8 LavaridgeGym1FWarpEffect_FadeOut(struct Task *task,
                                              struct ObjectEvent *objectEvent,
                                              struct Sprite *sprite) {
...
static bool8 LavaridgeGym1FWarpEffect_Warp(struct Task *task,
                                           struct ObjectEvent *objectEvent,
                                           struct Sprite *sprite) {
  if (!gPaletteFade.active && BGMusicStopped() == TRUE) {
    WarpIntoMap();
...
// For the ash effect when a trainer pops out of ash, or when the player
// enters/exits a warp in Lavaridge Gym 1F
u8 FldEff_AshPuff(void) {
  u8 spriteId;
  SetSpritePosToOffsetMapCoords((s16 *)&gFieldEffectArguments[0],
                                (s16 *)&gFieldEffectArguments[1], 8, 8);
  spriteId =
      CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_ASH_PUFF],
                        gFieldEffectArguments[0], gFieldEffectArguments[1],
                        gFieldEffectArguments[2]);
  gSprites[spriteId].oam.priority = gFieldEffectArguments[3];
  gSprites[spriteId].coordOffsetEnabled = TRUE;
...
static void EscapeRopeWarpOutEffect_Spin(struct Task *task) {
  ...
  if (!ObjectEventIsMovementOverridden(objectEvent) ||
    ...
    if (task->tTimer == 0 && !gPaletteFade.active && BGMusicStopped() == TRUE) {
      ...
      ObjectEventSetHeldMovement(
          objectEvent, GetFaceDirectionMovementAction(
...
static void (*const sEscapeRopeWarpInEffectFuncs[])(struct Task *) = {
    EscapeRopeWarpInEffect_Init, EscapeRopeWarpInEffect_Spin};
...
void FldEff_TeleportWarpOut(void) { CreateTask(Task_TeleportWarpOut, 0); }

static void (*const sTeleportWarpOutFieldEffectFuncs[])(struct Task *) = {
    TeleportWarpOutFieldEffect_Init, TeleportWarpOutFieldEffect_SpinGround,
    TeleportWarpOutFieldEffect_SpinExit, TeleportWarpOutFieldEffect_End};
...
static void TeleportWarpOutFieldEffect_SpinExit(struct Task *task) {
  ...
  if (task->data[4] > 8 &&
      (sprite->oam.priority = 1, sprite->subspriteMode != SUBSPRITES_OFF)) {
    sprite->subspriteMode = SUBSPRITES_IGNORE_PRIORITY;
  }
...
static void (*const sTeleportWarpInFieldEffectFuncs[])(struct Task *) = {
    TeleportWarpInFieldEffect_Init, TeleportWarpInFieldEffect_SpinEnter,
...
static void TeleportWarpInFieldEffect_Init(struct Task *task) {
  ...
  if (IsWeatherNotFadingIn()) {
    sprite = &gSprites[gPlayerAvatar.spriteId];
    centerToCornerVecY = -(sprite->centerToCornerVecY << 1);
    sprite->y2 = -(sprite->y + sprite->centerToCornerVecY +
                   gSpriteCoordOffsetY + centerToCornerVecY);
    gObjectEvents[gPlayerAvatar.objectEventId].invisible = FALSE;
    task->data[0]++;
    task->data[1] = 8;
...
static void TeleportWarpInFieldEffect_SpinGround(struct Task *task) {
  ...
  if ((--task->data[1]) == 0) {
    ...
    task->data[1] = 8;
    if ((++task->data[2]) > 4 &&
        task->data[14] == objectEvent->facingDirection) {
      UnlockPlayerFieldControls();
      CameraObjectReset();
      UnfreezeObjectEvents();
...
// There are two variants (outdoor/indoor) of the "show mon for a field move"
// effect Outdoor has a black background with thick white streaks and appears
// from the right by stretching vertically and horizontally Indoor has blue
// background with thin white streaks and appears from the left by stretching
// horizontally For both the background streaks move to the right, and the mon
// sprite enters from the right and exits left
bool8 FldEff_FieldMoveShowMon(void) {
  ...
  gTasks[taskId].tMonSpriteId =
      InitFieldMoveMonSprite(gFieldEffectArguments[0], gFieldEffectArguments[1],
                             gFieldEffectArguments[2]);
  return FALSE;
}
...
static void FieldMoveShowMonOutdoorsEffect_Init(struct Task *task) {
  ...
  task->tWinOut = WINOUT_WIN01_BG1 | WINOUT_WIN01_BG2 | WINOUT_WIN01_BG3 |
...
static void FieldMoveShowMonOutdoorsEffect_LoadGfx(struct Task *task) {
  ...
  LoadPalette(sFieldMoveStreaksOutdoors_Pal, BG_PLTT_ID(15),
              sizeof(sFieldMoveStreaksOutdoors_Pal));
...
static void FieldMoveShowMonOutdoorsEffect_CreateBanner(struct Task *task) {
  ...
  if (horiz == 0 && vertHi == DISPLAY_HEIGHT / 4 &&
      vertLo == DISPLAY_WIDTH / 2) {
...
static void FieldMoveShowMonIndoorsEffect_LoadGfx(struct Task *task) {
  ...
  CpuFill32(0, (void *)(VRAM + delta), 0x800);
  LoadPalette(sFieldMoveStreaksIndoors_Pal, BG_PLTT_ID(15),
              sizeof(sFieldMoveStreaksIndoors_Pal));
  task->tState++;
}
...
static void FieldMoveShowMonIndoorsEffect_SlideBannerOn(struct Task *task) {
  if (SlideIndoorBannerOnscreen(task)) {
    ...
    SetGpuReg(REG_OFFSET_WIN1V, WIN_RANGE(DISPLAY_HEIGHT / 4,
...
static bool8 SlideIndoorBannerOnscreen(struct Task *task) {
  ...
  if (dstOffs >= task->tBgOffset) {
    ...
    for (i = 0; i < 10; i++) {
      dest[dstOffs + i * 32] =
          sFieldMoveStreaksIndoors_Tilemap[srcOffs + i * 32];
      dest[dstOffs + i * 32] |= 0xf000;

      dest[((dstOffs + 1) & 0x1f) + i * 32] =
          sFieldMoveStreaksIndoors_Tilemap[((srcOffs + 1) & 0x1f) + i * 32] |
          0xf000;
...
static void SpriteCB_FieldMoveMonSlideOnscreen(struct Sprite *sprite) {
  if ((sprite->x -= 20) <= DISPLAY_WIDTH / 2) {
    ...
    if (sprite->data[6])
      PlayCry_NormalNoDucking(sprite->sSpecies, 0, CRY_VOLUME_RS,
                              CRY_PRIORITY_NORMAL);
    else
...
static void (*const sSurfFieldEffectFuncs[])(struct Task *) = {
    SurfFieldEffect_Init,    SurfFieldEffect_FieldMovePose,
    SurfFieldEffect_ShowMon, SurfFieldEffect_JumpOnSurfBlob,
    SurfFieldEffect_End,
};
...
static void SurfFieldEffect_Init(struct Task *task) {
  ...
  MoveCoords(gObjectEvents[gPlayerAvatar.objectEventId].movementDirection,
             &task->tDestX, &task->tDestY);
  task->tState++;
}
...
static void SurfFieldEffect_JumpOnSurfBlob(struct Task *task) {
  ...
  if (!FieldEffectActiveListContains(FLDEFF_FIELD_MOVE_SHOW_MON)) {
    objectEvent = &gObjectEvents[gPlayerAvatar.objectEventId];
    ObjectEventSetGraphicsId(objectEvent, GetPlayerAvatarGraphicsIdByStateId(
                                              PLAYER_AVATAR_STATE_SURFING));
    ObjectEventClearHeldMovementIfFinished(objectEvent);
    ObjectEventSetHeldMovement(
        objectEvent,
        GetJumpSpecialMovementAction(objectEvent->movementDirection));
...
static void SurfFieldEffect_End(struct Task *task) {
  ...
  if (ObjectEventClearHeldMovementIfFinished(objectEvent)) {
    ...
    ObjectEventSetHeldMovement(
        objectEvent,
        GetFaceDirectionMovementAction(objectEvent->movementDirection));
...
u8 FldEff_RayquazaSpotlight(void) {
  ...
  u8 spriteId = CreateSprite(
      gFieldEffectObjectTemplatePointers[FLDEFFOBJ_RAYQUAZA], 120, -24, 1);
  ...
  SetGpuReg(REG_OFFSET_WININ, WININ_WIN0_BG_ALL | WININ_WIN0_OBJ |
                                  WININ_WIN0_CLR | WININ_WIN1_BG_ALL |
  ...
  for (k = 0; k < 90; k++) {
    for (i = 0; i < 8; i++) {
      *(u16 *)(BG_CHAR_ADDR(2) + (k + 1) * 32 + i * 4) =
          (sSpotlight_Gfx[k * 32 + i * 4 + 1] << 8) +
          sSpotlight_Gfx[k * 32 + i * 4];
      *(u16 *)(BG_CHAR_ADDR(2) + (k + 1) * 32 + i * 4 + 2) =
          (sSpotlight_Gfx[k * 32 + i * 4 + 3] << 8) +
          sSpotlight_Gfx[k * 32 + i * 4 + 2];
    }
  }
  return spriteId;
}
...
u8 FldEff_NPCFlyOut(void) {
  u8 spriteId = CreateSprite(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_BIRD],
                             0x78, 0, 1);
  struct Sprite *sprite = &gSprites[spriteId];
...
static void FlyOutFieldEffect_BirdLeaveBall(struct Task *task) {
  if (!FieldEffectActiveListContains(FLDEFF_FIELD_MOVE_SHOW_MON)) {
    ...
    task->tBirdSpriteId =
        CreateFlyBirdSprite(); // Does "leave ball" animation by default
    task->tState++;
  }
}
...
static u8 CreateFlyBirdSprite(void) {
  u8 spriteId;
  struct Sprite *sprite;
  spriteId = CreateSprite(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_BIRD],
                          0xff, 0xb4, 0x1);
  sprite = &gSprites[spriteId];
  sprite->oam.paletteNum = 0;
  sprite->oam.priority = 1;
...
static const union AffineAnimCmd sAffineAnim_FlyBirdLeaveBall[] = {
    AFFINEANIMCMD_FRAME(8, 8, -30, 0), AFFINEANIMCMD_FRAME(28, 28, 0, 30),
    AFFINEANIMCMD_END};

static const union AffineAnimCmd sAffineAnim_FlyBirdReturnToBall[] = {
    AFFINEANIMCMD_FRAME(256, 256, 64, 0), AFFINEANIMCMD_FRAME(-10, -10, 0, 22),
    AFFINEANIMCMD_END};

static const union AffineAnimCmd *const sAffineAnims_FlyBird[] = {
    sAffineAnim_FlyBirdLeaveBall, sAffineAnim_FlyBirdReturnToBall};
...
static void StartFlyBirdReturnToBall(u8 spriteId) {
  StartFlyBirdSwoopDown(
      spriteId); // Set up is the same, but overrwrites the callback below
...
static void FlyInFieldEffect_JumpOffBird(struct Task *task) {
  s16 sYPositions[18] = {-2, -4, -5, -6, -7, -8, -8, -8, -7,
                         -7, -6, -5, -3, -2, 0,  2,  4,  8};
  struct Sprite *sprite = &gSprites[gPlayerAvatar.spriteId];
...
static void FlyInFieldEffect_FieldMovePose(struct Task *task) {
  ...
  if (GetFlyBirdAnimCompleted(task->tBirdSpriteId)) {
    ...
    sprite = &gSprites[objectEvent->spriteId];
    objectEvent->inanimate = FALSE;
    MoveObjectEventToMapCoords(objectEvent, objectEvent->currentCoords.x,
...
static void FlyInFieldEffect_End(struct Task *task) {
  ...
  if ((--task->data[1]) == 0) {
    ...
    if (task->tAvatarFlags & PLAYER_AVATAR_FLAG_SURFING) {
      ...
      SetSurfBlob_BobState(objectEvent->fieldEffectSpriteId,
                           BOB_PLAYER_AND_MON);
    }
    ObjectEventSetGraphicsId(objectEvent,
                             GetPlayerAvatarGraphicsIdByStateId(state));
...
static void CreateDeoxysRockFragments(struct Sprite *sprite) {
  ...
  for (i = 0; i < 4; i++) {
    u8 spriteId =
        CreateSprite(&sSpriteTemplate_DeoxysRockFragment, xPos, yPos, 0);
...
static void SpriteCB_DeoxysRockFragment(struct Sprite *sprite) {
  ...
  if (sprite->x < -4 || sprite->x > DISPLAY_WIDTH + 4 || sprite->y < -4 ||
      sprite->y > DISPLAY_HEIGHT + 4)
    DestroySprite(sprite);
}
...
bool8 FldEff_MoveDeoxysRock(struct Sprite *sprite) {
  ...
  if (!TryGetObjectEventIdByLocalIdAndMap(
    ...
    ShiftObjectEventCoords(object, gFieldEffectArguments[3] + MAP_OFFSET,
                           gFieldEffectArguments[4] + MAP_OFFSET);
