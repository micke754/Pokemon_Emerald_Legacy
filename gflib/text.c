...
static const u8 sFontHalfRowOffsets[] = {
    ,
...
static const u8 sDarkDownArrowTiles[] =
    INCBIN_U8("graphics/fonts/down_arrow_alt.4bpp");
static const u8 sUnusedFRLGBlankedDownArrow[] =
    INCBIN_U8("graphics/fonts/unused_frlg_blanked_down_arrow.4bpp");
static const u8 sUnusedFRLGDownArrow[] =
    INCBIN_U8("graphics/fonts/unused_frlg_down_arrow.4bpp");
...
struct {
  ...
  u8 height;
    ...
    [CHAR_A_BUTTON] = {0x00, 8, 12},      [CHAR_B_BUTTON] = {0x01, 8, 12},
    [CHAR_L_BUTTON] = {0x02, 16, 12},     [CHAR_R_BUTTON] = {0x04, 16, 12},
    [CHAR_START_BUTTON] = {0x06, 24, 12}, [CHAR_SELECT_BUTTON] = {0x09, 24, 12},
    [CHAR_DPAD_UP] = {0x0C, 8, 12},       [CHAR_DPAD_DOWN] = {0x0D, 8, 12},
    [CHAR_DPAD_LEFT] = {0x0E, 8, 12},     [CHAR_DPAD_RIGHT] = {0x0F, 8, 12},
    [CHAR_DPAD_UPDOWN] = {0x20, 8, 12},   [CHAR_DPAD_LEFTRIGHT] = {0x21, 8, 12},
    [CHAR_DPAD_NONE] = {0x22, 8, 12}};

static const u8 sKeypadIconTiles[] =
    INCBIN_U8("graphics/fonts/keypad_icons.4bpp");
...
static const u8 sMenuCursorDimensions[][2] = {
    [FONT_SMALL] = {8, 12},        [FONT_NORMAL] = {8, 15},
    [FONT_SHORT] = {8, 14},        [FONT_SHORT_COPY_1] = {8, 14},
    [FONT_SHORT_COPY_2] = {8, 14}, [FONT_SHORT_COPY_3] = {8, 14},
    [FONT_BRAILLE] = {8, 16},      [FONT_NARROW] = {8, 15},
    [FONT_SMALL_NARROW] = {8, 8},  [FONT_BOLD] = {}};

static const u16 sFontBoldJapaneseGlyphs[] =
    INCBIN_U16("graphics/fonts/bold.hwjpnfont");

static void SetFontsPointer(const struct FontInfo *fonts) { gFonts = fonts; }
...
u16 AddTextPrinterParameterized(u8 windowId, u8 fontId, const u8 *str, u8 x,
                                u8 y, u8 speed,
...
bool16 AddTextPrinter(struct TextPrinterTemplate *printerTemplate, u8 speed,
  ...
  GenerateFontHalfRowLookupTable(printerTemplate->fgColor,
                                 printerTemplate->bgColor,
                                 printerTemplate->shadowColor);
      ...
      if (sTextPrinters[i].active) {
        ...
        case RENDER_UPDATE:
          if (sTextPrinters[i].callback != NULL)
            sTextPrinters[i].callback(&sTextPrinters[i].printerTemplate,
                                      renderCmd);
          break;
        case RENDER_FINISH:
...
bool16 IsTextPrinterActive(u8 id) { return sTextPrinters[id].active; }
...
void DecompressGlyphTile(const void *src_, void *dest_) {
  ...
  temp = *(src++);
  *(dest)++ =
      ((sFontHalfRowLookupTable[sFontHalfRowOffsets[temp & 0xFF]]) << 16) |
      (sFontHalfRowLookupTable[sFontHalfRowOffsets[temp >> 8]]);
...
inline static void GLYPH_COPY(u8 *windowTiles, u32 widthOffset, u32 j, u32 i,
                              u32 *glyphPixels, s32 width, s32 height) {
...
void CopyGlyphToWindow(struct TextPrinter *textPrinter) {
  ...
  if ((glyphWidth = (template->width * 8) -
                    textPrinter->printerTemplate.currentX) > gCurGlyph.width)
    glyphWidth = gCurGlyph.width;

  if ((glyphHeight = (template->height * 8) -
                     textPrinter->printerTemplate.currentY) > gCurGlyph.height)
  ...
  if (glyphWidth < 9) {
    if (glyphHeight < 9) {
      GLYPH_COPY(windowTiles, widthOffset, currX, currY, glyphPixels,
                 glyphWidth, glyphHeight);
    } else {
      GLYPH_COPY(windowTiles, widthOffset, currX, currY, glyphPixels,
                 glyphWidth, 8);
      GLYPH_COPY(windowTiles, widthOffset, currX, currY + 8, glyphPixels + 16,
                 glyphWidth, glyphHeight - 8);
    }
  } else {
    if (glyphHeight < 9) {
      GLYPH_COPY(windowTiles, widthOffset, currX, currY, glyphPixels, 8,
                 glyphHeight);
      GLYPH_COPY(windowTiles, widthOffset, currX + 8, currY, glyphPixels + 8,
                 glyphWidth - 8, glyphHeight);
    } else {
      ...
      GLYPH_COPY(windowTiles, widthOffset, currX, currY + 8, glyphPixels + 16,
                 8, glyphHeight - 8);
      GLYPH_COPY(windowTiles, widthOffset, currX + 8, currY + 8,
                 glyphPixels + 24, glyphWidth - 8, glyphHeight - 8);
    }
  }
}
...
void ClearTextSpan(struct TextPrinter *textPrinter, u32 width) {
  ...
  if (sLastTextBgColor != TEXT_COLOR_TRANSPARENT) {
    ...
    FillBitmapRect4Bit(&pixels_data, textPrinter->printerTemplate.currentX,
                       textPrinter->printerTemplate.currentY, width,
                       *glyphHeight, sLastTextBgColor);
  }
}
  ...
  if (gTextFlags.autoScroll == 0) {
    if (subStruct->downArrowDelay != 0) {
      ...
      FillWindowPixelRect(textPrinter->printerTemplate.windowId,
                          textPrinter->printerTemplate.bgColor << 4 |
                              textPrinter->printerTemplate.bgColor,
                          textPrinter->printerTemplate.currentX,
                          textPrinter->printerTemplate.currentY, 8, 16);
      ...
      BlitBitmapRectToWindow(textPrinter->printerTemplate.windowId, arrowTiles,
                             0, sDownArrowYCoords[subStruct->downArrowYPosIdx],
                             8, 16, textPrinter->printerTemplate.currentX,
                             textPrinter->printerTemplate.currentY, 8, 16);
...
void DrawDownArrow(u8 windowId, u16 x, u16 y, u8 bgColor, bool8 drawArrow,
                   u8 *counter, u8 *yCoordIndex) {
  const u8 *arrowTiles;
  ...
  if (*counter != 0) {
    ...
    if (drawArrow == 0) {
      ...
      BlitBitmapRectToWindow(windowId, arrowTiles, 0,
                             sDownArrowYCoords[*yCoordIndex & 3], 8, 16, x,
                             y - 2, 8, 16);
...
static u32 UNUSED GetStringWidthFixedWidthFont(const u8 *str, u8 fontId,
                                               u8 letterSpacing) {
  int i;
  u8 width;
  int temp;
  ...
  return (u8)(GetFontAttribute(fontId, FONTATTR_MAX_LETTER_WIDTH) +
              letterSpacing) *
         width;
}
...
u8 RenderTextHandleBold(u8 *pixels, u8 fontId, u8 *str) {
  ...
  GenerateFontHalfRowLookupTable(TEXT_COLOR_WHITE, TEXT_COLOR_TRANSPARENT,
...
u8 DrawKeypadIcon(u8 windowId, u8 keypadIconId, u16 x, u16 y) {
  BlitBitmapRectToWindow(
      windowId,
      sKeypadIconTiles + (sKeypadIcons[keypadIconId].tileOffset * 0x20), 0, 0,
      0x80, 0x80, x, y, sKeypadIcons[keypadIconId].width,
...
void SetDefaultFontsPointer(void) { SetFontsPointer(sFontInfos); }
...
static void DecompressGlyph_Small(u16 glyphId, bool32 isJapanese) {
  ...
  if (isJapanese == 1) {
    glyphs = gFontSmallJapaneseGlyphs + (0x100 * (glyphId >> 0x4)) +
             (0x8 * (glyphId & 0xF));
...
static void DecompressGlyph_Narrow(u16 glyphId, bool32 isJapanese) {
  ...
  if (isJapanese == TRUE) {
    glyphs = gFontNormalJapaneseGlyphs + (0x100 * (glyphId >> 0x4)) +
             (0x8 * (glyphId % 0x10));
    DecompressGlyphTile(glyphs, gCurGlyph.gfxBufferTop);
    DecompressGlyphTile(glyphs + 0x80, gCurGlyph.gfxBufferBottom);
    gCurGlyph.width = 8;
...
static void DecompressGlyph_Short(u16 glyphId, bool32 isJapanese) {
  ...
  if (isJapanese == TRUE) {
    glyphs = gFontShortJapaneseGlyphs + (0x100 * (glyphId >> 0x3)) +
             (0x10 * (glyphId & 0x7));
    DecompressGlyphTile(glyphs, gCurGlyph.gfxBufferTop);
    DecompressGlyphTile(glyphs + 0x8, gCurGlyph.gfxBufferTop + 8);
    DecompressGlyphTile(glyphs + 0x80,
                        gCurGlyph.gfxBufferBottom); // gCurGlyph + 0x20
    DecompressGlyphTile(glyphs + 0x88,
                        gCurGlyph.gfxBufferBottom + 8); // gCurGlyph + 0x60
...
static void DecompressGlyph_Bold(u16 glyphId) {
  ...
  glyphs = sFontBoldJapaneseGlyphs + (0x100 * (glyphId >> 4)) +
           (0x8 * (glyphId & 0xF));
  DecompressGlyphTile(glyphs, gCurGlyph.gfxBufferTop);
  DecompressGlyphTile(glyphs + 0x80, gCurGlyph.gfxBufferBottom);
  gCurGlyph.width = 8;
