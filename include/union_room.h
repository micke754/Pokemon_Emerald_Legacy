...
// represent leaders of recently discovered link groups, and each of those
// groups may have up to MAX_RFU_PLAYERS (5) players in it including the leader.
// These players are represented on-screen by NPC sprites drawn around the
// leader. Thus there can be 40 sprites of other players on-screen, in 8 groups
// of 5.
...
// Information such as a group member's gender can instead be read from
// partnerInfo of the leader's RfuGameData by tracking at least all of the group
// leaders.
