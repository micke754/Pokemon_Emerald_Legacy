...
#define WEATHER_ABNORMAL                                                       \
  15 // The alternating weather during Groudon/Kyogre conflict
...
#define MARINE_CAVE_LOCATIONS_START                                            \
  (TERRA_CAVE_LOCATIONS_START + TERRA_CAVE_LOCATIONS)
...
#define ABNORMAL_WEATHER_LOCATIONS                                             \
  (MARINE_CAVE_LOCATIONS + TERRA_CAVE_LOCATIONS)
