...
#define PARTY_MENU_TYPE_CHOOSE_HALF                                            \
  4 // multi battles, eReader battles, and some battle facilities
...
#define PARTY_ACTION_GIVE_PC_ITEM                                              \
  6 // Unused. Not possible to give non-mail items directly from PC
...
#define PARTY_ACTION_REUSABLE_ITEM                                             \
  14 // Unused. The only reusable items are handled separately

// IDs for DisplayPartyMenuStdMessage, to display the message at the bottom of
// the party menu
...
// IDs for DisplayPartyPokemonDescriptionText, to display a message in the party
// pokemon's box
