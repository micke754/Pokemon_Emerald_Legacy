...
// The number of possible trainer classes for a trainer of a given gender in the
// Union Room. This value is necessarily a power of 2 because of the way it's
// treated in GetUnionRoomTrainerPic / GetUnionRoomTrainerClass
