...
#define ARENA_RESULT_RUNNING                                                   \
  0 // For intermediate steps, when BattleArena_ShowJudgmentWindow should be
    // called again immediately
#define ARENA_RESULT_STEP_DONE                                                 \
  1 // A step has been completed, the script may advance to the next instruction
