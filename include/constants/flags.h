...
// Temporary Flags
// These temporary flags are are cleared every time a map is loaded. They are
// used for things like shortening an NPCs introduction text if the player
// already spoke to them once.
...
#define FLAG_WHITEOUT_TO_LAVARIDGE                                             \
  0x6C // Set after defeating Flannery, so the player cant white out from poison
       // before receiving Go Goggles
...
#define FLAG_UNUSED_RS_LEGENDARY_BATTLE_DONE                                   \
  0x71 // Unused Flag. Used in R/S to indicate whether player defeated or caught
       // Groudon/Kyogre in Cave of Origin.
#define FLAG_SCOTT_CALL_BATTLE_FRONTIER                                        \
  0x72 // Used in order to activate a phone call from Scott, inviting the player
       // to the SS Tidal.
...
#define FLAG_ENABLE_ROXANNE_FIRST_CALL                                         \
  0x80 // Set after defeating Brawly. This will activate a call with Roxanne in
...
#define FLAG_ENABLE_FIRST_WALLY_POKENAV_CALL                                   \
  0x88 // Set after defeating Wally outside Mauville Gym. Will activate a call
       // later to register Wally.
#define FLAG_RECEIVED_HM_CUT 0x89
#define FLAG_SCOTT_CALL_FORTREE_GYM                                            \
  0x8A // Triggers call from Scott after defeating Winona
...
#define FLAG_FAN_CLUB_STRENGTH_SHARED                                          \
  0xD2 // Set when you rate the strength of another trainer in Lilycove's
       // Trainer Fan Club.
...
#define FLAG_WONDER_CARD_UNUSED_1                                              \
  0x13D // These Wonder Card flags are referenced but never set
...
#define FLAG_HIDDEN_ITEM_LAVARIDGE_TOWN_ICE_HEAL                               \
  (FLAG_HIDDEN_ITEMS_START + 0x00)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_GREEN_SHARD                            \
  (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_PEARL (FLAG_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_BIG_PEARL                              \
  (FLAG_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_BLUE_SHARD                             \
  (FLAG_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_1                          \
  (FLAG_HIDDEN_ITEMS_START + 0x0D)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_HEART_SCALE                            \
  (FLAG_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_ULTRA_BALL                             \
  (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_STARDUST                               \
  (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_PEARL (FLAG_HIDDEN_ITEMS_START + 0x11)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_YELLOW_SHARD                           \
  (FLAG_HIDDEN_ITEMS_START + 0x12)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_IRON (FLAG_HIDDEN_ITEMS_START + 0x13)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_BIG_PEARL                              \
  (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_UNDERWATER_127_STAR_PIECE                             \
  (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_UNDERWATER_127_HP_UP (FLAG_HIDDEN_ITEMS_START + 0x16)
#define FLAG_HIDDEN_ITEM_UNDERWATER_127_HEART_SCALE                            \
  (FLAG_HIDDEN_ITEMS_START + 0x17)
#define FLAG_HIDDEN_ITEM_UNDERWATER_127_RED_SHARD                              \
  (FLAG_HIDDEN_ITEMS_START + 0x18)
...
#define FLAG_HIDDEN_ITEM_LILYCOVE_CITY_HEART_SCALE                             \
  (FLAG_HIDDEN_ITEMS_START + 0x1B)
#define FLAG_HIDDEN_ITEM_FALLARBOR_TOWN_NUGGET (FLAG_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_HIDDEN_ITEM_MT_PYRE_EXTERIOR_ULTRA_BALL                           \
  (FLAG_HIDDEN_ITEMS_START + 0x1D)
#define FLAG_HIDDEN_ITEM_ROUTE_113_TM_DOUBLE_TEAM                              \
  (FLAG_HIDDEN_ITEMS_START + 0x1E)
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_1_KEY                               \
  (FLAG_HIDDEN_ITEMS_START + 0x1F)
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_2_KEY                               \
  (FLAG_HIDDEN_ITEMS_START + 0x20)
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_4_KEY                               \
  (FLAG_HIDDEN_ITEMS_START + 0x21)
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_6_KEY                               \
  (FLAG_HIDDEN_ITEMS_START + 0x22)
#define FLAG_HIDDEN_ITEM_SS_TIDAL_LOWER_DECK_LEFTOVERS                         \
  (FLAG_HIDDEN_ITEMS_START + 0x23)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_2                          \
  (FLAG_HIDDEN_ITEMS_START + 0x26)
...
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_EVERSTONE_1                          \
  (FLAG_HIDDEN_ITEMS_START + 0x30)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_EVERSTONE_2                          \
  (FLAG_HIDDEN_ITEMS_START + 0x31)
...
#define FLAG_HIDDEN_ITEM_ROUTE_109_HEART_SCALE_1                               \
  (FLAG_HIDDEN_ITEMS_START + 0x34)
...
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_TINY_MUSHROOM_1                       \
  (FLAG_HIDDEN_ITEMS_START + 0x3B)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_TINY_MUSHROOM_2                       \
  (FLAG_HIDDEN_ITEMS_START + 0x3C)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_POKE_BALL                             \
  (FLAG_HIDDEN_ITEMS_START + 0x3D)
...
#define FLAG_HIDDEN_ITEM_LILYCOVE_CITY_POKE_BALL                               \
  (FLAG_HIDDEN_ITEMS_START + 0x4B)
...
#define FLAG_HIDDEN_ITEM_MT_PYRE_EXTERIOR_MAX_ETHER                            \
  (FLAG_HIDDEN_ITEMS_START + 0x4E)
#define FLAG_HIDDEN_ITEM_MT_PYRE_SUMMIT_ZINC (FLAG_HIDDEN_ITEMS_START + 0x4F)
#define FLAG_HIDDEN_ITEM_MT_PYRE_SUMMIT_RARE_CANDY                             \
  (FLAG_HIDDEN_ITEMS_START + 0x50)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_ULTRA_BALL                            \
  (FLAG_HIDDEN_ITEMS_START + 0x51)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_B2F_ELIXIR                               \
  (FLAG_HIDDEN_ITEMS_START + 0x52)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_B2F_MAX_REPEL                            \
  (FLAG_HIDDEN_ITEMS_START + 0x53)
...
#define FLAG_HIDDEN_ITEM_ROUTE_109_HEART_SCALE_2                               \
  (FLAG_HIDDEN_ITEMS_START + 0x5A)
#define FLAG_HIDDEN_ITEM_ROUTE_109_HEART_SCALE_3                               \
  (FLAG_HIDDEN_ITEMS_START + 0x5B)
#define FLAG_HIDDEN_ITEM_ROUTE_128_HEART_SCALE_1                               \
  (FLAG_HIDDEN_ITEMS_START + 0x5C)
#define FLAG_HIDDEN_ITEM_ROUTE_128_HEART_SCALE_2                               \
  (FLAG_HIDDEN_ITEMS_START + 0x5D)
#define FLAG_HIDDEN_ITEM_ROUTE_128_HEART_SCALE_3                               \
  (FLAG_HIDDEN_ITEMS_START + 0x5E)
#define FLAG_HIDDEN_ITEM_PETALBURG_CITY_RARE_CANDY                             \
  (FLAG_HIDDEN_ITEMS_START + 0x5F)
#define FLAG_HIDDEN_ITEM_ROUTE_116_BLACK_GLASSES                               \
  (FLAG_HIDDEN_ITEMS_START + 0x60)
...
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_CALCIUM                              \
  (FLAG_HIDDEN_ITEMS_START + 0x65)
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_ZINC (FLAG_HIDDEN_ITEMS_START + 0x66)
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_PROTEIN                              \
  (FLAG_HIDDEN_ITEMS_START + 0x67)
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_IRON (FLAG_HIDDEN_ITEMS_START + 0x68)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_SOUTH_EAST_FULL_RESTORE                   \
  (FLAG_HIDDEN_ITEMS_START + 0x69)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_NORTH_EAST_RARE_CANDY                     \
  (FLAG_HIDDEN_ITEMS_START + 0x6A)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_NORTH_EAST_ZINC                           \
  (FLAG_HIDDEN_ITEMS_START + 0x6B)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_SOUTH_EAST_PP_UP                          \
  (FLAG_HIDDEN_ITEMS_START + 0x6C)
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_TOP_SACRED_ASH                             \
  (FLAG_HIDDEN_ITEMS_START + 0x6D)
...
// See constants/opponents.h. The values there + FLAG_TRAINER_FLAG_START are the
// flag IDs

#define TRAINER_FLAGS_START 0x500
#define TRAINER_FLAGS_END                                                      \
  (TRAINER_FLAGS_START + MAX_TRAINERS_COUNT - 1) // 0x85F
...
#define FLAG_IS_CHAMPION                                                       \
  (SYSTEM_FLAGS + 0x1F) // Seems to be related to linking.
...
#define FLAG_SYS_CAVE_SHIP                                                     \
  (SYSTEM_FLAGS + 0x37) // Unused Flag, leftover from R/S debug, presumably used
                        // by Emerald's debug too
...
// The start and end are byte-aligned because the flags are cleared in byte
// increments
...
#define FLAG_SPECIAL_FLAG_UNUSED_0x4003                                        \
  (SPECIAL_FLAGS_START + 0x3) // Unused Flag
