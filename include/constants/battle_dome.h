...
#define CARD_ALTERNATE_SLOT                                                    \
  (1 << 0) // When set, uses an alternate slot to store the incoming card
           // sprites
...
#define MOVE_CARD                                                              \
  (MOVE_CARD_RIGHT | MOVE_CARD_DOWN | MOVE_CARD_LEFT | MOVE_CARD_UP)
...
// Move point indexes for sBattleStyleMovePoints[][], to determine Battle Dome
// trainers battle styles
#define MOVE_POINTS_COMBO                                                      \
  0 // Moves that work well in combination (e.g. Rain Dance + Hydro Pump)
...
#define MOVE_POINTS_DEF                                                        \
  8 // Defensive moves, like Amnesia, Light Screen, or accuracy-lowers
#define MOVE_POINTS_ACCURATE 9
#define MOVE_POINTS_POWERFUL 10 // Most of the moves that are >= 100 power
#define MOVE_POINTS_POPULAR                                                    \
  11 // Group seems arbitrary. All using it are TM/HMs, but its only 11/58
