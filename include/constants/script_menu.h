...
#define MULTI_SSTIDAL_LILYCOVE                                                 \
  8 // Exit only, populated by CreateLilycoveSSTidalMultichoice
...
#define MULTI_UNUSED_SSTIDAL_1                                                 \
  89 // These 4 were replaced by CreateLilycoveSSTidalMultichoice
