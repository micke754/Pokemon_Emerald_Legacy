...
// * 4 is for each byte of data per secret base group in
// sSecretBaseEntrancePositions They are the map number, the entrance warp id,
// and the x/y position in front of the computer
