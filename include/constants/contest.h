...
// CONTEST_WINNER_ARTIST is for the winner of the most recent contest, and is
// not saved.
...
#define CONTEST_WINNER_HALL_UNUSED_1                                           \
  7 // These two have data for gDefaultContestWinners
#define CONTEST_WINNER_HALL_UNUSED_2                                           \
  8 // but there are only 6 paintings in the Contest Hall
...
#define CONTEST_AI_COMMON                                                      \
  (CONTEST_AI_CHECK_BAD_MOVE | CONTEST_AI_CHECK_COMBO |                        \
   CONTEST_AI_CHECK_BORING | CONTEST_AI_CHECK_EXCITEMENT |                     \
   CONTEST_AI_CHECK_ORDER | CONTEST_AI_CHECK_GOOD_MOVE | CONTEST_AI_ERRATIC |  \
   CONTEST_AI_DUMMY_1 | CONTEST_AI_DUMMY_2 | CONTEST_AI_DUMMY_3 |              \
