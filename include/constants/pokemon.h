...
#define FRIENDSHIP_EVENT_BATTLE_ITEM                                           \
  2 // unused, handled by PokemonUseItemEffects
...
// Friendship value that the majority of species use. This was changed in
// Generation 8 to 50.
...
#define EVO_FRIENDSHIP_DAY                                                     \
  2 // Pokémon levels up during the day with friendship ≥ 220
#define EVO_FRIENDSHIP_NIGHT                                                   \
  3                 // Pokémon levels up at night with friendship ≥ 220
#define EVO_LEVEL 4 // Pokémon reaches the specified level
#define EVO_TRADE 5 // Pokémon is traded
#define EVO_TRADE_ITEM                                                         \
  6                // Pokémon is traded while it's holding the specified item
#define EVO_ITEM 7 // specified item is used on Pokémon
#define EVO_LEVEL_ATK_GT_DEF                                                   \
  8 // Pokémon reaches the specified level with attack > defense
#define EVO_LEVEL_ATK_EQ_DEF                                                   \
  9 // Pokémon reaches the specified level with attack = defense
#define EVO_LEVEL_ATK_LT_DEF                                                   \
  10 // Pokémon reaches the specified level with attack < defense
#define EVO_LEVEL_SILCOON                                                      \
  11 // Pokémon reaches the specified level with a Silcoon personality value
#define EVO_LEVEL_CASCOON                                                      \
  12 // Pokémon reaches the specified level with a Cascoon personality value
#define EVO_LEVEL_NINJASK                                                      \
  13 // Pokémon reaches the specified level (special value for Ninjask)
#define EVO_LEVEL_SHEDINJA                                                     \
  14 // Pokémon reaches the specified level (special value for Shedinja)
...
#define EVO_MODE_ITEM_CHECK                                                    \
  3 // If an Everstone is being held, still want to show that the stone *could*
    // be used on that Pokémon to evolve
...
// - Unown has 1 frame, presumably to avoid the work of animating all 28 of its
// forms
