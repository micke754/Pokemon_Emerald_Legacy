...
// The player back pics are assumed to alternate according to the gender values
// (MALE/FEMALE)
...
#define TRAINER_ENCOUNTER_MUSIC_GIRL                                           \
  2 // used for male Tubers and Young Couples too
