...
#define FACILITY_MULTI_OR_EREADER                                              \
  9 // Direct Corner multi battles, multi battle with Steven, and e-Reader
    // battles
...
// This is the default number of battles (or floors, in Battle Pyramid) per
// challenge. There are 2 facilities that differ: Battle Dome
// (DOME_ROUNDS_COUNT) and Battle Pike (NUM_PIKE_ROOMS).
#define FRONTIER_STAGES_PER_CHALLENGE 7

// These sets of facility ids would be redundant if the order was consistent
// The order is important for this set so that all the non-link records can be
// continuous
