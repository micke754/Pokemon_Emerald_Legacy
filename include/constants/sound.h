...
#define CRY_MODE_ENCOUNTER                                                     \
  2 // Used when starting a static encounter, or when a Pokémon is "aggressive"
#define CRY_MODE_HIGH_PITCH                                                    \
  3 // Highest pitch mode, used exclusively by the move Howl
#define CRY_MODE_ECHO_START                                                    \
  4 // For 1st half of cry used by the move Hyper Voice. Played in reverse
...
#define CRY_MODE_GROWL_1                                                       \
  9 // For 1st cry used by the move Growl. Played in reverse
#define CRY_MODE_GROWL_2 10 // For 2nd cry used by the move Growl
#define CRY_MODE_WEAK 11    // Used when a Pokémon is unhealthy
#define CRY_MODE_WEAK_DOUBLES                                                  \
  12 // Equivalent to CRY_MODE_DOUBLES for CRY_MODE_WEAK

// Given to SoundTask_PlayDoubleCry to determine which cry mode to use. Values
// are arbitrary
...
// Cry volume was changed from 125 in R/S to 120 for FRLG/Em, but was
// (accidentally?) not updated outside of sound.c
