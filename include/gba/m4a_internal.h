...
#define SOUND_CHANNEL_SF_ON                                                    \
  (SOUND_CHANNEL_SF_START | SOUND_CHANNEL_SF_STOP | SOUND_CHANNEL_SF_IEC |     \
...
typedef void (*PlyNoteFunc)(u32, struct MusicPlayerInfo *,
                            struct MusicPlayerTrack *);
...
void TrackStop(struct MusicPlayerInfo *mplayInfo,
               struct MusicPlayerTrack *track);
...
void ply_note(u32 note_cmd, struct MusicPlayerInfo *,
              struct MusicPlayerTrack *);
