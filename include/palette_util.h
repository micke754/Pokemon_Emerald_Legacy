...
int InitPulseBlendPaletteSettings(struct PulseBlend *,
                                  const struct PulseBlendSettings *);
...
u8 RouletteFlash_Add(struct RouletteFlashUtil *r0, u8 r1,
                     const struct RouletteFlashSettings *r2);
