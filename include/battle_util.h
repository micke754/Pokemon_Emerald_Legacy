...
#define ABILITY_ON_OPPOSING_FIELD(battlerId, abilityId)                        \
  (AbilityBattleEffects(ABILITYEFFECT_CHECK_OTHER_SIDE, battlerId, abilityId,  \
                        0, 0))
...
// For the first argument of ItemBattleEffects, to deteremine which block of
// item effects to try
...
#define WEATHER_HAS_EFFECT                                                     \
  ((!ABILITY_ON_FIELD(ABILITY_CLOUD_NINE) &&                                   \
    !ABILITY_ON_FIELD(ABILITY_AIR_LOCK)))
#define WEATHER_HAS_EFFECT2                                                    \
  ((!ABILITY_ON_FIELD2(ABILITY_CLOUD_NINE) &&                                  \
    !ABILITY_ON_FIELD2(ABILITY_AIR_LOCK)))
...
u8 AbilityBattleEffects(u8 caseID, u8 battlerId, u8 ability, u8 special,
                        u16 moveArg);
