...
void DrawBattlerOnBg(int bgId, u8 x, u8 y, u8 battlerPosition, u8 paletteId,
                     u8 *tiles, u16 *tilemap, u16 tilesOffset);
...
void AnimLoadCompressedBgTilemapHandleContest(struct BattleAnimBgData *,
                                              const void *, bool32);
...
void StoreSpriteCallbackInData6(struct Sprite *sprite,
                                void (*spriteCallback)(struct Sprite *));
...
void StartMonScrollingBgMask(u8 taskId, int unused, u16 scrollSpeed, u8 battler,
                             bool8 includePartner, u8 numFadeSteps,
