...
// Constants for changing in-contest Condition (the stars that appear during
// appeals)
enum {
  CONDITION_NO_CHANGE,
  CONDITION_GAIN,
...
struct Contest {
  ...
  bool16 sliderHeartsAnimating : 1; // When the slider heart is
...
struct ContestantStatus {
  ...
  u8 conditionMod : 2; // 1: just raised condition; 2: appeal greatly improved
                       // by condition
