...
// Each 4 KiB flash sector contains 3968 bytes of actual data followed by a 128
// byte footer. Only 12 bytes of the footer are used.
...
// If the sector's signature field is not this value then the sector is either
// invalid or empty.
